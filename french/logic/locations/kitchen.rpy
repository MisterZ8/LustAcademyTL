...
translate french i_1_023_test_e91cf7fa:

    # ch_Name "Sam! What are you doing here?"
    ch_Name "Sam! Que fais-tu ici?"
...
translate french i_1_023_test_e246eb6d:
    ...
    Samantha "Tu veux que j'essaye de leur parler..."

# game/logic/locations/kitchen.rpy:47
translate french i_1_023_test_9dffadc6:

    # ch_Name "Sam, you don't have to take care of me all the time!"
    ch_Name "Sam, tu n'as pas à t'occuper de moi tout le temps !"

# game/logic/locations/kitchen.rpy:49
translate french i_1_023_test_12e194a1:

    # ch_Name "They just figured I was working my ass off for the fun of it."
    ch_Name "Ils ont juste pensé que je travaillais comme un fou pour le plaisir."
...
translate french i_1_023_test_df682742:
    ...
    Samantha "Je ne peux pas croire qu'ils te fassent ça ! Qu'est-ce qui leur a pris ?"

# game/logic/locations/kitchen.rpy:59
translate french i_1_023_test_a4fd11f8:

    # ch_Name "Don's punishing me for not going to university."
    ch_Name "Don me punit pour ne pas être allé à l'université."

# game/logic/locations/kitchen.rpy:61
translate french i_1_023_test_d1cb76e7:

    # ch_Name "Teaching me to be independent."
    ch_Name "M'apprendre à être indépendant."
...
translate french i_1_023_test_f93edfa8:
    ...
    ch_Name "Il n'y a pas assez d'argent pour le loyer et l'éducation."

# game/logic/locations/kitchen.rpy:69
translate french i_1_023_test_28909970:

    # Samantha "Did you tell them that? I'm sure Dad will understand."
    Samantha "Tu leur as dit ça ? Je suis sûr que Papa comprendra."

# game/logic/locations/kitchen.rpy:71
translate french i_1_023_test_a9f8e6f1:

    # ch_Name "{i}(What kind of a jerk is he? I doubt it.){/i}"
    ch_Name "{i}(Quel genre d'abruti est-il ? J'en doute.){/i}"

# game/logic/locations/kitchen.rpy:73
translate french i_1_023_test_4c7cf8b1:

    # ch_Name "I dunno. To this moment we failed to come to any understanding."
    ch_Name "Je ne sais pas. Jusqu'à présent, nous n'avons pas réussi à nous entendre."
...
translate french i_1_023_test_3e555eb1:
    ...
    Samantha "Je suis presque sûr d'avoir vu une enveloppe pour toi là-bas."
...
translate french i_1_023_test_0156708f:
    ...
    ch_Name "Je vais vérifier la boîte aux lettres. A plus tard."

# game/logic/locations/kitchen.rpy:96
translate french kitchen_label_2_04a5fbe8:

    # Olivia "Heard you talked to Don."
    Olivia "J'ai entendu dire que tu avais parlé à Don."

# game/logic/locations/kitchen.rpy:98
translate french kitchen_label_2_245f2fa8:

    # Olivia "How'd it go?"
    Olivia "Comment cela s'est-il passé?"

# game/logic/locations/kitchen.rpy:100
translate french kitchen_label_2_1ad560a9:

    # ch_Name "We're not done talking yet."
    ch_Name "Nous n'avons pas encore fini de parler."
...
translate french kitchen_label_2_3902fe2a:
    ...
    Olivia "Prends ton temps, [Nom]."

# game/logic/locations/kitchen.rpy:106
translate french kitchen_label_2_8ea066ad:

    # Olivia "Let me take a look at that letter."
    Olivia "Laisse-moi jeter un œil à cette lettre."

# game/logic/locations/kitchen.rpy:108
translate french kitchen_label_2_253c8c6a:

    # ch_Name "But there's nothing interesting here."
    ch_Name "Mais il n'y a rien d'intéressant ici."

# game/logic/locations/kitchen.rpy:110
translate french kitchen_label_2_d4047bce:

    # ch_Name "It's just a stupid prank from Samantha."
    ch_Name "C'est juste une blague stupide de Samantha."

# game/logic/locations/kitchen.rpy:112
translate french kitchen_label_2_c451f516:

    # Olivia "I see you've already read it..."
    Olivia "Je vois que tu l'as déjà lu..."
...
translate french kitchen_label_2_abec28f9:
    ...
    ch_Name "{i}(Olivia agit bizarrement ces derniers temps. Elle devrait arrêter de boire.){/i}"
...
translate french kitchen_label_2_17f221c8:
    ...
    ch_Name "{i}(je devrais suivre et écouter...){/i}"
