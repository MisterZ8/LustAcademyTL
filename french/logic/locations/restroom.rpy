...
translate french restroom_label_ecefc0d1:

    # ch_Name "How's it going, how's work?"
    ch_Name "Comment ça va,comment est le travail "
...
translate french restroom_label_3b0c1b5a:
    ...
    Don "Ne me fais pas perdre mon temps."
...
translate french restroom_label_58012455:

    # ch_Name "And? I'd like to discuss your rental idea..."
    ch_Name "Et? J'aimerais discuter de votre idée de location..."

# game/logic/locations/restroom.rpy:31
translate french restroom_label_81537022:

    # Don "It's not an idea."
    Don "Ce n'est pas une idée."

# game/logic/locations/restroom.rpy:33
translate french restroom_label_a410d3a2:

    # Don "It's a fact you've been informed about."
    Don "C'est un fait dont vous avez été informé."
...
translate french restroom_label_f5f74f6c:
    ...
    Don "Et puisque tu as 18 ans et que tu travailles..."

# game/logic/locations/restroom.rpy:39
translate french restroom_label_e0555c31:

    # Don "Why should I sweat for another grown man?"
    Don "Pourquoi devrais-je transpirer pour un autre homme adulte ?"
...
translate french restroom_label_6f619831:
    ...
    ch_Name "Tu sais que j'ai eu une bourse sportive..."

# game/logic/locations/restroom.rpy:51
translate french restroom_label_dce7c30c:

    # Don "So?"
    Don "Alors?"

# game/logic/locations/restroom.rpy:53
translate french restroom_label_9c8b6339:

    # ch_Name "If it wasn't for the injury, then..."
    ch_Name "Si ce n'était pas pour la blessure, alors..."
...
translate french restroom_label_5e4ace9f:
    ...
    Don "Tu as 18 ans. Tu n'étudies pas et tu es assis sur mon cou."
...
translate french restroom_label_f6015940:
    ...
    ch_Name "Pour payer l'université. Tu sais ce que je veux dire?"
...
translate french restroom_label_53b0ab25:

    # ch_Name "If I have to pay your rent."
    ch_Name "Si je dois payer votre loyer."
...
translate french restroom_label_3bb46233:
    ...
    ch_Name "C'est un cercle vicieux. Tu ne peux pas être sérieux... je veux dire..."
...
translate french restroom_label_18b25c53:
    ...
    Don "Bien sûr, je peux. Mais je m'en fiche."
...
translate french restroom_menu_2_label_0843679a:
    ...
    ch_Name "Si quelqu'un n'avait pas économisé de l'argent sur ma rééducation."

# game/logic/locations/restroom.rpy:118
translate french restroom_menu_2_label_0252acee:

    # ch_Name "I'm not saying you had to..."
    ch_Name "Je ne dis pas que tu devais..."
...
translate french restroom_menu_2_label_d80e228a:
    ...
    Don "Où serais-tu si ce n'était pas pour moi ?"
...
translate french restroom_menu_3_label_1b0b05ae:
    ...
    ch_Name "Je... j'ai besoin de réfléchir."

# game/logic/locations/restroom.rpy:158
translate french restroom_menu_3_label_4af10fbd:

    # ch_Name "I'm sorry, I'm gonna..."
    ch_Name "Je suis désolé, je vais..."

# game/logic/locations/restroom.rpy:160
translate french restroom_menu_3_label_c5b7df6d:

    # Don "Go on, get out of here."
    Don "Allez, sors d'ici."

# game/logic/locations/restroom.rpy:162
translate french restroom_menu_3_label_1f8ee931:

    # Don "And welcome to adulthood, boy!"
    Don "Et bienvenue à l'âge adulte, garçon!"
...
translate french restroom_menu_3_label_41ea1485:
    ...
    ch_Name "{i}(Putain d'hypocrite.){/i}"
