...
translate french strings:
    ...
    new "Pour une récompense, retournes ce livre à Amelie dans la bibliothèque"
    ...
    new "Ici, tu peux garder une trace de tous les itinéraires, activités, etc. qui sont à ta disposition, et naviguer avec aisance"
    ...
    new "vers celui voulue, sans perdre de temps à parcourir les lieux et à chercher. À côté de"

    # game/logic/main_interface/quest_log_screen.rpy:887
    old "avatars of the characters are icons, the decoding of which is next."
    new "l'avatar des personnages se trouve des icônes dont la signification apparaît au survol."
    ...
    new "À cette heure de la journée, cet itinéraire n'est pas disponible. Choisir cette option entraînera un saut dans le temps. Continuez ?"
