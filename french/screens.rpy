...
translate french strings:
    ...
    new "Passer à un dialogue ultérieur."

    # game/screens.rpy:2855
    old "Opens the inventory menu."
    new "Ouvre le menu d'inventaire."

    # game/screens.rpy:2855
    old "Opens the phone menu."
    new "Ouvre le menu du téléphone."

    # game/screens.rpy:2855
    old "Opens the list of available routes."
    new "Ouvre la liste des itinéraires disponibles."
    ...
    new "Basculer le saut de dialogue."
    ...
    new "Met en surbrillance tous les objets actifs."

    # game/screens.rpy:2880
    old "Enables fullscreen mode."
    new "Active le mode plein écran."
