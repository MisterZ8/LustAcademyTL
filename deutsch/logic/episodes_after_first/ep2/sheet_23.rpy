...
translate deutsch sheet_23_95435110:
    ...
    Victoria "Ja, ich erinnere mich an dich. {w} Komm herein. Geh in die Mitte des Raums."

# game/logic/episodes_after_first/ep2/sheet_23.rpy:9
translate deutsch sheet_23_7ff95dd1:

    # Victoria "Stand across from the board."
    Victoria "Stell dich gegenüber der Tafel auf."

# game/logic/episodes_after_first/ep2/sheet_23.rpy:11
translate deutsch sheet_23_a2243e3f:

    # Victoria "Your task is to create a simple magical glyph in the air."
    Victoria "Deine Aufgabe ist es, eine einfache magische Glyphe in der Luft zu erschaffen."
...
translate deutsch sheet_23_menu_2_2d98ec54:

    # ch_Name "{i}(Alright, let's focus on something you feel passionate about!){/i}"
    ch_Name "{i}(In Ordnung, konzentrieren wir uns auf etwas, für das wir eine Leidenschaft haben!){/i}"
...
translate deutsch sheet_23_menu_2_0befe970:
    ...
    ch_Name "{i}(Vielleicht diese Kellnerin nach dem Pokalspiel im letzten März?){/i}"

# game/logic/episodes_after_first/ep2/sheet_23.rpy:43
translate deutsch sheet_23_menu_2_8648b8e3:

    # ch_Name "{i}(No, I can barely remember her face...){/i}"
    ch_Name "{i}(Nein, ich kann mich kaum an ihr Gesicht erinnern...){/i}"

# game/logic/episodes_after_first/ep2/sheet_23.rpy:45
translate deutsch sheet_23_menu_2_62976ed9:

    # ch_Name "{i}(Maybe... Nah...){/i}"
    ch_Name "{i}(Vielleicht... nein...){/i}"

# game/logic/episodes_after_first/ep2/sheet_23.rpy:47
translate deutsch sheet_23_menu_2_481e1933:

    # ch_Name "{i}(Oh snap, I can't remember anything.){/i}"
    ch_Name "{i}(Ach verdammt, ich kann mich an nichts erinnern.){/i}"
...
translate deutsch sheet_23_olivia_b34ec7f3:
    ...
    ch_Name "{i}(Ein Gedanke an Olivias gottgleiche Figur erfüllt mich mit Kraft!){/i}"

# game/logic/episodes_after_first/ep2/sheet_23.rpy:78
translate deutsch sheet_23_haley_1a444368:

    # ch_Name "{i}(Haley is the most magical creature I've seen...){/i}"
    ch_Name "{i}(Haley ist die magischste Kreatur, die ich je gesehen habe...){/i}"
...
translate deutsch sheet_23_energy_4e743823:
    ...
    ch_Name "{i}(Ich spüre so viel Energie!){/i}"

translate deutsch strings:

    # game/logic/episodes_after_first/ep2/sheet_23.rpy:17
    old "Always ready!"
    new "Ich bin immer bereit!"
