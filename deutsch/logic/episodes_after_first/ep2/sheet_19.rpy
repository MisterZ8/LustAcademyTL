...
translate deutsch sheet_19_de22dd03:

    # UnknownJacob "All set? "
    UnknownJacob "Alle da?"

# game/logic/episodes_after_first/ep2/sheet_19.rpy:12
translate deutsch sheet_19_5e301744:

    # UnknownJacob "Great, let's begin!"
    UnknownJacob "Großartig, fangen wir an!"
...
translate deutsch sheet_19_142f896f:
    ...
    UnknownJacob "Anwerber!"

# game/logic/episodes_after_first/ep2/sheet_19.rpy:18
translate deutsch sheet_19_317d1e3d:

    # UnknownJacob "I am here to welcome you!"
    UnknownJacob "Ich bin hier, um Euch willkommen zu heißen!"

# game/logic/episodes_after_first/ep2/sheet_19.rpy:20
translate deutsch sheet_19_2876f8c6:

    # UnknownJacob "There you can see the Academy itself! "
    UnknownJacob "Dort hinten könnt ihr die Akademie sehen!"
...
translate deutsch sheet_19_ad65eec5:
    ...
    ch_Name "{i}(Sie sieht so gepflegt aus...){/i}"

# game/logic/episodes_after_first/ep2/sheet_19.rpy:26
translate deutsch sheet_19_7a01eddb:

    # ch_Name "{i}(I can't wait to get a closer look!){/i}"
    ch_Name "{i}(Ich kann es kaum erwarten, einen genaueren Blick auf sie zu werfen!){/i}"
...
translate deutsch sheet_19_04538919:
    ...
    UnknownJacob "... oder scheitern und diesen Ort für immer verlassen."

# game/logic/episodes_after_first/ep2/sheet_19.rpy:34
translate deutsch sheet_19_0aba2282:

    # UnknownJacob "Oh, by the way — My name is Jacob Constantine."
    UnknownJacob "Ach, übrigens – mein Name ist Jacob Constantine."

# game/logic/episodes_after_first/ep2/sheet_19.rpy:36
translate deutsch sheet_19_0c80d2cb:

    # Jacob "I'm the teacher of defense against the dark magic."
    Jacob "Ich bin der Lehrer der Verteidigung gegen die dunklen Künste."
...
translate deutsch sheet_19_eccdf630:
    ...
    ch_Name "[Name]. Entschuldigung, ich meinte das nicht respektlos..."

# game/logic/episodes_after_first/ep2/sheet_19.rpy:124
translate deutsch sheet_19_453b3226:

    # ch_Name "But how can I pass an exam if I have never practiced magic before?"
    ch_Name "Aber wie kann ich eine Prüfung bestehen, wenn ich noch nie gezaubert habe?"
...
translate deutsch sheet_19_2c6f27e9:
    ...
    ch_Name "Aber es fühlt sich an, als wäre ich nur [Name]..."
...
translate deutsch sheet_19_df59ad17:
    ...
    Jacob "Und das gilt für Sie alle – wenn Sie eingeladen wurden, steckt Magie in Ihnen."

# game/logic/episodes_after_first/ep2/sheet_19.rpy:136
translate deutsch sheet_19_639c04ac:

    # Jacob "Just try your best to find it when the time comes!"
    Jacob "Versuchen Sie einfach Ihr Bestes, um sie zu finden, wenn die Zeit gekommen ist!"

# game/logic/episodes_after_first/ep2/sheet_19.rpy:138
translate deutsch sheet_19_f881e1a2:
