...
translate deutsch strings:
    ...
    old "Lost foliant"
    new "Verlorener Foliant"

    # game/logic/main_interface/quest_log_screen.rpy:130
    old "Return this book to Amelie in the library for a reward"
    new "Bringe dieses Buch zu Amelie in die Bibliothek und erhalte eine Belohnung"
    ...
    new "Dieser Zauber ist noch nicht erlenrt."
    ...
    new "'s Geschichte für diese Version des Spiels ist zu einem Ende gekommen."
    ...
    new "Hier können sie alle Routen, Aktivitäten usw., die Ihnen zur Verfügung stehen, im Auge behalten und schnell navigieren."
    ...
    new "zum gewünschten Ort springen, ohne Zeit mit dem Herumlaufen und Suchen zu verschwenden. Neben dem"

    # game/logic/main_interface/quest_log_screen.rpy:887
    old "avatars of the characters are icons, the decoding of which is next."
    new "Die Avatare der Figuren sind Icons, deren Kodierung als nächstes erfolgt."
    ...
    new "Diese Route ist zu dieser Tageszeit nicht verfügbar. Die Wahl dieser Option führt zu einem Zeitsprung. Weiter?"
