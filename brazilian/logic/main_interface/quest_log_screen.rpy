...
translate brazilian strings:
    ...
    new "Devolva esse livro para Amelie na biblioteca para uma recompensa"
    ...
    new "Esse feitiço ainda não foi aprendido."
    ...
    new " - A estória para essa versão do jogo chegou ao fim."
    ...
    new "Aqui você pode registrar todas as rotas, atividades, etc. que estão disponíveis para você e navegar rapidamente"
    ...
    new "para o ponto desejado, sem perder tempo andando pelos locais e procurando. Próximo aos"

    # game/logic/main_interface/quest_log_screen.rpy:887
    old "avatars of the characters are icons, the decoding of which is next."
    new "avatares das personagens há ícones, cuja decodificação se segue."
    ...
    new "Essa rota não está disponível nesse momento do dia. Escolher essa opção levará a um salto de tempo. Continua?"
