...
translate brazilian MagicMiniGameLabel_start_534d5c17:

    # "Score: [b]%%"
    ""

# game/logic/mini_games/magick/logic.rpy:1300
translate brazilian MagicMiniGameLabel_start_534d5c17_1:

    # "Score: [b]%%"
    ""

# game/logic/mini_games/magick/logic.rpy:1305
translate brazilian MagicMiniGameLabel_start_534d5c17_2:

    # "Score: [b]%%"
    ""

# game/logic/mini_games/magick/logic.rpy:1311
translate brazilian MagicMiniGameLabel_start_52f9ac40:

    # Victoria "Pleasant surprise, Mr. [Surname]. "
    Victoria "Agradável surpresa, Sr. [Surname]. "

# game/logic/mini_games/magick/logic.rpy:1313
translate brazilian MagicMiniGameLabel_start_95b14f4c:

    # Victoria "I can see you have good potential. "
    Victoria "Eu consigo ver que você tem um bom potencial."

# game/logic/mini_games/magick/logic.rpy:1315
translate brazilian MagicMiniGameLabel_start_a35cab29:

    # ch_Name "{i}(Hell yes I do! That was too easy!){/i}"
    ch_Name "{i}(Deixa comigo! Isso foi muito fácil!){/i}"

# game/logic/mini_games/magick/logic.rpy:1317
translate brazilian MagicMiniGameLabel_start_c7ecc92d:

    # Victoria "Let's see if you can do even better."
    Victoria "Vamos ver se você pode fazer ainda melhor."

# game/logic/mini_games/magick/logic.rpy:1319
translate brazilian MagicMiniGameLabel_start_d92a5811:

    # ch_Name "{i}(Bring it on!){/i}"
    ch_Name "{i}(Pode vir!){/i}"

# game/logic/mini_games/magick/logic.rpy:1331
translate brazilian MagicMiniGameLabel_start_3f34e206:

    # Victoria "Not bad for the first time!"
    Victoria "Nada mal para a primeira vez!"

# game/logic/mini_games/magick/logic.rpy:1333
translate brazilian MagicMiniGameLabel_start_bb1ea8fb:

    # Victoria "But I've had more capable students."
    Victoria "eu já tive alunos mais capacitados."

# game/logic/mini_games/magick/logic.rpy:1335
translate brazilian MagicMiniGameLabel_start_fe28887d:

    # ch_Name "{i}(Not bad? I can do better than \"not bad\"! Come on, [Name]!){/i}"
    ch_Name "{i}(Nada mal? eu posso fazer melhor do que \"not bad\"! Vamos lá, [Name]!){/i}"

# game/logic/mini_games/magick/logic.rpy:1337
translate brazilian MagicMiniGameLabel_start_b59241f6:

    # Victoria "Let's try to make it more difficult..."
    Victoria "Vamos dificultar mais um pouquinho..."

# game/logic/mini_games/magick/logic.rpy:1348
translate brazilian MagicMiniGameLabel_start_ae3a718c:

    # Victoria "[Surname], you're on the verge of failure."
    Victoria "[Surname], você está à beira do fracasso."

# game/logic/mini_games/magick/logic.rpy:1350
translate brazilian MagicMiniGameLabel_start_bfde3b6e:

    # Victoria "That kind of concentration is no good!"
    Victoria "Esse tipo de concentração não é nada bom!"

# game/logic/mini_games/magick/logic.rpy:1352
translate brazilian MagicMiniGameLabel_start_c7db4080:

    # ch_Name "{i}(Crap... I need to focus! I won't lose this!){/i}"
    ch_Name "{i}(Merda... Eu preciso me concentrar! Eu não posso perder isso!){/i}"

# game/logic/mini_games/magick/logic.rpy:1354
translate brazilian MagicMiniGameLabel_start_2057d564:

    # Victoria "Try again."
    Victoria "Tente Novamente."

# game/logic/mini_games/magick/logic.rpy:1373
translate brazilian MagicMiniGameLabel_start_76cf645d:

    # Victoria "Very good, Mr. [Surname]! "
    Victoria "Muito Bom, Mr. [Surname]! "

# game/logic/mini_games/magick/logic.rpy:1375
translate brazilian MagicMiniGameLabel_start_f5887d1f:

    # Victoria "It is clear that you have potential."
    Victoria "É claro que você tem potencial."

# game/logic/mini_games/magick/logic.rpy:1377
translate brazilian MagicMiniGameLabel_start_a35cab29_1:

    # ch_Name "{i}(Hell yes I do! That was too easy!){/i}"
    ch_Name "{i}(Inferno, sim eu faço! Isso foi muito fácil!){/i}"

# game/logic/mini_games/magick/logic.rpy:1379
translate brazilian MagicMiniGameLabel_start_02c377d2:

    # Victoria "Let's see how good can you use it right now."
    Victoria "Vamos ver o quão bem você pode usá-lo agora."

# game/logic/mini_games/magick/logic.rpy:1381
translate brazilian MagicMiniGameLabel_start_e3fd81f2:

    # Victoria "Your last try! Go!"
    Victoria "Sua última tentativa! Vai!"

# game/logic/mini_games/magick/logic.rpy:1392
translate brazilian MagicMiniGameLabel_start_0762e342:

    # Victoria "Not bad, [Surname]!"
    Victoria "Nada mal, [Surname]!"

# game/logic/mini_games/magick/logic.rpy:1394
translate brazilian MagicMiniGameLabel_start_1d601a68:

    # Victoria "I'm really interested to see what else you can do!"
    Victoria "Estou realmente interessado em ver o que mais você pode fazer!"

# game/logic/mini_games/magick/logic.rpy:1396
translate brazilian MagicMiniGameLabel_start_c9b75c44:

    # ch_Name "{i}(Is this a dream, or am I really that good?!){/i}"
    ch_Name "{i}(Isso é um sonho ou eu sou tão foda assim?!){/i}"

# game/logic/mini_games/magick/logic.rpy:1398
translate brazilian MagicMiniGameLabel_start_1ce574b3:

    # Victoria "Last one will be even more difficult. Get ready!"
    Victoria "A última será ainda mais difícil. Prepare-se!"

# game/logic/mini_games/magick/logic.rpy:1400
translate brazilian MagicMiniGameLabel_start_d446a654:

    # ch_Name "{i}(I am ready!){/i}"
    ch_Name "{i}(Estou pronto!){/i}"

# game/logic/mini_games/magick/logic.rpy:1413
translate brazilian MagicMiniGameLabel_start_741d3d54:

    # Victoria "Mr. [Surname]! "
    Victoria "Sr. [Surname]! "

# game/logic/mini_games/magick/logic.rpy:1415
translate brazilian MagicMiniGameLabel_start_cf1ab158:

    # Victoria "I recommend that you take this task more seriously."
    Victoria "Eu recomendo que você leve essa tarefa mais a sério."

# game/logic/mini_games/magick/logic.rpy:1417
translate brazilian MagicMiniGameLabel_start_89f14e91:

    # ch_Name "{i}(I can do better, I know it!){/i}"
    ch_Name "{i}(Eu posso fazer melhor, eu sei disso!){/i}"

# game/logic/mini_games/magick/logic.rpy:1419
translate brazilian MagicMiniGameLabel_start_57821ef8:

    # Victoria "I'll give you one more try."
    Victoria "Vou te dar mais uma tentativa."

# game/logic/mini_games/magick/logic.rpy:1429
translate brazilian MagicMiniGameLabel_start_6e9e64fd:

    # Victoria "Better. "
    Victoria "Melhor. "

# game/logic/mini_games/magick/logic.rpy:1431
translate brazilian MagicMiniGameLabel_start_6563baa8:

    # Victoria "Bot not perfect."
    Victoria "Mas não é perfeito."

# game/logic/mini_games/magick/logic.rpy:1433
translate brazilian MagicMiniGameLabel_start_633835da:

    # ch_Name "{i}(I can nail this. Just need a little bit more focus.){/i}"
    ch_Name "{i}(Eu posso resolver isso. Só preciso de um pouco mais de foco.){/i}"

# game/logic/mini_games/magick/logic.rpy:1435
translate brazilian MagicMiniGameLabel_start_197779c1:

    # Victoria "Let's make the task more difficult this time..."
    Victoria "Vamos tornar a tarefa mais difícil desta vez..."

# game/logic/mini_games/magick/logic.rpy:1447
translate brazilian MagicMiniGameLabel_start_f323cd98:

    # Victoria "No, no, no... "
    Victoria "Não, não, não... "

# game/logic/mini_games/magick/logic.rpy:1449
translate brazilian MagicMiniGameLabel_start_3819cf7a:

    # Victoria "This is not the level I expect from my future students. "
    Victoria "Este não é o nível que espero dos meus futuros alunos."

# game/logic/mini_games/magick/logic.rpy:1451
translate brazilian MagicMiniGameLabel_start_30d06949:

    # ch_Name "Sorry, I've probably got disctracted. "
    ch_Name "Desculpe, eu me distraí."

# game/logic/mini_games/magick/logic.rpy:1453
translate brazilian MagicMiniGameLabel_start_94ad9efb:

    # Victoria "You still have one more try to impress me."
    Victoria "Você ainda tem mais uma tentativa de me impressionar."

# game/logic/mini_games/magick/logic.rpy:1455
translate brazilian MagicMiniGameLabel_start_7b1ee978:

    # ch_Name "{i}(it's now or never!){/i}"
    ch_Name "{i}(é agora ou nunca!){/i}"

# game/logic/mini_games/magick/logic.rpy:1473
translate brazilian MagicMiniGameLabel_start_881eaffe:

    # Victoria "You're a little bit bellow our standart level, mister [Surname]. "
    Victoria "Você está um pouco abaixo do seu nível padrão, senhor [Surname]."

# game/logic/mini_games/magick/logic.rpy:1475
translate brazilian MagicMiniGameLabel_start_ad616660:

    # ch_Name "{i}(...Shit.){/i}"
    ch_Name "{i}(...Merda.){/i}"

# game/logic/mini_games/magick/logic.rpy:1477
translate brazilian MagicMiniGameLabel_start_f947e5e6:

    # ch_Name "{i}(I was so close. Is this... the end?){/i}"
    ch_Name "{i}(Eu estava tão perto. Isso é... o fim?){/i}"

# game/logic/mini_games/magick/logic.rpy:1479
translate brazilian MagicMiniGameLabel_start_f5e2f167:

    # Victoria "But you've still managed to form a solid glyph for an entrant."
    Victoria "Mas você ainda conseguiu formar um glifo sólido para um participante."

# game/logic/mini_games/magick/logic.rpy:1481
translate brazilian MagicMiniGameLabel_start_89885c2d:

    # "#нет 1_196_7"
    ""

# game/logic/mini_games/magick/logic.rpy:1482
translate brazilian MagicMiniGameLabel_start_3ead61ac:

    # ch_Name "Does this mean...?"
    ch_Name "Isso significa...?"

# game/logic/mini_games/magick/logic.rpy:1484
translate brazilian MagicMiniGameLabel_start_b9e81ea2:

    # Victoria "Yes, but if you want to stay at this school, you'll have to show a special zeal for your studies."
    Victoria "Sim, mas se você quiser ficar nesta escola, terá que mostrar um zelo especial pelos seus estudos."

# game/logic/mini_games/magick/logic.rpy:1486
translate brazilian MagicMiniGameLabel_start_92fd40f4:

    # Victoria "You're enrolled."
    Victoria "Você está matriculado."

# game/logic/mini_games/magick/logic.rpy:1488
translate brazilian MagicMiniGameLabel_start_f6c3c213:

    # Victoria "For now."
    Victoria "Por Agora"

# game/logic/mini_games/magick/logic.rpy:1490
translate brazilian MagicMiniGameLabel_start_0b177c20:
...
translate brazilian MagicMiniGameLabel_start_c5219be6:
...
translate brazilian MagicMiniGameLabel_start_b100d14c:

    # ch_Name "I do."
    ch_Name "Pode deixar."

# game/logic/mini_games/magick/logic.rpy:1496
translate brazilian MagicMiniGameLabel_start_4bca6a71:
...
translate brazilian MagicMiniGameLabel_start_2aa2ed5c:

    # ch_Name "Thank you!"
    ch_Name "Obrigado!"

# game/logic/mini_games/magick/logic.rpy:1505
translate brazilian MagicMiniGameLabel_start_3ce71e31:

    # Victoria "Well..."
    Victoria "Bem..."

# game/logic/mini_games/magick/logic.rpy:1507
translate brazilian MagicMiniGameLabel_start_48c90ecb:
...
translate brazilian MagicMiniGameLabel_start_2c933c65:

    # ch_Name "{i}(Does this mean...?){/i}"
    ch_Name "{i}(Isso significa...?){/i}"

# game/logic/mini_games/magick/logic.rpy:1511
translate brazilian MagicMiniGameLabel_start_92fd40f4_1:

    # Victoria "You're enrolled."
    Victoria "Você está matriculado."

# game/logic/mini_games/magick/logic.rpy:1513
translate brazilian MagicMiniGameLabel_start_f6c3c213_1:

    # Victoria "For now."
    Victoria "Por enquanto."

# game/logic/mini_games/magick/logic.rpy:1515
translate brazilian MagicMiniGameLabel_start_0b177c20_1:

    # Victoria "But you'll have to show a special zeal for your studies."
    Victoria "Mas você terá que mostrar um zelo especial pelos seus estudos."

# game/logic/mini_games/magick/logic.rpy:1517
translate brazilian MagicMiniGameLabel_start_c5219be6_1:

    # Victoria "If you want to stay at this academy."
    Victoria "Se você quiser ficar nesta academia."

# game/logic/mini_games/magick/logic.rpy:1519
translate brazilian MagicMiniGameLabel_start_b100d14c_1:

    # ch_Name "I do."
    ch_Name "Eu faço."

# game/logic/mini_games/magick/logic.rpy:1521
translate brazilian MagicMiniGameLabel_start_4bca6a71_1:

    # ch_Name "I mean... I will. A special zeal from now on!"
    ch_Name "Quero dizer... eu vou. Um zelo especial a partir de agora!"

# game/logic/mini_games/magick/logic.rpy:1523
translate brazilian MagicMiniGameLabel_start_2aa2ed5c_1:

    # ch_Name "Thank you!"
    ch_Name "Obrigado!"

# game/logic/mini_games/magick/logic.rpy:1531
translate brazilian MagicMiniGameLabel_start_3ce71e31_1:

    # Victoria "Well..."
    Victoria "Bem..."

# game/logic/mini_games/magick/logic.rpy:1533
translate brazilian MagicMiniGameLabel_start_48c90ecb_1:

    # Victoria "At least you achieved some result."
    Victoria "Pelo menos você conseguiu algum resultado."

# game/logic/mini_games/magick/logic.rpy:1535
translate brazilian MagicMiniGameLabel_start_2c933c65_1:

    # ch_Name "{i}(Does this mean...?){/i}"
    ch_Name "{i}(Isso significa...?){/i}"

# game/logic/mini_games/magick/logic.rpy:1537
translate brazilian MagicMiniGameLabel_start_92fd40f4_2:

    # Victoria "You're enrolled."
    Victoria "Você está matriculado."

# game/logic/mini_games/magick/logic.rpy:1539
translate brazilian MagicMiniGameLabel_start_f6c3c213_2:

    # Victoria "For now."
    Victoria "Por enquanto."

# game/logic/mini_games/magick/logic.rpy:1541
translate brazilian MagicMiniGameLabel_start_0b177c20_2:

    # Victoria "But you'll have to show a special zeal for your studies."
    Victoria "Mas você terá que mostrar um zelo especial pelos seus estudos."

# game/logic/mini_games/magick/logic.rpy:1543
translate brazilian MagicMiniGameLabel_start_c5219be6_2:

    # Victoria "If you want to stay at this academy."
    Victoria "Se você quiser ficar nesta academia."

# game/logic/mini_games/magick/logic.rpy:1545
translate brazilian MagicMiniGameLabel_start_b100d14c_2:

    # ch_Name "I do."
    ch_Name "Eu faço."

# game/logic/mini_games/magick/logic.rpy:1547
translate brazilian MagicMiniGameLabel_start_4bca6a71_2:

    # ch_Name "I mean... I will. A special zeal from now on!"
    ch_Name "Quero dizer... eu vou. Um zelo especial a partir de agora!"

# game/logic/mini_games/magick/logic.rpy:1549
translate brazilian MagicMiniGameLabel_start_2aa2ed5c_2:

    # ch_Name "Thank you!"
    ch_Name "Obrigado!"

# game/logic/mini_games/magick/logic.rpy:1553
translate brazilian MagicMiniGameLabel_start_9220e8bd:

    # Victoria "Congratulations, Mr. [Surname]! "
    Victoria "Parabéns, Sr. [Surname]! "

# game/logic/mini_games/magick/logic.rpy:1555
translate brazilian MagicMiniGameLabel_start_6828e998:

    # Victoria "You have passed this exam. "
    Victoria ""

# game/logic/mini_games/magick/logic.rpy:1557
translate brazilian MagicMiniGameLabel_start_f93cc8d8:

    # Victoria "You have good potential! "
    Victoria "Você passou desse exame."

# game/logic/mini_games/magick/logic.rpy:1559
translate brazilian MagicMiniGameLabel_start_9225d683:

    # Victoria "Someday you may even become a worthy wizard!"
    Victoria "Algum dia você pode até se tornar um mago digno!"

# game/logic/mini_games/magick/logic.rpy:1561
translate brazilian MagicMiniGameLabel_start_184c9b55:

    # ch_Name "Thank you, miss Lapis!"
    ch_Name "Obrigado, Srta Lapis!"

# game/logic/mini_games/magick/logic.rpy:1563
translate brazilian MagicMiniGameLabel_start_8080efb6:

    # ch_Name "I won't dissapoint you!"
    ch_Name "Eu não vou te decepcionar!"

# game/logic/mini_games/magick/logic.rpy:1572
translate brazilian MagicMiniGameLabel_start_1827442b:

    # Victoria "Don't feel bad, Mr. [Surname]. "
    Victoria "Não se sinta mal, Sr. [Surname]."

# game/logic/mini_games/magick/logic.rpy:1574
translate brazilian MagicMiniGameLabel_start_ac5b164c:

    # Victoria "I see such results on this test very rarely."
    Victoria "Raramente eu vejo esses resultados neste teste."

# game/logic/mini_games/magick/logic.rpy:1576
translate brazilian MagicMiniGameLabel_start_18075a81:

    # ch_Name "Was it that bad?"
    ch_Name "Foi tão ruim assim?"

# game/logic/mini_games/magick/logic.rpy:1578
translate brazilian MagicMiniGameLabel_start_cf5a3409:

    # Victoria "On the contrary!"
    Victoria "Pelo contrário!"

# game/logic/mini_games/magick/logic.rpy:1580
translate brazilian MagicMiniGameLabel_start_d94cdafd:

    # Victoria "A very decent result. But I think you can do better!"
    Victoria "Um resultado muito decente. Mas acho que você pode fazer melhor!"

# game/logic/mini_games/magick/logic.rpy:1582
translate brazilian MagicMiniGameLabel_start_7fedbcc4:

    # Victoria "You're accepted. "
    Victoria "Você foi aceito"

# game/logic/mini_games/magick/logic.rpy:1584
translate brazilian MagicMiniGameLabel_start_9775addb:

    # Victoria "You'll need a lot of practice to get even better."
    Victoria "Você vai precisar de muita prática para ficar ainda melhor."

# game/logic/mini_games/magick/logic.rpy:1586
translate brazilian MagicMiniGameLabel_start_35fe932f:

    # ch_Name "I'm looking forward to it!"
    ch_Name "Estou ansioso para isso!"

# game/logic/mini_games/magick/logic.rpy:1588
translate brazilian MagicMiniGameLabel_start_7f146367:

    # Victoria "Nice zeal, don't lose it!"
    Victoria "ótimo cuidado, não o perca!"

# game/logic/mini_games/magick/logic.rpy:1592
translate brazilian MagicMiniGameLabel_start_e9844cc3:

    # Victoria "Great result, [Name]! "
    Victoria "Ótimo resultado, [Name]! "

# game/logic/mini_games/magick/logic.rpy:1594
translate brazilian MagicMiniGameLabel_start_c3729fcc:

    # Victoria "You are definitely accepted!"
    Victoria "Você está definitivamente aceito!"

# game/logic/mini_games/magick/logic.rpy:1596
translate brazilian MagicMiniGameLabel_start_67b2f21b:

    # Victoria "You have a great future ahead of you. "
    Victoria "Você terá um grande futuro pela frente."

# game/logic/mini_games/magick/logic.rpy:1598
translate brazilian MagicMiniGameLabel_start_64fe1295:

    # Victoria "And I will do my best to help you reach your potential!"
    Victoria "Eu farei o meu melhor para ajudá-lo a alcançar os seus objetivos"

# game/logic/mini_games/magick/logic.rpy:1600
translate brazilian MagicMiniGameLabel_start_184c9b55_1:

    # ch_Name "Thank you, miss Lapis!"
    ch_Name "Obrigado, srta Lapis!"

# game/logic/mini_games/magick/logic.rpy:1602
translate brazilian MagicMiniGameLabel_start_f766a18c:

    # ch_Name "That's an honor to hear this!"
    ch_Name "É uma honra ouvir isso!"

# game/logic/mini_games/magick/logic.rpy:1603
translate brazilian MagicMiniGameLabel_start_44a21287:
...
translate brazilian strings:
    ...
    new "Clique e arraste o mouse para desenhar o glifo na tela. Você tem "
...
translate brazilian MagicMiniGameLabel_start_d3b5301a:
    ...
    # Victoria "I can see you have good potential. "
    Victoria "Posso ver que você tem um bom potencial."

# game/logic/mini_games/magick/logic.rpy:1315
translate brazilian MagicMiniGameLabel_start_37ccf7af:

    # ch_Name "{i}(Hell yes I do! That was too easy!){/i}"
    ch_Name "{i}(Claro que sim! Isso foi muito fácil!){/i}"

# game/logic/mini_games/magick/logic.rpy:1317
translate brazilian MagicMiniGameLabel_start_03f7e5a9:

    # Victoria "Let's see if you can do even better."
    Victoria "Vamos ver se você consegue fazer ainda melhor."
...
translate brazilian MagicMiniGameLabel_start_9054e202:
    ...
    # Victoria "Not bad for the first time!"
    Victoria "Nada mal pela primeira vez!"

# game/logic/mini_games/magick/logic.rpy:1333
translate brazilian MagicMiniGameLabel_start_17474b4e:

    # Victoria "But I've had more capable students."
    Victoria "Mas eu tive alunos mais capazes."

# game/logic/mini_games/magick/logic.rpy:1335
translate brazilian MagicMiniGameLabel_start_829c5ea8:

    # ch_Name "{i}(Not bad? I can do better than \"not bad\"! Come on, [Name]!){/i}"
    ch_Name "{i}(Nada mal? Posso fazer melhor do que \"nada mal\"! Vamos lá, [Name]!){/i}"

# game/logic/mini_games/magick/logic.rpy:1337
translate brazilian MagicMiniGameLabel_start_43090c88:

    # Victoria "Let's try to make it more difficult..."
    Victoria "Vamos tentar dificultar..."
...
translate brazilian MagicMiniGameLabel_start_b6d47def:
    ...
    # Victoria "That kind of concentration is no good!"
    Victoria "Esse tipo de concentração não é bom!"

# game/logic/mini_games/magick/logic.rpy:1352
translate brazilian MagicMiniGameLabel_start_3a586ab7:

    # ch_Name "{i}(Crap... I need to focus! I won't lose this!){/i}"
    ch_Name "{i}(Droga... preciso me concentrar! Não vou perder isso!){/i}"
...
translate brazilian MagicMiniGameLabel_start_733fd849:
    ...
    # Victoria "Let's see how good can you use it right now."
    Victoria "Vamos ver o quão bom você pode usá-lo agora."

# game/logic/mini_games/magick/logic.rpy:1381
translate brazilian MagicMiniGameLabel_start_23a97552:

    # Victoria "Your last try! Go!"
    Victoria "Sua última tentativa! faça!"
...
translate brazilian MagicMiniGameLabel_start_8ce2feee:
    ...
    # Victoria "I'm really interested to see what else you can do!"
    Victoria "Estou realmente interessada em ver o que mais você pode fazer!"

# game/logic/mini_games/magick/logic.rpy:1396
translate brazilian MagicMiniGameLabel_start_916ce3a3:

    # ch_Name "{i}(Is this a dream, or am I really that good?!){/i}"
    ch_Name "{i}(Isso é um sonho, ou eu sou tão bom assim?!){/i}"
...
translate brazilian MagicMiniGameLabel_start_7260d6a4:
    ...
    # Victoria "I recommend that you take this task more seriously."
    Victoria "Recomendo que você leve essa tarefa mais a sério."

# game/logic/mini_games/magick/logic.rpy:1417
translate brazilian MagicMiniGameLabel_start_ebfeb22a:

    # ch_Name "{i}(I can do better, I know it!){/i}"
    ch_Name "{i}(Eu posso fazer melhor, eu sei!){/i}"

# game/logic/mini_games/magick/logic.rpy:1419
translate brazilian MagicMiniGameLabel_start_c15eb5de:

    # Victoria "I'll give you one more try."
    Victoria "Vou te dar mais uma chance."
...
translate brazilian MagicMiniGameLabel_start_f45b618f:
    ...
    # Victoria "Bot not perfect."
    Victoria "Mas ainda não é perfeito."
...
translate brazilian MagicMiniGameLabel_start_d9fed8b4:
    ...
    # Victoria "Let's make the task more difficult this time..."
    Victoria "Vamos tornar a tarefa mais difícil dessa vez..."
...
translate brazilian MagicMiniGameLabel_start_9bd05493:
    ...
    # ch_Name "Sorry, I've probably got disctracted. "
    ch_Name "Desculpe, provavelmente me distraí."
...
translate brazilian MagicMiniGameLabel_start_ef6a093b:
    ...
    # Victoria "You're a little bit bellow our standart level, mister [Surname]. "
    Victoria "Você está um pouco abaixo do nosso nível padrão, senhor [Surname]."
...
translate brazilian MagicMiniGameLabel_start_c8649f98:
    ...
    # Victoria "Yes, but if you want to stay at this school, you'll have to show a special zeal for your studies."
    Victoria "Sim, mas se você quiser ficar nesta escola, você terá que mostrar um zelo especial pelos seus estudos."
...
translate brazilian MagicMiniGameLabel_start_3029edcb:
    ...
    # Victoria "You have passed this exam. "
    Victoria "Você passou no exame."

# game/logic/mini_games/magick/logic.rpy:1557
translate brazilian MagicMiniGameLabel_start_1820d408:

    # Victoria "You have good potential! "
    Victoria "Você tem um bom potencial!"
...
translate brazilian MagicMiniGameLabel_start_90619c60:
    ...
    # ch_Name "Thank you, miss Lapis!"
    ch_Name "Obrigado, senhorita Lapis!"

# game/logic/mini_games/magick/logic.rpy:1563
translate brazilian MagicMiniGameLabel_start_de1b88f9:

    # ch_Name "I won't dissapoint you!"
    ch_Name "Não vou desapontá-la!"
...
translate brazilian MagicMiniGameLabel_start_2246d7ff:
    ...
    # Victoria "I see such results on this test very rarely."
    Victoria "Eu vejo esses resultados neste teste muito raramente."
...
translate brazilian MagicMiniGameLabel_start_086c8057:
    ...
    # ch_Name "I'm looking forward to it!"
    ch_Name "Estou ansioso por isso!"

# game/logic/mini_games/magick/logic.rpy:1588
translate brazilian MagicMiniGameLabel_start_21a50ec3:

    # Victoria "Nice zeal, don't lose it!"
    Victoria "Bom zelo, não perca!"
...
translate brazilian MagicMiniGameLabel_start_c58a677d:
    ...
    # Victoria "You have a great future ahead of you. "
    Victoria "Você tem um grande futuro pela frente."

# game/logic/mini_games/magick/logic.rpy:1598
translate brazilian MagicMiniGameLabel_start_1c8f3fb2:

    # Victoria "And I will do my best to help you reach your potential!"
    Victoria "E farei o meu melhor para ajudá-lo a alcançar seu potencial!"
