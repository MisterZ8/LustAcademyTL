...
translate brazilian strings:
    ...
    new "Tamanho de escala de texto"
    ...
    new "As opções neste menu visam melhorar a acessibilidade. Elas podem não funcionar com todos os jogos, e algumas combinações de opções podem tornar o jogo impossível de jogar. Isso não é um problema com o jogo ou mecanismo. Para obter os melhores resultados ao alterar as fontes , tente manter o tamanho do texto igual ao original."
    ...
    old "{#weekday}Monday"
    new "{#DiaDaSemana}segunda-feira"

    # renpy/common/00action_file.rpy:26
    old "{#weekday}Tuesday"
    new "{#DiaDaSemana}terça-feira"

    # renpy/common/00action_file.rpy:26
    old "{#weekday}Wednesday"
    new "{#DiaDaSemana}quarta-feira"

    # renpy/common/00action_file.rpy:26
    old "{#weekday}Thursday"
    new "{#DiaDaSemana}quinta-feira"

    # renpy/common/00action_file.rpy:26
    old "{#weekday}Friday"
    new "{#DiaDaSemana}sexta"

    # renpy/common/00action_file.rpy:26
    old "{#weekday}Saturday"
    new "{#DiaDaSemana}sábado"

    # renpy/common/00action_file.rpy:26
    old "{#weekday}Sunday"
    new "{#DiaDaSemana}domingo"
    ...
    new "O diretor interativo não está ativado aqui."
    ...
    new "Tem certeza de que deseja pular diálogos não vistos para a próxima opção?"
    ...
    new "Este programa contém software livre sob várias licenças, incluindo a Licença MIT e a Licença Pública Geral Menor GNU. Uma lista completa de software, incluindo links para o código-fonte completo, pode ser encontrada em {a=https://www.renpy .org/l/license}aqui{/a}."
    ...
    old "self voicing volume drop"
    new "queda de volume de voz própria"
    ...
    new "espaçamento entre linhas de fonte"
    ...
    new "Auto-voz diria \"[renpy.display.tts.last]\". Pressione 'alt+shift+V' para desativar."
    ...
    new "Seleção de localização de imagem"
    ...
    new "Mostrar log de carregamento de imagem (F4)"
    ...
    new "Retornar ao menu do desenvolvedor"
    ...
    new "Clique com o botão direito ou esc para sair."
    ...
    new "Está sendo simulado um erro."

    # renpy/common/00updater.rpy:680
    old "Either this project does not support updating, or the update status file was deleted."
    new "Ou este projeto não suporta atualização ou o arquivo de status de atualização foi excluído."
    ...
    new "[u.version] está disponível. Deseja instalá-lo?"
    ...
    new "As alterações entrarão em vigor na próxima vez que este programa for executado."
    ...
    new "Este computador está usando renderização de software."
    ...
    new "Este computador tem um problema ao exibir gráficos: [problem]."

    # renpy/common/00gltest.rpy:255
    old "Its graphics drivers may be out of date or not operating correctly. This can lead to slow or incorrect graphics display."
    new "Seus drivers gráficos podem estar desatualizados ou não funcionar corretamente. Isso pode levar a uma exibição gráfica lenta ou incorreta."
    ...
    new "Mais detalhes sobre como corrigir isso podem ser encontrados na {a=[url]}documentation{/a}."
    ...
    new "Continue, não mostrar aviso novamente"
    ...
    new "Falha ao analisar o script."
