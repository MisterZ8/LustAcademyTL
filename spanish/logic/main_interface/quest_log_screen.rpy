...
translate spanish strings:
    ...
    new "Devolver este libro a Amelie en la biblioteca por una recompensa"
    ...
    new "Este hechizo aun no ha sido aprendido."
    ...
    new "La historia para esta versión del juego ha terminado."
    ...
    new "Aquí puedes consultar todas la rutas, actividades, etc. disponibles, y buscar rápidamente"
    ...
    new "la que quieras, sin malgastar tiempo buscando por las localizaciones. Al lado de"

    # game/logic/main_interface/quest_log_screen.rpy:887
    old "avatars of the characters are icons, the decoding of which is next."
    new "los avatares de cada personaje hay iconos, cuya decodificación es la siguiente."
    ...
    new "Esta ruta no está disponible a esta hora. Si escoges esta opción saltarás el tiempo. ¿Quieres continuar?"
