...
translate russian start_input_2_f789cadc:
    ...
    ch_Name "Я должен был быть в тренировочном лагере со своей командой прямо сейчас."
...
translate russian start_input_2_4d4ef9ab:
    ...
    Olivia "Ты весь день был в своей комнате!"
...
translate russian start_input_2_9a44f10c:
    ...
    Olivia "Вот о чем говорил Дон. Ты вышел из-под контроля!"
...
translate russian start_input_2_2a5612ed:
    ...
    Olivia "Если бы твоя мать услышала, что ее 18 летний..."
...
translate russian start_input_2_f6724a46:
    ...
    ch_Name "Ты знаешь, почему так все так получилось!"
...
translate russian start_input_2_036404a6:
    ...
    Olivia "Как ты планируешь получать образование?"
...
translate russian start_input_2_b33dc905:
    ...
    Olivia "Я вижу, как ты усердно \"работаешь\"!"
...
translate russian start_input_2_f4cb3c7a:
    ...
    ch_Name "Что ты имеешь в виду? Ты что, выгоняешь меня?"
...
translate russian start_input_2_b8f6f104:
    ...
    ch_Name "{i}(Черт возьми, я знал, что не должен был поддаваться на ее провокации...){/i}"
...
translate russian strings:
    ...
    new "Все персонажи старше 18 лет, даже если указано иное."
