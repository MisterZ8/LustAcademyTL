...
translate russian CordLeftWing_label_9d3689bb:
    ...
    ch_Name "{i}(Не могу поверить в свою удачу. Здесь все ученицы такие красивые?){/i}"
...
translate russian CordLeftWing_label_be38b0ad:
    ...
    ch_Name "{i}(Что, если она уйдет, а я больше не увижусь с ней?){/i}"
...
translate russian CordLeftWing_label_46ca7571:
    ...
    ch_Name "{i}(Черт, мне нужно придумать предлог, чтобы позвать ее... О, придумал!){/i}"

# game/logic/tutorial.rpy:793
translate russian CordLeftWing_label_65c02259:

    # ch_Name "Hey! Excuse me, please."
    ch_Name "Привет! Прости меня пожалуйста."
...
translate russian CordLeftWing_label_ac72bb37:
    ...
    Gabriella "Без проблем! До скорого."
...
translate russian CordLeftWing_label_d495ac50:
    ...
    ch_Name "{i}(Я уверен, что позже у меня будет время познакомиться с ней поближе.){/i}"

# game/logic/tutorial.rpy:807
translate russian CordLeftWing_label_8403dbba:

    # ch_Name "{i}(For now, I have other things to do.){/i}"
    ch_Name "{i}(Пока у меня есть другие дела.){/i}"
...
translate russian CordRightWing_label_7b8ce845:
    ...
    ch_Name "{i}(Похоже, кто-то зол. Интересно, почему...){/i}"
...
translate russian CordRightWing_label_ff1af3f6:
    ...
    Grace "Проклятье! Он действительно закрыт? Это так раздражает!"
...
translate russian CordRightWing_label_641c2900:
    ...
    ch_Name "Эй, все в порядке? Могу ли я чем-нибудь помочь?"
...
translate russian CordRightWing_label_832bd4cf:
    ...
    Grace "О, привет. Ты все слышал, не так ли?"
...
translate russian CordRightWing_label_ab45415b:
    ...
    ch_Name "Слышал ли я как ты спорил с дверью? Готов поспорить."
...
translate russian CordRightWing_label_14e10a0f:
    ...
    Grace "Мне жаль, что тебе пришлось смотреть эту сцену."
...
translate russian CordRightWing_label_391b24b0:
    ...
    Grace "Я просто не люблю, когда что-то идет не по плану."
...
translate russian CordRightWing_label_29cab73c:
    ...
    Grace "Но местное кафе утром закрыто. Ты можешь в это поверить?!"
...
translate russian CordRightWing_label_a9685a1c:
    ...
    ch_Name "Мне правда очень жаль, что твои планы сорвались."
...
translate russian CordRightWing_label_93350343:
    ...
    Grace "И у меня нет времени добраться туда и обратно перед уроком."
...
translate russian CordRightWing_label_07e757d2:
    ...
    Grace "Я пойду готовиться к уроку. Пока-пока."
...
translate russian CordRightWing_label_4d3ec7ac:
    ...
    ch_Name "{i}(Кажется, наш разговор ее немного охладил.){/i}"
...
translate russian CordRightWing_label_951789d8:
    ...
    ch_Name "{i}(Не думал, что кто-то может так злиться из-за кофе.){/i}"
...
translate russian CordRightWing_label_ae1a6bec:
    ...
    ch_Name "{i}(С другой стороны, после всех этих разговоров о кофе я и сам очень хочу чашечку.){/i}"
...
translate russian CordMainHall_label_38e027ca:
    ...
    ch_Name "{i}(Вот так выглядит главный зал академии, когда он не занят.){/i}"
...
translate russian CordMainHall_label_1617ba3a:
    ...
    ch_Name "{i}(Интересно, что здесь еще происходит?){/i}"
...
translate russian CordMainHall_label_c21d0d35:
    ...
    ch_Name "{i}(Столы накрыты так, что здесь можно устроить настоящий праздник.){/i}"
...
translate russian CordMainHall_label_0bd52afc:
    ...
    ch_Name "{i}(Возможно, раньше тут была такая традиция?){/i}"
...
translate russian CordMainHall_label_19a1b81f:
    ...
    ch_Name "{i}(А эти статуи ангелов выглядят как стражники.){/i}"
...
translate russian CordMainHall_label_86756501:
    ...
    ch_Name "{i}(Мне показалось или кто-то говорил со мной?){/i}"
...
translate russian CordMainHall_label_a8dd1f73:
    ...
    Arthur "Не волнуйся, [Name]. Это я, Артур."
...
translate russian CordMainHall_label_7eb7551a:
    ...
    Arthur "Хе. Ну что тут скажешь... Старики тоже любят выглядеть опрятно."
...
translate russian CordMainHall_label_e1ba3607:
    ...
    Arthur "Уверен, вам интересно, почему в академии такой большой зал."
...
translate russian CordMainHall_label_75e7562f:
    ...
    Arthur "Я сам иногда задаюсь вопросом, нужна ли эта напыщенность."
...
translate russian CordMainHall_label_635f5f1c:
    ...
    Arthur "Всегда лучше держать самые ценные вещи спрятанными на виду. Не так ли?"
...
translate russian CordMainHall_label_d2a747bb:
    ...
    Arthur "Кстати, я уверен, Victoria и Sabrina уже ждут учеников."
...
translate russian CordMainHall_label_bda6c814:
    ...
    Arthur "Хорошо. Торопись. Ты же не хочешь опоздать?"
...
translate russian strings:
    ...
    new "Это ваш личный профиль. Здесь вы можете найти всю информацию о главном герое (статистика, уровни заклинаний, инвентарь) и следить за ходом еженедельного конкурса домов."

    # game/logic/tutorial.rpy:19
    old "Here you can change the name of the main character at any time."
    new "Здесь вы можете изменить имя главного героя в любой момент."
    ...
    new "Это статистика различных показателей. Ни на что не влияет, но может быть интересно для отслеживания процесса игры."
    ...
    new "Это блок с текущими результатами соревнований между домами. В конце каждой недели дом, набравший наибольшее количество очков, отправляется в Dale."
    ...
    new "Здесь показаны заклинания, которые вы выучили, а также уровень вашего мастерства. Чем выше уровень вашего мастерства, тем эффективнее заклинания."

    # game/logic/tutorial.rpy:19
    old "All items you collect go into the Inventory. You can mouse over over any item and get detailed information about it."
    new "Все предметы, которые вы собираете, попадают в инвентарь. Вы можете навести курсор мыши на любой элемент и получить подробную информацию о нем."
    ...
    new "А здесь вы можете проверить свой баланс. Вы можете зарабатывать деньги с помощью различных подработок, доступных в игре. Кроме того, небольшая сумма денег выделяется Академией за победу в конкурсе домов."

    # game/logic/tutorial.rpy:19
    old "You can use this button anytime to watch this tutorial again and refresh your memory. Good luck!"
    new "Вы можете использовать эту кнопку в любое время, чтобы просмотреть это руководство еще раз и освежить память. Удачи!"
    ...
    new "Практическое занятие по зельеварению проводится самостоятельно. Это руководство поможет вам понять, как открывать новые рецепты и варить эликсиры, используя уже изученные рецепты."

    # game/logic/tutorial.rpy:19
    old "This recipe has already been studied. Just click on Add to have all the necessary ingredients ready to mix"
    new "Этот рецепт уже изучен. Просто нажмите Добавить, чтобы все необходимые ингредиенты были готовы к смешиванию."

    # game/logic/tutorial.rpy:19
    old "You can learn the new recipes by visiting Sabrina's lectures, or you can try to discover them yourself."
    new "Вы можете узнать новые рецепты, посетив лекции Сабрины, или вы можете попробовать открыть их самостоятельно."
    ...
    new "Для этого выберите любые три понравившихся ингредиента и посмотрите, что из них получится. Если ваша смесь окажется удачной, новый рецепт будет немедленно добавлен в вашу книгу рецептов. На каждом уроке у вас есть только одна попытка. Вам решать, сварить ли всем известный эликсир или провести эксперимент."
    ...
    new "Эти ингредиенты предоставляются студентам Академией бесплатно и без ограничений. Когда вам случится найти редкие реагенты, они войдут в это меню с указанием доступного количества."
    ...
    new "Выбранные ингредиенты пойдут сюда. Если вам нужно отменить свой выбор, нажмите на ненужный ингредиент, чтобы очистить поле. Когда будете готовы, нажмите кнопку СМЕШАТЬ."
    ...
    new "Здесь вы узнаете результат своих экспериментов. Все эликсиры, приготовленные на практических занятиях, остаются у студентов, то есть ваши попадают в ваш инвентарь. Боевые эликсиры можно использовать в дуэльном клубе."
    ...
    new "Вы можете начать заниматься. Вы можете использовать эту кнопку в любое время, чтобы просмотреть это руководство еще раз и освежить память. Удачи!"
    ...
    new "Здесь вы можете найти информацию о каждом встреченном вами персонаже: их описание, отношение к вашему герою, журналы квестов и список интересных сцен."
    ...
    new "Список всех персонажей в игре, отсортированный от А до Я, и их текущий маршрут. Вы можете нажать на любого персонажа из списка, чтобы получить более подробную информацию."

    # game/logic/tutorial.rpy:19
    old "Use the star icon to mark favorite characters. They will always appear at the top of the list."
    new "Используйте значок звездочки, чтобы отметить любимых персонажей. Они всегда будут отображаться вверху списка."
    ...
    new "Эта полоса представляет историю отношений с этим персонажем. Вы можете нажать на выполненные шаги, чтобы освежить память."
    ...
    new "Этот значок означает, что на данном этапе история отношений с персонажем приостановлена в текущем релизе игры, но продолжится в будущем."

    # game/logic/tutorial.rpy:19
    old "Learn the requirements for the next step of this route, as well as the place and time for the next scene."
    new "Узнайте требования к следующему шагу этого маршрута, а также место и время следующей сцены."
    ...
    new "Когда требования будут выполнены, эта строка состояния станет зеленой, и вы получите доступ к кнопке быстрого перемещения, которая доставит вас на место происшествия."
    ...
    new "Это приложение для обмена и обсуждения фотографий. Здесь вы можете увидеть новые фотографии людей, с которыми вы познакомились, и оставить свои комментарии."
    ...
    new "Вот список всех людей, которых вы уже встречали. Они отсортированы по количеству подписчиков, начиная с самых популярных. Вы можете выбрать любого из списка, чтобы открыть его или ее профиль."
    ...
    new "Нажмите на это фото, чтобы развернуть его на весь экран."

    # game/logic/tutorial.rpy:19
    old "Here’s authors caption with hashtags you can use to find similar photos in the app."
    new "Вот авторская подпись с хэштегами, по которым можно найти похожие фотографии в приложении."

    # game/logic/tutorial.rpy:19
    old "Here are the comments other people left for this photo. You can click on any name to open their personal page."
    new "Вот комментарии других людей, оставленные к этой фотографии. Вы можете нажать на любое имя, чтобы открыть его личную страницу."

    # game/logic/tutorial.rpy:19
    old "Here you can leave a like and write your own comment."
    new "Здесь вы можете поставить лайк и написать свой комментарий."
    ...
    new "Вы можете выбрать один из предложенных вариантов, чтобы оставить комментарий. Иногда выбор может повлиять на ваши отношения, но в большинстве случаев он не имеет последствий."

    # game/logic/tutorial.rpy:19
    old "Click on the photo if you want to return to the previous page."
    new "Нажмите на фото, если хотите вернуться на предыдущую страницу."

    # game/logic/tutorial.rpy:19
    old "Click on this button to open your live feed and see all photos in app."
    new "Нажмите на эту кнопку, чтобы открыть ленту и просмотреть все фотографии в приложении."

    # game/logic/tutorial.rpy:19
    old "This feed features all the photos from people you’ve already met. Scroll down and up tho view them all."
    new "В этой ленте представлены все фотографии людей, с которыми вы уже встречались. Прокрутите вниз и вверх, чтобы просмотреть их все."

    # game/logic/tutorial.rpy:19
    old "To go the person’s personal page click on his/her avatar."
    new "Для перехода на личную страницу человека нажмите на его аватар."

    # game/logic/tutorial.rpy:19
    old "Click on the photo to switch to the fullscreen view."
    new "Нажмите на фото, чтобы перейти в полноэкранный режим."

    # game/logic/tutorial.rpy:19
    old "To exit the app and turn off your phone, tap this button or just click past the smartphone screen."
    new "Чтобы выйти из приложения и выключить телефон, коснитесь этой кнопки или просто щелкните за экраном смартфона."
    ...
    new "Мы рекомендуем короткий вводный туториал, чтобы узнать назначение всех элементов основного интерфейса и как их использовать для упрощения игры."
    ...
    new "Здесь вы можете увидеть текущее время суток. Всего их четыре: утро, день, вечер и ночь. Есть специальные события и мероприятия для каждого времени. Следите за временем, чтобы не пропустить встречи."
    ...
    new "Эти подсказки связаны только с основной сюжетной линией и не влияют на маршруты персонажей. Все маршруты символов являются необязательными и могут быть пропущены."
    ...
    new "Здесь вы можете проверить свой прогресс в любое время. Полоса заполнится, когда вы завершите все возможные квесты для текущей версии игры."

    # game/logic/tutorial.rpy:19
    old "Here are the main buttons to find all the useful information and statistics."
    new "Вот основные кнопки, чтобы найти всю полезную информацию и статистику."
    ...
    new "Это календарь. С его помощью вы сможете узнать обо всех доступных заданиях в любое время суток и легко спланировать свой маршрут."
    ...
    new "Здесь хранится вся информация о доступных в игре персонажах: подсказки, подсказки, прогресс, а также история развития отношений с ними."
    ...
    new "Это ваш личный профиль. Здесь вы можете найти всю информацию о главном герое: характеристики, уровни заклинаний, инвентарь. Кроме того, вы можете следить за ходом еженедельного конкурса домов здесь."
    ...
    new "Это ваш телефон. Вы можете использовать его для просмотра фотографий вашего друга в приложении Lustagram. Мы можем добавить новые функции в смартфон в будущих выпусках."

    # game/logic/tutorial.rpy:19
    old "Here is the map, which allows you to quickly move between the available game zones."
    new "Перед вами карта, позволяющая быстро перемещаться между доступными игровыми зонами."
    ...
    new "Каждая игровая зона разделена на несколько локаций. Эта панель отвечает за быстрое перемещение между локациями внутри зоны. Перемещаться из комнаты в комнату можно обычным способом — через двери или знаки."
    ...
    new "А вот и кнопки быстрого доступа для управления некоторыми настройками."

    # game/logic/tutorial.rpy:19
    old "This button is only available in open locations and helps to highlight all active and interactive objects."
    new "Эта кнопка доступна только на открытых локациях и помогает выделить все активные и интерактивные объекты."

    # game/logic/tutorial.rpy:19
    old "This button allows you to go back to the previous frame. It’s only available within scenes."
    new "Эта кнопка позволяет вернуться к предыдущему кадру. Она доступен только внутри сцен."
    ...
    new "Это кнопка быстрого доступа для доступа к журналу диалогов. Это может быть полезно, если вы хотите освежить память и просмотреть предыдущие строки персонажей."
    ...
    new "Используйте эту кнопку, чтобы быстро отключить звуки в игре, а затем снова быстро включить их. Громкость звуков можно регулировать в настройках игры."
    ...
    new "Работа в кафе позволяет вам заработать немного денег и получить баллы для вашей школы. Этот туториал расскажет вам, как правильно выполнять работу и получать больше денег."

    # game/logic/tutorial.rpy:19
    old "This is the first out of five possible orders. Remember the sequence of dishes. When you're ready, click Start."
    new "Это первый из пяти возможных заказов. Запомните последовательность блюд. Когда будете готовы, нажмите Старт."

    # game/logic/tutorial.rpy:19
    old "You only have 5 seconds to complete the order."
    new "У вас есть только 5 секунд, чтобы выполнить заказ."
    ...
    new "Вот полный список всех блюд, представленных в меню. Нажмите на товары, которые нужно добавить в заказ."

    # game/logic/tutorial.rpy:19
    old "If you manage to serve the dishes on time and without mistakes, you'll get an extra $5 tip for each order."
    new "Если вам удастся подать блюда вовремя и без ошибок, вы получите дополнительные $5 чаевых за каждый заказ."
    ...
    new "Вы можете завершить мини-игру в любое время, нажав на эту кнопку. Вы получите минимальное вознаграждение в размере 10 долларов в любом случае и 5 долларов за каждый заказ, который вам удастся выполнить."
    ...
    new "Вы можете приступить к работе сейчас. Вы можете использовать эту кнопку в любое время, чтобы просмотреть это руководство еще раз и освежить память. Удачи!"

    # game/logic/tutorial.rpy:19
    old "Welcome to the arena. Here's a quick guide to the mini-game, so you can play without any hassle."
    new "Добро пожаловать на арену. Вот краткое руководство по мини-игре, чтобы вы могли играть без каких-либо хлопот."
    ...
    new "Это хитбар вашего оппонента. Цель игры - довести уровень его выносливости до нуля. Первый, кому это удается, объявляется победителем."
    ...
    new "Вот хитбар вашего персонажа. Следите за своим уровнем выносливости и вовремя используйте эликсиры и исцеляющие заклинания. Если они есть в вашем арсенале, конечно. Здесь вы также увидите все баффы и дебаффы вашего персонажа."
    ...
    new "Это доступные вам боевые заклинания. Боевой болт можно использовать без ограничений, а остальные не чаще, чем раз в два хода. Выучить недостающие заклинания можно на уроках Victoria."
    ...
    new "Следите за ползунком на волшебном глифе, чтобы остановить его в момент максимальной окраски. Чем больше площадь глифа закрашена, тем мощнее будет заклинание. Сила каста также зависит от уровня заклинания."
    ...
    new "Теперь вы можете попробовать это сами! Вы можете использовать эту кнопку в любое время, чтобы просмотреть это руководство еще раз и освежить память. Удачи!."
    ...
    new "В этом меню вы можете легко найти всех персонажей в игре, которые предлагают квест или активность в течение игрового дня. Вот лучшая часть: вы можете мгновенно перейти к ним прямо из списка."
    ...
    new "Аватары персонажей расположены напротив значков времени. Это означает, что это время дня, когда вы можете взаимодействовать с ними."
    ...
    new "Например, здесь показаны все персонажи, чьи действия доступны в ночное время. Этот принцип применим в любое время суток."
    ...
    new "Выберите аватар персонажа, которого вы планируете встретить, и нажмите эту кнопку. Вы сразу же телепортируетесь в место, где находится этот персонаж."
    ...
    new "Если вы выберете персонажа, взаимодействие с которым будет доступно позже в тот же день, вы будете предупреждены, что этот выбор приведет к таймскипу. Это сделано для того, чтобы уберечь вас от случайного нажатия на нее."
    ...
    new "Если время суток закончилось, аватары становятся недоступными до следующего утра. Он по-прежнему показывает всех персонажей, доступных на тот момент, но вы не можете получить к ним доступ напрямую из этого меню, пока не наступит новый день."
