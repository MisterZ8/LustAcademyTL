...
translate russian strings:
    ...
    old "Lost foliant"
    new "Потерянная книга"

    # game/logic/main_interface/quest_log_screen.rpy:130
    old "Return this book to Amelie in the library for a reward"
    new "Верните эту книгу Амелии в библиотеку за вознаграждение"
    ...
    new "'s история этой версии игры подошла к концу."
    ...
    new "Здесь вы можете отслеживать все доступные вам диалоги, мероприятия и т.д. и быстро перемещаться"
    ...
    new "аватары персонажей - это иконки, расшифровка которых находится далее."
    ...
    new "Эта активность недоступна в это время суток. Выбор этого параметра приведет к пропуску времени. Продолжить?"
