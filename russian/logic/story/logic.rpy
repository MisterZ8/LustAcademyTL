...
translate russian Boat_2_1_7fd0a907:
    ...
    ch_Name "{i}(Думаю, я обязан выиграть новое соревнование домов, только чтобы снова сюда попасть!){/i}"
...
translate russian Boat_2_2_ef09c6af:
    ...
    ch_Name "{i}(Не могу избавиться от грусти каждый раз, когда приплываю обратно в академию.){/i}"
...
translate russian Boat_2_2_a9451fa2:
    ...
    ch_Name "{i}(Это странно, потому что обучение магии это здорово. Никогда раньше не получал такого удовольствия от учебы.){/i}"

# game/logic/story/logic.rpy:1148
translate russian Boat_2_2_6ade452e:

    # ch_Name "{i}(But there's no substitute for freedom.){/i}"
    ch_Name "{i}(Но ничто не заменит свободы.){/i}"
...
translate russian Boat_2_2_97ff4894:
    ...
    ch_Name "{i}(Особенно теперь, когда я узнал о существовании огромного неизведанного магического мира.){/i}"

# game/logic/story/logic.rpy:1152
translate russian Boat_2_2_6c00293e:

    # ch_Name "So, how was your trip?"
    ch_Name "Ну, как прошла твоя поездка?"
...
translate russian Boat_2_2_67cf3c1b:
    ...
    Haley "Восхитительно! Я побывала в местном историческом музее и на экскурсии в катакомбах."
...
translate russian Boat_2_2_959f0812:
    ...
    Jacob "Все вернулись в целости и сохранности? Хорошо."
...
translate russian Boat_2_2_7d7dca70:
    ...
    Jacob "Ничто так не радует меня как студенты, готовые к учебе!"
...
translate russian Boat_2_3_c9dadbdd:
    ...
    Haley "О, прекрати! Она уже отплывала, когда мы поднялись на борт!"
...
translate russian Boat_2_3_43dea207:
    ...
    ch_Name "Я не заметил. Время с тобой летит незаметно."
...
translate russian Boat_2_3_40fc42c9:
    ...
    Haley "Ты можешь не смущать меня? Лучше расскажи о своих выходных."
...
translate russian InStory_1_f0175db8:
    ...
    ch_Name "{i}(Нет, заснуть снова не получится.){/i}"
...
translate russian InStory_1_999cb886:
    ...
    ch_Name "{i}(Моим мозгам требуется заправка, чтобы впитать все эти знания о магии.){/i}"
...
translate russian InStory_2_cb4e0649:
    ...
    ch_Name "{i}(Интересно, почему она лишилась своих сил в первую очередь...){/i}"
...
translate russian InStory_2_96f10ab4:
    ...
    ch_Name "{i}(Черт, еще не так поздно, но я всерьез думаю о том, чтобы лечь спать.){/i}"
...
translate russian InStory_2_b0ac28f6:
    ...
    ch_Name "{i}(Быть трудоголиком или хорошенько выспаться?){/i}"
