...
translate russian MagicMiniGameLabel_2_0d57492a:
    ...
    Victoria "Похвальное рвение, [Name]. Какое заклинание вас интересует?"
...
translate russian MagicMiniGameLabel_2_e928ed52:
    ...
    ch_Name "Я хочу улучшить свое владение [spellname], мэм."
...
translate russian MagicMiniGameLabel_2_7fe45ab2:
    ...
    Victoria "Отлично! Встаньте к доске и начинайте."
...
translate russian MagicMiniGameLabel_2_9ca4635e:
    ...
    Victoria "Сконцентрируйтесь, [Surname]! Я знаю, что вы можете добиться большего»."
...
translate russian MagicMiniGameLabel_2_c0a430be:
    ...
    Victoria "Неплохой результат, но есть куда расти."
...
translate russian MagicMiniGameLabel_2_48a2ce7f:
    ...
    Victoria "Удивительно, [Name]! Отличная концентрация! Вы можете сделать это снова?"
...
translate russian MagicMiniGameLabel_2_b103f4dd:
    ...
    Victoria "Давай, [Name]. Я уверен, ты можешь лучше."
...
translate russian MagicMiniGameLabel_2_2dc12541:
    ...
    Victoria "Неплохо, но я видела, что ты можешь лучше."
...
translate russian MagicMiniGameLabel_2_ade62796:
    ...
    Victoria "Молодец, [Name]! Вы всё лучше и лучше! Смоежете сделать это снова?"
...
translate russian MagicMiniGameLabel_2_28ff02a7:
    ...
    Victoria "Нет, нет. Это явно не ваш день, [Name]!"
...
translate russian MagicMiniGameLabel_2_35637f40:
    ...
    Victoria "Это довольно стабильное заклинание, но могло быть и лучше."
...
translate russian MagicMiniGameLabel_2_49d1071b:
    ...
    Victoria "Замечательно! Это феноменальный результат!"
...
translate russian end_MagicMiniGame_2_label_7feba4d1:
    ...
    Victoria "Достаточно, [Name]. Урок подошёл к концу, поэтому продолжим в следующий раз."
...
translate russian strings:
    ...
    new "\n\nНажмите и перетащите мышь, чтобы нарисовать глиф на экране. У вас есть"
