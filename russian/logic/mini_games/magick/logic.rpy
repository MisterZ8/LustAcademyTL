...
translate russian MagicMiniGameLabel_start_a35cab29:

    # ch_Name "{i}(Hell yes I do! That was too easy!){/i}"
    ch_Name "{i}(Черт возьми, да! Это было слишком просто!){/i}"

# game/logic/mini_games/magick/logic.rpy:1317
translate russian MagicMiniGameLabel_start_c7ecc92d:

    # Victoria "Let's see if you can do even better."
    Victoria "Посмотрим, сможете ли вы сделать еще лучше."

# game/logic/mini_games/magick/logic.rpy:1319
translate russian MagicMiniGameLabel_start_d92a5811:

    # ch_Name "{i}(Bring it on!){/i}"
    ch_Name "{i}(Давай!){/i}"

# game/logic/mini_games/magick/logic.rpy:1331
translate russian MagicMiniGameLabel_start_3f34e206:

    # Victoria "Not bad for the first time!"
    Victoria "Неплохо для первого раза!"

# game/logic/mini_games/magick/logic.rpy:1333
translate russian MagicMiniGameLabel_start_bb1ea8fb:

    # Victoria "But I've had more capable students."
    Victoria "Но у меня были более способные ученики."

# game/logic/mini_games/magick/logic.rpy:1335
translate russian MagicMiniGameLabel_start_fe28887d:

    # ch_Name "{i}(Not bad? I can do better than \"not bad\"! Come on, [Name]!){/i}"
    ch_Name "{i}(Неплохо? Я могу лучше, чем \"неплохо\"! Да ладно, [Name]!){/i}"

# game/logic/mini_games/magick/logic.rpy:1337
translate russian MagicMiniGameLabel_start_b59241f6:

    # Victoria "Let's try to make it more difficult..."
    Victoria "Попробуем усложнить..."

# game/logic/mini_games/magick/logic.rpy:1348
translate russian MagicMiniGameLabel_start_ae3a718c:
...
translate russian MagicMiniGameLabel_start_bfde3b6e:

    # Victoria "That kind of concentration is no good!"
    Victoria "Такая концентрация никуда не годится!"

# game/logic/mini_games/magick/logic.rpy:1352
translate russian MagicMiniGameLabel_start_c7db4080:

    # ch_Name "{i}(Crap... I need to focus! I won't lose this!){/i}"
    ch_Name "{i}(Черт... Мне нужно сосредоточиться! Я не проиграю!){/i}"

# game/logic/mini_games/magick/logic.rpy:1354
translate russian MagicMiniGameLabel_start_2057d564:

    # Victoria "Try again."
    Victoria "Попробуйте снова."

# game/logic/mini_games/magick/logic.rpy:1373
translate russian MagicMiniGameLabel_start_76cf645d:

    # Victoria "Very good, Mr. [Surname]! "
    Victoria "Очень хорошо, мистер [Surname]!"

# game/logic/mini_games/magick/logic.rpy:1375
translate russian MagicMiniGameLabel_start_f5887d1f:

    # Victoria "It is clear that you have potential."
    Victoria "Понятно, что у вас есть потенциал."

# game/logic/mini_games/magick/logic.rpy:1377
translate russian MagicMiniGameLabel_start_a35cab29_1:

    # ch_Name "{i}(Hell yes I do! That was too easy!){/i}"
    ch_Name "{i}(Черт возьми, да! Это было слишком просто!){/i}"

# game/logic/mini_games/magick/logic.rpy:1379
translate russian MagicMiniGameLabel_start_02c377d2:
...
translate russian MagicMiniGameLabel_start_e3fd81f2:

    # Victoria "Your last try! Go!"
    Victoria "Ваша последняя попытка! Идти!"

# game/logic/mini_games/magick/logic.rpy:1392
translate russian MagicMiniGameLabel_start_0762e342:

    # Victoria "Not bad, [Surname]!"
    Victoria "Неплохо, [Surname]!"

# game/logic/mini_games/magick/logic.rpy:1394
translate russian MagicMiniGameLabel_start_1d601a68:

    # Victoria "I'm really interested to see what else you can do!"
    Victoria "Мне очень интересно посмотреть, что еще вы можете сделать!"

# game/logic/mini_games/magick/logic.rpy:1396
translate russian MagicMiniGameLabel_start_c9b75c44:
...
translate russian MagicMiniGameLabel_start_b100d14c:

    # ch_Name "I do."
    ch_Name "Уже проявляю."

# game/logic/mini_games/magick/logic.rpy:1496
translate russian MagicMiniGameLabel_start_4bca6a71:
...
translate russian MagicMiniGameLabel_start_2aa2ed5c:

    # ch_Name "Thank you!"
    ch_Name "Спасибо!"

# game/logic/mini_games/magick/logic.rpy:1505
translate russian MagicMiniGameLabel_start_3ce71e31:

    # Victoria "Well..."
    Victoria "Что ж..."

# game/logic/mini_games/magick/logic.rpy:1507
translate russian MagicMiniGameLabel_start_48c90ecb:

    # Victoria "At least you achieved some result."
    Victoria "По крайней мере, вы добились какого-то результата."

# game/logic/mini_games/magick/logic.rpy:1509
translate russian MagicMiniGameLabel_start_2c933c65:

    # ch_Name "{i}(Does this mean...?){/i}"
    ch_Name "{i}(Означает ли это...?){/i}"

# game/logic/mini_games/magick/logic.rpy:1511
translate russian MagicMiniGameLabel_start_92fd40f4_1:

    # Victoria "You're enrolled."
    Victoria "Вы зачислены."

# game/logic/mini_games/magick/logic.rpy:1513
translate russian MagicMiniGameLabel_start_f6c3c213_1:

    # Victoria "For now."
    Victoria "Пока что."

# game/logic/mini_games/magick/logic.rpy:1515
translate russian MagicMiniGameLabel_start_0b177c20_1:

    # Victoria "But you'll have to show a special zeal for your studies."
    Victoria "Но вам придется проявить особое рвение к учебе."

# game/logic/mini_games/magick/logic.rpy:1517
translate russian MagicMiniGameLabel_start_c5219be6_1:

    # Victoria "If you want to stay at this academy."
    Victoria "Если вы хотите остаться в этой академии."

# game/logic/mini_games/magick/logic.rpy:1519
translate russian MagicMiniGameLabel_start_b100d14c_1:

    # ch_Name "I do."
    ch_Name "Уже проявляю."

# game/logic/mini_games/magick/logic.rpy:1521
translate russian MagicMiniGameLabel_start_4bca6a71_1:

    # ch_Name "I mean... I will. A special zeal from now on!"
    ch_Name "Я имею в виду... я буду. Особое рвение отныне!"

# game/logic/mini_games/magick/logic.rpy:1523
translate russian MagicMiniGameLabel_start_2aa2ed5c_1:

    # ch_Name "Thank you!"
    ch_Name "Спасибо!"

# game/logic/mini_games/magick/logic.rpy:1531
translate russian MagicMiniGameLabel_start_3ce71e31_1:

    # Victoria "Well..."
    Victoria "Что ж..."

# game/logic/mini_games/magick/logic.rpy:1533
translate russian MagicMiniGameLabel_start_48c90ecb_1:

    # Victoria "At least you achieved some result."
    Victoria "По крайней мере, вы добились какого-то результата."

# game/logic/mini_games/magick/logic.rpy:1535
translate russian MagicMiniGameLabel_start_2c933c65_1:

    # ch_Name "{i}(Does this mean...?){/i}"
    ch_Name "{i}(Означает ли это...?){/i}"

# game/logic/mini_games/magick/logic.rpy:1537
translate russian MagicMiniGameLabel_start_92fd40f4_2:

    # Victoria "You're enrolled."
    Victoria "Вы зачислены."

# game/logic/mini_games/magick/logic.rpy:1539
translate russian MagicMiniGameLabel_start_f6c3c213_2:

    # Victoria "For now."
    Victoria "Пока что."

# game/logic/mini_games/magick/logic.rpy:1541
translate russian MagicMiniGameLabel_start_0b177c20_2:

    # Victoria "But you'll have to show a special zeal for your studies."
    Victoria "Но вам придется проявить особое рвение к учебе."

# game/logic/mini_games/magick/logic.rpy:1543
translate russian MagicMiniGameLabel_start_c5219be6_2:

    # Victoria "If you want to stay at this academy."
    Victoria "Если вы хотите остаться в этой академии."

# game/logic/mini_games/magick/logic.rpy:1545
translate russian MagicMiniGameLabel_start_b100d14c_2:

    # ch_Name "I do."
    ch_Name "Уже проявляю."

# game/logic/mini_games/magick/logic.rpy:1547
translate russian MagicMiniGameLabel_start_4bca6a71_2:

    # ch_Name "I mean... I will. A special zeal from now on!"
    ch_Name "Я имею в виду... я буду. Особое рвение отныне!"

# game/logic/mini_games/magick/logic.rpy:1549
translate russian MagicMiniGameLabel_start_2aa2ed5c_2:

    # ch_Name "Thank you!"
    ch_Name "Спасибо!"

# game/logic/mini_games/magick/logic.rpy:1553
translate russian MagicMiniGameLabel_start_9220e8bd:

    # Victoria "Congratulations, Mr. [Surname]! "
    Victoria "Поздравляем, мистер [Surname]!"

# game/logic/mini_games/magick/logic.rpy:1555
translate russian MagicMiniGameLabel_start_6828e998:

    # Victoria "You have passed this exam. "
    Victoria "Вы сдали этот экзамен."

# game/logic/mini_games/magick/logic.rpy:1557
translate russian MagicMiniGameLabel_start_f93cc8d8:

    # Victoria "You have good potential! "
    Victoria "У вас хороший потенциал!"

# game/logic/mini_games/magick/logic.rpy:1559
translate russian MagicMiniGameLabel_start_9225d683:

    # Victoria "Someday you may even become a worthy wizard!"
    Victoria "Возможно, когда-нибудь ты даже станешь достойным волшебником!"
...
translate russian strings:
    ...
    new "Нажмите и перетащите мышь, чтобы нарисовать глиф на экране. У вас есть"
