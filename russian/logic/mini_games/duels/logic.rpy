...
translate russian test_duel_game_start_fa6f0a63:
    ...
    Jacob "Я с радостью приветствую участников магической дуэли!"
...
translate russian test_duel_game_start_f80b189c:
    ...
    Jacob "Сегодня два наших студента применят боевую магию на практике."
...
translate russian test_duel_game_start_77c82957:
    ...
    Jacob "Студент справа от меня представляет факультет [f_now]!"
...
translate russian test_duel_game_start_8e46ead1:
    ...
    Jacob "Студент слева от меня представляет факультет Леонхарт!"
...
translate russian strings:
    ...
    new "Молчание тебе больше к лицу."

    # game/logic/mini_games/duels/logic.rpy:2543
    old "So appetizing. I wonder who's hiding beneath that mask?"
    new "Интригующе. Интересно, кто скрывается за этой маской?"

    # game/logic/mini_games/duels/logic.rpy:2543
    old "A worthy fight! I wish I knew who you were..."
    new "Достойная битва! Но хотелось бы знать, кто ты..."

    # game/logic/mini_games/duels/logic.rpy:2543
    old "And so shall it be with anyone I challenge!"
    new "И так будет со всеми, кто выйдет против меня!"
