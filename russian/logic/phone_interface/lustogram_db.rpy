...
translate russian strings:
    ...
    new "Один милый парень с Румынской Конвенции по Истории Волшебства привел меня в это прекрасное место. Мы чудесно побеседовали и попробовали восхитительный экзотический сыр."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "I wish I'd meet someone as intelligent and funny in my life. Why are other guys not like him?"
    new "Хотела бы я встретить в своей жизни кого-нибудь такого же умного и веселого. Почему другие парни не такие, как он?"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "{b}Samantha:{/b} Miss Amelie, I'm so glad for you! So what about that guy? Isn't he an option? 😍"
    new "{b}Саманта:{/b} Мисс Амели, я так рада за вас! Так что насчет того парня? Разве он не вариант? 😍"
    ...
    new "Трудно представить, что есть кто-то умнее вас, мисс Амели."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "Maybe you should not friend zone the only guys who suit your fucking description?!"
    new "Может быть, не стоит френдзонить тех парней, которые подходят под это долбаное описание?!"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "Any place would be better than Romanian Wizardry History Convention."
    new "Сложно придумать что-то хуже, чем Румынская Конвенция по Истории Волшебства."
    ...
    new "Иногда даже работа в библиотеке может быть утомительной. Слава богу, у меня дома есть набор ароматических свечей и успокаивающая теплая вода."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "{b}Victoria:{/b} Girl, I can relate. I used to read in the bath too, but the thought of getting the book wet... Horrifying. "
    new "{b}Виктория:{/b} Дорогая, я понимаю. Раньше я тоже читала в ванне, но мысль о том, что книга может промокнуть... Ужасает."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "{b}Sabrina:{/b} Come see me when you're out of candles. I have a few exciting aromas. "
    new "{b}Сабрина:{/b} Приходи ко мне, когда у тебя закончатся свечи. У меня есть несколько прекрасных ароматов."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "I hope you'll get enough rest, miss Amelie ❤️"
    new "Я надеюсь, что вы хорошо отдохнете, мисс Амели ❤️"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "Doesn't it feel lonely to be alone in that king-size bath? I would be honored to help you fix this problem."
    new "Разве не тоскливо быть одной в этой огромной ванне? Для меня было бы честью помочь вам решить эту проблему."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "Got tired of working at the library? You poor thing! Maybe you can switch with coalminers to relax a little?"
    new "Надоело работать в библиотеке? Бедняжка! Может быть, вы поменяетесь местами с шахтерами, чтобы немного расслабиться?"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "It can be so lonely in the library. Aren't there any readers left among the youths?"
    new "В библиотеке бывает так одиноко. Среди молодёжи хоть какие-то читатели остались?"
    ...
    new "{b}Виктория:{/b} Дорогая, я видела двух или трех студентов с книгами. Так что да, можно сказать, что они находятся на грани вымирания."
    ...
    new "{b}Хейли:{/b} Я уверена, что люди не понимают, как весело копаться в библиотеке, пока не прочитаешь десять или двадцать книг в поисках ответа."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "{b}Elijah:{/b} Haley, I'm sure people realize it's the opposite of fun."
    new "{b}Элайджа:{/b} Хейли, я уверен, люди понимают, что это что угодно, только не весело."
    ...
    new "Мисс, я буду более чем счастлив составить вам компанию. Может быть, даже лучше, если мы будем одни."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "Amelie: I'm not sure you'll keep me entertained long enough🙄 😛"
    new "Амели: Я не уверена, что вы сможете развлекать меня достаточно долго🙄 😛"
    ...
    new "Напомните мне, почему я предпочла библиотеку, а не подиум на показе мод?"
    ...
    new "Мисс Амели, я уверена, что для библиотекарей тоже существуют модные показы."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "Hey, I'm a professional photographer. Maybe we can make your dream about a fashion shoot come true? "
    new "Кстати, а я профессиональный фотограф. Может быть, мы сможем воплотить в реальность вашу мечту о модной съемке?"
    ...
    new "Потому что вы хотели спасти себя от позора?"
    ...
    new "Однажды Уильям Шекспир сказал: \"Мне нравится это место, и я охотно убивал бы в нем свое время\", и именно так я отношусь к своей библиотеке. Смело могу назвать её \"вторым домом\" - даже не могу представить свою жизнь без неё. Я хочу быть здесь, и я действительно здесь - всё на своих местах."
    ...
    new "Я даже не могу представить Академию без библиотеки и без вас. Вы - её неотъемлемая часть!"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "I'm also interested what William Shakespeare would say about your curves."
    new "Мне также интересно, что сказал бы Уильям Шекспир о ваших формах."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "Now I'm a frisky little witch not in my mind only!"
    new "Теперь я шаловливая ведьмочка не только в своем воображении!"
    ...
    new "Эй, ребята, извините, что так долго не постила 😅 Тренировки 24\\7. Вы же меня знаете - только золото, остальное неприемлемо."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "{b}Samantha:{/b} Keep it up sis! I'm so sorry I can't be there to support you."
    new "{b}Саманта:{/b} Продолжай в том же духе, сестрёнка! Мне так жаль, что я не могу быть рядом, чтобы поддержать тебя."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "{b}Ashley:{/b} It's alright, sis. I'll send you my first selfie with gold."
    new "{b}Эшли:{/b} Все в порядке, сестрёнка. Я пришлю тебе свое первое селфи с золотом."
    ...
    new "Эшли, я горжусь твоим упорством. Пускай мы и не всегда очень хорошо ладим, но я хочу, чтобы ты знала - я на 100% уверен, что ты сделаешь это."
    ...
    new "Саманта: Ребята, вы такие милые, я сейчас расплачусь."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "Hey, girl - those curves are golden already. Does it matter what the jury says? "
    new "Эй, девочка, твои формы уже золотые. Имеет ли значение, что скажет жюри?"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "Ashley: Is there anything except sex about you? Come on."
    new "Эшли: Да ладно. В твоей голове есть что-нибудь, кроме секса?"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "Maybe you should consider switching your focus to Go-Go dancing? "
    new "Может быть, тебе стоит подумать о том, чтобы переключить свое внимание на танцы Гоу-Гоу?"
    ...
    new "Вуаля! Еще один взгляд на мою будущую рутину: посмотрите на новые трюки, над которыми я работала! Это было действительно очень весело!"
    ...
    new "{b}Дон:{/b}Не глупи, дорогая. Она профессионал, она знает, что делает!"
    ...
    new "Я могу придумать более подходящий способ использовать с тобой эти веревки..."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "\"Stop and look at yourself in the mirror. Are you happy with what you see?\""
    new "\"Остановись и посмотри на себя в зеркало. Довольна ли ты тем, что видишь?\""

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "Mom gave me that advice when I turned 12. I was chubby kid. I was not happy."
    new "Мама дала мне этот совет, когда мне исполнилось 12. Я была пухлым ребенком. Я была несчастлива."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "Now I am."
    new "Теперь я счастлива."
    ...
    new "{b}Оливия:{/b} Заткнись, Эвелин. Пусть ваши дети сами решают, какие советы полезны для них."
    ...
    new "Имеет значение только то, что ты великолепна внутри, Эш."
    ...
    new "Я все еще не понимаю, почему зеркала не плавятся от того, как ты горяча."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "Ashley: Stop it, you! I'm blushing already."
    new "Эшли: Прекрати это! Я уже краснею."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "Are you that basic? It's sad, honestly."
    new "Ты настолько поверхностна? Это печально, честно говоря."
    ...
    new "Так... Я хотела похвастаться своим просторным диваном, но в итоге снова похвасталась своими формами. Упс!"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "{b}Don:{/b} I don't think posting things like that is the reason we bought you your phone, young lady."
    new "{b}Дон:{/b} Я думаю, юная леди, мы не для того купили вам смартфон, чтобы вы такое тут размещали."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "{b}Ashley:{/b} Dad, come on! It's nothing."
    new "{b}Эшли:{/b} Ну пап, ладно тебе! Ничего страшного."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "{b}Don:{/b} Come into my office. Now. "
    new "{b}Дон:{/b} Ко мне в кабинет. Быстро."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "You just need to hear good things about your curves more often. I'll make sure you do."
    new "Тебе просто почаще надо слышать комплименты в адрес своей фигуры. Я обеспечу это."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "I think you have a gift for photography. This is my favorite photo of a couch!  "
    new "Я думаю, у тебя определённо таланты в фотографии. Это моё любимое фото дивана!"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "This is me approvingly watching you writing me positive comments. Well done, keep it up!"
    new "А это я сижу и радостно наблюдаю, как вы пишете мне хорошие комменты. Умнички, продолжайте!"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "{b}Samantha:{/b} Things I'd do for sisters approval."
    new "{b}Саманта:{/b} На что только не пойдёшь ради одобрения со стороны сестры."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "{b}Ashley:{/b} I bless you."
    new "{b}Эшли:{/b} Благословляю тебя."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "😀🥳 - this is as positive as I can get. "
    new "😀🥳 - позитивнее уже некуда."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "Ashley: Close enough."
    new "Эшли: Ну почти, почти."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "Don't you think bragging for likes like this is pathetic?"
    new "Тебе не кажется, что вот так вот выпрашивать лайки - это пошлость?"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "Ashley: Do you know you can just ignore the things you don't like?"
    new "Эшли: Тебе не кажется, что ты мог бы просто проигнорировать то, что тебе не нравится?"
    ...
    new "{b}Дон:{/b} Не думаю, что мы тебе купили тебе телефон для того, чтобы ты размещала такие фото. На разговор ко мне в кабинет, быстро!"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "{b}Olivia:{/b} Don, she is a grown woman and it's absolutely okay. Baby, you're gorgeous!"
    new "{b}Оливия:{/b} Дон, она уже взрослая и это совершенно нормально. Детка, ты прекрасна!"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "In your eyes, of course! "
    new "В твои глаза, конечно же!"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "Let's be honest - 99% check out your boobs. And I can say that it worth looking at!"
    new "Будем честны - 99% пялятся на твои сиськи. И, скажу я тебе, оно того стоит!"
    ...
    new "На экран телефона, разве не очевидно?"
    ...
    new "Наконец я на своём месте, и дорогие мне люди рядом. Как бы назвать это странное чувство? Может быть, это... счастье?"
    ...
    new "{b}Саманта:{/b} Рада вновь встретиться со своей лучшей!"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "You look lovely together ☺️"
    new "Вы очаровательно смотритесь ☺️"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "What do I have to do to get that look from you, baby?"
    new "Чем же я могу заслужить такой взгляд от тебя, детка?"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "Are you sure this is the best photo you've got?"
    new "Ты уверена, что фотографии получше не нашлось?"
    ...
    new "Средневековая ярмарка была интересной, но загадочности ей явно недоставало. Решила помочь им в этом! Как вам мой костюмчик?"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "{b}Elijah:{/b} WTF... Those wings look so natural."
    new "{b}Элайджа:{/b} ВАУ... Крылья прямо как настоящие."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "{b}Samantha:{/b} @Elijah +1. Your costume is fantastic! I'm so glad we've bought it."
    new "{b}Саманта:{/b} @Элайджа +1. Костюм прекрасен! Я так рада, что мы его купили."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "I love how this costume suits your hair!"
    new "Костюм очень здорово сочетается с твоими волосами!"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "Wow... I think you've accidentally stolen all the attention."
    new "Вау... Кажется, ты нечаянно украла всё внимание."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "I don't want to go medieval on you, so I won't say anything about your look."
    new "Не хочу быть невежливым, так что про твой образ лучше ничего не стану говорить."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "You  never know what's waiting around the darkest corner. Maybe it's me..."
    new "Никогда не знаешь, что тебя ждёт в мрачном переулке. Может быть, это я..."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "Would you dare to take a closer look? "
    new "Кто-нибудь осмелится подойти поближе?"
    ...
    new "Как же этот переулок может быть мрачным, если твои глаза сияют так ярко?"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "I'm not sure I'm going to stop at just looking."
    new "Не уверен, что для меня будет достаточно лишь посмотреть."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "Nah, it's too creepy..."
    new "Нее, слишком уж стрёмно..."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "Paid a visit to my old haters.... And people who sent me dick pics 🤬"
    new "Заглянула к своим хейтерам... И к тем, кто слал мне дикпики 🤬"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "Seriously, what's wrong with you, guys? I'm more turned on by looking at this gravestone than by receiving this trash."
    new "Серьёзно, народ, что с вами не так? Меня больше заводит смотреть на этот могильный камень, чем на ту дрянь, которую вы шлёте."
    ...
    new "Лушче бы вы попробовали позвать меня на свидание, но, честно говоря - лучше бы вы вообще от меня отстали! Пожалуйста, уползите куда-нибудь подальше да сдохните."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "{b}Elijah:{/b} Yeah, you can send me those dick pics instead. "
    new "{b}Элайджа:{/b} Да, те дикпики лучше пересылайте мне."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "{b}Elijah:{/b} That's a joke, guys. "
    new "{b}Элайджа:{/b} Если что, это шутка была."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "I'm totally with you on this. Men are disgusting."
    new "Совершенно согласен с тобой. Мужики отвратительны."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "You know that there is no sign that dick pics are not welcomed in your private?"
    new "Ты же в курсе, что тут нет нигде запрещающих знаков по поводу дикпиков в личке?"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "Every girl has her secrets. Are you sure you can unravel mine? Many have tried and ended up like Yorick."
    new "У всех девушек есть секреты. Ты уверен, что готов познать мой? Многие пытались, и их постигла та же судьба, что и Йорика."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "{b}Samantha:{/b} Maybe you should not brag about secrets if you don't want people to snoop around?"
    new "{b}Саманта:{/b} Может быть, тебе не стоит хвастаться секретами, если ты не хочешь, чтобы люди пытались их разнюхать?"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "{b}Ashley:{/b} What's the fun in that?"
    new "{b}Эшли:{/b} Ну и в чём тогда веселье?"
    ...
    new "{b}Джейкоб:{/b} Одна из главных загадок - это как вам удастся не вылететь из школы, если вы не сдадите свою курсовую работу."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "Hey, sometimes it's worth the risk. I think you're just that case."
    new "Ну, иногда стоит и рискнуть. Думаю, здесь как раз тот случай."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "Samantha: It's nice to see you guys get along so well."
    new "Саманта: Мило, что вы так здорово ладите."
    ...
    new "Главная загадка - кто вообще ставит лайки под такими тупыми постами."
    ...
    new "Привожу себя в форму. В форму обжигающе горячей цыпочки!"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "I hope I won't get the academy on fire."
    new "Надеюсь, я не спалю ненароком всю школу."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "{b}Lily:{/b} Hey, wow! I have the same sport's top!"
    new "{b}Лили:{/b} Оу, вау! У меня такой же топ!"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "{b}Elijah:{/b} Too hot for this app. "
    new "{b}Элайджа:{/b} Для этого приложения точно слишком горячо."
    ...
    new "Какое вдохновение - видеть, как идеальная девушка стремится стать ещё идеальнее."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "Audrey: I'm uncomfortable with getting compliments. Go away."
    new "Одри: Я не люблю получать комплименты. Уйди."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "I wish I could spend more time in a gym last summer."
    new "Жаль, что я прошлым летом не проводил больше времени в тренажёрном зале."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "Audrey: Your minor injury is not an excuse for laziness."
    new "Одри: Твоя мелкая травма - не оправдание лени."
    ...
    new "Чувствую покой и гармонию, которые раньше не ощущала. Не думала, что душа и тело настолько сильно связаны. Спасибо за совет, Саманта."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "{b}Samantha:{/b} Become one with your inner spirit."
    new "{b}Саманта:{/b} Стань одним целым со своим внутренним миром."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "{b}Elijah:{/b} I don't know. Aren't you afraid of inner demons?"
    new "{b}Элайджа:{/b} Ну не знаю. Ты не боишься демонов внутри себя?"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "{b}Audrey:{/b} You can't even imagine..."
    new "{b}Одри:{/b} Даже представить не можешь..."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "One look at this picture fills me with harmony. Or, well, maybe those are some other feelings 😈 "
    new "Один лишь взгляд на это фото дарит мне гармонию. Ну или может быть это иное чувство 😈"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "Isn't yoga a juhe waste of money and time with no confirmed effect?"
    new "А разве йога это не пустая трата времени с недоказанной пользой?"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "I feel the need... the need for speed."
    new "Я чувствую жажду... жажду скорости."
    ...
    new "Вчера один парень сказал мне, что девушки на мотоциклах - самые сексуальные. Вы согласны, или думаете, что он просто подкатывал ко мне? 😈"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "{b}Elijah:{/b} Your friend is so right! But desire to hook up with you also makes sense..."
    new "{b}Элайджа:{/b} Тот парень точно прав! Впрочем, нельзя его упрекать, если он хотел с тобой замутить..."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "{b}Samantha:{/b} Only look at her! I love you so much, Audrey! ❤️"
    new "{b}Саманта:{/b} Да вы только посмотрите! Я так люблю тебя, Одри! ❤️"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "Awesomeness of this photo is just off the charts!"
    new "Крутость этого фото зашкаливает!"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "Can my belief that girls on motorcycles are the hottest help me somehow to make a pass at you? "
    new "А если я давно убеждён, что девушки на байках самые сексуальные, это поможет мне охмурить тебя?"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "Let me see those likes!"
    new "Отгрузите-ка мне лайков!"
    ...
    new "Первый день в роли старосты Леонхарта прошёл отлично! Это [Name], новый студент и мой друг - посмотрите в его глаза! Вперёд в светлое будущее!"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "{b}Haley:{/b} ha-ha, [Name] looks so silly here!"
    new "{b}Хейли:{/b} ха-ха, [Name] выглядит так забавно!"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "{b}Lily:{/b} True. You guys are cute ❤️"
    new "{b}Лили:{/b} И правда. Вы милашки ❤️"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "Thanks, buddy. Glad that you are my prefect."
    new "Спасибо, братан. Здорово, что ты мой старости."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "Delete this. Now."
    new "Удали. Немедленно."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "At first I was afraid I'd look bad, but next to you, I look handsome)."
    new "Сначала я думал, что плохо получился, но на фоне тебя я просто красавчик!)"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "1 book a day and it's okay"
    new "Одна книга в день - то, что надо."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "What could be more satisfying than gliding on ice while the wind flutters your hair? "
    new "Что может быть лучше, чем скользить по льду, пока ветерок колышет твои волосы?"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "I think I could do this forever. How do you take a break from your studies?"
    new "Могла бы вечно наслаждаться. А вы как отдыхаете от учёбы?"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "{b}Lily:{/b} I love skiing too!"
    new "{b}Лили:{/b} Мне ещё нравятся лыжи!"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "{b}Elijah:{/b} It's too soon to take any breaks from studies, young lady."
    new "{b}Элайджа:{/b} Юная леди, рановато ещё отдыхать от учёбы."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "{b}Elijah:{/b} Kidding! I prefer snowboarding; it just seems more remarkable."
    new "{b}Элайджа:{/b} Шутка! Я любою сноуборд; это просто круче, мне кажется."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "I used to play soccer before, after, and even instead of school."
    new "Я любил играть в футбол - до, после и иногда даже вместо школы."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "You look incredible on ice skates!"
    new "Ты чудесно смотришься на коньках!"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "Scrolling through my Lustagram feed, mostly..."
    new "В основном, листаю ленту в Lustagram..."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "I read that a person's real beauty is on the inside, not the outside. What is the first thing you pay attention to?"
    new "Прочитала, что истинная красота человека скорее внутри, чем снаружи. А вы на что в первую очередь обращаете внимание?"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "{b}Elijah:{/b} It works that way with ugliness too. If someone looks like a candy, it does not mean he does not taste sour."
    new "{b}Элайджа:{/b} С уродством так же работает. Если кто-то выглядит классно, то совсем не значит, что человек не окажется дерьмом."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "{b}Haley:{/b} @Elijah That's true..."
    new "{b}Хейли:{/b} @Элайджа Это правда..."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "Yeah, every person deserves a chance, no matter the looks..."
    new "Правильно, каждый человек заслуживает шанса вне зависимости от внешности..."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "Lucky, you've got both."
    new "К счастью, у тебя и там и там всё супер."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "It's usually two big things in the front and one on the back. Why?"
    new "Обычно на эти две большие штуки спереди, ну и на одну сзади. А что?"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "Do I look like I've grinded through five textbooks in one night? Because that's what I did, Yay!"
    new "Я похожа на человека, который вызубрил материал пяти книг за одну ночь? Потому что именно этим я и занималась. Йеееей!"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "{b}Elijah:{/b} I'm sorry, was #Funnight a mistake, or why am I here, reading about reading? Ugh..."
    new "{b}Элайджа:{/b} Простите, а тэг #Funnight был ошибкой, или почему я только что прочитал про чтение? Фуу..."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "{b}Lily:{/b} That's a tremendous amount of books. How do you read so fast?"
    new "{b}Лили:{/b} Невероятный объем информации. Как ты можешь так быстро читать?"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "{b}Haley:{/b} Practice, I guess..."
    new "{b}Хейли:{/b} Привыкла, наверное..."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "Wow! I'd have to spend a whole week if I were to finish five textbooks..."
    new "Вау! У меня на пять книг ушла бы наверняка целая неделя..."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "So that's your secret? I hope all models will read that much at night because you've even more beautiful than usual."
    new "В чём твой секрет? Надеюсь, все красавицы так любят читать перед сном, потому что ты-то точно невероятно красива."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "I stayed last night reading too! Got five comic books done in no time."
    new "Я тоже вчера долго читал перед сном! Проглотил пять выпусков комиксов."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "About how fast things change:"
    new "Про то, как быстро всё меняется:"
    ...
    new "Ещё летом я была самым одиноким человеком на свете. Родители меня не понимали, подруги меня бросили, и у меня не было бойфренда, с которым можно было бы хотя бы поговорить."
    ...
    new "Теперь я постоянно улыбаюсь, вокруг меня куча новых друзей, я в самом невероятном месте на Земле, и есть тут ещё этот парень... Нет, насчёт парня давайте пока не спешить с выводами 😅"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "Anyway, if life is like a box of chocolates, this fall I haven't had any bad ones yet."
    new "В любом случае, жизнь как коробка конфет, и этой осенью мне попадаются только вкусные."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "I wish you a white streak, too."
    new "Желаю и вам встретить светлую полосу."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "{b}Samantha:{/b} That's very sweet. We're here for you."
    new "{b}Саманта:{/b} Это очень мило. Мы с тобой."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "{b}Elijah:{/b} Hey, you are too beautiful to have those sad thoughts. We won't let that happen again. Welcome to the family."
    new "{b}Элайджа:{/b} Хей, ты слишком красива, чтобы так грустить. Мы такое больше не допустим. Добро пожаловать в семью."
    ...
    new "Хейли, ты отличная подруга и заслуживаешь улыбаться каждый день!"
    ...
    new "Вау! У тебя так здорово и ярко! Нравится!"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "Haley: Thanks! You're welcomed to visit! "
    new "Хейли: Спасибо! Заглядывай!"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "The main question is - how sturdy is your bad? "
    new "Главный вопрос - насколько крепкая у тебя кровать?"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "Haley: Why?',' Haley: Oh! I got it! Ew!!!! "
    new "Хейли: А что?',' Хейли: А! Поняла! Блин!!!"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "Your room is much brighter and cozier than mine. I'm depressed. "
    new "Твоя комната намного ярче и уютнее, чем моя. Я в печали."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "Haley: Is it that bad, sweety? I'll help you redecorate if you want 💪."
    new "Хейли: Дорогой, неужели всё так плохо? Если хочешь, я могу помочь тебе её прикурасить 💪"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "The best way to take a break from studies is to make a selfie. Do I look like I'm ready to ace the test?"
    new "Лучший способ отвлечься от учёбы - это сделать селфи. Ну что, как думаете, я готова сдать тест на отлично?"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "{b}Lily:{/b} You look like you're ready to ace all the tests. Should I already celebrate Leonhearts victory?"
    new "{b}Лили:{/b} Выглядит так, как будто ты готова сдать на отлично вообще всё. Не пора ли уже праздновать победу Леонхарта?"
    ...
    new "{b}Виктория:{/b} Мисс Рейнджер, вам виднее, конечно, но если вы будете так много заниматься теорией, у вас не останется времени на практику."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "{b}Haley:{/b} Don't worry, miss Lapis. I'm confident in my spellcasting."
    new "{b}Хейли:{/b} Не волнуйтесь, мисс Лапис. Я уверена в своих заклинаниях."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "You always look like you're ready to ace everything, girl!"
    new "Ты всегда выглядишь готовой к любым успехам, детка!"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "Haley: Aww, that's so nice, [Name]. ty..."
    new "Хейли: Оооу, это так приятно, [Name]. Спс..."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "I never thought that a girl in a library could look so hot."
    new "Никогда не думал, что девушка в библиотеке может выглядеть так сексуально."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "Haley: Glad I've changed your mind. I'm not too fond of those old stereotypes about library-type girls."
    new "Хейли: Рада, что сумела тебя убедить. Мне не по душе эти устаревшие стереотипы про прилежных студенток."
    ...
    new "Здесь в Кордейле так много интересных вещей и созданий! Но будьте осторожны - этот ангел меня только что до смерти перепугал..."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "{b}Lily:{/b} What's this place? I didn't know we have something like that in the Academy. We should go there!"
    new "{b}Лили:{/b} Что это за место? Я не знала, что у нас такое есть в Академии. Надо туда сходить!"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "Thank you for a walk, Haley! I really enjoy it."
    new "Спасибо за прогулку, Хейли! Мне очень понравилось."
    ...
    new "Никогда бы не подумал, что мраморные фигуры могут так меня заинтересовать..."
    ...
    new "Так приятно понимать, что меня повсюду окружают книги: даже у нас в общежитии есть небольшая библиотека, в которой можно найти что-то интересное."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "My last discovery - \"Fantastic Beasts and Where to Find Them\". EVERYONE should read it!"
    new "Моё свежее открытие - \"Фантастические Твари и Где Они Обитают\". Советую ВСЕМ!"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "{b}Samantha:{/b} I've already read it and can say that it's amazing!"
    new "{b}Саманта:{/b} Уже читала и уверенно говорю, что книга супер!"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "{b}Elijah:{/b} Do you write a blog only about books or what?"
    new "{b}Элайджа:{/b} Ты ведёшь блог только про книги или как?"
    ...
    new "Можем почитать её вместе, в более интимной обстановке..."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "Haley: But I've already read it."
    new "Хейли: Но я уже её закончила."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "I know where you can find fantastic beasts - in our living room!"
    new "Я знаю, где обитают фантастические твари - у нас в гостиной!"
    ...
    new "Выбрались с семьёй на пикник в день перед моим отъездом. Уже скучаю по ним и по беззаботным летним денькам..."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "{b}Naomi:{/b} We might be able to have a picnic this weekend somehow."
    new "{b}Наоми:{/b} Мы могли бы в эти выходные устроить какой-нибудь пикник."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "{b}Lily:{/b} That's a great idea!"
    new "{b}Лили:{/b} А это идея!"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "{b}Naomi:{/b} Let's see whose house will do a better job of organizing it!"
    new "{b}Наоми:{/b} Посмотрим, чей факультет лучше справится с организацией!"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "{b}Elijah:{/b} Do you ever get tired of fighting each other?"
    new "{b}Элайджа:{/b} Вам не надоедает соперничать друг с другом?"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "It's so nice of you to spend time with your family."
    new "Очень мило, что ты проводишь время с семьёй."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "I'd love to get carefree with you, Lily. Any place, any time."
    new "Лили, с тобой я бы охотно забыл про все заботы. В любом месте, в любое время."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "Wow, photo of Lily where she does not talk about housepoints... I've seen everything now."
    new "Вау, пост Лили, где она не говорит про баллы для факультета... Теперь я видел всё."
    ...
    new "Возле бабушкиного дома есть древнее озеро с волшебными лилиями, которые цветут лишь один день в году. Я в такой день и родилась, потому мама и придумала мне это имя."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "They wanted to call me Angie. Could you imagine?!"
    new "Они думали назвать меня Энджи. Представляете?!"
    ...
    new "{b}Саманта:{/b} Очень красиво..."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "I never thought you name has such a deep meaning. Wow."
    new "Не подозревал, что у твоего имени такой глубокий смысл. Вау."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "The real mystery here is how your parents predicted that you'll be as beautiful as those magical lilies."
    new "Настоящая загадка в том, как твои родители сумели предугадать, что ты будешь такая же прекрасная, как и эти цветы."
    ...
    new "Первый раз в спа. Это было чудесно! Не думала, что моё тело будет чувствовать себя таким расслабленным и свежим. Магия какая-то?"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "{b}Elijah:{/b} I love the spa! It brings me back to life after raves and partying too hard!"
    new "{b}Элайджа:{/b} Мне очень нравится спа! Приводит в чувство после жёстких вечеринок и пьянок!"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "{b}Samantha:{/b} @Elijah, I'm pretty sure you shouldn't be there during a hangover. "
    new "{b}Саманта:{/b} @Элайджа, уверена, что с похмелья туда ходить не стоит."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "{b}Elijah:{/b} What do you know..."
    new "{b}Элайджа:{/b} Тебе-то откуда знать..."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "It looks soothing. Can you recommend a place?"
    new "Звучит классно. Будут рекоммендации?"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "I wish I was water in that pool..."
    new "Хотел бы я быть водой в том бассейне..."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "It looks like all you do is relax, and you never knew you could feel so relaxed? Wow."
    new "Ты как будто только и делаешь, что расслабляешься - и говоришь, что такой расслабленной себя никогда не чувстсвовала? Вау."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "Future elders of Leonheart and Adderin. Naomi can be pretty sly and sassy, but she is one of the best even at that."
    new "Будущие старшекурсники Леонхарта и Аддерина. Наоми бывает хитрой и дерзкой, но даже в этом она одна из лучших."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "And only by competing with the best will our house reach the top!"
    new "И наш факультет займёт вершину, только соревнуясь с лучшими!"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "{b}Naomi:{/b} And you can be too stubborn and naive. But guess for a Leonheart, that's good?"
    new "{b}Наоми:{/b} А ты бываешь упёртой и наивной. Но, видимо, для Леонхарта это норма?"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "{b}Elijah:{/b} I'm proud of you guys. Being friends despite the different houses."
    new "{b}Элайджа:{/b} Горжусь вами. Дружите, несмотря на столь разные факультеты."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "{b}Lily:{/b} Are you saying that's unusual?"
    new "{b}Лили:{/b} Хочешь сказать, это необычно?"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "{b}Elijah:{/b} Who? Me? No, of course, I'm not. For your information: I don't see the house."
    new "{b}Элайджа:{/b} Кто? Я? Нет, конечно нет. Чтобы ты знала - я вижу человека, а не факультет."
    ...
    new "Вау, пассивная агрессия льёт через край. Вы всегда так друг с дружкой?"
    ...
    new "За окном просто море удивительных возможностей, а вы выбрали пялиться в экран и листать Lustagram. Ну раз уж вы оказались здесь, не хотите ли поставить мне лайк?"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "{b}Elijah:{/b} You got me. Here you go."
    new "{b}Элайджа:{/b} Убедила. Держи."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "{b}Naomi:{/b} You have to work harder to earn my like."
    new "{b}Наоми:{/b} Чтобы заслужить мой лайк, надо получше стараться."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "{b}Audrey:{/b} Nothing interesting behind those windows. Trust me."
    new "{b}Одри:{/b} Нет ничего интересного за окном, поверь мне."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "Here you go ❤️"
    new "Милости просим ❤️"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "Hey, babe! I'm 100% with you on this. Let's explore those possibilities together! "
    new "Эй, детка! На все сто согласен с тобой. Давай исследовать эти возможности вместе!"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "There's a whole world of amazing possibilities, but here you are, asking for likes on Lustagram 😢"
    new "За окном просто море удивительных возможностей, а ты сидишь тут и выпрашиваешь лайки в Lustagram 😢"
    ...
    new "Вчера звонила мама и спрашивала, как у меня дела. Интересовалась, скучаю ли я по большой кровати, слугам и другим роскошествам. Не скучаю. Впрочем, её звонок показал, как я скучаю по семье."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "{b}Samantha:{/b} I understand that feeling. We don't get very well with my mom, but I miss her every day..."
    new "{b}Саманта:{/b} Знакомое чувство. Мы с мамой не всегда хорошо ладим, но я скучаю по ней постоянно..."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "{b}Elijah:{/b} So, you're a spoiled rich girl?"
    new "{b}Элайджа:{/b} То есть ты избалованная богатенькая девочка?"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "I'm sure your family misses you too. Your mom called to hear your voice. That's how much she misses you."
    new "Уверен, что и семья по тебе очень скучает. Мама хотела услышать твой голос - вот как ей тебя не хватает."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "Lily: Thanks, [Name]. That means a lot to me."
    new "Лили: Спасибо, [Name]. Это многое для меня значит."
    ...
    new "Лили: Почему ты так груб со мной сегодня?!"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "Having fun at the pajama party with girls!! Would you join us?"
    new "У нас тут с девочками суперская пижамная вечермнка!! Хотите присоединиться?"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "{b}Haley:{/b} It was incredible!"
    new "{b}Хейли:{/b} Было супер!"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "{b}Elijah:{/b} Definitely YES!"
    new "{b}Элайджа:{/b} Однозначно ДА!"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "Do you know how cute you look in this panties?"
    new "Ты очень мило смотришься в этих трусиках"
    ...
    new "Давай устроим пижамную вечеринку с тобой на двоих! Мы найдём стооолько интересных занятий. 😉"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "Lily: I will think about it."
    new "Лили: Я об этом подумаю."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "If I start to jump with you then the bed will break down - is it what you want?"
    new "Если я буду прыгать там с вами, кровать сломается - вы точно этого хотите?"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "Owner of Cordale cafe"
    new "Хозяйка кафе в Кордейле"
    ...
    new "Подруги переживают, что раз уж я занимаюсь своим бизнесом, мне не светит найти парня и я навсегда останусь одна."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "Do you boys think they're right?"
    new "Как думаете, они правы?"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "{b}Elijah:{/b} Yes, Molly, you'll remain an old maid..."
    new "{b}Элайджа:{/b} Да, Молли, ты останешься старой девой..."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "{b}Haley:{/b} With those legs? Your friends are just jealous."
    new "{b}Хейли:{/b} С этими-то ножками? Да они просто завидуют."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "Nonsense, they just have outdated views. You're awesome!"
    new "Ерунда, у них какие-то несовременные взгляды. Ты великолепна!"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "I've always thought that confident, successful women are the most attractive."
    new "Всегда считал, что успешные и уверенные в себе женщины наиболее привлекательны."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "As if your obsession with work was the only issue..."
    new "Можно подумать, твой трудоголизм это единственная проблема..."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "Mood: to be on top of the world and to ignore the haters."
    new "Настроение: быть на вершине мира и игнорировать всяких хейтеров."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "{b}Elijah:{/b} Go, Molly!"
    new "{b}Элайджа:{/b} Молли, жги!"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "You're on top, but I'm not sure there's a single soul that hates you out here."
    new "Ты и так на вершине, но я не думаю, что хоть одна душа тебя ненавидит."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "This photo should be on the cover of Forbes. Or maybe a Playboy. Both?"
    new "Такая фотография должна быть на обложке Forbes. Или Playboy. Или на обеих?"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "You're lying on the floor. How is it \"on the top\"?"
    new "Ты валяешься на полу. Где же тут \"вершина\"?"
    ...
    new "В нашей отрасли многие начинают с небольшой стойки посреди улицы. Моё кафе на территории древнего замка. Как тебе такое, Гордон Рэмзи?"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "{b}Victoria:{/b} We're all very proud of you, Molly. "
    new "{b}Виктория:{/b} Молли, мы все тобой очень гордимся."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "{b}Sabrina:{/b} In the morning, there's nothing better than your black potion and bagels. Love you."
    new "{b}Сабрина:{/b} Нет ничего лучше с утра, чем твоё чёрное зелье и бейглы. Обожаю."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "{b}Elijah:{/b} Our food and juice queen."
    new "{b}Элайджа:{/b} Наша королева еды и напитков."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "Never doubted your talents, Molly. I know you won't stop until the very top!"
    new "Никогда не сомневался в твоих талантах, Молли. Ты не остановишься, пока не достигнешь успеха!"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "Molly: You damn right, I won't. Thank you, honey."
    new "Молли: Вот и правильно, да. Спасибо, дорогой."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "Well, Gordon sure had fewer relatives with prominent locations like this..."
    new "Ну, у Гордона не было родственников со связями в подобных местах..."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "Bought a new blouse and have some doubts. Do you think it suits me or not?"
    new "Купила новую блузку и засомневалась. Как думаете, идёт она мне или нет?"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "{b}Audrey:{/b} Beauty queen in anything. 🔥"
    new "{b}Одри:{/b} Королева красоты в любом наряде 🔥"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "{b}Molly:{/b} Just like you!"
    new "{b}Молли:{/b} Прямо как ты!"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "{b}Elijah:{/b} I personally think that it is better without it... and without any other blouse."
    new "{b}Элайджа:{/b} Я лично считаю, без неё было бы лучше... Да и вообще безо всякой блузки."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "{b}Molly:{/b} Dummy..."
    new "{b}Молли:{/b} Тупица..."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "It's definitely suits you! "
    new "Тебе определённо идёт!"
    ...
    new "Согласен с Элайджа."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "Molly: Dummy +1"
    new "Молли: И ты тупица"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "Sorry, not interested"
    new "Прости, не интересно"
    ...
    new "Люблю делать всё быстро, чётко и прямолинейно. Как стрела, выпущенная из лука. Вот почему мне так нравится это оружие."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "{b}Lily:{/b} I always thought shart tongue was your scariest weapon..."
    new "{b}Лили:{/b} А я всегда думала, что твоё главное оружие это острый язык..."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "{b}Lily:{/b} And it's still is.😜"
    new "{b}Лили:{/b} И он на месте 😜"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "Sharp and deadly!"
    new "Остро и смертоносно!"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "I like woman like that..."
    new "Такие женщины мне по душе..."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "Are you as low-efficient as the bow compared to a modern weapon?"
    new "Ты настолько же неэффективна, как и лук в сравнении с современным оружием?"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "I don't understand where does the hatred of rich kids come from in the first place?"
    new "Не могу понять, откуда вообще берётся эта ненависть в адрес детей из богатых семей?"
    ...
    new "Мало кто заслуживает роскошную жизнь больше, чем я. Моя семья поколениями трудилась для достижения статуса и богатства, поэтому я могу жить на широкую ногу."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "{b}Lily:{/b} Naomi, do you really think so?"
    new "{b}Лили:{/b} Наоим, ты правда так думаешь?"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "{b}Elijah:{/b} Ah, it's so nice to see that the most spoiled one is not in our house."
    new "{b}Элайджа:{/b} Ах, как же здорово, что самая испорченная студентка - на другом факультете."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "You were born for this. Ignore the haters."
    new "Ты для этого рождена. К чёрту хейтеров."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "With such a gorgeous body, you could have achieved a world of your own..."
    new "С таким потрясным телом ты могла бы завоевать ещё и ещё больше..."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "And what have YOU done to say you've deserved this kind of life?"
    new "А чего же добилась ТЫ, чтобы утверждать, что заслуживаешь такой жизни?"
    ...
    new "Отец подарил мне традиционный боевой костюм моего народа. Просто представьте - сотни лет назад лучницы из нашего племени сражались против колонизаторов..."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "{b}Victoria:{/b} Naomi, that's so interesting! Did your tribe practice magic at that time?"
    new "{b}Виктория:{/b} Наоми, это так интересно! Твоё племя тогда практиковало магию?"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "{b}Naomi:{/b} Only voodoo from father's side."
    new "{b}Наоми:{/b} Только вуду по папиной линии."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "If you were there, you'd kick their asses."
    new "Если бы ты была там, ты бы им всем надрала зады."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "I think we can find another way to use this costume if you know what I mean."
    new "Думаю, мы можем найти этому костюму иное применение, если ты понимаешь, о чём я."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "It seems to me that they did a crappy job that time."
    new "Сдаётся мне, с костюмом они не очень-то старались."
    ...
    new "Иногда стены в комнате так пусты и скучны, что я не могу удержаться и украшаю их собой для фото. Ну как?"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "{b}Lily:{/b} We exist to make this place look brighter. Go for it, girl!"
    new "{b}Лили:{/b} Мы здесь как раз для того, чтобы это место было ярче. Вперёд, детка!"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "{b}Samantha:{/b} +1. It's totally okay for every girl I know."
    new "{b}Саманта:{/b} +1, совершенно нормально для любой девушки."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "Wow... Maybe you'll help me with boring walls behind my bad, baby?"
    new "Вау... Может быть, ты поможешь мне и с моими скучными стенами возле кровати, детка?"
    ...
    new "С каких пор это называется украшением?"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "Desperately looking for a potion that will revitalize my interest in studying."
    new "В отчаянном поиске зелья, которое бы оживило мой интерес к обучению."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "{b}Sabrina:{/b} Maybe the \"Get expelled\" potion will work?"
    new "{b}Сабрина:{/b} Может быть, \"зелье отчисления\" поможет?"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "{b}Naomi:{/b} Miss Spellman, I was just joking, I swear."
    new "{b}Наоми:{/b} Мисс Спеллман, я пошутила, честное слово."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "Maybe a love juice will do?"
    new "Может быть, соки любви подойдут?"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "Naomi: I hope you were talking about love potions."
    new "Наоми: Я надеюсь, ты говоришь о любовном зелье."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "Then why the fuck do you attend Potions? You know it's not an obligation, do you?!"
    new "Так и нахрена тогда ты ходишь на зельеварение?! Ты же понимаешь, что не обязана?"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "The only interesting thing in this class is me."
    new "Самое интересное за этом уроке - это я."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "{b}Sabrina:{/b} At least try to not spit that in my face, Naomi."
    new "{b}Сабрина:{/b} По крайней мене постарайтесь не бросаться такими репликами мне в лицо, Наоми."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "{b}Naomi:{/b} Miss Spellman, that's just a joke. Come on,"
    new "{b}Наоми:{/b} Мисс Спеллман, ну ладно вам, это просто шутка."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "{b}Elijah:{/b} Roasting teachers in public account - epic!"
    new "{b}Элайджа:{/b} Прожарка педагогов в соцсетях - эпично!"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "It's not fair, girl. You're the most interesting thing anywhere you go."
    new "Несправедливо, детка. Ты самая интересная везде, куда бы ни пошла."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "Naomi: You think you?😚"
    new "Наоми: Ты так думаешь, да?😚"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "That makes 0 interesting things in that class."
    new "Ну то есть нет вообще ничего интересного на уроке, получается."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "Naomi: Remind me, why don't I just ban you??🤬"
    new "Наоми: Напомни-ка, почему бы мне тебя просто не забанить??🤬"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "The devil doesn't wear prada; I'm clearly without anything."
    new "Дьявол не носит Прада. На мне точно ничего нет."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "{b}Samantha:{/b} Gosh, that's provocative but sooo sexy!"
    new "{b}Саманта:{/b} Воу, провокационно, но тааак секси!"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "{b}Elijah:{/b} Yep, there is something devilish in you."
    new "{b}Элайджа:{/b} Да, есть в тебе что-то дьявольское."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "Didn't know that devils can be THAT hot!"
    new "Не подозревал, что дьявол может быть НАСТОЛЬКО горяч!"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "The size of your boobs is really impressive!!!"
    new "Сиськи у тебя ну просто огромные!!!"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "Naomi: nothing new for me."
    new "Наоми: не новость для меня."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "Has someone stolen your clothes?"
    new "Кто-то стащил твою одежду?"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "Wife, model, artist"
    new "Жена, модель, художница"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "My friends often ask me what is the secret of my beautiful skin."
    new "Меня часто спрашивают, в чём секрет моей красивой кожи."
    ...
    new "Всё очень просто - молодость это состояние души, а не тела. Отпуск на море с любимым мужем, естественный загар и \"секс на пляже\" 😈 - вот мой рецепт молодости и красоты ❤️"
    ...
    new "{b}Эшли:{/b} Хватит меня смущать!"
    ...
    new "{b}Эвелин:{/b} Спасибо за совет! Можно я позаимствую твоего мужа на следующих выходных? 😉"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "{b}Olivia:{/b}  I WILL END YOU 😡"
    new "{b}Оливия:{/b} Я УБЬЮ ТЕБЯ 😡"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "Your tan looks fantastic 👍"
    new "Загар выглядит потрясно 👍"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "The sun was no the hottest thing on the beach that day 😉"
    new "В тот день на пляже было нечто погорячее, чем Солнце 😉"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "I hope before you got your \"Sex on the beach\" Don managed to get all the ingredients for his \"Dirty martini\" 👅"
    new "Надеюсь, что прежде чем ты получила свой \"секс на пляже\", Дон нашёл все игредиенты для своего \"грязного мартини\" 👅"
    ...
    new "Испекла капкейки для нашей встречи книжного клуба. Выглядят аппетитно, а главное - ни грамма сахара! Напишите мне, поделюсь рецептом."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "{b}Samantha:{/b} Wow, mom, looks yummy!"
    new "{b}Саманта:{/b} Вау, мам, вкуснота!"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "{b}Olivia:{/b} Thanks! But you can't have one 😜"
    new "{b}Оливия:{/b} Спасибо! Но тебе не достанется 😜"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "{b}Samantha:{/b} But whyyyy? 😱😭"
    new "{b}Саманта:{/b} Ну почемууу? 😱😭"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "{b}Olivia:{/b} First rule of the book club: never share a cupcake with an outsider."
    new "{b}Оливия:{/b} Первое правило книжного клуба: никогда не делись капкейками с посторонними."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "{b}Samantha:{/b} I'm your daughter 🥺"
    new "{b}Саманта:{/b} Я же твоя дочь 🥺"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "{b}Olivia:{/b} Means nothing to me 😈"
    new "{b}Оливия:{/b} Это ничего не меняет 😈"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "{b}Samantha:{/b} roasted by my own mother. ☠️☠️☠️"
    new "{b}Самвнта:{/b} меня прожарила родная мать. ☠️☠️☠️"
    ...
    new "Капкейки выглядят очень вкусными 😏"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "If there's no sugar it's not a cupcake! 🤢"
    new "Если там нет сахара, то это и не капкейки! 🤢"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "It's not quantity but quality that counts in shopping. I'm good at both, though 😂"
    new "В шоппинге решает не количество, а качество. Впрочем, я в обоих аспектах молодец 😂"
    ...
    new "Муж однозначно меня недооценил, когда оставил одну в торговом центре со своей платиновой карточкой. А как ваши любимые вас радуют?"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "{b}Don:{/b} Mistakes were made..."
    new "{b}Дон:{/b} Я совершил ошибку..."
    ...
    new "{b}Дон:{/b} Тебе придётся отрабатывать 👉👌"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "It's always nice to take a day off and spoil yourself  a little. You deserved it! 💪"
    new "Это же прекрасно - взять выходной и побаловать себя чуток. Ты этого достойна! 💪"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "Is there any new additions to your lingerie collection? 👀"
    new "А в коллекции нижнего белья есть пополнения? 👀"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "I know how your loved one spoils my life. Does that count?"
    new "Я знаю, как феерически твой любимый \"радует\" меня. Это считается?"
    ...
    new "Не бывает слишком много ухода за собой. Муж балует меня дорогими подарками и роскошными поездками не просто так."
    ...
    new "{b}Эшли:{/b} Мам, не говори так. Папа любит тебя и за личные качества тоже."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "{b}Don:{/b} That's a good one, Ash. Cracks me up every time."
    new "{b}Дон:{/b} Отличная шутка, Эш. От души посмеялся."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "I have to say - I'd never guess how old you were if I did not know."
    new "Надо признать - если бы я не знал правду, я бы никогда не догадался, сколько тебе лет."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "Olivia: It'd be nice if you keep this information to yourself. "
    new "Оливия: Буду благодарна, если ты продолжишь держать эту информацию при себе."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "Or he just buys your loyalty, so you would not start seeing shreds of evidence in his strange actions."
    new "Либо же он просто покупает твою лояльность, чтобы ты не начала замечать очевидные странности в его поведении."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "Don: Is that some internet slang I don't get, punk? "
    new "Дон: Эй, шпана, это какой-то непонятный интернет-сленг?"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "Don: We'll talk about this when you get home."
    new "Дон: Поговорим об этом, когда ты вернёшься домой."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "I always feel refreshed and full of energy after spa treatments. "
    new "После посещения спа я всегда чувствую себя свежей и полной энергии."
    ...
    new "Что скажете насчёт моего нового дизайнерского купальника? Дон заказал специально его для меня, чтобы я всегда чувствовала себя королевой, достойной Его Величества."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "{b}Don:{/b} You look gorgeous!"
    new "{b}Дон:{/b} Ты выглядишь роскошно!"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "{b}Samantha:{/b} It suits your eyes, mom."
    new "{b}Саманта:{/b} Хорошо сочетается с цветом глаз, мам."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "You look gorgeous as always, Olvia."
    new "Прекрасна, как и всегда, Оливия."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "Maybe this queen is tired of an old and sluggish scepter her majesty has to offer?"
    new "Не устала ли часом королева от старого и вялого скипетра Его Величества?"
    ...
    new "Взгляните на этих крошек!"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "Wow, it's nice to say things like that and feel like a proud mother for a change.😉"
    new "Вау, классное ощущение - говорить такие вещи и при этом чувствовать себя гордой матерью.😉"
    ...
    new "Сэм и Эшли - мои самые главные жизненные достижения. Не знаю, как уж там работает генетика, но глядя на них обеих, очевидно, что природа расщедрилась и выкрутила на максимум все мои лучшие качества."
    ...
    new "{b}Эшли:{/b} Я постараюсь сделать так, чтобы у тебя было еще больше причин гордиться, мам."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "Perfect family photo. All the diamonds with no useless people around."
    new "Идеальное семейное фото. Все сокровища в сборе и никаких бесполезных людей вокруг."
    ...
    new "Вау. Если бы мне пришлось выбирать, кого из вас позвать на свидание, у меня бы мозг взорвался. Вот насколько все вы великолепны."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "Olivia: Well-well, since when did you know how to compliment a woman?"
    new "Оливия: Так, и когда ты успел научиться раздавать женщинам комплименты?"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "Samantha: Three of them at the same time!"
    new "Саманта: Трём сразу, между прочим!"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "Ashley:  And we're all flattered."
    new "Эшли: И нам всем приятно."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "I love love potions"
    new "Обожаю любовные зелья."
    ...
    new "Решила развеяться и сходить в аквапарк. Уже и забыла, как это весело! Нужно почаще самой себе напоминать, что в мире есть такая простая и беззаботная забава."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "{b}Jacob:{/b} Good for you! I hope you're well-rested now."
    new "{b}Джейкоб:{/b} Молодец! Надеюсь, ты хорошо отдохнула."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "{b}Lily:{/b} Miss Spellman, you're smoking hot!"
    new "{b}Лили:{/b} Мисс Спеллман, да вы огонь!"
    ...
    new "{b}Лили:{/b} Что? Говорю как есть."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "You're laying on the floor. How is it \"on the top\"?"
    new "Вы на полу лежите. Где же тут \"вершина\"?"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "This is me desperately looking out for someone to rub sunscreen on me... "
    new "Это я отчаянно ищу кого-нибудь, кто намазал бы меня кремом от загара..."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "Where were you that day, my savior?"
    new "Где же ты пропадал в тот день, о, мой спаситель?"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "{b}Victoria:{/b} I thought you went on vacation with a guy..."
    new "{b}Виктория:{/b} Я думала, ты поехала в отпуск не одна..."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "{b}Sabrina:{/b} Well, yeah, but It did not work out."
    new "{b}Сабрина:{/b} Нууу, да, но у нас не срослось."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "{b}Victoria:{/b} His loss."
    new "{b}Виктория:{/b} Ему же хуже."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "Your skin looks great with or without a tan, teacher."
    new "Вы отлично выглядите с загаром или без, мисс Спеллман."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "I know that look. Are you sure you're looking only for tan help?"
    new "Я узнаю этот взгляд. Вы точно искали компанию только для крема от загара?"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "I'm pretty sure I had an operation that day. Now, I know it's not an excuse..."
    new "Уверен, что у меня была операция в тот день. Понимаю, так себе оправдание..."
    ...
    new "Некоторые ингредиенты раздобыть не так и просто! Например, недавно мне пришлось заплыть голой в пещеру, чтобы насытить воду своей магией, и тогда на берегу появились бы русалочьи цветы. На что только не пойдёшь ради науки!"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "{b}Jacob:{/b} Always loved mermaid flowers in potions. You're doing amazing job, Sabrina!"
    new "{b}Джейкоб:{/b} Всегда любил зелья с русалочьими цветами. Отличная работа, Сабрина!"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "Potions are so complex and interesting. Please, tell me more!"
    new "Зельеварение такое сложное и интересное. Расскажите ещё что-нибудь!"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "If I'd were to write a potions textbook, I'd include more flowers like this..."
    new "Если бы я писал учебник по зельям, я бы включил туда побольше таких цветочков..."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "Are you sure there's no hidden camera in that cave? Those footages would cost a fortune."
    new "Вы уверены, что в той пещене нет скрытых камер? Записи бы пользовались спросом."
    ...
    new "Немало студентов скептично относятся к занятиям по зельям, но те, кто дают предмету шанс, обычно в него влюбляются. Поверьте."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "{b}Elijah:{/b} So It works just as like as with alcohol? "
    new "{b}Элайджа:{/b} То есть это работает так же, как и с алкоголем?"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "{b}Audrey:{/b} Were you EVER skeptical about alcohol?)"
    new "{b}Одри:{/b} А ты хоть когда-то сомневался в алкоголе?:)"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "{b}Sabrina:{/b} Guys, are you sure you know that you're discussing than in your teachers comments?"
    new "{b}Сабрина:{/b} Ребята, вы осознаёте, что обсуждаете это в комментариях у преподавателя?"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "I love your classes, miss Spellman. I don't get how someone can think that potions are boring."
    new "Обожаю ваши уроки, мисс Спеллман. Понять не могу, как может кто-то считать их скучными."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "Sabrina: I'm happy that you're one of us, [Name]!"
    new "Сабрина: Я рада, что вы один из нас, [Name]!"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "Maybe there's a love potion in the air in your class?"
    new "Может быть, у вас в аудитории распыляют любовное зелье?"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "Sabrina: It's just my charisma, darling."
    new "Сабрина: Дорогой, это просто моя харизма."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "Got a photo from and underwater camera in the water park. Damn I look good here, don't I?"
    new "Сделала фото в аквапарке на подводную фотокамеру. Обалденно выгляжу, не правда ли?"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "{b}Victoria:{/b} What an interesting angle! You look lovely here!"
    new "{b}Виктория:{/b} Какой интересный ракурс! Прекрасно смотришься!"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "{b}Jacob:{/b} The colors on this photo are so nice. I'm in love."
    new "{b}Джейкоб:{/b} Цвета на фото отличные, я в восторге."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "{b}Samantha:{/b} Miss Spellman, please send me the location of this paradise. I want an underwater photo!!!"
    new "{b}Саманта:{/b} Мисс Спеллман, поделитесь, где находится это чудо. Я тоже хочу фото под водой!!!"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "Wow, you look great here!"
    new "Вау, вы шикарно выглядите!"
    ...
    new "Как вообще можно купаться в бассейнах? Я думал, в них все только и писают..."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "I've dreamt about being a glorious goddess all my entire life and only look at me now!"
    new "Всю жизнь мечтала быть блистательной богиней - и вот, посмотрите на меня!"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "{b}Victoria:{/b} I'm going to die from this magnificence. 😭"
    new "{b}Виктория:{/b} Я сейчас помру от этого великолепия. 😭"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "{b}Haley:{/b} You look gorgeous, Professor!"
    new "{b}Хейли:{/b} Вы выглядите восхитительно, профессор!"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "Are you a miracle from heaven? Seems like you came from the stars.."
    new "Только что звонили из рая и сказали, что от них сбежал самый красивый ангел..."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "Don't you want to go to the class in this outfit, at least for one day? We will be so pleased!"
    new "А не хотите ли провести урок в этом наряде хотя бы один раз? Мы все будем очень рады!"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "If the goddess looks like that, I cannot stay on Earth no more!"
    new "Если богини выглядят так, то я больше не желаю оставаться на Земле!"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "Being the best at being ME"
    new "Это я в своём репертуаре"
    ...
    new "Сижу такая скромная и жду, когда мой тогдашний бойфренд сходит за моим коктейлем вместо того, чтобы фотографировать меня."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "{b}Ashley:{/b} Sam. I love that swimsuit! Can I borrow it?"
    new "{b}Эшли:{/b} Сэм. Я без ума от этого купальника! Можешь одолжить?"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "{b}Samantha:{/b} @Ashley ofc, honey."
    new "{b}Саманта:{/b} @Эшли конечно, дорогая."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "{b}Audrey:{/b} When was this shot taken?"
    new "{b}Одри:{/b} Когда сделано это фото?"
    ...
    new "Это ты про Энди или Пола? Не припоминаю."
    ...
    new "В такой непростой момент я немного жалею, что мы не проводили отпуск вместе - тогда бы ты увидела разницу между настоящим джентльменом и оболтусом."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "Imagine how fun that strange armchair can be when it comes to coitus!"
    new "Представь, как прикольно было бы трахаться на этом странном кресле!"
    ...
    new "Не понимаю людей, которые купаются в гостиничном бассейне, приехав на море. Рядом же настоящий пляж! Бассейны годятся только для того, чтобы делать красивые фотографии в купальнике. Вот как эта."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "{b}Olivia:{/b} Nonsense, swimming pool is so much more convenient!"
    new "{b}Оливия:{/b} Ерунда, бассейн намного комфортнее!"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "{b}Samantha:{/b} Oh no! My Mom is talking like an old lady! Help! 😱"
    new "{b}Саманта:{/b} О, нет! Моя мама рассуждает, как старушка! Помогите! 😱"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "{b}Olivia:{/b} That's not funny."
    new "{b}Оливия:{/b} Обхохочешься."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "Well, I can't argue with that, the photo is really nice."
    new "Ну, тут невозможно не согласиться, фото действительно супер."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "I can come up with few spicy ideas of how we can use the pool..."
    new "Есть у меня несколько мыслей о том, чем можно заняться у этого бассейна..."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "I've heard that you don't need a pool to take a photo either. It's just a common misunderstanding."
    new "Слышал, что бассейн совсем не обязателен, если хочется сделать фото. Распространённое заблуждение."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "Warm air, sand, sunset and a love story. This seems to be my girlish paradise."
    new "Тепло, песок, закат и история про любовь. Это мой девчачий рай."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "{b}Elijah:{/b} Wow, this sounds like my girlish paradise too."
    new "{b}Элайджа:{/b} Вау, двучит и как мой девчачий рай."
    ...
    new "{b}Одри:{/b} @Элайджа ты увенен, что тебе нужен именно \"девчачий\" рай?"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "{b}Elijah:{/b} @Audrey why not? "
    new "{b}Элайджа:{/b} @Одри а почему бы и нет?"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "What book are you reading?"
    new "Что за книгу ты читаешь?"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "Wouldn't you rather have a mutual love interest instead of a book?"
    new "Может, ты бы предпочла книге настощую взаимную любовь?"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "It's not that good for eyes to read in dim light. Why is your paradise so self-harming?"
    new "Для глаз не очень хорошо читать при таком тусклом свете. Почему твой рай влечёт вред здоровью?"
    ...
    new "Вначале я сомневалась, стоит ли садиться на стол, за которым едят, но потом я поняла одну простую вещь - я тут самое вкусное блюдо!"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "{b}Audrey:{/b} I'd eat you 😈"
    new "{b}Одри:{/b} Я бы тебя попробовала 😈"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "{b}Samantha:{/b} Audrey! Stop it..."
    new "{b}Саманта:{/b} Одри! Перестань..."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "{b}Elijah:{/b} No, please! Don't stop. "
    new "{b}Элайджа:{/b} Пожалуйста, нет! Не останавливайся."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "Hey, can I get a taste of that special meal?"
    new "А мне можно попробовать эту вкусняшку?"
    ...
    new "Извини, я жирное не ем."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "Audrey: Hey, jackass! Leave her alone!"
    new "Одри: Слышь, козёл! Отвали от неё!"
    ...
    new "Как думаете, я бы хорошо смотрелась на такой фреске? Стать частью истории такого престижного учреждения... стоит затраченных усилий, не правда ли?"
    ...
    new "{b}Джейкоб:{/b} Быть изображённым на этих стенах - огромная честь. Вы уверены, что уже заслужили хотя бы право задавать подобные вопросы?"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "{b}Victoria:{/b} Don't be so harsh, Jacob, Samantha meant nothing but respect."
    new "{b}Виктория:{/b} Будь помягче, Джейкоб, Саманта не высказала ни капли неуважения."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "Of all the people that I know, you are the only one who can reach such greatness. I believe in you! "
    new "Из всех людей, кого я знаю, только ты способна достичь подобного величия. Верю в тебя!"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "Samantha: Thank you. [Name]. You always know the right words."
    new "Саманта: Спасибо, [Name]. Ты всегда находишь нужные слова."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "I can imagine so many things with you Sam. But the mural is not usually part of those thoughts. "
    new "Я могу нафантазировать многое с твоим участием, Сэм. Но фрески там обычно не фигурируют."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "Samantha: Your imagination is too limited to grasp all my abilities 😜"
    new "Саманта: Твого воображения не хватит, чтобы представить все мои способности 😜"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "Honestly, what was the first thing you noticed when you looked at this photo?"
    new "Скажите честно - на что вы в первую очередь обратили внимание на этом фото?"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "Interesting statistic: 75% of guys won't remember the color of my eyes if they don't look at the photo again."
    new "Занимаиельная статистика: 75% парней не смогут назвать цвет моих глаз, не взглянув на фото повторно."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "{b}Molly:{/b} I'm a girl, but those things are worth looking at."
    new "{b}Молли:{/b} Хоть я и девушка, но не засмотреться на них я не могу."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "{b}Elijah:{/b} Wow, Molly. Is that really you commenting on someone's photo?"
    new "{b}Элайджа:{/b} Вау, Молли. Не верю своим глазам - ты комментируешь чьё-то фото?"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "{b}Molly:{/b} I got hacked."
    new "{b}Молли:{/b} Меня взломали."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "{b}Elijah:{/b} sure, sure."
    new "{b}Элайджа:{/b} Ну да, ну да."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "You make a valid point, Sam. We should be more respectful to women."
    new "Справедливое замечание, Сэм. Женщины достойны большего уважения."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "I can tell you the color of your beautiful eyes even without a photo. How can someone not notice them?"
    new "Цвет твоих восхитительных глаз я могу назвать безо всякого фото. Разве можно не замечать их?"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "Samantha: [Name], you are so sweet..."
    new "Саманта: [Name], это так приятно..."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "It does not mean that those 20% forgot to check out your boobs. They are just better with details."
    new "Это не означает, что остальные парни не заценили твои сиськи. Они просто лучше замечают детали."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "We maaaaaaade it! "
    new "Мы сдееееелали это!"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "P.S. It's always a bad idea to fall asleep at the party, don't you think so?"
    new "П.С. Уснуть на вечеринке - паршивая идея, вы не находите?"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "{b}Elijah:{/b} Such a shame that you left so early! You missed so much..."
    new "{b}Элайджа:{/b} Очень жаль, что ты так рано ушла! Столько всего пропустила..."
    ...
    new "Элайджа: Только Сэм? А как же я?', ' Саманта: Во многом потому что у человека, который помог мне выбрать наряд, ооочень хороший вкус..."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "Mmmm, stockings! That's too hot even for you."
    new "Мммм, чулки! Слишком горячо, даже для тебя."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "Samantha: I will take it as a compliment..."
    new "Саманта: Приму это как комплимент..."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "Poor guy! That's cruel."
    new "Бедный парень! Жёстко."
    ...
    new "Сижу и улыбаюсь, как будто не сидела всю ночь без сна и не повторяла всё перед экзаменом. Спрашивается - и зачем я так убиваюсь?"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "The answer is simple - in choosing between what I want now and what I want most I'd rather prefer the second one."
    new "Ответ прост - между тем, что я хочу прямо сейчас, и тем, что я в целом хотела бы сильнее всего, я выбираю второе."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "{b}Haley:{/b} You're such an inspiration, Sam!"
    new "{b}Хейли:{/b} Сэм, ты меня вдохновляешь!"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "Hard work pays off... 🧠"
    new "За упорство нам воздаётся... 🧠"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "Intelligence is sooo sexy!"
    new "Ум - это так сексуально!"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "I'm sure you should think more about your health."
    new "Тебе стоило бы побольше думать о своём самочувстсвии."
    ...
    new "Сегодня я в полной мере осознала, что массаж может успокоить и расслабить не только тело, но и ум. Только почувствуйте эту волшебную атмосферу полного релакса и восстановления сил! Моя массажистка, Фейт, была невероятна и я очень её рекоммендую!"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "{b}Amelie:{/b} It's so nice to see how closely you take care of your health and state of mind!"
    new "{b}Амели:{/b} Очень приятно видеть, как тщательно ты заботишься о здоровье тела и ума!"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "{b}Naomi:{/b} Wow! Now I need this massage too."
    new "{b}Наоми:{/b} Вау! Теперь и я хочу такой массаж."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "Ohh, i was there and the quality of massage is really good!"
    new "Ооо, я там был и подтверждаю - массаж на высшем уровне!"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "Fantastic ass!"
    new "Обалденная задница!"
    ...
    new "Мне идёт небольшой загар? Как вы думаете?"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "{b}Jacob:{/b} You look stunning, as always, miss Lapis."
    new "{b}Джейкоб:{/b} Вы, как всегда, сногсшибательны, мисс Лапис."
    ...
    new "Этот оттенок кожи вам очень идёт, мисс Лапис."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "It's hard to tell with those massive swimsuit covering everything. Can you take it off?"
    new "Сложно сказать, когда этот купальник столько всего скрывает. Нельзя ли его снять?"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "Tell me the nicest way to spend the last night of your vacation..."
    new "Поделитесь со мной лучшим способом провести последний день отпуска..."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "{b}Sabrina:{/b} I've DMed you some... interesting options."
    new "{b}Сабрина:{/b} Переслала тебе в личку некотороые... интересные варианты."
    ...
    new "Мисс Лапис, такие вещи я просто не осмелюсь говорить преподавателю вслух. Придётся показать в деле."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "I'm not sure you can handle things my generation does on vacation... Maybe a glass of fine wine?"
    new "Не уверен, что вам по силам то, что вытворяют в отпуске люди моего возраста... Может, просто бокальчик хорошего вина?"
    ...
    new "Собираюсь провести свой первое в этом году практическое занятие. Я немного переживаю - это заметно? Надеюсь, что в этом году обойдёмся без происшествий."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "{b}Sabrina:{/b} I'm sure everything will be fine."
    new "{b}Сабрина:{/b} Уверена, всё пройдёт гладко."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "{b}Elijah:{/b} Miss Lapis, you look amazing!"
    new "{b}Элайджа:{/b} Мисс Лапис, выглядите суперски!"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "You did a great job, miss Lapis! You're one of the best teachers I've ever had."
    new "Мисс Лапис, всё прошло замечательно! Вы - один из лучших педагогов в моей жизни."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "Victoria: Thank you, mister [Name]."
    new "Виктория: Спасибо вам, мистер [Name]."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "Don't worry, miss Lapis. When you have curves like this, no one pays attention to your emotions."
    new "Не переживайте, мисс Лапис. С такими формами, как у вас, никто не заметит вашего волнения."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "I always take cappuccino with two extra shots. Tasty and refreshing enough!"
    new "Всегда беру капуччино с двумя шотами. Вкусно и очень бодряще!"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "{b}Molly:{/b} You should take mochaccino someday. I bet you will love it!"
    new "{b}Молли:{/b} Советую как-нибудь попробовать моккачино."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "Oh my, I take cappuccino with two shots of espresso EVERY TIME!"
    new "Оо, и я тоже всегда беру капуччино с двумя шотами эспрессо!"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "What do you think about the idea to have a cup of coffee together?"
    new "Как вы смотрите на идею выпить как-нибудь кофе вместе?"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "Two shots of brandy is always a good idea."
    new "Два шота бренди - вот это действительно отличная идея."
    ...
    new "Самое лучшее на свете решение - провести отпуск за городом. Назад к природе - и никаких неудобств."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "{b}Sabrina:{/b} Oh, dear, you've fulfilled my dream!"
    new "{b}Сабрина:{/b} О, дорогая, ты воплотила мою мечту!"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "{b}Amelie:{/b} I bet you weren't there all alone."
    new "{b}Амели:{/b} Уверена, что ты там была не одна."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "{b}Victoria:{/b} All details in the Direct."
    new "{b}Виктория:{/b} Подробности - в личку."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "I'm so happy that you had at least little rest from your work. "
    new "Я очень рад, что вы хоть немного отдохнули от работы."
