...
translate russian street_label_0fa198b4:
    ...
    ch_Name "{i}(Sam была права. Это письмо действительно адресовано мне!){/i}"
...
translate russian street_label_d2a9e68b:
    ...
    ch_Name "{i}(Академия Cordale. Samantha там учится. Может, они не тому человеку направили письмо?){/i}"
...
translate russian street_label_bfba75ba:
    ...
    ch_Name "{i}(Хотя это же моё имя. Чего бы и не прочитать.){/i}"
...
translate russian street_label_a4bfb822:
    ...
    ch_Name "Вы были отобраны для прохождения вступительного испытания..."
...
translate russian street_label_e59e5cf0:
    ...
    ch_Name "...в элитное высшее учебное заведение: Академию Магии и Волшебства Cordale."
...
translate russian street_label_ca651f50:
    ...
    ch_Name "Чтобы принять участие в экзамене, вам следует прибыть на Центральный Вокзал в полдень, 31 августа."
...
translate russian street_label_b8e60260:
    ...
    ch_Name "Вы должны сесть на поезд, идущий в Cordale, до 12:30 пополудни. Не опаздывайте!"
...
translate russian street_label_1a9ff24f:
    ...
    ch_Name "Экзамен состоится в школе 1-го сентября."
...
translate russian street_label_bb78052c:
    ...
    ch_Name "Пожалуйста, возьмите с собой это письмо, а также личные вещи..."
...
translate russian street_label_16f31a9e:
    ...
    ch_Name "...которые могут вам потребоваться для того, чтобы поселиться в общежитии Cordale."
...
translate russian street_label_9946de68:
    ...
    ch_Name "{i}(Академия Магии и Волшебства? Ха ха, Sam. Обхохочешься.){/i}"
...
translate russian street_label_be50e466:
    ...
    ch_Name "{i}(Хватит с меня шуток. Ей не суждено стать третьим человеком, издевающимся надо мной сегодня.){/i}"
...
translate russian street_label_5d738915:
    ...
    ch_Name "{i}(Так ей и скажу прямо в лицо!){/i}"
