...
translate russian restroom_stump_label_6bcbc6d0:
    ...
    ch_Name "{i}(Так, я точно уверен, что больше ничего не хочу сделать перед тем, как спуститься?){/i}"
...
translate russian restroom_label_d4167a3d:
    ...
    Don "Скоро начнётся бейсбол, так что давай говори уже..."
...
translate russian restroom_label_58012455:
    ...
    ch_Name "И? Я бы хотел обсудить твою идею с арендой..."
...
translate russian restroom_label_9c8b6339:
    ...
    ch_Name "Если бы не моя травма, то..."
...
translate russian restroom_label_abf076ed:
    ...
    ch_Name "И я всё лето работал, чтобы получить образование."
...
translate russian restroom_label_0a168ce2:
    ...
    ch_Name "Я работал, чтобы откладывать на колледж."
...
translate russian restroom_label_16f04a0d:
    ...
    ch_Name "Я никогда не сумею накопить на колледж!"
...
translate russian restroom_label_3bb46233:
    ...
    ch_Name "Это порочный круг. Не может быть, чтобы ты всерьёз... Ну, я имею в виду..."
...
translate russian restroom_label_8203ea8f:
    ...
    Don "Парень, тебе пора научиться быть самостоятельным."
...
translate russian restroom_label_a99eee17:
    ...
    Don "Плати аренду или ищи себе другое жильё. Что выбираешь?"
...
translate russian restroom_menu_2_label_f87461fa:
    ...
    ch_Name "Может быть, я должен напомнить тебе, что я уже сейчас мог бы быть в университете."
...
translate russian restroom_menu_2_label_8d965803:
    ...
    Don "Именно это ты сейчас и говоришь!"
...
translate russian restroom_menu_2_label_01f136c0:
    ...
    Don "И я считаю, что тебе стоит затнкуться и подумать над своим тоном."
...
translate russian restroom_menu_2_label_363df24c:
    ...
    Don "Неужели я не работал достаточно усердно, чтобы у тебя была пища, одежда и образование?"
...
translate russian restroom_menu_2_label_32fefd64:
    ...
    Don "Ты вообще представляешь, сколько стоила бы твоя реабилитация?"
...
translate russian restroom_menu_2_label_bbb98143:
    ...
    ch_Name "Я только говорю тебе о том, что я не \"выбирал\" не идти в университет."
...
translate russian restroom_menu_2_label_3fe05916:
    ...
    ch_Name "Сложно держать эмоции в узде, когда c тобой так резко разговаривают."
