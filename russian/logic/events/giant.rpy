...
translate russian giant_1_label_524e5b0a:
    ...
    ch_Name "{i}(Пойду-ка я лучше спать.){/i}"
...
translate russian giant_1_label_90b439bd:
    ...
    ch_Name "{i}(Уже становится поздно, и переулок возле клуба всё сильнее забивается людьми.){/i}"

# game/logic/events/giant.rpy:34
translate russian giant_1_label_5f763497:

    # ch_Name "{i}(Do people here even sleep?){/i}"
    ch_Name "{i}(Люди тут вообще спят?){/i}"
...
translate russian giant_1_label_0931de10:
    ...
    ch_Name "Эй... Человек... Ты в порядке?"
...
translate russian giant_1_label_7a0e2657:
    ...
    ch_Name "{i}(Что за чёрт... Оно попыталось меня схватить и сожрать?){/i}"
...
translate russian giant_1_label_c11f8925:
    ...
    Giant "СМОТРИ ЧТО ОНИ СО МНОЙ СДЕЛАЛИ..."
...
translate russian giant_1_label_2fd601bc:
    ...
    Giant "Ты же не один из них, так ведь?!"
...
translate russian giant_1_label_41edf95c:
    ...
    ch_Name "Прости, но я не стану помогать стрёмному незнакомцу."
...
translate russian giant_1_label_22c8ad77:
    ...
    ch_Name "{i}(Не похоже, чтобы он за мной гнался...){/i}"
...
translate russian giant_1_label_a2bc7378:
    ...
    ch_Name "{i}(Но лучше не вот так одному ночами по здешним улицам не слоняться.){/i}"

# game/logic/events/giant.rpy:111
translate russian giant_1_label_e3e69c43:

    # ch_Name "{i}(I was lucky he was stopped by my feeble combat spell.){/i}"
    ch_Name "{i}(Повезло ещё, что его остановило моё нехитрое боевое заклинание.){/i}"

# game/logic/events/giant.rpy:113
translate russian giant_1_label_0e9a9852:

    # ch_Name "{i}(Damn, that was even too close...){/i}"
    ch_Name "{i}(Чёрт, это было немного на грани...){/i}"
...
translate russian giant_1_label_23617545:
    ...
    ch_Name "{i}(Это было довольно странно...){/i}"
...
translate russian giant_1_label_5d0ef032:
    ...
    ch_Name "{i}(Хватит с меня приключений за один вечер. Надо выспаться.){/i}"

# game/logic/events/giant.rpy:158
translate russian Giant_2_label_3637bde0:

    # ch_Name "{i}(Sabrina seems to be in good spirits.){/i}"
    ch_Name "{i}(Кажется, Сабрина в хорошем расположении духа.){/i}"
...
translate russian Giant_2_label_3e938d2c:
    ...
    ch_Name "{i}(Подходящий момент, чтобы узнать про зелье для того гиганта в городе.){/i}"
...
translate russian Giant_2_label_ef599765:
    ...
    Sabrina "Тем интереснее. Говорите же."
...
translate russian Giant_2_label_433b5c01:
    ...
    ch_Name "Недавно в Дейле по мне подошёл какой-то уродливый гигант в рваных одеждах."
...
translate russian Giant_2_label_08e0b55d:
    ...
    ch_Name "Неразборчиво, но я уловил..."
...
translate russian Giant_2_label_7acde20c:
    ...
    Sabrina "Нужно убедиться. Я дам вам нужное зелье."
...
translate russian Giant_2_label_e26e6f8a:
    ...
    Sabrina "Конечно. Но только при одном условии: вы мне всё расскажете."
...
translate russian Giant_2_label_a689c1e0:
    ...
    Sabrina "Я только должна проверить, что у меня есть готовая порция."
...
translate russian Giant_2_label_6ba3d9b7:
    ...
    ch_Name "Я знал, что могу на вас рассчитывать."
...
translate russian Giant_2_label_b66c15ab:
    ...
    ch_Name "{i}(Так, на сегодня с занятиями покончено. Теперь я свободен.){/i}"
...
translate russian Giant_2_label_73109193:
    ...
    ch_Name "{i}(Надо бы отнести Элайдже его нектар. Он его ждёт.){/i}"
...
translate russian Giant_2_label_47fc0b1c:
    ...
    ch_Name "{i}(Кажется, будто он меня и ждал.){/i}"
...
translate russian strings:
    ...
    # game/logic/events/giant.rpy:11
    old "Stay away"
    new "Держаться подальше"

    # game/logic/events/giant.rpy:83
    old "Say you'll help"
    new "Согласиться помочь"
