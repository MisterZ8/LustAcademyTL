...
translate russian Sabrina_1_label_13f3bf9a:
    ...
    Sabrina "Что думаете о нашем интерьере?"
...
translate russian Sabrina_1_label_2c621b2c:
    ...
    Sabrina "...последняя оставшаяся нетронутой часть академии."
...
translate russian Sabrina_1_label_188be4e9:
    ...
    Sabrina "Стены и пол этого класса пропитаны парами сотен тысяч магических эликсиров."
...
translate russian Sabrina_1_label_f4b44677:
    ...
    Sabrina "И это неким образом делает их неразрушимыми."
...
translate russian Sabrina_1_label_bc4f3867:
    ...
    Sabrina "Директор долго думал, как же избавиться от этого эффекта."
...
translate russian Sabrina_1_label_3dcd9753:
    ...
    Sabrina "Однако по сей день никто так и не смог найти способ это сделать."

# game/logic/events/sabrina.rpy:151
translate russian Sabrina_1_label_b2ca662b:

    # ch_Name "{i}(Can potions do that?){/i}"
    ch_Name "{i}(Зелья могут делать такое?){/i}"
...
translate russian Sabrina_1_label_82012ccc:
    ...
    ch_Name "{i}(Или же это просто сказка для оправдания распила бюджета на реновацию?){/i}"

# game/logic/events/sabrina.rpy:153
translate russian Sabrina_1_label_a5d5c470:

    # ch_Name "{i}(I guess we'll never know.){/i}"
    ch_Name "{i}(Наверное, мы никогда не узнаем.){/i}"
...
translate russian Sabrina_1_label_c109a9ee:
    ...
    Sabrina "На этом мы закончим с нашим погружением в историю Кордейла."
...
translate russian Sabrina_1_label_2701abf2:
    ...
    Sabrina "Сегодня вы начинаете своё обучение знаменитому искусству зельеварения."
...
translate russian Sabrina_1_label_50c8ac22:
    ...
    Sabrina "Но поспешу вас разочаровать! Сегодня вы даже не подойдёте к котлам!"
...
translate russian Sabrina_1_label_0451ce76:
    ...
    ch_Name "{i}(Она говорит, что делать зелья ещё опаснее, чем заниматься магией?){/i}"
...
translate russian Sabrina_1_label_0d0622dd:
    ...
    Sabrina "По этой причине процесс обучения сделали менее интенсивным."
...
translate russian Sabrina_1_label_d4747740:
    ...
    Sabrina "Затем - курс по безопасности."
...
translate russian Sabrina_1_label_292ae976:
    ...
    Sabrina "И только после этого начинается настоящая магия..."
...
translate russian Sabrina_1_label_34_9505e58a:
    ...
    Sabrina "Тому случаю способствовал очень неудачный набор обстоятельств."
...
translate russian Sabrina_1_label_34_8e36ee7b:
    ...
    Sabrina "Нет ничего безопаснее, чем изготовление зелий!"
...
translate russian Sabrina_1_label_44_5ae5f60c:
    ...
    ch_Name "Просто весь этот мир магии для меня в новинку."
...
translate russian Sabrina_1_label_44_baf2ccbb:
    ...
    ch_Name "Но если волшебники могут колдовать, зачем им зелья?"
...
translate russian Sabrina_1_label_44_686269db:
    ...
    Sabrina "Особенно потому, что это очень важная тема!"
...
translate russian Sabrina_1_label_54_ddeaaed2:
    ...
    Sabrina "Итак, главная тема сегодняшнего вступительного занятия будет зелья..."
...
translate russian Sabrina_1_label_54_bbaa064d:
    ...
    Sabrina "...и почему вам следует изучать искусство создания этих магических напитков."
...
translate russian Sabrina_1_label_54_251304aa:
    ...
    Sabrina "Я уверена, что мисс Лапис уже рассказала вам об источниках силы."
...
translate russian Sabrina_1_label_54_4877aae1:
    ...
    Grace "Но как это относится к зельям?"
...
translate russian Sabrina_1_label_54_86132766:
    ...
    Sabrina "Не все источники магии подчиняются силе волшебника."
...
translate russian Sabrina_1_label_54_e2f0d322:
    ...
    Sabrina "Тем более, что связь каждого отдельного волшебника и стихии индивидуальна."
...
translate russian Sabrina_1_label_54_13976270:
    ...
    Sabrina "Но с зельями, любой маг может нарушить эти законы."
...
translate russian Sabrina_1_label_54_d75355f2:
    ...
    Sabrina "Зелья помогают запутать врага, усилить ваши умения и быстро заживлять раны."
...
translate russian Sabrina_1_label_54_8bec8ee2:
    ...
    Sabrina "...научить вас определять магические функции ингредиентов."
...
translate russian Sabrina_1_label_54_80c1f607:
    ...
    Sabrina "А также - как смешивать и готовить их так, чтобы получить желаемый эффект."
...
translate russian Sabrina_1_label_54_e6199a4b:
    ...
    Sabrina "Все вы должны были получить учебники."
...
translate russian Sabrina_1_label_54_9c193ca0:
    ...
    Sabrina "Они станут вашими верными книгами рецептов и подсказок."
...
translate russian Sabrina_1_label_54_70cf14e1:
    ...
    Sabrina "Прочитайте параграфы 1 и 2 ваших учебников."
...
translate russian Sabrina_1_label_54_4a036cf0:
    ...
    Sabrina "Выучите ингредиенты для всех зелий, упомянутых в этих параграфах."
...
translate russian Sabrina_1_label_54_e22dfe46:
    ...
    ch_Name "{i}(Надеюсь, когда мы перейдём к практике, станет поинтереснее.){/i}"
...
translate russian Sabrina_1_label_54_94633b43:
    ...
    ch_Name "{i}(Инструкции безопасности и теория меня усыпили.){/i}"
...
translate russian Sabrina_1_label_54_72168e18:
    ...
    ch_Name "{i}(Сейчас бы не помешала чашечка кофе.){/i}"
...
translate russian Sabrina_1_label_54_a767366c:
    ...
    ch_Name "{i}(Ах да! Я чуть не забыл, что Элайджа хотел встретить меня в кафе после уроков.){/i}"
...
translate russian Sabrina_1_label_54_bef24927:
    ...
    ch_Name "{i}(Что ж, видимо, два зайца одним выстрелом.){/i}"
...
translate russian Sabrina_2_label_23755bb1:
    ...
    Sabrina "Я как раз собиралась сварить себе зелье малого исцеления."
...
translate russian Sabrina_2_label_263732a4:
    ...
    Sabrina "И я совершенно забыла, что для него требуется."
...
translate russian Sabrina_2_label_d79eee61:
    ...
    Sabrina "Кто может показать мне, что нам нужно для зелья малого исцеления?"
...
translate russian Sabrina_2_label_4d624696:
    ...
    ch_Name "{i}(Не думаю, что могу вспомнить рецепт.){/i}"
...
translate russian Sabrina_2_label_248e474e:
    ...
    Sabrina "Замечательно, милая! Не стесняйся так!"
...
translate russian Sabrina_2_label_646d136f:
    ...
    Grace "{b}Слёзы лесного оленя, порошок из волоса единорога, исландская центрария.{/b}"

# game/logic/events/sabrina.rpy:303
translate russian Sabrina_2_label_71c8e7d5:

    # Sabrina "That's right! Great job, Grace!"
    Sabrina "Всё верно! Прекрасная работа, Грейс!"
...
translate russian Sabrina_2_label_755fefb5:
    ...
    ch_Name "{i}(Уверен, я бы забыл про центрарию...){/i}"
...
translate russian Sabrina_2_label_a685fd11:
    ...
    Sabrina "Отлично! Подойди к котлу и покажи мне."
...
translate russian Sabrina_2_label_152a1aff:
    ...
    ch_Name "{i}(Там точно было что-то про слёзы и волосы...){/i}"
...
translate russian Sabrina_2_label_aa37f83d:
    ...
    ch_Name "Слёзы единорога, порошок из волоса лесного оленя, норвежский мох."
...
translate russian Sabrina_2_label_4c41342c:
    ...
    ch_Name "Слёзы горной козы, перо пересмешницы, и европейская береста."
...
translate russian Sabrina_2_label_8a342b36:
    ...
    ch_Name "{b}Слёзы лесного оленя, порошок из волоса единорога, исландская центрария.{/b}"
...
translate russian Sabrina_2_label_df2389c4:
    ...
    Sabrina "И даже в правильном порядке, я впечатлена!"
...
translate russian Sabrina_2_label_46_29e6d455:
    ...
    Sabrina "К сожалению, много недостаточно опытных студентов, как бы выразиться..."
...
translate russian Sabrina_2_label_46_3d3e71ca:
    ...
    Sabrina "Отмеряют щепотку соли на вкус, ужасаются и добавляют вместо неё другой ингредиент..."
...
translate russian Sabrina_2_label_46_f9c8caa0:
    ...
    Sabrina "Забудьте об этой ерунде, иначе вас отстранят от этого предмета."
...
translate russian Sabrina_2_label_46_3ad59955:
    ...
    Sabrina "Гончарное мастерство и Алхимия - точные науки."
...
translate russian Sabrina_2_label_46_15332525:
    ...
    Sabrina "Даже малейшая деталь необычайно важна!"
...
translate russian Sabrina_2_label_46_f779b388:
    ...
    Sabrina "Лишний миллиграм может повлечь за собой ужасающий исход!"
...
translate russian Sabrina_2_label_46_60948480:
    ...
    Sabrina "Исцеляющее зелье, приготовленное на неправильном виде мха, превращается в кислоту."
...
translate russian Sabrina_2_label_46_6c857fa7:
    ...
    Sabrina "Выпьете его и все ваши внутренности можно будет поместить в один флакончик."
...
translate russian Sabrina_2_label_46_c0b5d88e:
    ...
    Sabrina "Представьте, что вы выпили некачественное зелье невидимости."
...
translate russian Sabrina_2_label_46_bbb4d92b:
    ...
    Sabrina "Надеясь пробраться через Драконье Ущелье."
...
translate russian Sabrina_2_label_46_c7f7c135:
    ...
    Sabrina "И на середине пути эффект развеется."
...
translate russian Sabrina_2_label_46_b198b64c:
    ...
    Sabrina "Поздравляю, теперь вы - гриль."
...
translate russian Sabrina_2_label_46_56855a9d:
    ...
    Sabrina "...вы можете не дожить до момента, когда вы выроните опустошенный флакон."
...
translate russian Sabrina_2_label_46_b6b420d2:
    ...
    Sabrina "Не поймите неправильно, эти стены неразрушимы."
...
translate russian Sabrina_2_label_46_437f6179:
    ...
    Sabrina "Но я устала соскабливать с них останки студентов..."
...
translate russian Sabrina_2_label_46_9ed796a6:
    ...
    ch_Name "{i}(Что ж, сегодняшний урок объясняет, почему практике зельеварения предшествует так много теории.){/i}"

# game/logic/events/sabrina.rpy:394
translate russian Sabrina_2_label_46_fbc146ed:

    # ch_Name "{i}(I should be more attentive.){/i}"
    ch_Name "{i}(Мне следует быть внимательней.){/i}"
...
translate russian Sabrina_2_label_46_adf5c82e:
    ...
    ch_Name "{i}(У меня есть немного свободного времени, может, стоит попробовать сосать хуй?){/i}"
...
translate russian Sabrina_2_label_46_03ebb22f:
    ...
    ch_Name "{i}(Это поможет мне покрыть все затраты.){/i}"
...
translate russian Sabrina_2_label_46_39b15567:
    ...
    ch_Name "{i}(А у меня их будет достаточно, если я хочу продолжать звать девочек в кафе.){/i}"
...
translate russian Sabrina_3_label_916187cb:
    ...
    # Sabrina "Take your seats, class is about to begin!"
    Sabrina "Рассаживайтесь, урок сейчас начнётся!"
...
translate russian Sabrina_3_label_d1b92402:
    ...
    Sabrina "Тема сегодняшнего урока: подготовка рабочего места."
...
translate russian Sabrina_3_label_79134fc0:
    ...
    Sabrina "Да, да, знаю, уроки безопасности не самые интересные."
...
translate russian Sabrina_3_label_716ef2cc:
    ...
    Sabrina "Но, как я вам говорила на прошлом занятии, это важно."
...
translate russian Sabrina_3_label_15bcaed2:
    ...
    Sabrina "В первую очередь для вашей безопасности."
...
translate russian Sabrina_3_label_3ebc65dd:
    ...
    ch_Name "{i}(Сабрина выглядит такой несчастной, когда учит теории.){/i}"
...
translate russian Sabrina_3_label_fbb742bc:
    ...
    Sabrina "Котлом указанной в рецепте ёмкости."
...
translate russian Sabrina_3_label_1e5ec51a:
    ...
    Sabrina "Для обучения мы используем настольные котлы, такие, как мой."
...
translate russian Sabrina_3_label_73570323:
    ...
    Sabrina "Он выдаётся перед началом практикума."
...
translate russian Sabrina_3_label_57f8b62a:
    ...
    Sabrina "На самом деле, это зельице, которое замораживает вас во времени."
...
translate russian Sabrina_3_label_009ccbb5:
    ...
    Sabrina "Никто не говорил, что данный опыт не оставит на вас следа."
...
translate russian Sabrina_3_label_c34b2495:
    ...
    Sabrina "Он включает в себя скальпель, пинцет, ювелирный молоток..."
...
translate russian Sabrina_3_label_0c2bd7ea:
    ...
    Sabrina "В общем, всё, что вам может понадобиться для обработки ингредиентов."
...
translate russian Sabrina_3_label_1ada458c:
    ...
    Sabrina "Набор выдаётся в начале обучения."
...
translate russian Sabrina_3_label_958fc1e7:
    ...
    Sabrina "Запомните, эти правила придуманы не для того, чтобы с вами нянчиться."

# game/logic/events/sabrina.rpy:461
translate russian Sabrina_3_label_3840f9bd:

    # Sabrina "You are mature enough."
    Sabrina "Вы уже достаточно взрослые."
...
translate russian Sabrina_3_label_1172b898:
    ...
    ch_Name "{i}(Я думал, Сабрина и правда не любит теорию...){/i}"
...
translate russian Sabrina_3_label_635ada32:
    ...
    ch_Name "{i}(Но, несмотря на это, она подходит к ней очень серьёзно.){/i}"
...
translate russian Sabrina_4_label_eac4a739:
    ...
    Sabrina "Сегодня у нас весьма увлекательное занятие."
...
translate russian Sabrina_4_label_8b084486:
    ...
    Sabrina "[Surname], пожалуйста, будьте серьёзнее."
...
translate russian Sabrina_4_label_d21ec207:
    ...
    Sabrina "Конечно, вам слишком рано делать свои собственные зелья."
...
translate russian Sabrina_4_label_e194058b:
    ...
    Sabrina "Но вы уже можете асисстировать."
...
translate russian Sabrina_4_label_2c1d564c:
    ...
    Sabrina "Основа зелья вскипает в котле на моём столе."
...
translate russian Sabrina_4_label_8eea7944:
    ...
    Sabrina "Ваша задача - подойти и добавить ингредиенты под моим чутким наблюдением."
...
translate russian Sabrina_4_label_3667cdb1:
    ...
    Sabrina "Перед тем, как вы это сделаете, подготовьте их как полагается и измерьте дозу."
...
translate russian Sabrina_4_label_0a7bae23:
    ...
    ch_Name "Кабинет зельеварения словно минное поле."
...
translate russian Sabrina_4_label_7e1f98ec:
    ...
    Sabrina "Простите, не сдержалась."
...
translate russian Sabrina_4_label_c3e16f1f:
    ...
    Sabrina "Я не просто так вас пугала на протяжении трёх занятий."
...
translate russian Sabrina_4_label_866614fe:
    ...
    ch_Name "Я просто не очень хорошо себя чувствую!"
...
translate russian Sabrina_4_label_35fe7720:
    ...
    ch_Name "Меня всё утро подташнивало."
...
translate russian Sabrina_4_label_ccade092:
    ...
    Sabrina "[Name], почему ты приходишь в класс в таком состоянии?"
...
translate russian Sabrina_4_label_3195bfe5:
    ...
    Sabrina "Разве директор не объяснял, как нужно поступать в такой ситуации?"
...
translate russian Sabrina_4_label_3af1907f:
    ...
    Sabrina "Причина уважительная, но тебе всё же следовало бы дважды об этом подумать."

# game/logic/events/sabrina.rpy:539
translate russian Sabrina_4_label_2cf9b106:

    # Sabrina "Take care of your health, [Surname]."
    Sabrina "Следи за своим здоровьем, [Surname]."
...
translate russian Sabrina_4_label_0347547f:
    ...
    Sabrina "Грейс, милая, может, ты поможешь?"
...
translate russian Sabrina_4_label_973ff772:
    ...
    ch_Name "{i}(Увы, кажется, сегодняшний урок по зельеварению для меня окончен.){/i}"
...
translate russian Sabrina_4_label_55_beadbcdf:
    ...
    Sabrina "Будь добр, нарежь центрарию соответственно рецепту и добавь в котёл."
...
translate russian Sabrina_4_label_55_7bf74275:
    ...
    Sabrina "В твоей голове, конечно же."
...
translate russian Sabrina_4_label_55_f734177b:
    ...
    ch_Name "Подождите-ка...{w} Что насчёт наличия учебника на столе?"
...
translate russian Sabrina_4_label_55_ea0e419d:
    ...
    ch_Name "{i}(Теперь волос оленя...){/i}"
...
translate russian Sabrina_4_label_55_e888191b:
    ...
    Sabrina "Между прочим, ты можешь оставить зелье себе.{w} Это вошло здесь в обычай."
...
translate russian Sabrina_1_1_label_5763b06d:
    ...
    ch_Name "Изучать основы алхимии и зельеварения, конечно же."
...
translate russian Sabrina_1_1_label_59ac051e:
    ...
    Sabrina "Я рада слышать, что ты заинтересован в предмете."
...
translate russian Sabrina_1_1_label_3dc8e68a:
    ...
    Sabrina "{b}Ты уже был на вступительной лекции Виктории?{/b}"
...
translate russian Sabrina_1_1_label_3107d16e:
    ...
    ch_Name "Таково правило. Все студенты должны присутствовать на вступительной лекции..."

# game/logic/events/sabrina.rpy:618
translate russian Sabrina_1_1_label_52a4386d:

    # Sabrina "...before attending any other classes."
    Sabrina "...перед посещением всех других занятий."
...
translate russian Sabrina_1_1_label_b9690c07:
    ...
    Sabrina "{b}Возвращайся после лекции Виктории.{/b}"
...
translate russian Sabrina_5_label_916187cb:
    ...
    # Sabrina "Take your seats, class is about to begin!"
    Sabrina "Все по местам, сейчас мы начнём занятие!"
...
translate russian Sabrina_5_label_95a4a6ab:
    ...
    Sabrina "Конечно, название может звучать излишне литературно и пафосно."
...
translate russian Sabrina_5_label_7f33726f:
    ...
    Sabrina "Но скучная реальность такова - ваша кожа получит большее сопротивление магическому воздействию."

# game/logic/events/sabrina.rpy:637
translate russian Sabrina_5_label_ab4a4f4a:

    # Sabrina "\"But no \"Golem-like\" appearance."
    Sabrina "\"Однако, никакого \"Големного\" внешнего вида."
...
translate russian Sabrina_5_label_ed11bd2c:
    ...
    Sabrina "Ваша кожа всего-навсего станет такой же прочной, как латы, или, если хотите, камень."

# game/logic/events/sabrina.rpy:639
translate russian Sabrina_5_label_73ed6194:

    # Sabrina "Hence the name \"Stoneskin\". That's all."
    Sabrina "Отсюда и название - \"Каменная Кожа\". Вот и всё."
...
translate russian Sabrina_5_label_25ab6962:
    ...
    Sabrina "Картер, кто варит зелье Каменной Кожи на таком медленном огне?"

# game/logic/events/sabrina.rpy:650
translate russian Sabrina_5_label_89838258:

    # Sabrina "You see how sloppy it gets?"
    Sabrina "Неужели ты не видишь, каким жидким оно получается?"
...
translate russian Sabrina_5_label_6114d53d:
    ...
    Sabrina "Прочитай рецепт ещё разок и повнимательней, мы попробуем снова на следующем уроке."
...
translate russian Sabrina_5_label_a4a55be8:
    ...
    Sabrina "Прекрасно, не спорю, но ты абсолютно точно перепутала ингредиенты."
...
translate russian Sabrina_5_label_1e109358:
    ...
    Sabrina "У тебя природный дар к зельеварению."
...
translate russian Sabrina_5_label_649f364e:
    ...
    Sabrina "Класс, я хочу, чтобы вы обратили внимание на эти два экземпляра."

# game/logic/events/sabrina.rpy:695
translate russian Sabrina_5_label_6d4fd842:

    # Sabrina "Perfect shade, nutty smell, no bubbles."
    Sabrina "Прекрасный оттенок, ореховый запах, никаких пузырьков."
...
translate russian Sabrina_5_label_dd8c816b:
    ...
    Sabrina "И другая только что была сотворена руками Мистера [Surname]!"
...
translate russian Sabrina_5_label_90b09d2a:
    ...
    Sabrina "Браво! Поаплодируем ему!"
...
translate russian Sabrina_5_label_dd9e45d4:
    ...
    ch_Name "О, бросьте, ребята. Мне повезло."
...
translate russian Sabrina_5_label_600da1d3:
    ...
    ch_Name "{i}(Чёрт, я зря волновался. Приятно быть в центре внимания.){/i}"
...
translate russian Sabrina_5_label_9478dfbb:
    ...
    ch_Name "{i}(Как будто я снова вышел на поле и слышу одобрительный гул с трибун...){/i}"
...
translate russian Sabrina_5_label_3ff5654b:
    ...
    Sabrina "На это сегодняшний урок закончен."
...
translate russian Sabrina_5_label_1c71b918:
    ...
    ch_Name "{i}(Точно, я могу забрать его!){/i}"
...
translate russian Sabrina_5_label_79b9acd0:
    ...
    ch_Name "Разве это можно назвать наградой?"
...
translate russian Sabrina_5_label_6d6c92c1:
    ...
    ch_Name "{i}(Ай. Об её реакцию можно порезаться.){/i}"
...
translate russian Sabrina_5_label_14c8a1b9:
    ...
    Sabrina "Ты ведь мой ученик, и как бы это выглядело со стороны..."
...
translate russian Sabrina_5_label_db938ec5:
    ...
    ch_Name "{i}(С другой стороны, она не сказала, что я ей не нравлюсь.){/i}"
...
translate russian Sabrina_5_label_9fcb939b:
    ...
    ch_Name "{i}(Думаю, даже наоборот... Но сейчас лучше разрядить обстановку.){/i}"
...
translate russian Sabrina_5_label_db22f06d:
    ...
    ch_Name "Ну что вы, мисс Спеллман. Я просто шучу."
...
translate russian Sabrina_5_label_df9d9e74:
    ...
    Sabrina "О, Виктория говорила мне об этих твоих шуточках..."
...
translate russian Sabrina_5_label_fd9618db:
    ...
    ch_Name "{i}(Кажется, я становлюсь популярным у учителей.){/i}"
...
translate russian Sabrina_5_label_4858901a:
    ...
    ch_Name "{i}(Если я хочу заработать реальный кэш, мне нужно обдумывать больше вариантов.){/i}"
...
translate russian Sabrina_5_label_faf54563:
    ...
    ch_Name "{i}(На чаевых в кафе не разбогатеешь.){/i}"
...
translate russian Sabrina_6_label_c314bfd2:
    ...
    Sabrina "Сегодня мы будем варить зелье Магического Отражения!"
...
translate russian Sabrina_6_label_54591356:
    ...
    Sabrina "Это очень полезное зелье на случай, если вы нарвётесь на бой с волшебником."
...
translate russian Sabrina_6_label_84bb0be7:
    ...
    Sabrina "Оно отражает заклинания, отправляя их в того, кто вас атаковал."
...
translate russian Sabrina_6_label_895e031e:
    ...
    Sabrina "Это зелье нужно помешивать безостановочно, даже при добавлении ингредиентов."

# game/logic/events/sabrina.rpy:756
translate russian Sabrina_6_label_007a0b2f:

    # Sabrina "So today you have to split into pairs."
    Sabrina "Поэтому сегодня вам придётся поделиться на пары."
...
translate russian Sabrina_6_label_47a0d16f:
    ...
    ch_Name "{i}(Мне почудилось? Она хочет со мной в пару?){/i}"
...
translate russian Sabrina_6_label_fd5228ba:
    ...
    ch_Name "{i}(Даже если успех заключается лишь в том, чтобы знать, как варить зелья.){/i}"
...
translate russian Sabrina_6_label_9bace742:
    ...
    ch_Name "Давай начнём. Нас ждёт много работы."
...
translate russian Sabrina_6_label_9d5ddd22:
    ...
    Grace "У тебя такие сильные руки. Ты занимаешься?"
...
translate russian Sabrina_6_label_f922594a:
    ...
    Grace "Жалко. Я бы пришла поболеть за тебя как-нибудь."
...
translate russian Sabrina_6_label_d382a74d:
    ...
    ch_Name "Ну, мы в Кордейле, так что... Всё может быть."
...
translate russian Sabrina_6_label_5804b6d6:
    ...
    Sabrina "Студенты, гасите пламя и прекращайте мешать!"
...
translate russian Sabrina_6_label_04fa6e93:
    ...
    Grace "Жалко. Ну да ладно, может, ты и прав, [Name]."
...
translate russian Sabrina_6_label_13181a93:
    ...
    Carter "Спасибо. Годы готовки для моей матери прошли не зря."
...
translate russian Sabrina_6_label_124a5bb0:
    ...
    Sabrina "Такое зелье и продать можно."
...
translate russian Sabrina_6_label_4989fc49:
    ...
    Sabrina "Возьмите каждый по флакону в награду за старания."
...
translate russian Sabrina_7_label_10a42b8d:
    ...
    Carter "Кажется, мне плохо... Можно мне уйти?"
...
translate russian Sabrina_7_label_27d5c151:
    ...
    Sabrina "Так как мы варим зелье Вдохновения!"
...
translate russian Sabrina_7_label_55b571b1:
    ...
    ch_Name "{i}(Сабрина сегодня странная. Что её так воодушевило?){/i}"
...
translate russian Sabrina_7_label_fc3aaa50:
    ...
    ch_Name "{i}(Может, она сама выпила один-два флакончика?){/i}"
...
translate russian Sabrina_7_label_9cd649f1:
    ...
    Sabrina "Не проморгай, скоро время добавлять ингредиент."
...
translate russian Sabrina_7_label_fcb07386:
    ...
    ch_Name "Это занимает целую вечность..."
...
translate russian Sabrina_7_label_41ae8b80:
    ...
    ch_Name "{i}(Поверить не могу, что она называет это вдохновляющим. Я чуть не уснул.){/i}"
...
translate russian Sabrina_7_label_3b518b25:
    ...
    ch_Name "{i}(Я обещал Хейли встретиться с ней в её комнате вечером.){/i}"
...
translate russian Sabrina_7_label_9ea66a67:
    ...
    ch_Name "{i}(Пойти прямо к ней или побродяжить ещё какое-то время?){/i}"

translate russian strings:

    # game/logic/events/sabrina.rpy:9
    old "Ask about Giant"
    new "Спросить про Гиганта"
    ...
    new "Слёзы единорога, волос оленя, Норвежский мох"

    # game/logic/events/sabrina.rpy:318
    old "Goat tears, mockingbird feather, birch bark"
    new "Слёзы овцы, перо пересмешницы, экстракт бересты"

    # game/logic/events/sabrina.rpy:318
    old "Tears of deer, unicorn hair, Icelandic lichen"
    new "Слёзы оленя, волос единорога, Исландский лишайник"

    # game/logic/events/sabrina.rpy:512
    old "Find an excuse"
    new "Придумать отговорку"

    # game/logic/events/sabrina.rpy:766
    old "Agree to work with Grace"
    new "Поработать с Грейс"

    # game/logic/events/sabrina.rpy:766
    old "Work with someone else"
    new "Поработать с кем-то ещё"
