...
translate russian Samantha_3_label_9dc8023c:
    ...
    ch_Name "{i}(Ну и как бы мне выудить из него нужные сведения, не называя имён...){/i}"
...
translate russian Samantha_3_label_cc00f8fa:
    ...
    ch_Name "Вчера студент третьего курса рассказал нам, что сила магии в человеке может истощиться"
...
translate russian Samantha_3_label_50f65561:
    ...
    ch_Name "Рассказывал, что у ученика другой школы однажды появилась боль в руках."

# game/logic/events/jacob.rpy:106
translate russian Samantha_3_label_a0194069:

    # ch_Name "When he was doing magic."
    ch_Name "Когда он творил магию."
...
translate russian Samantha_3_label_94890760:
    ...
    Jacob "Не придумывайте лишнего, [Surname]. Такие вещи на ровном месте не случаются."

# game/logic/events/jacob.rpy:117
translate russian Samantha_3_label_3af329f2:

    # Jacob "Is that all you wanted?"
    Jacob "Это всё, что вы хотели узнать?"
...
translate russian Samantha_3_label_61471075:
    ...
    Jacob "У меня есть более важные дела, чем развенчивать всякие студенческие мифы."
...
translate russian Samantha_3_label_ef96d3b2:
    ...
    ch_Name "Мне очень важно знать, почему такое состояние появляется. И как его вылечить."
...
translate russian Samantha_3_label_233122c3:
    ...
    Jacob "Вы очень заинтересовались этой темой, [Surname]"
...
translate russian Samantha_3_label_41ff4fa1:
    ...
    ch_Name "Любопытство и ипохондрия - мои заклятые друзья."
...
translate russian Samantha_3_label_f20b2ca2:
    ...
    Jacob "{i}(Вы думаете, что вы первый студент, обладающий таким даром?){/i}"
...
translate russian Samantha_3_label_6a01d9a3:
    ...
    Jacob "{i}(Очень глупо с вашим-то неразвитым навыком пытаться залезть в голову к преподавателю.){/i}"
...
translate russian Samantha_3_label_82c13ae9:
    ...
    # ch_Name "I apologize."
    ch_Name "Приношу свои извинения."
...
translate russian Samantha_3_label_43_f0536800:
    ...
    ch_Name "Мистер Фролло, правда в том, что я не могу сказать вам, для кого мне нужны эти сведения."

# game/logic/events/jacob.rpy:157
translate russian Samantha_3_label_43_09534c55:

    # ch_Name "But it's a matter of life and death."
    ch_Name "Но всё же это вопрос жизни и смерти."
...
translate russian Samantha_3_label_43_82113bfe:
    ...
    ch_Name "Если вы мне поможете, я буду вам должен."
...
translate russian Samantha_3_label_43_905bed4a:
    ...
    Jacob "Ну вот теперь совсем другой разговор."
...
translate russian Samantha_3_label_43_849a2efa:
    ...
    Jacob "Мистер [Surname], вы желаете заключить со мной {b}(магический договор){/b}?"
...
translate russian Samantha_3_label_43_dd664cea:
    ...
    ch_Name "Вы не могли бы уточнить, что это означает?"
...
translate russian Samantha_3_label_43_d4091b5a:
    ...
    Jacob "Вы сказали, что будете должны мне, не правда ли?"
...
translate russian Samantha_3_label_43_b5abaa71:
    ...
    Jacob "В мире магии такие слова несут в себе особое значение."
...
translate russian Samantha_3_label_43_32799593:
    ...
    Jacob "Мы с вами заключим договор, и когда время придёт, я взыщу с вас это одолжение."
...
translate russian Samantha_3_label_43_cfa5cf05:
    ...
    ch_Name "Я лишь прошу, чтобы вы поделились своими знаниями, как преподаватель со студентом."

# game/logic/events/jacob.rpy:177
translate russian Samantha_3_label_43_d47f537f:

    # Jacob "Ah, excuse me."
    Jacob "Ах, прошу прощенья."
...
translate russian Samantha_3_label_43_ee8600a4:
    ...
    Jacob "Мне показалось, что вам крайне срочно нужна информация, которой владею только я."
...
translate russian Samantha_3_label_43_5267ad28:
    ...
    Jacob "Но если вы лишь желаете научиться, то вам придётся потерпеть."
...
translate russian Samantha_3_label_43_b4464275:
    ...
    ch_Name "Я об этом наверняка пожалею."
...
translate russian Samantha_3_label_43_11b7464a:
    ...
    Jacob "Информация в обмен на одолжение. Ударим по рукам."
...
translate russian Samantha_3_label_43_0f671be6:
    ...
    Jacob "Всегда приятно осознавать, что молодой волшебник у тебя в долгу."
...
translate russian Samantha_3_label_43_4d0dafa9:
    ...
    ch_Name "Как скажете. А теперь прошу вас ответить на мои вопросы."
...
translate russian Samantha_3_label_43_0393ce09:
    ...
    Jacob "Не представляю, зачем вам эта информация столь срочно нужна."
...
translate russian Samantha_3_label_43_d6b63b37:
    ...
    Jacob "Когда происходит надрыв магических связок, становится невозможно выполнять сложные заклинания."
...
translate russian Samantha_3_label_43_9f220998:
    ...
    Jacob "Магическая сила становится нестабильна и начинает разрушать носителя изнутри."
...
translate russian Samantha_3_label_43_502b683d:
    ...
    ch_Name "Это ужасно! Можно ли что-то с этим сделать?"
...
translate russian Samantha_3_label_43_9a6b18e1:
    ...
    Jacob "Конечно, можно. Это неприятное состояние, но не смертельное."
...
translate russian Samantha_3_label_43_eabee476:
    ...
    Jacob "Вам лишь требуется {b}(повязка из пыльцы ночных фей){/b} и некоторые травы."
...
translate russian Samantha_3_label_43_3e4bd061:
    ...
    Jacob "{b}(У мисс Виктории всё это точно найдётся.){/b}"
...
translate russian Samantha_3_label_43_0dc476bf:
    ...
    Jacob "Вы ищете способ устранить последствия, хотя на самом деле вы должны искать причину всего этого."
...
translate russian Samantha_3_label_43_889e2027:
    ...
    Jacob "Магические связки не рвутся на ровном месте."
...
translate russian Samantha_3_label_43_819f31b2:
    ...
    Jacob "Если вы не хотите, чтобы это повторилось, надо найти причину."
...
translate russian Samantha_3_label_43_28efefa2:
    ...
    ch_Name "И что же может привести к такой травме?"
...
translate russian Samantha_3_label_43_7ac60163:
    ...
    Jacob "Что я знаю точно - так это то, что крайне опасно подвергаться воздействию магической энергии иных сущностей."

# game/logic/events/jacob.rpy:227
translate russian Samantha_3_label_43_bcc60582:

    # Jacob "It can kill whoever is doing it."
    Jacob "Она может убить кого угодно."
...
translate russian Samantha_3_label_43_5362c273:
    ...
    Jacob "Для кого бы вы не искали эти ответы, этому человеку очень повезло остаться в живых."

# game/logic/events/jacob.rpy:230
translate russian Samantha_3_label_43_4a4d64b4:

    # ch_Name "What do you mean, \"different essence\"?"
    ch_Name "Что значит \"иных сущностей\"?"
...
translate russian Samantha_3_label_43_7f54c269:
    ...
    Jacob "Разные существа могут творить магию, [Surname]. Люди, феи, драконы, суккубы..."
...
translate russian Samantha_3_label_43_ce72d42a:
    ...
    Jacob "Множество различных рас и видов магии. Смешивать их бывает невероятно опасно."
...
translate russian Samantha_3_label_43_7972298a:
    ...
    Jacob "О нет, мистер [Surname]. Это я вас должен благодарить. Удачи вам в ваших поисках."
...
translate russian Samantha_3_label_43_5bb4d59b:
    ...
    ch_Name "{i}(Отлично. Теперь надо спросить Викторию про это лекарство.){/i}"

# game/logic/events/jacob.rpy:245
translate russian Samantha_3_label_43_f5d6db5d:

    # ch_Name "{i}(Oh... I have her lesson in the schedule.){/i}"
    ch_Name "{i}(Оу... У меня как раз её урок в расписании.){/i}"

# game/logic/events/jacob.rpy:246
translate russian Samantha_3_label_43_840360dc:

    # ch_Name "{i}(It's... right now!){/i}"
    ch_Name "{i}(Причём... прямо сейчас!){/i}"
...
translate russian Samantha_3_label_43_9e6cd387:
    ...
    ch_Name "{i}(Ну и хорошо, схожу на занятие и потом спрошу её про это средство.){/i}"
...
translate russian Jacob_1_label_78d983a6:
    ...
    Molly "Это круто! Твоя смена закончена, так что можешь идти. Удачи!"
...
translate russian Jacob_1_label_a48eaa6e:
    ...
    ch_Name "{i}(Ух! Я почти был уверен, что не успею его застать из-за работы.){/i}"
...
translate russian Jacob_1_label_5d03fc47:
    ...
    Jacob "Дьявольский символ, почитаемый всеми волшебниками."

# game/logic/events/jacob.rpy:284
translate russian Jacob_1_label_6403b66d:

    # Jacob "Remind me..."
    Jacob "Напомните-ка мне..."
...
translate russian Jacob_1_label_f07d7a92:
    ...
    Jacob "Мы здесь встречаемся с членами дуэльного клуба."
...
translate russian Jacob_1_label_efcc1110:
    ...
    Jacob "Студенты анонимно участвуют в сражениях за баллы для своих факультетов."
...
translate russian Jacob_1_label_5e9324e5:
    ...
    Jacob "Это самый лучший способ отрабатывать изучаемые заклятия."
...
translate russian Jacob_1_label_4eb183a5:
    ...
    ch_Name "Как мне к вам присоединиться?"
...
translate russian Jacob_1_label_436b0c19:
    ...
    Jacob "Неопытному бойцу у нас придётся несладко."
...
translate russian Jacob_1_label_90a66d1c:
    ...
    Jacob "Охотно бы на это посмотрел, но у нас есть правила."
...
translate russian Jacob_1_label_5241240b:
    ...
    Gabriella "Я выучила то заклинание, о котором вы говорили."
...
translate russian Jacob_1_label_300941f0:
    ...
    Gabriella "Очень приятно. Ты тоже хочешь вступить в дуэльный клуб?"
...
translate russian Jacob_1_label_38605691:
    ...
    ch_Name "Я?{w} Да, я вот как раз хотел узнать про него."
...
translate russian Jacob_1_label_5d37ec35:
    ...
    Gabriella "Здорово! Мне уже не терпится провести свою первую дуэль."
...
translate russian Jacob_1_label_43da18f9:
    ...
    Jacob "О! Есть, у меня есть для вас подходящий соперник, Габи."
...
translate russian Jacob_1_label_db053d82:
    ...
    Jacob "Поторопитесь и готовьтесь к выходу на арену. Я скоро подойду."
...
translate russian Jacob_1_label_7a9a2c4d:
    ...
    Jacob "Когда будете готовы его испробовать, приходите."
...
translate russian Jacob_1_label_97aef292:
    ...
    Jacob "Мы с участниками дуэльного клуба собираемся здесь каждый вечер."
...
translate russian Jacob_1_label_c9ab0315:
    ...
    ch_Name "{i}(Впрочем, не сегодня. Уже есть иные планы. С другой девушкой.){/i}"
...
translate russian Jacob_1_label_5e183251:
    ...
    ch_Name "{i}(К слову, надо бы уже пойти туда, если я не хочу опаздывать.){/i}"
...
translate russian Jacob_1_label_2ffbdbab:
    ...
    ch_Name "{i}(Я и так тут проторчал слишком долго.){/i}"
...
translate russian Jacob_2_label_2fa9da3b:
    ...
    Jacob "Всё ещё метите в дуэльный клуб?"
...
translate russian Jacob_2_label_631df7a8:
    ...
    ch_Name "На самом деле, я уже выучил заклинание боевой молнии."
...
translate russian Jacob_2_label_d06a2167:
    ...
    ch_Name "Так что я готов стать новым чемпионом Кордейла."
...
translate russian Jacob_2_label_8999f480:
    ...
    Jacob "Это отличная шутка, мистер [Surname]."
...
translate russian Jacob_2_label_4325afef:
    ...
    Jacob "Для победы в дуэли вы должны показать лучший навык владения боевой магией."
...
translate russian Jacob_2_label_5ce29a38:
    ...
    Jacob "Вы должны одолеть своего соперника с помощью заклинаний."
...
translate russian Jacob_2_label_38c8d382:
    ...
    Jacob "Также вы можете использовать зелья для увеличения ваших шансов на успех."

# game/logic/events/jacob.rpy:394
translate russian Jacob_2_label_f60df828:

    # Jacob "Now, about battle magic."
    Jacob "Так, по поводу магии."
...
translate russian Jacob_2_label_809a2eff:
    ...
    Jacob "Можно применять только простые заклятия, которые вы изучаете на уроках Виктории."
...
translate russian Jacob_2_label_1a41cc9f:
    ...
    Jacob "Потому что таким образом мы можем быть уверены, что вы случайно не превратите Кордейл в руины."

# game/logic/events/jacob.rpy:398
translate russian Jacob_2_label_45495618:

    # ch_Name "Alright. That sounds reasonable."
    ch_Name "Понял. Звучит разумно."
...
translate russian Jacob_2_label_590ceffd:
    ...
    Jacob "Вначале вы сможете применять только заклинание боевой молнии."
...
translate russian Jacob_2_label_069e362d:
    ...
    Jacob "Пока один из сражающихся не свалится без дыхания."
...
translate russian Jacob_2_label_527e4926:
    ...
    ch_Name "Какого чёрта, мистер Фролло? Там что, погибнуть можно?"
...
translate russian Jacob_2_label_38fc944d:
    ...
    Jacob "К тому же, я не говорил, что дуэль ведётся насмерть."
...
translate russian Jacob_2_label_c00f70b8:
    ...
    Jacob "Проигравший просто теряет сознание, истощив свою энергию."
...
translate russian Jacob_2_label_e01f59c1:
    ...
    Jacob "Боквые маги - это этита, и в их рядах нет места неуверенным в себе слабакам."

# game/logic/events/jacob.rpy:421
translate russian Jacob_2_label_e2a72faa:

    # Jacob "But I'm sure you're not one of those."
    Jacob "Впрочем, я уверен, это не про вас."
...
translate russian Jacob_2_label_4ea7e4aa:
    ...
    Jacob "Вы можете подумать над этим и обратиться ко мне в другой раз."
...
translate russian Jacob_2_label_5782a1db:
    ...
    Jacob "Подходите, выбирайте факультет вашего оппонента, и мы проследуем на арену без промедлений."
...
translate russian Jacob_2_label_790a11c2:
    ...
    Jacob "Габи! Отличное сражение было вчера. Я рад, что вы освоили новое заклятие."
...
translate russian Jacob_2_label_c26b2619:
    ...
    Jacob "Вот, к примеру, мистер [Surname] полон решимости вступить в клуб."
...
translate russian Jacob_2_label_177d7581:
    ...
    Jacob "Итак, мистер [Surname], против какого факультета вы желали бы сразиться?"
...
translate russian Jacob_2_label_dbe17e7b:
    ...
    ch_Name "Я бы хотел сразиться со студентом Аддерина, сэр."
...
translate russian Jacob_2_label_e9d47805:
    ...
    Gabriella "Интересный выбор. У меня вчера была дуэль с Аддеринцем."
...
translate russian Jacob_2_label_f54885f7:
    ...
    Gabriella "Жаль, что мы с тобой не будем биться. Я была бы рада быть у тебя первой."
...
translate russian Jacob_2_label_be1afec6:
    ...
    Jacob "Хорошо. Есть у меня на примете один новичок из Мартендера, от также хотел участвовать."
...
translate russian Jacob_2_label_6ce0e675:
    ...
    Gabriella "Жаль, что ты не выбрал Кроухайв, красавчик."
...
translate russian Jacob_2_label_5bb98c07:
    ...
    ch_Name "Я бы хотел сразиться со студентом Кроухайва."
...
translate russian Jacob_2_label_48e9c985:
    ...
    ch_Name "Ты очень уверена в себе. Может, даже слишком."
