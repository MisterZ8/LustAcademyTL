...
translate russian Katrina_1_label_b5c500bc:
    ...
    ch_Name "{i}(О... Какая жуткая головная боль.){/i}"
...
translate russian Katrina_1_label_d2fd5b41:
    ...
    ch_Name "{i}(Что произошло вчера? Не могу вспомнить.){/i}"
...
translate russian Katrina_1_label_913db7e4:
    ...
    ch_Name "Что за черт... Что я здесь делаю?!"
...
translate russian Katrina_1_label_6b707201:
    ...
    ch_Name "{i}(Меня пригласили учиться. Где-то.){/i}"
...
translate russian Katrina_1_label_13dd8db6:
    ...
    ch_Name "{i}(Особенно со времени изобретения электронной почты и мобильных телефонов.){/i}"

# game/logic/events/Katrina.rpy:30
translate russian Katrina_1_label_f628c877:

    # ch_Name "{i}(I remember now...){/i}"
    ch_Name "{i}(Теперь я вспоминаю...){/i}"
...
translate russian Katrina_1_label_f4b6a0fc:
    ...
    ch_Name "{i}(Samantha говорила о письме из школы магии.){/i}"
...
translate russian Katrina_1_label_5634a664:
    ...
    ch_Name "{i}(Мы должны идти на железнодорожную станцию сегодня. Я опаздываю!){/i}"
...
translate russian Katrina_1_label_fd113125:
    ...
    ch_Name "{i}(Я должен найти Samantha. Надеюсь, я не проспал.){/i}"
...
translate russian Katrina_1_label_d61d34f4:
    ...
    ch_Name "Samantha! Подожди минуту."
...
translate russian Katrina_1_label_646b4cdd:
    ...
    ch_Name "Я же не проспал, правда?"
...
translate russian Katrina_1_label_7f5e4de6:
    ...
    Samantha "Я должна вызвать такси? Может, и твою комнату прибрать заодно?"
...
translate russian Katrina_1_label_bd3b0136:
    ...
    ch_Name "Ты не должна этого делать. Мы едем в академию вместе."
...
translate russian Katrina_1_label_08d8b9a6:
    ...
    Samantha "Не могу поверить что ты такой неудачник, что поверил в это."
...
translate russian Katrina_1_label_37c38f7d:
    ...
    ch_Name "{i}(Как это... Это казалось таким реальным.){/i}"
...
translate russian Katrina_1_label_9f5c2061:
    ...
    ch_Name "{i}(Может, я и правда неудачник, если готов верить в магию.){/i}"
...
translate russian Katrina_1_label_08dc6245:
    ...
    ch_Name "{i}(Отлично, очередная ссора с Don это то, что мне сейчас нужно.){/i}"
...
translate russian Katrina_1_label_6706d91d:
    ...
    Don "Ты не учишься - ты платишь за комнату."
...
translate russian Katrina_1_label_d0450104:
    ...
    Don "И прямо сейчас время платить за первый и последний месяц аренды."
...
translate russian Katrina_1_label_395c987b:
    ...
    ch_Name "Don, у меня сейчас нет таких денег."
...
translate russian Katrina_1_label_c90437f6:
    ...
    Don "Мне надоели твои отговорки!"
...
translate russian Katrina_1_label_4cee64c0:
    ...
    Don "Тогда убирайся из моего дома, ты придурок!"
...
translate russian Katrina_1_label_2bfd0a34:
    ...
    ch_Name "{i}(Ну и удар у него. В ушах звенит.){/i}"
...
translate russian Katrina_1_label_92cf679b:
    ...
    ch_Name "{i}(Я с трудом понимаю что он говорит...){/i}"
...
translate russian Katrina_1_label_3bbb4635:
    ...
    Don "Я проверю, сколько можно получить за твой фотоаппарат и компьютер."
...
translate russian Katrina_1_label_851d7c11:
    ...
    ch_Name "{i}(Так сильно долит голова... Этот удар был жестким.){/i}"
...
translate russian Katrina_1_label_0005c450:
    ...
    Olivia "Как грязный, бесполезный таракан, какой ты и есть!"
...
translate russian Katrina_1_label_afb09aec:
    ...
    ch_Name "{i}(Я всегда знал, что глубоко внутри ты доминантная стерва.){/i}"
...
translate russian Katrina_1_label_c17bfaec:
    ...
    ch_Name "{i}(Я должен понять, что с ней произошло...){/i}"
...
translate russian Katrina_1_label_d6f9934c:
    ...
    ch_Name "{i}(Что за черт, убери от меня свою ногу, женщина!){/i}"
...
translate russian Katrina_1_label_0798b536:
    ...
    Olivia "С тех пор, как появился ты... Все превратилось в дерьмо."
...
translate russian Katrina_1_label_cfd2ebf1:
    ...
    Olivia "Когда-то это был счастливый брак, знаешь ли. Я и Don."
...
translate russian Katrina_1_label_fe5dda95:
    ...
    ch_Name "Если я был таким тяжким грузом, почему вы не отдали меня в приемную семью?"

# game/logic/events/Katrina.rpy:257
translate russian Katrina_1_label_ec21cd3c:

    # Olivia "Don asked me to. Many times."
    Olivia "Don просил меня. Много раз."
...
translate russian Katrina_1_label_8967e159:
    ...
    Olivia "Как ты чувствуешь себя сейчас, когда все твои ошибки возвращаются к тебе?"
...
translate russian Katrina_1_label_87762acd:
    ...
    Olivia "Никому до тебя нет дела."
...
translate russian Katrina_1_label_bc3deadb:
    ...
    Olivia "Если бы я была тобой, я бы заползла в глубокую нору и сдохла в ней."

# game/logic/events/Katrina.rpy:274
translate russian Katrina_1_label_5e13d69a:

    # ch_Name "So why don't you?"
    ch_Name "Так почему ты этого не делаешь?"
...
translate russian Katrina_1_label_1963ed87:
    ...
    ch_Name "Почему ты не заползаешь в глубокую нору и не сдыхаешь, а?"
...
translate russian Katrina_1_label_402cd952:
    ...
    ch_Name "Также, как мне послышалось о магии Leona, так, Katrina?"
...
translate russian Katrina_1_label_b8128d00:
    ...
    ch_Name "Все еще бесишься, что я выбрал дом получше?"
...
translate russian Katrina_1_label_d05c2d71:
    ...
    Katrina "Смейся от души, в этот раз ты победил."
...
translate russian Katrina_1_label_1b68c28f:
    ...
    Katrina "И однажды ночью ты не найдешь пути назад."
...
translate russian Katrina_1_label_5e347f10:
    ...
    ch_Name "Черт... Этот сон был таким реальным. Черт!"
...
translate russian Katrina_1_label_84c46967:
    ...
    ch_Name "Мне нужно найти способ вызвать Leona. Надеюсь у нее имеются некоторые ответы."
...
translate russian Katrina_1_label_4a94868f:
    ...
    ch_Name "Возможно, я смогу найти информацию в Sorting Foliant."

# game/logic/events/Katrina.rpy:318
translate russian Katrina_1_label_d610861b:

    # ch_Name "That nightmare made me feel so lonely..."
    ch_Name "Этот кошмар заставил меня чувствовать себя таким одиноким..."
...
translate russian Katrina_1_label_7151a4de:
    ...
    ch_Name "Мне жизненно необходимо общение с настоящими живыми людьми."
...
translate russian Katrina_1_label_025e6c8e:
    ...
    ch_Name "Но если я хочу вовремя явиться на урок Victoria, у меня не так много времени."
...
translate russian Katrina_1_label_470add5b:
    ...
    ch_Name "Я могу выпить чашечку кофе с Audrey или рассказать Lily что я выиграл пари."
