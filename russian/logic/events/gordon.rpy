...
translate russian Gordon_1_label_91ca2eee:
    ...
    ch_Name "{i}(Кажется, это хорошее место.){/i}"
...
translate russian Gordon_1_label_0544583a:
    ...
    ch_Name "{i}(Странно, магазин не закрыт, но здесь никого нет...){/i}"
...
translate russian Gordon_1_label_f94e9d69:
    ...
    UnknownGordon "Как обычно с молодежью, никакого уважения."
...
translate russian Gordon_1_label_9c4c0003:
    ...
    ch_Name "{i}(Что это за существо? Это настоящий дварф?!){/i}"
...
translate russian Gordon_1_label_dd55f052:

    # UnknownGordon "I'm Gordon Chompsky."
    UnknownGordon "Я Гордон Чомпски."

# game/logic/events/gordon.rpy:101
translate russian Gordon_1_label_26f50841:

    # Gordon "And this is Chompsky's shop. Best store in Dale."
    Gordon "А это магазин Чомпски. Лучший магазин в Дейле."
...
translate russian Gordon_1_label_967614f0:
    ...
    Gordon "Конечно это так. Дварфы никогда не лжут!"
...
translate russian Gordon_1_label_92a4c1f1:
    ...
    ch_Name "Я из Кордейла. Наш дом выиграл соревнование на этой неделе."
...
translate russian Gordon_1_label_e7a327c0:
    ...
    Gordon "Вау. Ты что, ученик что ли?"
...
translate russian Gordon_1_label_bfd37f27:
    ...
    Gordon "Я люблю волшебников! Вы знаете хорошие ингредиенты. Платит хорошие деньги."
...
translate russian Gordon_1_label_889bfdfa:
    ...
    ch_Name "{i}(Вау! Откуда она взялась?){/i}"
...
translate russian Gordon_1_label_c61c4134:
    ...
    ch_Name "{i}(И вообще, что она за существо? Она тоже дварф?){/i}"
...
translate russian Gordon_1_label_7c27bc43:
    ...
    ch_Name "{i}(Он предлагает мне купить ее, или что сейчас происходит?!){/i}"
...
translate russian Gordon_1_label_0e4100b6:
    ...
    Gordon "Полуфея, придурок! В конце концов, феи лучшие в магии!"
...
translate russian Gordon_1_label_e6123a9c:
    ...
    Gordon "Конечно! Уиллоу чувствовала волшебство, как никто другой, с тех пор, как она была маленькой девочкой."
...
translate russian Gordon_1_label_1703d5e2:
    ...
    Gordon "Если тебе когда-нибудь понадобится что-то, чего нет в моем магазине, иди к ней!"
...
translate russian Gordon_1_label_625537a2:
    ...
    Willow "Это правда, я могла бы помочь вам с чем-нибудь необычным."
...
translate russian Gordon_1_label_e7e579d3:
    ...
    Willow "И я нахожу почти все, если мне нужно."
...
translate russian Gordon_1_label_9f0c00cf:
    ...
    Willow "Это, конечно, если ты сможешь достаточно отблагодарить меня."
...
translate russian Gordon_1_label_9a77a435:
    ...
    ch_Name "{i}(Это мне кажется, или она говорит не о деньгах?){/i}"
...
translate russian Gordon_1_label_02856daf:
    ...
    ch_Name "Ничего не могу придумать, но буду иметь в виду."
...
translate russian Gordon_1_label_8c0ba6b6:
    ...
    Gordon "Я знаю, какой раздражающей она может быть. Она наполовину фея."
...
translate russian Gordon_1_label_143af000:
    ...
    Gordon "Ладно, блины у меня за прилавком замерзают."
...
translate russian Gordon_1_label_3eee173e:
    ...
    Gordon "Дай мне знать, если ты надумаешь купить что-нибудь."
...
translate russian Gordon_1_label_4b555c3a:
    ...
    Gordon "Мне нужна пара запасных рук."

# game/logic/events/gordon.rpy:188
translate russian Gordon_1_label_075093fc:

    # Gordon "If you need a part-time job, there's nobody better than Chompsky."
    Gordon "Если тебе нужна работа на неполный рабочий день, нет никого лучше, чем Чомпски."

# game/logic/events/gordon.rpy:189
translate russian Gordon_1_label_bd3363fd:

    # ch_Name "Really? Can you tell me more about that?"
    ch_Name "Действительно? Можете ли вы рассказать мне больше об этом?"
...
translate russian Gordon_1_label_f84f4aa7:
    ...
    Gordon "Здесь у нас не только магазин, но и небольшая пекарня."
...
translate russian Gordon_1_label_34570dbb:
    ...
    Gordon "Местным очень нравятся рыбные пироги, которые печет Уиллоу."
...
translate russian Gordon_1_label_04207990:
    ...
    ch_Name "Хммм... Разве волшебные холодильники в Дейле не работают?"
...
translate russian Gordon_1_label_1e5fe998:
    ...
    Gordon "Этот хлам, который гоблины делают за несколько пенни?"
...
translate russian Gordon_1_label_0485c0d9:
    ...
    Gordon "Нет, спасибо. Дварфы не едят такое дерьмо."
...
translate russian Gordon_1_label_f268a61f:
    ...
    Gordon "А судя по популярности пирогов Уиллоу, разницу почувствует каждый."
...
translate russian Gordon_1_label_20c5fd71:
    ...
    Gordon "Поэтому нам всегда нужно несколько рук, чтобы подбросить удочку."
...
translate russian Gordon_1_label_f613d9f6:
    ...
    Gordon "По крайней мере те, что клюют с берега на удочку."
...
translate russian Gordon_1_label_290c6cca:
    ...
    Gordon "А вот, возьми удочку и наживку."
...
translate russian Gordon_1_label_b5a5f7b8:
    ...
    Gordon "Я заплачу тебе доллар за каждую рыбку."
...
translate russian Gordon_1_label_3885f587:
    ...
    Gordon "Я буду ждать тебя со свежей рыбой."
...
translate russian Gordon_2_label_ac4ba1da:
    ...
    ch_Name "Значит, все, что мне нужно сделать, это поймать пару рыбок? Звучит легко."
...
translate russian Gordon_2_label_11b1ca1c:
    ...
    ch_Name "{i}(Здесь рыба действительно вкуснее?){/i}"
...
translate russian Gordon_2_label_de489e55:
    ...
    ch_Name "{i}(Но я от скуки смотрел шоу о рыбалке.){/i}"
...
translate russian Gordon_2_label_11b1ca1c_1:
    ...
    # ch_Name "{i}(Does the fish really taste better here?){/i}"
    ch_Name "{i}(Здесь рыба действительно вкуснее?){/i}d"
...
translate russian Gordon_2_label_a9fac133:
    ...
    ch_Name "{i}(В любом случае, я не боюсь русалок.){/i}"
...
translate russian Willow_1_label_b5da35ff:
    ...
    ch_Name "{i}(Я скоро увижу все красоты города Дейл.){/i}"
...
translate russian Willow_1_label_c47818af:
    ...
    ch_Name "{i}(Мне просто нужно пройти по этой лестнице, и я на главной площади.){/i}"

# game/logic/events/gordon.rpy:333
translate russian Willow_1_label_d2442782:

    # ch_Name "{i}(I still have to decide what to do.){/i}"
    ch_Name "{i}(Мне еще нужно решить, что делать.){/i}"
...
translate russian Willow_1_label_6f5f6e1b:
    ...
    ch_Name "{i}(Я мог бы записаться на массаж, но еще так рано.){/i}"
...
translate russian Willow_1_label_51f86b76:
    ...
    ch_Name "{i}(Возможно, в магазине Гордона есть что-нибудь интересное в наличии.){/i}"

# game/logic/events/gordon.rpy:338
translate russian Willow_1_label_bf7d543c:

    # ch_Name "{i}(Chompsky's store. That's where I'm going.){/i}"
    ch_Name "{i}(Магазин Чомпски. Я иду туда.){/i}"
...
translate russian Willow_1_label_9d91b413:
    ...
    ch_Name "Эй, Гордон! Как жизнь, как дела?"
...
translate russian Willow_1_label_081defcc:
    ...
    Gordon "О, все идет довольно хорошо. Я вижу, Леонхарт снова победил. Поздравляю."
...
translate russian Willow_1_label_ef2ae37a:
    ...
    ch_Name "Спасибо чувак. Мне кажется, или ты сегодня выглядишь немного подавленным?"
...
translate russian Willow_1_label_db5d5dd4:
    ...
    Gordon "Так и есть. Дочь два дня ноет, чем-то расстроена."
...
translate russian Willow_1_label_5087b9cc:
    ...
    Gordon "Может быть, это те картинки для газеты, я не знаю. Грустно смотреть на нее."

# game/logic/events/gordon.rpy:348
translate russian Willow_1_label_20516ddd:

    # ch_Name "Maybe I can talk to her. See if I can make her happy."
    ch_Name "Может быть, я смогу поговорить с ней. Посмотрим, смогу ли я сделать ее счастливой."

# game/logic/events/gordon.rpy:350
translate russian Willow_1_label_37496a3d:

    # Gordon "Hmm, maybe. That's an idea. You couldn't do any worse. Go for it."
    Gordon "Хм, может быть. Это идея. Ты не можешь сделать хуже. Действуй."
...
translate russian Willow_1_label_e4b53fcf:
    ...
    ch_Name "{i}(Что происходит? Я буквально вижу слезы в ее глазах!){/i}"

# game/logic/events/gordon.rpy:356
translate russian Willow_1_label_784febcb:

    # ch_Name "Are you okay?"
    ch_Name "Все в порядке?"

# game/logic/events/gordon.rpy:357
translate russian Willow_1_label_acba38e0:

    # ch_Name "You look very sad."
    ch_Name "Ты выглядишь очень грустной."

# game/logic/events/gordon.rpy:359
translate russian Willow_1_label_047f3da0:

    # Willow "Hey!"
    Willow "Привет!"

# game/logic/events/gordon.rpy:360
translate russian Willow_1_label_3597c787:

    # Willow "There's nothing wrong..."
    Willow "Ничего страшного..."

# game/logic/events/gordon.rpy:361
translate russian Willow_1_label_363b1a02:

    # ch_Name "C'mon, you can tell me anything."
    ch_Name "Давай, ты можешь рассказать мне что угодно."

# game/logic/events/gordon.rpy:362
translate russian Willow_1_label_8acf726a:

    # ch_Name "Just trust me."
    ch_Name "Просто поверь мне."

# game/logic/events/gordon.rpy:364
translate russian Willow_1_label_baaef472:

    # Willow "The article... will be up tomorrow... on the first page..."
    Willow "Статья... будет завтра... на первой странице..."
...
translate russian Willow_1_label_6ffdcc4f:

    # Willow "Yes, the article about the Chompski shop."
    Willow "Да, статья о магазине Чомпски."

# game/logic/events/gordon.rpy:367
translate russian Willow_1_label_42b3216c:

    # Willow "We agreed to release it year two months ago and only now are they actually going to do it."
    Willow "Мы договорились выпустить его год и два месяца назад, и только сейчас они действительно собираются это сделать."

# game/logic/events/gordon.rpy:369
translate russian Willow_1_label_9bebc323:

    # ch_Name "Congratulations! And what's the problem, then?"
    ch_Name "Поздравляю! А в чем тогда проблема?"

# game/logic/events/gordon.rpy:370
translate russian Willow_1_label_20e855b6:

    # Willow "They want to put my photo there but all the pictures that were taken... they're just.... horrible!"
    Willow "Они хотят поместить туда мою фотографию, но все фотографии, которые были сделаны... они просто... ужасны!"
...
translate russian Willow_1_label_2adf9ac6:
    ...
    Willow "Я даже не могу представить, чтобы все их видели! Включая тебя!"

# game/logic/events/gordon.rpy:372
translate russian Willow_1_label_c6e4230d:

    # ch_Name "That sucks!"
    ch_Name "Это отстой!"

# game/logic/events/gordon.rpy:374
translate russian Willow_1_label_5c2bd0d2:

    # ch_Name "Have you tried talking to them?"
    ch_Name "Ты пробовала с ними разговаривать?"
...
translate russian Willow_1_label_ea72e2df:
    ...
    ch_Name "Они не должны игнорировать ваши опасения."
...
translate russian Willow_1_label_9fa17cfd:
...
translate russian Willow_1_label_e4546994:
    ...
    ch_Name "Ты хочешь показать мне свое самое серьезное лицо?"
...
translate russian Willow_1_label_e805d352:

    # ch_Name "Relax, okay?"
    ch_Name "Расслабься, хорошо?"

# game/logic/events/gordon.rpy:416
translate russian Willow_1_label_16d75ee2:

    # ch_Name "All that you need is to lift your head up and smile."
    ch_Name "Все, что тебе нужно, это поднять голову и улыбнуться."

# game/logic/events/gordon.rpy:419
translate russian Willow_1_label_947fb588:

    # ch_Name "That's it!" with flash
    ch_Name "Вот оно!" with flash

# game/logic/events/gordon.rpy:420
translate russian Willow_1_label_20793774:

    # ch_Name "Just what we need."
    ch_Name "Как раз то, что нам нужно."
...
translate russian Willow_1_label_c7db5563:

    # ch_Name "Move for me." with flash
    ch_Name "Встань в позу." with flash
...
translate russian Willow_1_label_181a9c2b:
...
translate russian Willow_1_label_c0415cbd:

    # Willow "Do you like it?"
    Willow "Тебе понравилось?"

# game/logic/events/gordon.rpy:433
translate russian Willow_1_label_8ef5e8d0:

    # ch_Name "Absolutely yes!"
    ch_Name "Абсолютно да!"
...
translate russian Willow_1_label_058f55a4:

    # ch_Name "I'm sure these photos will be amazing."
    ch_Name "Я уверен, что эти фотографии будут потрясающими."

# game/logic/events/gordon.rpy:438
translate russian Willow_1_label_8ef3c4c1:

    # ch_Name "Look!"
    ch_Name "Смотри!"

# game/logic/events/gordon.rpy:440
translate russian Willow_1_label_0aa342e9:

    # Willow "Oh, God!"
    Willow "О, Боже!"

# game/logic/events/gordon.rpy:441
translate russian Willow_1_label_4d010d49:

    # Willow "Who is this pretty girl?"
    Willow "Кто эта красивая девушка?"

# game/logic/events/gordon.rpy:442
translate russian Willow_1_label_06bf94f1:
...
translate russian Willow_1_label_61e8d581:
    ...
    ch_Name "Конечно, я не могу жить без него."
...
translate russian Willow_1_label_ebd1adf6:
    ...
    Willow "Тогда ты должен как-нибудь пригласить меня на свидание в кафе Ачи."
...
translate russian Willow_1_label_836b6011:
    ...
    ch_Name "Хм, спасибо за подсказку. Я загляну туда."
...
translate russian Willow_1_label_86804f32:
    ...
    ch_Name "{i}(Хммм... Пока Уиллоу не сказала это, я и не осознавал, как сильно хочу кофе.){/i}"

# game/logic/events/gordon.rpy:475
translate russian Willow_1_label_0865ced5:

    # ch_Name "{i}(But now it's all I can think about.){/i}"
    ch_Name "{i}(Но сейчас я могу думать только об этом.){/i}"
...
translate russian Willow_1_label_a82a2cd0:
    ...
    ch_Name "{i}(Нужно посмотреть место, где она просила о свидании.){/i}"
...
translate russian Willow_1_label_b3e07cfc:
    ...
    ch_Name "{i}(Кофейня? Должно быть, она говорила об этом.){/i}"
...
translate russian strings:
    ...
    old "1 Go Fishing"
    new "1 Пойти на рыбалку"

    # game/logic/events/gordon.rpy:12
    old "4 Ask for Willow"
    new "4 Спросить о Уиллоу"
...
# game/logic/events/gordon.rpy:380
translate russian Willow_1_label_abb32ea5:
...
translate russian Willow_1_label_b04f62ab:
...
# game/logic/events/gordon.rpy:414
translate russian Willow_1_label_b99bbf43:
