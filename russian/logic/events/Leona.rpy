...
translate russian Leona_1_label_b222bc8d:
    ...
    Leona "Мой избранный, услышь меня!"
...
translate russian Leona_1_label_85166d94:
    ...
    ch_Name "Но я всё-таки не понимаю, как такое возможно..."
...
translate russian Leona_1_label_f46cc524:
    ...
    Leona "Я же сказала, ты мой избранный."
...
translate russian Leona_1_label_c9680544:
    ...
    Leona "Но после сотен лет взаперти в книге - это уже немало!"
...
translate russian Leona_1_label_80093038:
    ...
    Leona "Моя душа наблюдает за всеми его членами."
...
translate russian Leona_1_label_6300fa5e:
    ...
    ch_Name "Ну да, кажется, я что-то такое припоминаю..."
...
translate russian Leona_1_label_62df5367:
    ...
    Leona "Так, ладно, хватит болтовни!"
...
translate russian Leona_1_label_1b960987:
    ...
    Leona "{b}Я явилась, чтобы помочь тебе открыть источник твоей магической силы!{/b}"
...
translate russian Leona_1_label_679f7e2c:
    ...
    ch_Name "Разве я не сам должен познать источник своей силы?"
...
translate russian Leona_1_label_928900a5:
    ...
    Leona "Обычно у учеников нет сложностей с нахождением источника."
...
translate russian Leona_1_label_367c9894:
    ...
    Leona "Я впервые вижу перед собой волшебника с таким огромным потенциалом."

# game/logic/events/Leona.rpy:161
translate russian Leona_1_label_d6a1c6ff:

    # Leona "And such a deafness to elemental magic!"
    Leona "И при этом такого слабого в магии стихий!"
...
translate russian Leona_1_label_f0936d8d:
    ...
    Leona "В итоге ты всё равно овладеешь магией стихий."
...
translate russian Leona_1_label_486751cd:
    ...
    Leona "Но для пробуждения твоего потенциала я поделюсь своим источником."
...
translate russian Leona_1_label_ae878fbc:
    ...
    Leona "Дело в том, что классический ритуал подразумевает пробуждение души..."
...
translate russian Leona_1_label_9449f5fa:
    ...
    Leona "Чтобы я смогла передать тебе свою силу..."
...
translate russian Leona_1_label_7ea92572:
    ...
    Leona "Я не могу тебя ни к чему принуждать..."
...
translate russian Leona_1_label_3ab11bc3:
    ...
    ch_Name "Кажется, тут нет реального выбора."
...
translate russian Leona_1_label_c00fb9ff:
    ...
    ch_Name "Сочту за честь доставить тебе наслаждение."
...
translate russian Leona_1_label_f273e657:
    ...
    Leona "Надеюсь, твоя страсть будет достойна Леонхарта..."

# game/logic/events/Leona.rpy:250
translate russian Leona_1_label_6ad1b451:

    # ch_Name "Try me!"
    ch_Name "А ты проверь!"
...
translate russian Leona_1_label_bef6f25e:
    ...
    ch_Name "{i}(Чёрт, она ооочень хороша...){/i}"
...
translate russian Leona_1_label_2428453a:
    ...
    ch_Name "{i}(Ничего подобного не испытывал в жизни...){/i}"
...
translate russian Leona_1_label_db09fce4:
    ...
    ch_Name "{i}(Не знаю, что это за волшебство, но её киска такая узкая...){/i}"

# game/logic/events/Leona.rpy:304
translate russian Leona_1_label_51afcce6:

    # ch_Name "{i}(It's like fucking a teenager...){/i}"
    ch_Name "{i}(Как будто я трахаю совсем молодую девушку...){/i}"
...
translate russian Leona_1_label_45b2eaff:
    ...
    Leona "Мне нравится, когда ты командуешь."
...
translate russian Leona_1_label_86e2ebeb:

    # ch_Name "You like being in charge?"
    ch_Name "Нравится?"

# game/logic/events/Leona.rpy:331
translate russian Leona_1_label_25e64be5:
...
translate russian Leona_1_label_a68118d5:
    ...
    ch_Name "{i}(Её энергия передаётся мне через член...){/i}"
...
translate russian Leona_1_label_24022bb4:
    ...
    ch_Name "{i}(Я чувствую это с каждым движением...){/i}"
...
translate russian Leona_1_label_79af1719:
    ...
    ch_Name "{i}(Теперь я тебе покажу, на что способен!){/i}"
...
translate russian Leona_1_label_91d3f9e4:
    ...
    ch_Name "{i}(Невероятно... С каждым разом...){/i}"
...
translate russian Leona_1_label_db9a9c7c:
    ...
    ch_Name "{i}(Чистейшая энергия, нетронутая стихиями...){/i}"
...
translate russian Leona_1_44_label_b159fa86:
    ...
    ch_Name "{i}(С каких пор я так ослаб?){/i}"
...
translate russian Leona_1_44_label_0a4e5814:
    ...
    ch_Name "{i}(Главное, что дело сделано.){/i}"
...
translate russian Leona_1_44_label_9fa92c5b:
    ...
    ch_Name "{i}(Всё ещё до конца не понял, на самом ли деле это произошло. Леона была здесь?){/i}"
...
translate russian Leona_1_44_label_ac2cdabf:
    ...
    ch_Name "{i}(Надо спуститься вниз и поболтать с кем-нибудь.){/i}"
...
translate russian Leona_1_44_label_d6dd2e49:
    ...
    ch_Name "{i}(Просто чтобы понять, что во мне изменилось.){/i}"
...
translate russian Leona_2_label_b37ded33:
    ...
    ch_Name "{i}(Вау, я так увлёкся, что потерял счёт времени. Ну, может, так даже и лучше.){/i}"
...
translate russian Leona_2_label_1771d833:
    ...
    ch_Name "{i}(Не хотел бы я снова пережить тот кошмар, который вызвала Катрина.){/i}"
...
translate russian Leona_2_label_58f58419:
    ...
    ch_Name "{i}(Виктория говорила, что в книге заточена частица души каждой из основательниц.){/i}"
...
translate russian Leona_2_label_0f37cca1:
    ...
    ch_Name "{i}(А Леона говорила, что у нас с ней есть связь.){/i}"
...
translate russian Leona_2_label_c0004073:
    ...
    ch_Name "{i}(Главное, чтобы Катрина не услышала его первой.){/i}"
...
translate russian Leona_2_label_ba563614:
    ...
    ch_Name "{i}(И ничего. Блин. Выгляжу как дурак, наверняка.){/i}"
...
translate russian Leona_2_label_87a57c8a:
    ...
    ch_Name "{i}(Точно, надо поискать страницу, на которой изображён её символ...){/i}"
...
translate russian Leona_2_label_a5baaf4c:
    ...
    Leona "В чём дело, разве ты не рад меня лицезреть? Ты же сам меня вызвал."
...
translate russian Leona_2_label_e5c95c28:
    ...
    Leona "Раньше ты на мой внешний вид не жаловался."
...
translate russian Leona_2_label_f47da454:
    ...
    ch_Name "Я бы предпочёл, чтобы ты сейчас была одета."
...
translate russian Leona_2_label_1b4614e5:
    ...
    ch_Name "Может быть, дело в том, что никто обычно не выходит на люди голым?"
...
translate russian Leona_2_label_9cf7d6cb:
    ...
    Leona "Я много столетий не одевалась, дай мне немного личного простанства."

# game/logic/events/Leona.rpy:532
translate russian Leona_2_label_f2834f77:

    # Leona "And don't peek, I'll know!"
    Leona "И не подглядывай, я точно узнаю!"
...
translate russian Leona_2_label_94f674ad:
    ...
    ch_Name "{i}(Иногда по разговору с Леоной и не скажешь, что она мудрая старая ведьма.){/i}" with vpunch
...
translate russian Leona_2_label_c99008fc:
    ...
    ch_Name "{i}(Видимо, сотни лет в мире духов повлияли на её мозги.){/i}"
...
translate russian Leona_2_label_342c66c7:
    ...
    Leona "{i}(Твоё сомнение в моих способностях оскорбительно.){/i}" with vpunch
...
translate russian Leona_2_label_9d137652:
    ...
    ch_Name "{i}(Уже можно повернуться?){/i}"
...
translate russian Leona_2_label_7eee9630:
    ...
    ch_Name "Воу... Ты следила за модными трендами все эти годы?"
...
translate russian Leona_2_label_c50e9fd4:
    ...
    Leona "В конце концов, я всемогущая волшебница, неужели я одежду не смогу выбрать?"
...
translate russian Leona_2_label_a0513010:
    ...
    ch_Name "Катрина истязает меня во снах. Я не знаю, как ещё это описать..."
...
translate russian Leona_2_label_ba8b41ed:
    ...
    Leona "Ты вызвал меня, чтобы пожаловаться на дурные сны?"
...
translate russian Leona_2_label_530906d6:
    ...
    ch_Name "Потом она попробовала залезть ко мне в голову и стереть всё знание о мире магии!"
...
translate russian Leona_2_label_8aebed90:
    ...
    Leona "Нет. Но я не думаю, что Катрина сделала бы что-то в таком духе."
...
translate russian Leona_2_label_2cd19636:
    ...
    Leona "Она сука, конечно, но я всё же знаю её уже не одну сотню лет..."
...
translate russian Leona_2_label_f86fe97b:
    ...
    Leona "Говоришь, что она является во снах и создаёт тебе кошмары?"
...
translate russian Leona_2_label_649407fd:
    ...
    Leona "Есть в мире магии более гуманные методы."
...
translate russian Leona_2_label_70a4491b:
    ...
    Leona "Нужен флакон, очищенный ритуалом Аластара в осеннее равноденствие."
...
translate russian Leona_2_label_d1d23977:
    ...
    ch_Name "Ты же одна из четырёх матерей-основательниц Кордейла!"
...
translate russian Leona_2_label_9563a299:
    ...
    ch_Name "Ты изображена на половине портретов и фресок в академии!"
...
translate russian Leona_2_label_a83aec0b:
    ...
    ch_Name "{i}(Кажется, что абсолютно все только и смотрят на неё.){/i}"
...
translate russian Leona_2_label_117d7a74:
    ...
    ch_Name "{i}(Они узнают её или они просто смотрят на её одежду?){/i}"
...
translate russian Leona_2_label_476d72f7:
    ...
    ch_Name "{i}(Надо было, наверное, одеться менее приметно.){/i}"
...
translate russian Leona_2_label_bbfada0f:
    ...
    Joshi "Не знаю, кажется, да. Лицо какое-то знакомое."
...
translate russian Leona_2_label_289b5b87:
    ...
    Joshi "Ну блин, не могу же я помнить в лицо всех девушек, правда?"
...
translate russian Leona_2_label_c93df85b:
    ...
    Leona "Это только на вид кажется. Он обладает особыми свойствами."
...
translate russian Leona_2_label_01303876:
    ...
    Leona "Стой смирно и не забивай голову мыслями. И не разговаривай."
...
translate russian Leona_2_label_1c6f5072:
    ...
    Leona "Теперь я достану у тебя воспоминания о твоих кошмарах..."
...
translate russian Leona_2_label_a93cf850:
    ...
    Leona "И аккуратно помещаю их в сосуд."
...
translate russian Leona_2_label_be533811:
    ...
    Leona "Мне нужно время, чтобы их изучить."
...
translate russian Leona_2_label_b15cab75:
    ...
    Leona "Прикоснуться к символу льва достаточно. Не надо ничего напевать."
...
translate russian Leona_2_label_87cee974:
    ...
    ch_Name "{i}(Вау, не ожидал, что встреча с Леоной настолько сильно меня вымотает.){/i}"
...
translate russian Leona_2_label_2e27b874:
    ...
    ch_Name "{i}(Но, видимо, сегодня я лягу спать пораньше.){/i}"
...
translate russian Leona_3_label_48851a91:
    ...
    ch_Name "{i}(Чувствую себя так, словно разгрузил целый грузовик кирпича.){/i}"
...
translate russian Leona_3_label_1fcf6703:
    ...
    Leona "Лишь благодаря тебе я смогла воссоединиться с миром живых."
...
translate russian Leona_3_label_b5f0ba37:
    ...
    Leona "Но для начала я должна избавиться от этих жутких ночных кошмаров."

# game/logic/events/Leona.rpy:715
translate russian Leona_3_label_cffe44f7:

    # Leona "Wake up, my beloved!"
    Leona "Просыпайся, мой любимый!"
...
translate russian Leona_3_label_1706d20f:
    ...
    Leona "Как крепко ты спишь! Да тебя даже рёв дракона не разбудил бы!"

# game/logic/events/Leona.rpy:723
translate russian Leona_3_label_a7d6498c:

    # Leona "Wake up, sleepyhead. We really have to go!"
    Leona "Соня, просыпайся. Нам действительно надо торопиться!"
...
translate russian Leona_3_label_74047657:
    ...
    Leona "Ты болен?! [Name], да чтоб тебя!"
...
translate russian Leona_3_label_01982cea:
    ...
    Victoria "Вот он и даст ответ всему классу..."
...
translate russian Leona_3_label_374887fd:
    ...
    ch_Name "{i}(Я не могу перед всеми отвечать. Пожалуйста, только не я, только не я!){/i}"
...
translate russian Leona_3_label_a8acf4f6:
    ...
    Victoria "Раз уж вы у нас такой гений, скажите, как призвать демона в наш мир?"
...
translate russian Leona_3_label_721bd66d:
    ...
    Victoria "И что мне теперь с вами делать, мистер [Name]?"
...
translate russian Leona_3_label_fc9f45c7:
    ...
    Victoria "Как вы смеете срывать мне урок?"
...
translate russian Leona_3_label_ef5e4a04:
    ...
    Victoria "А мне, вы думаете, не больно?!"
...
translate russian Leona_3_label_5d300c33:
    ...
    Victoria "Наблюдать неудачника, который даже на самый простой вопрос ответить не может?"

# game/logic/events/Leona.rpy:808
translate russian Leona_3_label_b9c01e71:

    # Victoria "Do you have any idea where you are?"
    Victoria "Вы вообще понимаете, где находитесь?"
...
translate russian Leona_3_label_401527a3:
    ...
    ch_Name "{i}(Он ещё раз собирается запулить в меня чем-то?!){/i}"
...
translate russian Leona_3_label_L_101_b06f7bfb:
    ...
    Haley "Предупреждаю, вставай, пока есть возможность!"
...
translate russian Leona_3_label_L_101_ca1a0331:
    ...
    Haley "Что-то не так... Не просыпается."
...
translate russian Leona_3_label_L_116_75d5970e:
    ...
    Lily "А потом пойдём на занятие к Виктории, чтобы зарабатывать баллы для факультета."
...
translate russian Leona_3_label_L_116_2f778c4b:
    ...
    Lily "Или мы можем вернуться в общежитие и... Ну, ты понял."
...
translate russian Leona_3_label_L_116_d07b4056:
    ...
    Lily "Или ты беззаботно спал всё это время?"
...
translate russian Leona_3_label_L_116_3d1bbcc9:
    ...
    Lily "Что-то не так... Не просыпается."
...
translate russian Leona_3_label_L_132_10ee4e68:
    ...
    Samantha "Ленивые первокурсники... Мы вот не дрыхли подолгу вместо уроков!"
...
translate russian Leona_3_label_L_132_801740ae:
    ...
    Samantha "Ладно, лежи, не вставай. Я просто зашла за жвачкой."
...
translate russian Leona_3_label_L_132_0ac5c135:
    ...
    Samantha "Да, да, это формально твоя жвачка, но знай, что я её позаимствовала, так сказать."
...
translate russian Leona_3_label_L_132_96da79f7:
    ...
    Samantha "Неужели так сложно подумать и обо мне, когда ты идёшь в магазин?"
...
translate russian Leona_3_label_L_132_47adc65f:
    ...
    Samantha "Дыхание ровное... Пульс ровный."
...
translate russian Leona_3_label_L_132_598696b7:
    ...
    Samantha "Но кроме этого, никаких признаков жизни... Словно душа покинула тело."
...
translate russian Leona_3_label_L_132_767745bd:
    ...
    Samantha "Ну всё, хватит дурачиться!"
...
translate russian Leona_3_label_L_150_cbf09638:
    ...
    Elijah "Что ж, разбудить тебя - моя обязанность в роли старосты..."
...
translate russian Leona_3_label_L_162_8eca7960:
    ...
    ch_Name "{i}(Хмм, оказалось довольно неплохо...){/i}"
...
translate russian Leona_3_label_L_162_e8e91a2b:
    ...
    Sabrina "Это самая бездарная работа, которую я видела за всю свою карьеру!"
...
translate russian Leona_3_label_L_162_ee21cdf3:
    ...
    Sabrina "Хотите знать, что не так с вашим зельем? САМИ ЕГО ПОПРОБУЙТЕ!" with vpunch
...
translate russian Leona_3_label_L_162_82a1d9a3:
    ...
    ch_Name "{i}(Кожа горит, словно её ошпаривает кипяток! Какая невыносимая боль!){/i}"
...
translate russian Leona_3_label_L_162_a560e90b:
    ...
    Lily "Мы чем-то можем ему помочь?"
...
translate russian Leona_3_label_L_162_f3cb1ba0:
    ...
    Elijah "Ну пульс у него присутствует. Дышит он равномерно."
...
translate russian Leona_4_label_622fe711:
    ...
    Samantha "Весь день вот так лежишь. Элайджа боится обращаться к Артуру."
...
translate russian Leona_4_label_8b2d7ede:
    ...
    Samantha "Я знаю, что ты там, и ты не сдашься. Что бы тебя там не удерживало."
...
translate russian Leona_4_label_efd3e064:
    ...
    Samantha "Сражайся! Слышишь! И мы будем за тебя сражаться!"
...
translate russian Leona_4_label_f5c21812:
    ...
    Leona "Кое-кто хлопотал возле тебя весь день."
...
translate russian Leona_4_label_8afc51e2:
    ...
    Jacob "Вы думаете, что ваш несчастный вид вызовет у кого-то жалость, мистер [Surname]?"

# game/logic/events/Leona.rpy:1097
translate russian Leona_4_label_1ef235b6:

    # Jacob "Are you a wizard or a wimp?"
    Jacob "Вы волшебник или нытик?"
...
translate russian Leona_4_label_d706de5e:
    ...
    Jacob "Катрина преподаст вам урок!"
...
translate russian Leona_4_label_dbf6ddbc:
    ...
    ch_Name "{i}(Чёрт... Палки и камни это одно дело...){/i}"
...
translate russian Leona_4_label_7d3d922f:
    ...
    ch_Name "{i}(Я знаю, что это сон, но ощущается, как будто всё реально...){/i}"
...
translate russian Leona_4_label_faf94b43:
    ...
    Katrina "Ты слишком долго отгораживался от меня и прятался в дебрях своего разума."
...
translate russian Leona_4_label_f14161c6:
    ...
    Katrina "Идиот, это тебе не поможет. Ничто тебя не убережёт."
...
translate russian Leona_4_label_8081f414:
    ...
    ch_Name "{i}(Она столько болтает, боже, в чём смысл-то?){/i}"
...
translate russian Leona_4_label_ebe10b2f:
    ...
    ch_Name "{i}(Нет сил уже её слушать. Я бы даже предпочёл смерть...){/i}"
...
translate russian Leona_4_label_4d1fd1ff:
    ...
    Jacob "Он абсолютно сломлен! Чего ты ждёшь?"
...
translate russian Leona_4_label_6d8d67c9:
    ...
    Jacob "Прикончи его! Выполни свою часть сделки!"
...
translate russian Leona_4_label_141ecea6:
    ...
    ch_Name "Больше не могу это выносить."
...
translate russian Leona_4_label_fa7d7a29:
    ...
    Leona "Не смей забывать про честь Леонхарта, [Name]!"
...
translate russian Leona_4_label_112d5f98:
    ...
    ch_Name "Но что ты здесь делаешь, это же..."
...
translate russian Leona_4_label_5fc86c99:
    ...
    Leona "Кто-то вмешался в процедуру распределения!"
...
translate russian Leona_4_label_33ffda31:
    ...
    Leona "Тебя подставили. В тебя вселили фантом, который способен украсть твою душу."
...
translate russian Leona_4_label_d926f369:
    ...
    Leona "Он почувстсовал горечь и злость Катрины, когда ты её отверг."
...
translate russian Leona_4_label_8e70c7fb:
    ...
    Leona "И принял её форму, чтобы пытать тебя и ослабить твой дух."
...
translate russian Leona_4_label_aa14b3a9:
    ...
    ch_Name "Что за ерунду про фантомы ты несёшь?"
...
translate russian Leona_4_label_98f52d31:
    ...
    ch_Name "Я тебя подвёл. Выходит, я недостоин Леонхарта?"
...
translate russian Leona_4_label_21d15c2a:
    ...
    Leona "Я это почувствовала при первой же встрече и никогда этого не забуду."
...
translate russian Leona_4_label_f29e0b35:
    ...
    Leona "Твоя сила вдохнула в меня жизнь и вернула меня в этот мир."
...
translate russian Leona_4_label_78f1612f:
    ...
    ch_Name "Но если это всё правда, почему мне до сих пор ничего не удалось?"
...
translate russian Leona_4_label_9da5ca6d:
    ...
    ch_Name "Думаешь, я не пытался отсюда выбраться?"
...
translate russian Leona_4_label_3f9d1e81:
    ...
    Leona "Загляни в своё сердце и найди в нём силу."
...
translate russian Leona_4_label_931d2fe5:
    ...
    Leona "Это твой мир, и правила в нём задаёшь ты сам!"
...
translate russian Leona_4_label_a180a79c:
    ...
    Leona "Всё, что ты должен сделать, это закрыть глаза и представить!"
...
translate russian Leona_4_label_c5349e90:
    ...
    ch_Name "{i}(Всё, что я должен сделать, это закрыть глаза и представить...){/i}"
...
translate russian Leona_4_label_bedc6ff7:
    ...
    ch_Name "{i}(Она права! Так гораздо лучше!){/i}" with vpunch
...
translate russian Leona_4_label_90e80339:
    ...
    ch_Name "{i}(Как будто ничего не поменялось и в то же самое время поменялось вообще всё.){/i}"
...
translate russian Leona_4_label_3a8d8c37:
    ...
    ch_Name "Сработало! Поверить не могу..."
...
translate russian Leona_4_label_6148847b:
    ...
    ch_Name "{i}(Какое необычное создание...){/i}"
...
translate russian Leona_4_label_c7aaef0e:
    ...
    ch_Name "{i}(Даже после смерти оно сохраняет свою форму.){/i}"
...
translate russian Leona_4_label_1e5a3779:
    ...
    ch_Name "Ну да, на вид просто скукожилось."
...
translate russian Leona_4_label_90abc6ed:
    ...
    ch_Name "{i}(Хотя если на голову надеть мешок, то тело-то довольно симпатичное...){/i}"

# game/logic/events/Leona.rpy:1231
translate russian Leona_4_label_3c439efd:

    # ch_Name "{i}(I wonder what it feels like?){/i}"
    ch_Name "{i}(Интересно, а как наощупь?){/i}"
...
translate russian Leona_4_label_c4a770ac:
    ...
    ch_Name "{i}(Надеюсь, моё подсознание сотрёт эти воспоминания...){/i}"
...
translate russian Leona_4_label_983bb796:
    ...
    ch_Name "{i}(Но любопытство во мне сейчас сильнее, чем самоконтроль.){/i}"

# game/logic/events/Leona.rpy:1239
translate russian Leona_4_label_1e63d835:

    # ch_Name "{i}(Hmm, why...){/i}"
    ch_Name "{i}(Хмм, почему...){/i}"
...
translate russian Leona_4_label_61e7df0e:
    ...
    ch_Name "{i}(Ощущается намного приятнее, чем я ожидал.){/i}"
...
translate russian Leona_4_label_6ee437d2:
    ...
    ch_Name "{i}(Может там и ниже пояса что-то есть, например, зубастая вагина?){/i}"
...
translate russian Leona_4_label_8e54a60a:
    ...
    ch_Name "{i}(Оо... Я не ожидал, что там будет ещё тепло...){/i}"
...
translate russian Leona_4_label_ea4cf1e8:
    ...
    Leona "Я подозревала, что фантом будет выглядеть именно так."

# game/logic/events/Leona.rpy:1257
translate russian Leona_4_label_84d3dc7e:

    # ch_Name "Thank you!"
    ch_Name "Спасибо тебе!"
...
translate russian Leona_4_label_f2b3c1f0:
    ...
    ch_Name "Если бы не ты, я бы не сумел победить..."
...
translate russian Leona_4_label_bae7f363:
    ...
    Leona "Ты отлично справился, [Name]."
...
translate russian Leona_4_label_f830d760:
    ...
    Leona "В таком юном возрасте выдержать 24 часа в цепких лапах этой твари..."

# game/logic/events/Leona.rpy:1265
translate russian Leona_4_label_c2501d80:

    # Leona "You really are an outstanding mage, [Name]."
    Leona "Ты по-настоящему выдающийся маг, [Name]."

# game/logic/events/Leona.rpy:1267
translate russian Leona_4_label_3b2d4a2b:

    # Leona "I think it's time for you to wake up. I need to go now. Summon me on tuesday."
    Leona "Я думаю, что пора тебе уже проснуться. А мне нужно уйти. Вызови меня во вторник."

# game/logic/events/Leona.rpy:1268
translate russian Leona_4_label_f450df55:

    # Leona "Until then I'll try to find out who's behind all of this."
    Leona "К тому времени я постараюсь узнать, кто за всем этим стоит."

# game/logic/events/Leona.rpy:1270
translate russian Leona_4_label_0140d2b7:

    # ch_Name "Wait a minute! Are you leaving already? I have so many questions for you..."
    ch_Name "Погоди минутку! Ты уже уходишь? У меня к тебе столько вопросов..."

# game/logic/events/Leona.rpy:1271
translate russian Leona_4_label_3e2672f1:

    # Leona "Alas, I have to go. I'll answer them next time we'll meet."
    Leona "Увы, мне нужно уйти. Я отвечу на них при нашей следующей встрече."
...
translate russian Leona_4_label_2a408707:
    ...
    ch_Name "{i}(Чёрт... Только что была тут...){/i}"
...
translate russian Leona_4_label_1f649495:
    ...
    ch_Name "{i}(Почему я вообще во всё это замешан, я же простой первокурсник...){/i}"

# game/logic/events/Leona.rpy:1288
translate russian Leona_4_label_e3a3c313:

    # ch_Name "{i}(So many questions and no answers...){/i}"
    ch_Name "{i}(Столько вопросов и ни одного ответа...){/i}"
...
translate russian Leona_4_label_eac85244:
    ...
    ch_Name "{i}(Кажется, за окном уже вечер...){/i}"
...
translate russian Leona_4_label_2d9d12ad:
    ...
    ch_Name "{i}(Как долго я был заложником своих снов?){/i}"
...
translate russian Leona_4_label_0af7e781:
    ...
    ch_Name "Спасибо за такую заботу, Сэм. Серьёзно. Мне очень приятно."
...
translate russian Leona_4_label_c35ee781:
    ...
    ch_Name "Но я даже не знаю, что тебе сказать. Видимо, я очень сильно переутомился."
...
translate russian Leona_4_label_881b31bb:
    ...
    ch_Name "И мне надо было выспаться. На самом деле, я бы сейчас и ещё поспал..."
...
translate russian Leona_4_label_7dfa589c:
    ...
    Samantha "Директор послал за медсестрой. И никто понять не мог, что с тобой не так..."
...
translate russian Leona_4_label_0fcee427:
    ...
    ch_Name "Я же сказал, я просто утомился... Можем мы завтра об этом поговорить?"
...
translate russian Leona_4_label_82c9f95c:
    ...
    Samantha "Но пообещай, что завтра утром ты всё же проснёшься."
...
translate russian Leona_4_label_2a593b7f:
    ...
    ch_Name "{i}(Мне больно лгать Саманте про случившееся.){/i}"
...
translate russian Leona_4_label_6d210c0a:
    ...
    ch_Name "{i}(Но пока я сам во всём не разберусь, я не стану подвергать её опасности.){/i}"
...
translate russian Leona_5_label_78ea733d:
    ...
    ch_Name "{i}(Как же хорошо начинать новый день, будучи полным энергии.){/i}"
...
translate russian Leona_5_label_3a9f300c:
    ...
    ch_Name "{i}(После того, как Леона и я прекратили кошмары, я сплю как младенец.){/i}"
...
translate russian Leona_5_label_6a223d78:
    ...
    ch_Name "{i}(Может, Хейли хотела о чём-то со мной побеседовать?){/i}"
...
translate russian Leona_5_label_26a178c7:
    ...
    ch_Name "{i}(Странно, нет ответа.){/i}"
...
translate russian Leona_5_label_c31d095f:
    ...
    ch_Name "{i}(Может, дверь перепутали, либо это шутка такая...){/i}"
...
translate russian Leona_5_label_d322b032:
    ...
    ch_Name "{i}(Даже шума никакого за дверью не слышно. Странно.){/i}"
...
translate russian Leona_5_label_15e42143:
    ...
    ch_Name "{i}(Вдруг это признание в любви от какой-нибудь робкой девочки.){/i}"
...
translate russian Leona_5_label_bbcd5ffd:
    ...
    Note "Мистер [Name]. Меня впечатляет ваш прогресс."
...
translate russian Leona_5_label_d81acbcc:
    ...
    Note "Сожалею, что пришлось вас такому подвергнуть в целях проверки."
...
translate russian Leona_5_label_a271b278:
    ...
    Note "Впрочем, честно говоря, у нас нет времени ждать, пока вы достигнете потенциала."
...
translate russian Leona_5_label_ad74b0c3:
    ...
    Note "Поэтому мне пришлось \"помочь\" вам в этом. Уверен, у вас масса вопросов. Если вы хотите ответы..."
...
translate russian Leona_5_label_abc0f7d1:
    ...
    Note "Жду вас в час ночи в холле Кордейла. Встаньте возле Солнца."
...
translate russian Leona_5_label_8a935a91:
    ...
    ch_Name "{i}(Ничего не понимаю... Что это за ерунда?){/i}"
...
translate russian Leona_5_label_0f7ede62:
    ...
    ch_Name "{i}(Как может кто-либо здесь что-то знать о моих родителях?){/i}"
...
translate russian Leona_5_label_0f562923:
    ...
    ch_Name "{i}(И почему на меня наслали этого фантома?){/i}"
...
translate russian Leona_5_label_2659e332:
    ...
    Haley "Я очень рада, что ты пригласил меня на прогулку в саду."
...
translate russian Leona_5_label_09ab0e8f:
    ...
    ch_Name "Уснуть? Опять всю ночь читала?"
...
translate russian Leona_5_label_a29a2309:
    ...
    Haley "Не могла остановиться, история академии в Кордобе так увлекательна..."
...
translate russian Leona_5_label_c30957bd:
    ...
    ch_Name "{i}(Её ноги такие мягкие и приятные наощупь...){/i}"
...
translate russian Leona_5_label_869f0b2c:
    ...
    ch_Name "{i}(Сложно на чём-то другом сконцентрироваться.){/i}"
...
translate russian Leona_5_label_c554e971:
    ...
    Haley "Я читала про то место, где основательницы Кордейла обучались сами."

# game/logic/events/Leona.rpy:1401
translate russian Leona_5_label_8015e265:

    # ch_Name "Oh, uh... That's it."
    ch_Name "Оу, вот в чём дело."
...
translate russian Leona_5_label_116e8434:
    ...
    ch_Name "Хах. Ты слишком хорошо меня знаешь."
...
translate russian Leona_5_label_c5c76527:
    ...
    ch_Name "Но на самом деле мне было бы интересно про это послушать."
...
translate russian Leona_5_label_4e86adea:
    ...
    ch_Name "Это точно гораздо интереснее, чем если бы мне пришлось читать..."
...
translate russian Leona_5_label_381b1961:
    ...
    Haley "Да брось, [Name]. Не может быть, чтобы ты пригласил меня сюда ради лекции по истории."
...
translate russian Leona_5_label_016f108a:
    ...
    ch_Name "В общем, есть объяснение. Это был не просто сон."
...
translate russian Leona_5_label_8f2952c2:
    ...
    ch_Name "Кто-то наслал на меня фантом, ворующий душу. Он преследует людей во снах."
...
translate russian Leona_5_label_88cedd08:
    ...
    Haley "Ворующий душу фантом? Ты уверен?! Я, кажется, читала про них."
...
translate russian Leona_5_label_0318f19b:
    ...
    ch_Name "Конечно, уверен. Не мог перестать думать про это."
...
translate russian Leona_5_label_0c19842c:
    ...
    ch_Name "А теперь кто-то продолжает меня терзать. Оставили утром записку под дверью."
...
translate russian Leona_5_label_ab4bb0b2:
    ...
    ch_Name "Говорит, испытывает меня для чего-то и хочет встретиться. Один на один."
...
translate russian Leona_5_label_dd28a24d:
    ...
    Haley "Я верю, что с тобой всё будет в порядке. Ты очень талантливый и сильный волшебник."
...
translate russian Leona_5_label_feb537d8:
    ...
    Haley "И ты всегда хорошо ориентируешься в критической ситуации."
...
translate russian Leona_5_label_9c801c43:
    ...
    Haley "Если бы не ты, я не знаю, что бы со мной стало тогда в библиотеке..."
...
translate russian Leona_5_label_23b7136a:
    ...
    ch_Name "{i}(В её объятьях грустить просто невозможно.){/i}"
...
translate russian Leona_5_label_8965ef06:
    ...
    ch_Name "{i}(И после её слов моя уверенность очень сильно возрастает.){/i}"
...
translate russian Leona_5_label_499d9f3e:
    ...
    ch_Name "Ладно, пойдём. И спасибо. Мне это было важно."
...
translate russian Leona_5_label_87c629cf:
    ...
    ch_Name "{i}(Я помню отлично, как ты бегала ко мне в комнату, чтобы сплетничать о бойфрендах Эшли...){/i}"
...
translate russian Leona_5_label_5d4df1f4:
    ...
    Samantha "Или ты соблазнить меня пытаешься? Если так, тот тут маловато свечей..."
...
translate russian Leona_5_label_333403da:
    ...
    ch_Name "У тебя сегодня игривое настроение. Приятно тебя видеть такой."
...
translate russian Leona_5_label_c825c1ef:
    ...
    Samantha "Видел бы ты своё лицо сейчас!"
...
translate russian Leona_5_label_86c8377c:
    ...
    ch_Name "{i}(Давно Сэм не была в таком приподнятом настроении. Жаль, что мне сейчас не до забав.){/i}"
...
translate russian Leona_5_label_e195ab66:
    ...
    ch_Name "Ворующий души фантом чуть было не убил меня. Поэтому я и проспал тогда весь день."
...
translate russian Leona_5_label_eddadb2a:
    ...
    ch_Name "И теперь я узнал, что его на меня наслали нарочно."
...
translate russian Leona_5_label_81b737b9:
    ...
    ch_Name "Какой-то псих оставил мне под дверью записку, рассказав про это."
...
translate russian Leona_5_label_67609b77:
    ...
    ch_Name "Говорит, что проверял меня. И теперь хочет встретиться."
...
translate russian Leona_5_label_54cfa09b:
    ...
    Samantha "Ты уверен, что он не обманывает? Кто это может быть?"
...
translate russian Leona_5_label_217682ad:
    ...
    Samantha "Тогда я поддерживаю тебя. Уверена, ты справишься, что бы тебя там не ожидало..."
...
translate russian Leona_5_label_e63f72ff:
    ...
    ch_Name "{i}(Не ожидал, что она так легко согласится.){/i}"
...
translate russian Leona_5_label_113381a5:
    ...
    Samantha "Всё, достаточно с тебя."
...
translate russian Leona_5_label_c92c0e79:
    ...
    ch_Name "Спасибо. Уже чувствую, как удача начинает прибавляться."
...
translate russian Leona_5_label_3f9a3087:
    ...
    ch_Name "{i}(Саманта не просто так переживает. Мне надо быть готовым и к худшему.){/i}"
...
translate russian Leona_5_label_f90110aa:
    ...
    ch_Name "{i}(Посмотрим, помогут ли мне эти поцелуи.){/i}"
...
translate russian Leona_5_label_from_gallery_fc5f2d65:
    ...
    ch_Name "{i}(Наоми, да что это за чары такие?){/i}"
...
translate russian Leona_5_label_from_gallery_fcc23301:
    ...
    ch_Name "{i}(Стоило лишь попросить тебя уединиться и поболтать...){/i}"
...
translate russian Leona_5_label_from_gallery_4c8a1447:
    ...
    ch_Name "И тут я не успеваю опомниться, как ты тащишь меня на второй этаж и стягиваешь с меня штаны."

# game/logic/events/Leona.rpy:1546
translate russian Leona_5_label_from_gallery_a37bab3e:

    # ch_Name "{i}(That feels so good...){/i}"
    ch_Name "{i}(Это очень приятно...){/i}"
...
translate russian Leona_5_label_from_gallery_4339207c:
    ...
    Naomi "Уверена, никто ещё своим языком не обрабатывал твой член так, как я!"
...
translate russian Leona_5_label_from_gallery_7999d61d:
    ...
    ch_Name "{i}(Интересно, заподозрила ли что-то Амели?){/i}"
...
translate russian Leona_5_label_from_gallery_f7ddbbd2:
    ...
    ch_Name "{i}(Мы без единого слова убежали на второй этаж, и уже прошло какое-то время.){/i}"
...
translate russian Leona_5_label_from_gallery_861ffe01:
    ...
    ch_Name "{i}(Это она так весело машет мне?){/i}"
...
translate russian Leona_5_label_from_gallery_fa6fec9d:
    ...
    ch_Name "{i}(Ну хорошо, мисс. Только не поднимайтесь сюда, не стоит.){/i}"
...
translate russian Leona_5_label_from_gallery_9dad1140:
    ...
    ch_Name "{i}(Улыбаемся и машем, улыбаемся и машем...){/i}"
...
translate russian Leona_5_label_from_gallery_ea9f42f4:
    ...
    ch_Name "{i}(Даа, сложно думать о чём-то постороннем, когда твою головку...){/i}"
...
translate russian Leona_5_label_from_gallery_2937ea49:
    ...
    ch_Name "{i}(...так умело облизывают.){/i}"
...
translate russian Leona_5_label_from_gallery_0ae9bcd0_1:
...
translate russian Leona_5_label_from_gallery_8ce974de:
    ...
    Naomi "{i}(Какой вкусный член у него.){/i}"
...
translate russian Leona_5_label_from_gallery_1e109b8f:
    ...
    ch_Name "Отлично работаешь языком, но я бы хотел поглубже."
...
translate russian Leona_5_label_from_gallery_0ae9bcd0_2:
...
translate russian Leona_5_label_from_gallery_bd2bb1e1:
    ...
    ch_Name "{i}(Её ротик просто создан для моего члена.){/i}"

# game/logic/events/Leona.rpy:1587
translate russian Leona_5_label_from_gallery_0ae9bcd0_3:
...
translate russian Leona_5_label_from_gallery_0ae9bcd0_4:
...
translate russian Leona_5_label_from_gallery_605674e0:
    ...
    ch_Name "Потому я тебя и позвал. Спасибо за совет."
...
translate russian Leona_5_label_from_gallery_49b9a3ec:
    ...
    Naomi "Хах. Я не просто волшебница, мальчик. Я самая лучшая."
...
translate russian Leona_5_label_from_gallery_58d95a42:
    ...
    Naomi "{i}(И я только что получила самую лучшую маску для лица.){/i}"
...
translate russian Leona_5_label_from_gallery_1699bf05:
    ...
    Naomi "{i}(И для кожи полезно, и на вкус прекрасно... Красота!){/i}"
...
translate russian Leona_5_label_from_gallery_5ddfb378:
    ...
    ch_Name "{i}(Я точно не такое подразумевал, когда хотел увидеться с Наоми.){/i}"
...
translate russian Leona_5_label_from_gallery_06779f0b:
    ...
    ch_Name "{i}(Но нельзя не признать - теперь я чувствую себя намного лучше.){/i}"
...
translate russian Leona_5_label_from_gallery_1b2b186d:
    ...
    ch_Name "{i}(Наоми права, я должен выяснить, кто затеял эти игры со мной.){/i}"
...
translate russian Leona_5_label_from_gallery_121995b5:
    ...
    ch_Name "{i}(И по меньшей мере вломить ему за такие идиотские шутки.){/i}"
...
translate russian Leona_5_label_from_gallery_5699ba00:
    ...
    Lily "Нет проблем. По телефону показалось, что ты чем-то обеспокоен."
...
translate russian Leona_5_label_from_gallery_409ea600:
    ...
    # ch_Name "Remember that time I slept all day?"
    ch_Name "Помнишь, как я весь день проспал?"
...
translate russian Leona_5_label_from_gallery_d28fc00e:
    ...
    ch_Name "И неспроста. Это был не просто сон."
...
translate russian Leona_5_label_from_gallery_dea6bb4c:
    ...
    Lily "Ты уверен?! Это невероятно опасные твари."
...
translate russian Leona_5_label_from_gallery_729d9936:
    ...
    ch_Name "Уверен. И теперь этот парень хочет со мной встретиться."
...
translate russian Leona_5_label_from_gallery_24b7f65b:
    ...
    ch_Name "Подсунул мне записку. Говорит, что знал моих родителей..."
...
translate russian Leona_5_label_from_gallery_871c724c:
    ...
    ch_Name "Не знаю, что мне делать. Я точно хочу ответы."
...
translate russian Leona_5_label_from_gallery_ca51da66:
    ...
    ch_Name "Но вся эта загадочность меня пугает..."
...
translate russian Leona_5_label_from_gallery_245f82bf:
    ...
    Lily "Такие фантомы - это отнюдь не шутка."
...
translate russian Leona_5_label_from_gallery_7a6755cc:
    ...
    Lily "Если кто-то способен на такое, тебе точно следует выяснить, кто это."
...
translate russian Leona_5_label_from_gallery_c68fb71d:
    ...
    Lily "Считаю, тебе стоит пойти. Не уверена, что это ловушка."
...
translate russian Leona_5_label_from_gallery_e2ac113e:
    ...
    Lily "Ну да. Зачем бы кто-то стал рисковать, оставляя тебе записку, если бы целью было навредить тебе?"
...
translate russian Leona_5_label_from_gallery_275ec897:
    ...
    Lily "Особенно если этот кто-то умеет насылать фантомов."
...
translate russian Leona_5_label_from_gallery_88a1760a:
    ...
    Lily "Уверена, это просто очень дурная шутка."
...
translate russian Leona_5_label_from_gallery_5926cd74:
    ...
    Lily "Но даже если это и не так, ты справишься. Ты же из Леонхарта."
...
translate russian Leona_5_label_from_gallery_53c5b8f8:
    ...
    ch_Name "Спасибо, Лили. Ты очень помогла мне определиться."
...
translate russian Leona_5_label_from_gallery_7ba39e73:
    ...
    ch_Name "Прости, мне надо идти. Увидимся с тобой позже."
...
translate russian Leona_5_label_from_gallery_f6ce8d02:
    ...
    ch_Name "{i}(Не знаю, следует ли мне рассказывать Элайдже все детали.){/i}"
...
translate russian Leona_5_label_from_gallery_261528a4:
    ...
    ch_Name "{i}(Что если это он всё сделал? Он старше, он мог и научиться насылать фантомов...){/i}"

# game/logic/events/Leona.rpy:1681
translate russian Leona_5_label_from_gallery_8e036bbc:

    # ch_Name "{i}(No, that's nonsense.){/i}"
    ch_Name "{i}(Да нет, быть не может.){/i}"
...
translate russian Leona_5_label_from_gallery_d9cc1bcb:
    ...
    ch_Name "Да. Прости, задумался. Мне нужно посоветоваться."
...
translate russian Leona_5_label_from_gallery_871603bf:
    ...
    ch_Name "Кто-то наслал на меня ворующий души фантом. Вот почему я тогда проспал целый день."
...
translate russian Leona_5_label_from_gallery_e8d1b274:
    ...
    Elijah "О, вот как? Ворующий души фантом?! Братан, это очень опасно."
...
translate russian Leona_5_label_from_gallery_a2d48967:
    ...
    ch_Name "А теперь я получил записку. Со мной хотят встретиться. Сказано, что меня проверяли."
...
translate russian Leona_5_label_from_gallery_bc811c1b:
    ...
    ch_Name "Также этот человек утверждает, что знает что-то о моих настоящих родителях..."
...
translate russian Leona_5_label_from_gallery_04aa3488:
    ...
    Elijah "Звучить очень странно. Довольно мрачно. Ты уверен, что тебе не лгут?"
...
translate russian Leona_5_label_from_gallery_301dff92:
    ...
    ch_Name "Я не знаю. И ещё не знаю, стоит ли идти."
...
translate russian Leona_5_label_from_gallery_f0034d64:
    ...
    Elijah "Я бы пошёл. Вдруг это просто неудачная шутка."
...
translate russian Leona_5_label_from_gallery_7611dece:
    ...
    ch_Name "Надо привести мысли в порядок, прежде чем идти туда."
...
translate russian Leona_5_label_from_gallery_94ac4f7c:
    ...
    Elijah "Может быть, это и шутка, но что если..."
...
translate russian Leona_5_label_from_gallery_9996c226:
    ...
    Elijah "Что если это нечно опасное?"
...
translate russian Leona_5_label_from_gallery_e745ce63:
    ...
    Elijah "Я себе не прощу, если отпущу тебя без поцелуя на удачу."
...
translate russian Leona_5_label_from_gallery_a05442c6:
    ...
    ch_Name "{i}(Что происходит... Это не сон?){/i}"
...
translate russian Leona_5_label_from_gallery_03bfd715:
    ...
    ch_Name "{i}(А Элайджа недурно целуется, надо отдать ему должное.){/i}"
...
translate russian Leona_5_label_from_gallery_47e6d73e:
    ...
    ch_Name "{i}(Я уж не знаю, завидовать ему или радоваться тому, что он меня целует...){/i}"
...
translate russian Leona_5_label_from_gallery_5081907c:
    ...
    Elijah "Пусть это будет твой защитный талисман."
...
translate russian Leona_6_label_a7e909b1:
    ...
    ch_Name "{i}(Соберись уже, [Name]. Бояться нечего.){/i}"
...
translate russian Leona_6_label_6b103257:
    ...
    ch_Name "{i}(Если это розыгрыш, то это, конечно, не смешно, но уже и не особо опасно.){/i}"
...
translate russian Leona_6_label_0a0dcbf8:
    ...
    ch_Name "{i}(А если всё всерьёз, то зачем ему мне снова вредить?){/i}"
...
translate russian Leona_6_label_3ade40f8:
    ...
    ch_Name "{i}(Судя по записке, он словно готовит меня для чего-то.){/i}"
...
translate russian Leona_6_label_b639b283:
    ...
    ch_Name "{i}(Итак, уже час ночи. Ну и где же он?){/i}"
...
translate russian Leona_6_label_2a85864c:
    ...
    ch_Name "И как это понимать? Куда вы меня ведёте?"
...
translate russian Leona_6_label_e1280250:
    ...
    ch_Name "Вот такие будут ответы? Молчаливые?"
...
translate russian Leona_6_label_795b7e3b:
    ...
    ch_Name "{i}(Блин. Мне это не нравится. Но что поделать?){/i}"
...
translate russian Leona_6_label_f4c8add3:
    ...
    ch_Name "{i}(Интересно, куда он меня ведёт? Я выше этого этажа раньше не бывал...){/i}"
...
translate russian Leona_6_label_246046ec:
    ...
    ch_Name "Первокурсникам на этот этаж нельзя, вы же знаете?"
...
translate russian Leona_6_label_357b0046:
    ...
    ch_Name "Если меня здесь обнаружат, у меня будут проблемы."
...
translate russian Leona_6_label_952699c9:
    ...
    ch_Name "{i}(Хмм... Надеюсь, за этой дверью не какая-нибудь пыточная.){/i}"
...
translate russian Leona_6_label_9dcc5a2d:
    ...
    ch_Name "{i}(Вообще было бы странно, если бы в школе была пыточная...){/i}"
...
translate russian Leona_6_label_b9fa011c:
    ...
    ch_Name "{i}(Ммм... Да, для пыточной черезчур уютно.){/i}"
...
translate russian Leona_6_label_8221fb42:
    ...
    ch_Name "{i}(Похоже на чью-то спальню. Одного из преподавателей?){/i}"
...
translate russian Leona_6_label_342847cb:
    ...
    UnknownJacob "Терпение. Вы скоро получите ответы на ваши вопросы."
...
translate russian Leona_6_label_a64965c7:
    ...
    ch_Name "{i}(Не люблю, когда кто-то говорит загадками.){/i}"
...
translate russian Leona_6_label_3f8533d0:
    ...
    ch_Name "{i}(Давно у меня не было такого желания взглянуть на чьё-то лицо...){/i}"
...
translate russian Leona_6_label_34389aa0:
    ...
    ch_Name "До самого конца не мог поверить, что это вы."
...
translate russian Leona_6_label_c5534201:
    ...
    Jacob "Хах. Не такую реакцию я ожидал. Позвольте мне вам объяснить, [Name]."
...
translate russian Leona_6_label_e0db595f:
    ...
    ch_Name "{i}([Name]? Как необычно слышать от него это, а не \"мистер [Surname]\"...){/i}"
...
translate russian Leona_6_label_91802cdc:
    ...
    Jacob "За нами следят люди, убившие ваших родителей."
...
translate russian Leona_6_label_528a8a69:
    ...
    ch_Name "Вы путаете. Моя мать умерла при родах, а про отца я вообще ничего не знаю..."
...
translate russian Leona_6_label_a53f956f:
    ...
    Jacob "Ваши родители были волшебниками, [Name]. Очень талантливыми."
...
translate russian Leona_6_label_6a48cbc7:
    ...
    ch_Name "Что вы имеете в виду? Это чушь!"
...
translate russian Leona_6_label_7c4edb4c:
    ...
    Jacob "Он посвятил всю жизнь высвобождению великого зла."
...
translate russian Leona_6_label_1b9f2320:
    ...
    Jacob "Ваша мать случайно прочла его мысли и тем самым обнаружила правду."
...
translate russian Leona_6_label_007cca6a:
    ...
    Jacob "Мы попробовали остановить его, запечатав его магию, но он оказался сильнее."
...
translate russian Leona_6_label_9050cea1:
    ...
    Jacob "Мы сумели предотвратить открытие ворот в тёмное измерение, но..."
...
translate russian Leona_6_label_efae8a70:
    ...
    Jacob "В порыве ярости он убил вашего отца собственными руками."
...
translate russian Leona_6_label_7f20161f:
    ...
    Jacob "И ещё он проклял вашу мать, оставив ей умирать медленной и мучительной смертью."

# game/logic/events/Leona.rpy:1847
translate russian Leona_6_label_08940a6f:

    # Jacob "She was nine months pregnant."
    Jacob "Она была на девятом месяце."
...
translate russian Leona_6_label_08c6a15c:
    ...
    Jacob "Если бы я не сумел спрятаться, то погиб бы вместе с ними."
...
translate russian Leona_6_label_f24b9cb7:
    ...
    Jacob "Я сумел в итоге завершить ритуал и запечатать часть его магической силы..."
...
translate russian Leona_6_label_7b6c3084:
    ...
    Jacob "Но как я ни пытался спасти вашу мать, я сумел лишь замедлить действие проклятия."
...
translate russian Leona_6_label_70693eea:
    ...
    Jacob "Артур никогда не отказывался от своего замысла."
...
translate russian Leona_6_label_1b96304b:
    ...
    Jacob "Даже будучи ослабленным и лишённым части его сил..."
...
translate russian Leona_6_label_29b335e9:
    ...
    Jacob "...он ждал и кормился силой своих последователей."
...
translate russian Leona_6_label_075f8187:
    ...
    Jacob "И скоро, очень скоро, он предпримет новую попытку высвободить тот ужас."
...
translate russian Leona_6_label_e0fc2335:
    ...
    ch_Name "Вы вообще представляете, как сложно в это поверить?"
...
translate russian Leona_6_label_f6e9746d:
    ...
    Jacob "Я понимаю, что вам непросто это всё даётся. Но у нас нет времени на это."
...
translate russian Leona_6_label_5e7a2cbc:
    ...
    Jacob "Иначе я бы не стал подвергать опасности сына Лианы, насылая фантома."
...
translate russian Leona_6_label_6fc0b135:
    ...
    ch_Name "Вместо причины доверять вам вы только что напомнили, почему я этого делать не должен."
...
translate russian Leona_6_label_f7d00c72:
    ...
    ch_Name "Почему вообще кто-либо в здравом уме будет насылать таких чудовищ на человека?"

# game/logic/events/Leona.rpy:1870
translate russian Leona_6_label_d5dfd600:

    # Jacob "I had no choice. I had to test you!"
    Jacob "У меня не было иного выбора. Я должен был испытать вас!"
...
translate russian Leona_6_label_3ceedd9f:
    ...
    Jacob "Я бы себе не простил, если бы их сын тоже погиб, сражаясь с Артуром."
...
translate russian Leona_6_label_9cd3ca4d:
    ...
    Jacob "Если бы вы не смогли одолеть фантом, то и здесь бы тоже не преуспели."
...
translate russian Leona_6_label_2fbca572:
    ...
    Jacob "Ну конечно знаю. Именно я направил вас в тот самый лес."
...
translate russian Leona_6_label_6cf2bd38:
    ...
    Jacob "Без неё мы не могли обойтись..."
...
translate russian Leona_6_label_c14fe36f:
    ...
    Jacob "Я верил, что она не сможет устоять перед сыном Лианы и Ричарда."

# game/logic/events/Leona.rpy:1881
translate russian Leona_6_label_2f485204:

    # Jacob "After all, they were from Leonheart too."
    Jacob "В конце концов, они же тоже учились на Леонхарте."
...
translate russian Leona_6_label_a5e92061:
    ...
    ch_Name "Уф... Ну пускай. И что мне надо сделать, чтобы одолеть Артура?"

# game/logic/events/Leona.rpy:1883
translate russian Leona_6_label_54a3e08a:

    # Jacob "I do not wish your imminent death, boy."
    Jacob "Молодой человек, я точно не желаю вам неминуемой смерти."
...
translate russian Leona_6_label_85bab21f:
    ...
    Jacob "Но вы поможете сохранить этот мир в покое раз и на всегда."
...
translate russian Leona_6_label_306caedb:
    ...
    Jacob "Вызовите Леону и попросите её раздобыть Свиток с Печатью Льва."

# game/logic/events/Leona.rpy:1890
translate russian Leona_6_label_ac7465b6:

    # Jacob "Only with it can we deny Arthur his powers."
    Jacob "Только с его помощью мы сумеем лишить Артура его силы."
...
translate russian Leona_6_label_23919178:
    ...
    Jacob "Но ни в коем случае не рассказывайте никому об этом разговоре."
...
translate russian Leona_6_label_da722419:
    ...
    Jacob "Даже Леона не должна знать, зачем вам потребовался этот свиток."
...
translate russian Leona_6_label_9ff77859:
    ...
    Jacob "Разве история с фантомом не научила вас тому, что внешность бывает обманчива?"

# game/logic/events/Leona.rpy:1896
translate russian Leona_6_label_eaf74df8:

    # Jacob "Trust no one. Do you hear me?"
    Jacob "Не доверяйте никому. Слышите меня?"
...
translate russian Leona_6_label_9b232bd6:
    ...
    Jacob "У Артура было 18 лет на то, чтобы подготовиться. У него повсюду есть шпионы."
...
translate russian Leona_6_label_c42af589:
    ...
    Jacob "Наша встреча и так привлекла достаточно внимания."
...
translate russian Leona_6_label_59100fdd:
    ...
    Jacob "Когда вы раздобудете свиток, найдите меня."
...
translate russian Leona_6_label_735fd918:
    ...
    Jacob "Обещаю вам, когда мы устраним угрозу, то обсудим всё как следует..."
...
translate russian Leona_6_label_0b8c1f54:
    ...
    Jacob "Мне столько всего следует рассказать вам про ваших родителей. Всё, идите!"
...
translate russian Leona_6_label_eefca1d7:
    ...
    ch_Name "{i}(Поверить не могу... Это что, правда?){/i}"
...
translate russian Leona_7_label_f50e6b1a:
    ...
    ch_Name "{i}(Не та страница. Тут какой-то ритуал троицы...){/i}"
...
translate russian Leona_7_label_9a47bc23:
    ...
    ch_Name "{i}(Страшно представить, как много знаний таит в себе эта книга.){/i}"
...
translate russian Leona_7_label_18cf628a:
    ...
    ch_Name "{i}(Уверен, Хейли бы с огромным интересом её прочитала.){/i}"
...
translate russian Leona_7_label_050b73e1:
    ...
    ch_Name "{i}(Это всё, что надо сделать?){/i}"
...
translate russian Leona_7_label_128472d7:
    ...
    Leona "Как приятно вновь ощущать кожей воздух..."
...
translate russian Leona_7_label_930e7b77:
    ...
    Leona "Не смущайся, я одета. Можешь обернуться."
...
translate russian Leona_7_label_7c7e87d0:
    ...
    ch_Name "У меня мало времени, так что я перейду сразу к сути."
...
translate russian Leona_7_label_0e8131e2:
    ...
    ch_Name "Мне нужен Свиток с Печатью Льва. Я знаю, что ты можешь мне с ним помочь."
...
translate russian Leona_7_label_5d680c90:
    ...
    Leona "Свиток с Печатью Льва? Зачем он тебе понадобился?"
...
translate russian Leona_7_label_4e3df128:
    ...
    Leona "Это невероятно мощный артефакт... Ты уверен, что ничего не напутал?"

# game/logic/events/Leona.rpy:1950
translate russian Leona_7_label_cdfa920b:

    # ch_Name "I'm sure I need it. As soon as possible."
    ch_Name "Совершенно точно мне нужен именно он. Как можно скорее."
...
translate russian Leona_7_label_63908a29:
    ...
    ch_Name "Я понимаю. Но мне действительно нужен этот свиток."
...
translate russian Leona_7_label_5e9cbccc:
    ...
    Leona "Ты можешь хотя бы сказать мне, зачем он тебе?"
...
translate russian Leona_7_label_765e99e1:
    ...
    ch_Name "Нет. Пока что я не могу тебе ничего рассказать."
...
translate russian Leona_7_label_c166e5f3:
    ...
    Leona "Ты хочешь, чтобы я добыла тебе один из самых мощных артефактов..."
...
translate russian Leona_7_label_4b2cb5c1:
    ...
    Leona "И ты не готов мне ничего объяснить?"
...
translate russian Leona_7_label_9a7b9535:
    ...
    ch_Name "Ха-ха. Ну да. Я же твой избранный. Доверься мне."
...
translate russian Leona_7_label_ca33aa99:
    ...
    Leona "Что ж, в одном ты точно прав. Я обещала поддерживать тебя во всём."

# game/logic/events/Leona.rpy:1968
translate russian Leona_7_label_e132a053:

    # Leona "I'll get the scroll. But I need time."
    Leona "Я найду этот свиток. Но мне нужно время."
...
translate russian Leona_7_label_8f140470:
    ...
    Leona "Пообещай мне, что пока я его ищу, ты тщательно всё обдумаешь ещё раз..."
...
translate russian Leona_7_label_12fb4fe0:
    ...
    Leona "Использовать этот свиток очень опасно. Я не шучу."
...
translate russian Leona_7_label_d150551e:
    ...
    ch_Name "Я обещаю, что буду осторожен. Когда ты сможешь мне его принести?"

# game/logic/events/Leona.rpy:1973
translate russian Leona_7_label_581301ce:

    # Leona "I don't know. I made sure it would be hard to get. Even for me."
    Leona "Я не знаю. Я постаралась, чтобы его было очень сложно найти. Даже мне самой."

# game/logic/events/Leona.rpy:1974
translate russian Leona_7_label_4c1e4977:

    # Leona "I need a week, at least."
    Leona "Мне нужно не менее недели."
...
translate russian Leona_7_label_d81260ab:
    ...
    Leona "Я сама к тебе явлюсь, когда найду его. Тогда и увидимся."
...
translate russian strings:
    ...
    new "Попробовать вызвать Леону"

    # game/logic/events/Leona.rpy:198
    old "Reject pleasure"
    new "Отказаться от наслаждения"

    # game/logic/events/Leona.rpy:198
    old "Accept pleasure"
    new "Выбрать наслаждение"
