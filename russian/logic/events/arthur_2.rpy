...
translate russian arthur_2_310b1595:
    ...
    Arthur "Уверен, всем вам любопытно, почему я собрал вас здесь сегодня!"
...
translate russian arthur_2_c7b1aca6:
    ...
    Arthur "Каждую субботу утром мы подводим итоги нашего традиционного соревнования факультетов."
...
translate russian arthur_2_6dfcc04f:
    ...
    Arthur "Через несколько мгновений будут объявлены результаты."
...
translate russian arthur_2_bf0a70b2:
    ...
    Arthur "Мы невероятно гордимся вашим усердием и трудолюбием."
...
translate russian arthur_2_e472d89a:
    ...
    Arthur "Это соревнование на самом деле является одним из ключей к раскрытию вашего потенциала в полной мере."
...
translate russian arthur_2_53fa4e38:
    ...
    Arthur "Принимая участие в нём, вы демонстрируете силу и старание."
...
translate russian arthur_2_f6175ffb:
    ...
    Arthur "Мы рады быть частью вашего богатого пути к постижению вашей силы."
...
translate russian arthur_2_c2bc33b6:
    ...
    Arthur "Мы подсчитали все баллы для каждого факультета."
...
translate russian arthur_2_3f164f48:
    ...
    Arthur "Всем остальным студентам, чьи факультеты на текущей неделе не победили, я скажу: не падайте духом!"
...
translate russian arthur_2_0dad76fb:
    ...
    Arthur "Вам лишь нужно приложить больше усилий и выиграть соревнование на грядущей неделе!"
...
translate russian arthur_2_32_a7a4792e:
    ...
    Arthur "Победителем на текущей неделе становится {b}[wins_house]{/b}!"

# game/logic/events/arthur_2.rpy:102
translate russian arthur_2_32_a26c5366:

    # ch_Name "Crap, we've lost this week..."
    ch_Name "Вот дерьмо, мы проиграли на этой неделе..."
...
translate russian arthur_2_32_1838a81d:
    ...
    Elijah "Да ничего, у нас впереди еще есть немало недель, мы сумеем выиграть пару раз!"

# game/logic/events/arthur_2.rpy:104
translate russian arthur_2_32_d1098240:

    # ch_Name "You're not very optimistic about us."
    ch_Name "Да ты о нас не очень-то высокого мнения."
...
translate russian arthur_2_32_36af6813:
    ...
    Arthur "Он проводит вас на корабль."
...
translate russian arthur_2_32_cea9308a:
    ...
    # ch_Name "Well, that was informative."
    ch_Name "Что же, это было информативно."
...
translate russian arthur_2_32_e0cf2721:
    ...
    ch_Name "А теперь я могу пойти обратно и ещё поспать..."
...
translate russian arthur_2_0_c32abc02:
    ...
    Arthur "Как обычно, мы собрали вас здесь для объявления итогов нашего традиционного соревнования факультетов."
...
translate russian arthur_2_0_8e86b1c7:
    ...
    Arthur "Мы подсчитали баллы, заработанные каждым факультетом. И победу одерживает..."
...
translate russian arthur_2_3_82381200:
    ...
    ch_Name "Я даже не знаю, что там есть."
...
translate russian arthur_2_3_4e61651c:
    ...
    Haley "Я тоже. Буду изучать. Я надеюсь, в местной библиотеке можно почитать что-нибудь про историю города..."

# game/logic/events/arthur_2.rpy:263
translate russian arthur_2_3_c15f9a7d:

    # ch_Name "I'm sure there is."
    ch_Name "Я уверен, что-нибудь найдётся."
...
translate russian arthur_2_3_972052a9:
    ...
    ch_Name "{i}(Иногда я совсем не понимаю её интересы.){/i}"
...
translate russian arthur_2_3_71026dc1:
    ...
    Jacob "Сейчас узнаешь. Я думаю, всем будет полезно про это услышать."

# game/logic/events/arthur_2.rpy:290
translate russian arthur_2_3_7a843e21:

    # Jacob "Students! Pay attention."
    Jacob "Студенты! Минуту вашего внимания."
...
translate russian arthur_2_3_aad21c2b:
    ...
    Jacob "...студентам нужно прилагать усилия, чтобы стать великими волшебниками."

# game/logic/events/arthur_2.rpy:293
translate russian arthur_2_3_6df880d7:

    # Jacob "So you need to get plenty of rest, too."
    Jacob "Для этого вам нужно также и отдыхать."
...
translate russian arthur_2_3_ade72805:
    ...
    Jacob "Как победители соревнования факультетов, вы получили право взойти на борт корабля."
...
translate russian arthur_2_3_cc8ef5ee:
    ...
    Jacob "Это сделано из соображений безопасности."
...
translate russian arthur_2_3_24015a42:
    ...
    Jacob "Озеро выглядит небольшим, однако любой, кто решится его переплыть..."
...
translate russian arthur_2_3_3bacab58:
    ...
    Jacob "Главное - не выпрыгивайте за борт без необходимости."
...
translate russian arthur_2_3_0d8a9635:
    ...
    ch_Name "{i}(Он качается, когда люди заходят на палубу... Так должно быть?){/i}"
...
translate russian arthur_2_3_95360302:
    ...
    ch_Name "{i}(Кто бы мог подумать, что поездка на корабле может быть такой живописной.){/i}"
...
translate russian arthur_2_3_618c4214:
    ...
    ch_Name "{i}(Мне уже очень нравится выигрывать соревнование факультетов.){/i}"
...
translate russian arthur_2_3_57656768:
    ...
    ch_Name "{i}(Что за хрень. Где я?){/i}"
...
translate russian arthur_2_3_fd3312e8:
    ...
    Katrina "Потому что если я могу добраться до тебя из потустороннего мира..."
...
translate russian arthur_2_3_d7e6f74a:
    ...
    Katrina "Только представь, что я смогу сделать, оказавшись в твоём!"
...
translate russian arthur_2_3_d1a1f964:
    ...
    Haley "В каюте капитана. Мы отнесли тебя сюда, когда тебе стало плохо."
...
translate russian arthur_2_3_297e8375:
    ...
    ch_Name "Извини, я немного не в настроении, чтобы его угонять."
...
translate russian arthur_2_3_0868fcec:
    ...
    Haley "Когда же ты наконец научишься понимать, когда я шучу, а когда нет."
...
translate russian arthur_2_3_54e75ba9:
    ...
    ch_Name "Если ты этого хочешь, нам точно надо проводить больше времени вместе."

# game/logic/events/arthur_2.rpy:411
translate russian arthur_2_3_05f34be1:

    # Haley "Are you offering me a date?"
    Haley "Зовёшь меня на свидание?"
...
translate russian arthur_2_3_607fe232:
    ...
    ch_Name "Думаешь, в озере есть акулы?"
...
translate russian arthur_2_3_176569fa:
    ...
    ch_Name "{i}(Не позволю ей нарушить мои планы на выходные.){/i}"
...
translate russian arthur_2_5_42bca763:
    ...
    Elijah "Конечно, капитан ворчала и жаловалась на тебя всю дорогу."
...
translate russian arthur_2_5_bfd9816e:
    ...
    ch_Name "Просто укачало. Я в порядке."
...
translate russian arthur_2_5_6431c90f:
    ...
    Elijah "Я собираюсь выйти в город, хочешь, устрою тебе небольшую экскурсию?"

# game/logic/events/arthur_2.rpy:495
translate russian arthur_2_5_05a537ad:

    # ch_Name "I think I'll pass."
    ch_Name "Думаю, я пока пропущу."
...
translate russian arthur_2_5_fe3ba5cd:
    ...
    Elijah "Про этот городок я знаю не меньше, чем про свой родной."
...
translate russian arthur_2_5_706e4bef:
    ...
    ch_Name "Камера в телефоне такую красоту запечатлеть не способна."
...
translate russian arthur_2_5_a1ddbb09:
    ...
    Elijah "Может, ты найдёшь себе тут новую камеру."
...
translate russian arthur_2_5_0ff62b56:
    ...
    Elijah "Местный магазин. В основном продаётся всякое барахло, но вообще они могут всё, что угодно, под заказ привезти."
...
translate russian arthur_2_5_273da471:
    ...
    ch_Name "Понял. Не думаю, что у меня есть деньги на новую камеру, но заглянуть точно стоит."
...
translate russian arthur_2_5_9a53d507:
    ...
    Elijah "К вопросу о местах, куда стоит заглянуть. Видишь вывеску справа?"
...
translate russian arthur_2_5_8c7c9a2c:
    ...
    Elijah "Кроме того раза в Тайланде, это лучший массаж в моей жизни."
...
translate russian arthur_2_5_1d29d069:
    ...
    Elijah "Ты на мой зад пялился вместо того, чтобы смотреть по сторонам?"
...
translate russian arthur_2_5_074885a4:
    ...
    Elijah "Daily Lee Apartments. Та гостиница, про которую я говорил."
...
translate russian arthur_2_5_f7626c6c:
    ...
    Elijah "Довольно уютная, и ты можешь рассчитывать на скидки для студентов."

# game/logic/events/arthur_2.rpy:567
translate russian arthur_2_5_84067ac1:

    # ch_Name "Sounds great. Thank you!"
    ch_Name "Звучит здорово, спасибо!"
...
translate russian arthur_2_5_bc2335e9:
    ...
    Elijah "Не за что. Как-нибудь в другой раз покажу тебе остальную часть города."
...
translate russian strings:
    ...
    new "Пока мы проскочим выходные дни и перейдём сразу в понедельник."
