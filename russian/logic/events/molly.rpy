...
translate russian Molly_3_label_26efd3c2:
    ...
    ch_Name "{i}(Надеюсь, она шутит от отчаяния, а не составляет план.){/i}"
...
translate russian Molly_3_label_5473c987:
    ...
    ch_Name "{i}(Может, самое время намекнуть Molly...){/i}"
...
translate russian Molly_3_label_f4fdda1b:
    ...
    ch_Name "{i}(Что ее юбка сводит с ума всех студентов?){/i}"
...
translate russian Molly_3_label_9af5fbdc:
    ...
    Molly "Я могу споткнуться о швабру..."
...
translate russian Molly_3_label_db9b257e:
    ...
    ch_Name "{i}(Не переживай, все идет по плану.){/i}"
...
translate russian Molly_3_label_92028af9:
    ...
    ch_Name "Здесь есть одно место, которое трудно отчистить."
...
translate russian Molly_3_label_8769282a:
    ...
    ch_Name "Нужна хорошая чистка. И усиленная полировка."
...
translate russian Molly_3_label_a1afb298:
    ...
    ch_Name "{i}(Эй, тебе это явно нравится.){/i}"
...
translate russian Molly_3_label_057958fb:
    ...
    Molly "Убери уже швабру подальше, [Name]!"
...
translate russian Molly_3_label_66afc6f2:
    ...
    ch_Name "{i}(Похоже на правдоподобную случайность.){/i}"
...
translate russian Molly_3_label_1d1675fd:
    ...
    Molly "Ты мог бы убиться... Ну, может, не убиться, но..."
...
translate russian Molly_3_label_0ff305a1:
    ...
    ch_Name "{i}(Интересно, почему она выпроводила меня выбрасывать мусор.){/i}"
...
translate russian Molly_3_label_c0f03031:
    ...
    ch_Name "{i}(Надеюсь, моя невинная шалость не нанесла ей психологическую травму.){/i}"
...
translate russian Molly_3_label_6352a6ad:
    ...
    ch_Name "{i}(Странно, кафе уже закрыто.){/i}"
...
translate russian Molly_3_label_498f0e6a:
    ...
    ch_Name "{i}(Ох! Это директор! Что он тут делает?){/i}"
...
translate russian Molly_3_label_faeef6ed:
    ...
    Molly "Я знаю, куда ты клонишь и я не хочу этого слышать."
...
translate russian Molly_3_label_8549e0db:
    ...
    Arthur "О чем ты? Я пришел проверить, как идут дела у моей племянницы."
...
translate russian Molly_3_label_a452c996:
    ...
    Molly "Ты пришел уговаривать меня отказаться от кафе и от моей мечты быть бизнеследи."
...
translate russian Molly_3_label_d9f637c0:
    ...
    Molly "Чтобы я могла вернуться к учебе и стать послушной волшебницей, как мама."
...
translate russian Molly_3_label_ed66692f:
    ...
    Arthur "Хех, похоже, ты поймала меня, Molly. Не обижайся на старика."
...
translate russian Molly_3_label_64450011:
    ...
    Arthur "Я позволил тебе открыть это кафе. Но учеба тоже важна."
...
translate russian Molly_3_label_53cf10e3:
    ...
    Arthur "Хотел бы я, чтобы ты поняла, но... Мудрость приходит с возрастом. "
...
translate russian Molly_3_label_f18e28b8:
    ...
    Arthur "Я, пожалуй, пойду. Подумай, прежде чем будет слишком поздно."
...
translate russian Molly_3_label_65a14a33:
    ...
    Molly "Он ничего не понимает. Гребаный Gandalf."
...
translate russian Molly_3_label_c5f481af:
    ...
    ch_Name "{i}(Черт, похоже, Molly сильно расстроилась.){/i}"
...
translate russian Molly_3_label_4edbc2a1:
    ...
    Molly "Стать успешной и не покончить с собой в семье директора школы магии."

# game/logic/events/molly.rpy:497
translate russian Molly_3_label_7f521aea:

    # Molly "Now that's real magic!"
    Molly "Вот в чем истинная магия!"
...
translate russian Molly_3_label_03337741:
    ...
    ch_Name "Эй, Molly, что стряслось? Меня не было всего пару минут!"
...
translate russian Molly_3_label_4a0bf881:
    ...
    Molly "Как мило с твоей стороны претвориться, что ты ничего не слышал, [Name], правда."
...
translate russian Molly_3_label_0c83c65f:
    ...
    Molly "Но я знаю, сколько времени нужно на то, чтобы вынести мусор."
...
translate russian Molly_3_label_f529b5b4:
    ...
    ch_Name "И это 100%% не мое дело! Но я считаю..."
...
translate russian Molly_3_label_2a165e1e:
    ...
    ch_Name "Что нет ничего более правильного и клевого, чем следовать за своей мечтой."
...
translate russian Molly_3_label_84b34529:
    ...
    ch_Name "На самом деле, представь как красиво будет смотреться это личико..."

# game/logic/events/molly.rpy:511
translate russian Molly_3_label_77ac52fb:

    # ch_Name "On Forbes!"
    ch_Name "На обложке Forbes!"
...
translate russian Molly_3_label_9b316c07:
    ...
    ch_Name "{i}(Вау. Иногда я забываю, какая Molly красивая девушка.){/i}"
...
translate russian Molly_3_label_631ade76:
    ...
    ch_Name "{i}(Вау, я весь день потратил на работу в кафе.){/i}"
...
translate russian Molly_3_label_3734c74d:
    ...
    ch_Name "{i}(Напоминает о том лете, которое прошло впустую.){/i}"
...
translate russian Molly_3_label_5e68621d:
    ...
    ch_Name "{i}(Может, мне стоит немного разогреться на дуэли?){/i}"
