...
translate russian Elijah_1_label_21c176ab:
    ...
    Elijah "[Name]!{w} Тебя-то я как раз и ждал! У меня есть инструкции для тебя - вот!"

# game/logic/events/elijah.rpy:163
translate russian Elijah_1_label_bea5117d:

    # ch_Name "Sorry, had to change."
    ch_Name "Извини, надо было переодеться."
...
translate russian Elijah_1_label_134279a8:
    ...
    Elijah "Расслабься.{w} Я просто шучу."
...
translate russian Elijah_1_label_f910bbfd:
    ...
    Elijah "Я имел в виду обучение и всякое такое."
...
translate russian Elijah_1_label_129b6050:
    ...
    Elijah "Да, кстати! Ты же первокурсник. Надо тебе рассказать, что да как."
...
translate russian Elijah_1_label_c29f2332:
    ...
    Elijah "Убедиться, что ты полностью готов к учёбе - моя личная зона ответственности!"

# game/logic/events/elijah.rpy:176
translate russian Elijah_1_label_35e0ad63:

    # Elijah "So I need you to get your textbooks."
    Elijah "Так что теперь надо, чтобы ты получил свои учебники."
...
translate russian Elijah_1_label_89178c39:
    ...
    ch_Name "Зачем вообще нужна эта карточка? Кто ещё может здесь быть, кроме преподавателей и студентов?"
...
translate russian Elijah_1_label_f1fe3585:
    ...
    Elijah "Оборотни, злые существа, духи из иных измерений."
...
translate russian Elijah_1_label_d0caa680:
    ...
    Elijah "Странный вопрос, чувак. Не забывай, где ты находишься!"
...
translate russian Elijah_1_label_64c53180:
    ...
    Elijah "Библиотека работает утром и днём."
...
translate russian Elijah_1_label_d20f1940:
    ...
    Elijah "Загляни туда в это время и получи у Амели учебники."
...
translate russian Elijah_1_label_cc58522f:
    ...
    ch_Name "Да, я хотел узнать побольше про занятия."
...
translate russian Elijah_1_label_2da7d5ac:
    ...
    Elijah "Держи при себе свою студенческую карточку."
...
translate russian Elijah_1_label_86f9b981:
    ...
    Elijah "С ней ты сможешь посещать Основы Магии и Зельеварение."
...
translate russian Elijah_1_label_405cc983:
    ...
    Elijah "Занятия будут в той же аудитории, в которой был твой экзамен."
...
translate russian Elijah_1_label_c802d584:
    ...
    Elijah "Не сказал бы, что это плохо."
...
translate russian Elijah_1_label_9deb0a2a:
    ...
    Elijah "Ты только береги свои брови. Очень легко их спалить."
...
translate russian Elijah_1_label_c3899c16:
    ...
    Elijah "Зельеварение преподаёт мисс Сабрина Спеллман."
...
translate russian Elijah_1_label_9afd3a02:
    ...
    Elijah "Ты её не знаешь, так что обязательно сходи на занятие."
...
translate russian Elijah_1_label_b77b96e0:
    ...
    Elijah "Чаще всего первокурсникам гораздо интереснее творить магию, чем варить зелья."

# game/logic/events/elijah.rpy:235
translate russian Elijah_1_label_976abb37:

    # Elijah "And she really resents that."
    Elijah "И ей это всерьёз не нравится."
...
translate russian Elijah_1_label_64_e6460dae:
    ...
    Elijah "Чуть не забыл! Вот твоя форма допуска."
...
translate russian Elijah_1_label_64_0b376608:
    ...
    Elijah "Она тоже нужна, чтобы посещать Основы Магии и Зельеварение."
...
translate russian Elijah_1_label_69_0b7658fd:
    ...
    Elijah "В общем, у меня ещё есть дела."
...
translate russian Elijah_1_label_69_b71faa73:
    ...
    ch_Name "{i}(Надо получить в библиотеке учебники.){/i}"
...
translate russian Elijah_1_label_69_26dd810e:
    ...
    ch_Name "{i}(Хотя до занятий у меня ещё достаточно времени.){/i}"
...
translate russian Elijah_1_label_69_25a405a4:
    ...
    ch_Name "{i}(Может, мне стоит поболтать с Самантой или поближе познакомиться с Одри?){/i}"
...
translate russian Elijah_3_label_26f206d4:
    ...
    Elijah "Ну как, ходил на занятия?"
...
translate russian Elijah_3_label_aa892c32:
    ...
    Elijah "Уверен, что скоро ты на 100% вольёшься в студенческую жизнь."
...
translate russian Elijah_3_label_3ef8758f:
    ...
    Elijah "Ну, учёба, клубы, вечеринки, отношения."
...
translate russian Elijah_3_label_4c4d981f:
    ...
    Elijah "Зачем ты приехал в Кордейл?"
...
translate russian Elijah_3_label_0257f59d:
    ...
    ch_Name "Пришло приглашение, и я ухватился за эту возможность."
...
translate russian Elijah_3_label_6aa5a83d:
    ...
    Elijah "Да.{w} Человек, который хватается за возможность, когда видит её."
...
translate russian Elijah_3_label_26_ba294846:
    ...
    Elijah "Это случаем не влияние Саманты?"
...
translate russian Elijah_3_label_26_3aa12a5d:
    ...
    ch_Name "Не совсем.{w} Но нас воспитывали схожим образом."
...
translate russian Elijah_3_label_26_a766afe4:
    ...
    Elijah "Да. Многие люди не очень-то заботятся о себе."
...
translate russian Elijah_3_label_26_9fbf13f7:
    ...
    Elijah "А ты хочешь быть лучшим. Я это уважаю."
...
translate russian Elijah_3_label_39_62e8326f:
    ...
    Elijah "Обычного местного колледжа для этого было бы более чем достаточно."
...
translate russian Elijah_3_label_51_2c870455:
    ...
    Elijah "Кроме парочки слишком уж строгих правил."
...
translate russian Elijah_3_label_51_c19cab6b:
    ...
    Elijah "Нууу, например... Некоторые вещества, которые помогут сфокусироваться."
...
translate russian Elijah_3_label_51_105a029a:
    ...
    Elijah "Или наоборот, расслабиться и никуда не спешить."
...
translate russian Elijah_3_label_51_538e553e:
    ...
    Elijah "В каких-то государствах это легально, в других не совсем."
...
translate russian Elijah_3_label_51_256912c6:
    ...
    Elijah "Можно умереть и от избыточного количества кофе."
...
translate russian Elijah_3_label_51_7e58d340:
    ...
    Elijah "И если ты запустишь фейерверк с венгерским драконом, не прочитав инструкции..."

# game/logic/events/elijah.rpy:399
translate russian Elijah_3_label_51_4663d49e:

    # Elijah "It's a lot easier to die."
    Elijah "То умереть станет ещё проще."
...
translate russian Elijah_3_label_51_e9902c39:
    ...
    Elijah "Особенно теперь, когда на мне ещё и обязанности старосты."
...
translate russian Elijah_3_label_51_cf208e21:
    ...
    Elijah "Меня однажды поймали с настоящим драконьим яйцом!"
...
translate russian Elijah_3_label_51_6f5e08f0:
    ...
    Elijah "Не важно для чего. Важно, что меня ни за что не выгнали."
...
translate russian Elijah_3_label_51_cf784b93:
    ...
    Elijah "Как видишь, это даже не помешало мне стать старостой."
...
translate russian Elijah_3_label_51_9edf833d:
    ...
    ch_Name "У меня сегодня запланировано свидание с одной симпатичной девушкой."
...
translate russian Elijah_3_label_51_573e7dab:
    ...
    Elijah "Ничего такого, что стоило бы обсуждать на публике, амиго."
...
translate russian Elijah_3_label_51_c29fbb5e:
    ...
    Elijah "Но ты за меня не переживай. Давай, оторвись!"
...
translate russian Elijah_4_label_004f12f2:
    ...
    ch_Name "Передо мной возникла одна дилемма. Думал, вдруг ты сможешь подсказать."

# game/logic/events/elijah.rpy:478
translate russian Elijah_4_label_9af1ea5e:

    # Elijah "Sure thing. Spit it out."
    Elijah "Конечно. Давай выкладывай."

# game/logic/events/elijah.rpy:480
translate russian Elijah_4_label_473c339c:

    # ch_Name "So, I'm going to participate in a dueling club tonight."
    ch_Name "В общем, сегодня я буду участвовать в дуэльном клубе."
...
translate russian Elijah_4_label_1fdc1c13:
    ...
    ch_Name "И я вполне уверен, что благодаря выученному заклинанию и зельям я сумею победить."
...
translate russian Elijah_4_label_335218c1:
    ...
    ch_Name "Но в этом как будто бы нет смысла, потому что у меня нет денег, чтобы погулять на них в городе."
...
translate russian Elijah_4_label_bd0986ab:
    ...
    ch_Name "И я подумал, что может быть твоё предложение о работе ещё актуально..."
...
translate russian Elijah_4_label_3706c24d:
    ...
    ch_Name "И ты мог бы заплатить мне хотя бы часть авансом..."
...
translate russian Elijah_4_label_c3708630:
    ...
    Elijah "Нет проблем, братан, я могу заплатить тебе заранее."
...
translate russian Elijah_4_label_3ec65c04:
    ...
    Elijah "Чёрт, да я даже бонус тебе дам, если ты обеспечишь победу нашего факультета в еженедельном соревновании."
...
translate russian Elijah_4_label_b0d38c3a:
    ...
    Elijah "Рад, что ты спросил. Мне бы помощь не помешала!"
...
translate russian Elijah_4_label_2affbc6b:
    ...
    Elijah "Я попросил фею раздобыть кое-что для меня."
...
translate russian Elijah_4_label_0d15f68c:
    ...
    Elijah "И у неё возникли проблемы с законом по этой причине."
...
translate russian Elijah_4_label_7d03c493:
    ...
    Elijah "А её отец сказал, что голову мне оторвёт, когда увидит меня в следующий раз."

# game/logic/events/elijah.rpy:505
translate russian Elijah_4_label_2cff1b4e:

    # ch_Name "So that's why you can't go there... I see."
    ch_Name "Так вот почему ты туда не можешь пойти... Понятно."
...
translate russian Elijah_4_label_bd15d72f:
    ...
    Elijah "Ну так что, ты заберёшь для меня нектар дриад?"
...
translate russian Elijah_4_label_7863c898:
    ...
    Elijah "Ты никогда про него не слышал что ли?"
...
translate russian Elijah_4_label_28_9b5b6ac0:

    # Elijah "Of course it is, handsome. I told you it was a great job."
    Elijah "Конечно просто, красавчик. Я же сказал, отличная работа."
...
translate russian Elijah_4_label_28_071569e1:
    ...
    ch_Name "{i}(Уверен, что благодаря моей подготовке никто не сможет меня остановить!){/i}"
...
translate russian Elijah_5_label_b2d2544b:
    ...
    ch_Name "{i}(Не самая комфортная кровать в моей жизни, конечно. Спина болит.){/i}"

# game/logic/events/elijah.rpy:581
translate russian Elijah_5_label_54aa5e1e:

    # ch_Name "{i}(But It's okay, especially for free.){/i}"
    ch_Name "{i}(Но ничего, сойдёт, особенно если это бесплатно.){/i}"
...
translate russian Elijah_5_label_8e5e5ec8:
    ...
    ch_Name "На самом деле в этот раз я здесь не для того, чтобы с тобой увидеться."

# game/logic/events/elijah.rpy:601
translate russian Elijah_5_label_ab9b4db6:

    # ch_Name "Can you get Willow?"
    ch_Name "Можешь позвать Уиллоу?"
...
translate russian Elijah_5_label_012bcb2d:
    ...
    Gordon "Погоди немного, она наверняка занята чем-нибудь важным."
...
translate russian Elijah_5_label_0de637db:
    ...
    ch_Name "Ничего, я подожду столько, сколько потребуется..."
...
translate russian Elijah_5_label_9206d46c:
    ...
    Willow "Глупыш, ты забыл, что я фея?"
...
translate russian Elijah_5_label_29fcbe27:
    ...
    ch_Name "Я не знал, что феи умеют вот так сзади подкрадываться."
...
translate russian Elijah_5_label_8682125b:
    ...
    Willow "Люди просто не обращают внимание на то, что творится у них вокруг."

# game/logic/events/elijah.rpy:618
translate russian Elijah_5_label_caae54cc:

    # ch_Name "Interesting opinion."
    ch_Name "Интересная точка зрения."
...
translate russian Elijah_5_label_ea28a71e:
    ...
    Willow "Хочешь попросить меня раздобыть для тебя магический артефакт?"
...
translate russian Elijah_5_label_df4942b3:
    ...
    Willow "Я же говорила, люди просто не умеют смотреть по сторонам."
...
translate russian Elijah_5_label_6581121a:
    ...
    Willow "Ваша способность чувствовать магию даже близко не сравнится с нашей."
...
translate russian Elijah_5_label_a6ad0784:
    ...
    ch_Name "{i}(Как будто я смотрю в бескрайнюю глубь космоса...){/i}"
...
translate russian Elijah_5_label_7002e459:
    ...
    Willow "Портал для фей, который соединяет мою рощу с этим миром."
...
translate russian Elijah_5_label_b9851534:
    ...
    ch_Name "Я лишь хотел понять, что происходит."
...
translate russian Elijah_5_label_d424a12f:
    ...
    ch_Name "Как ты достала его... оттуда?"
...
translate russian Elijah_5_label_4bde070f:
    ...
    Willow "Феи могут приглашать в рощу только своих избранников."
...
translate russian Elijah_5_label_b46a0681:
    ...
    ch_Name "{i}(Загляну-ка я в тот массажный салон, про который мне говорил Элайджа.){/i}"
...
translate russian Elijah_6_label_e38636bf:
    ...
    Elijah "Прошу, скажи мне, что ты уже забрал ту посылку с нектаром у Уиллоу."
...
translate russian Elijah_6_label_32813c4c:
    ...
    ch_Name "Я для этого сюда и пришёл, братан."
...
translate russian Elijah_6_label_24346adc:
    ...
    Elijah "Не надо, бро. Я не хочу видеть, что у тебя там с собой."
...
translate russian Elijah_6_label_29821818:
    ...
    # Elijah "Not in here."
    Elijah "Только не здесь."

# game/logic/events/elijah.rpy:730
translate russian Elijah_6_label_123a9dfb:

    # Elijah "Let's take a walk and I'll tell you about the dueling club."
    Elijah "Давай-ка прогуляемся и я тебе расскажу про дуэльный клуб."

# game/logic/events/elijah.rpy:731
translate russian Elijah_6_label_51b1ec04:
...
translate russian Elijah_6_label_48c63c35:
    ...
    Elijah "Не забывай, нельзя ничего светить в публичных местах."
...
translate russian Elijah_6_label_4730aa36:
    ...
    Elijah "Пойдём, у меня есть идея."
...
translate russian Elijah_6_label_7dc0d182:
    ...
    Elijah "Тупица. Мужская мода - очень важная вещь."
...
translate russian Elijah_6_label_b4343a33:
    ...
    Elijah "Девушки с ума сходят по тем, кто одет с иголочки, я тебе говорю!"
...
translate russian Elijah_6_label_a255a7f4:
    ...
    Elijah "Ладно, если ты ещё не понял намёка..."
...
translate russian Elijah_6_label_c29f9d56:
    ...
    ch_Name "{i}(Прикрывая свою сумку, он забрал флакон и передал мне деньги.){/i}"
...
translate russian Elijah_6_label_e422bf7d:
    ...
    Elijah "Надо как-то поближе придвинуться, чтобы я тихонько его забрал."
...
translate russian Elijah_6_label_c1203722:
    ...
    ch_Name "Элайджа. Это выглядит странно."
...
translate russian Elijah_6_label_161ade55:
    ...
    Elijah "[Name], давай притворимся, что целуемся, чтобы всё выглядело более натурально."

# game/logic/events/elijah.rpy:783
translate russian Elijah_6_label_b7e318bc:

    # ch_Name "Look, I'm not a very good actor."
    ch_Name "Слушай, я не очень-то хороший актёр."
...
translate russian Elijah_6_label_ce077303:
    ...
    ch_Name "{i}(Достаточно долго, чтобы не быть случайностью...){/i}"
...
translate russian Elijah_6_label_d9cf4cc6:
    ...
    ch_Name "{i}(Так странно... Почему я раньше это не пробовал?){/i}"
...
translate russian Elijah_6_label_8a665371:
    ...
    Elijah "И за приятную часть тоже."
...
translate russian Elijah_6_label_c9ca3d32:
    ...
    Elijah "Кстати, вот деньги за все твои хлопоты."
...
translate russian Elijah_6_label_5b13f822:
    ...
    Elijah "Мне надо идти. Спасибо за компанию."
...
translate russian Elijah_6_label_40b69df0:
    ...
    Elijah "Мне нужно идти. Спасибо за компанию"
...
translate russian Elijah_6_label_adb74870:
    ...
    ch_Name "{i}(Итак, первую работу для Элайджи можно считать успешной.){/i}"
...
translate russian Elijah_6_label_9baf4875:
    ...
    ch_Name "{i}(Теперь надо разобраться с Катриной и теми кошмарными снами.){/i}"
...
translate russian Elijah_6_label_c442eb9c:
    ...
    ch_Name "{i}(Надо вызвать Леону, но так, чтобы никто этого не заметил.){/i}"
...
translate russian Elijah_6_label_6d2065d5:
    ...
    ch_Name "{i}(Лучше я дождусь, пока студенты разойдутся по общежитиям.){/i}"
...
translate russian Elijah_6_label_50841470:
    ...
    ch_Name "{i}(Тем временем, я бы мог ещё чем-нибудь заняться...){/i}"
...
translate russian strings:
    ...
    new "0 Поговорить с Элайджа"

    # game/logic/events/elijah.rpy:84
    old "Talk to Elijah"
    new "Поговорить с Элайджа"
    ...
    new "Мне предоставился шанс"

    # game/logic/events/elijah.rpy:308
    old "To be the best"
    new "Чтобы стать лучшим"
