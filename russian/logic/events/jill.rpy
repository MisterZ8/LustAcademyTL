...
translate russian Jill_2_label_8_d5c48bb2:
    ...
    ch_Name "{i}(И запах потрясающий!){/i}"
...
translate russian Jill_2_label_8_64304343:
    ...
    Jill "Можешь оставить нижнее белье, если стесняешься."
...
translate russian Jill_2_label_8_946ee40e:
    ...
    Jill "Не важно. Меня зовут Faith и я счастлива тебя расслабить."
...
translate russian Jill_2_label_8_57db8112:
    ...
    Faith "Больно видеть, когда с таким прекрасным телом так обращаются."

# game/logic/events/jill.rpy:141
translate russian Jill_2_label_8_e1cf31bb:

    # Faith "It deserves some love..."
    Faith "Оно заслуживает немного любви..."
...
translate russian Jill_2_label_8_901750da:
    ...
    Faith "Легко понять, когда кто-то напрягал свои мышцы до предела."
...
translate russian Jill_2_label_8_acea34f7:
    ...
    Faith "Но не переживай, сладенький! Я знаю как ублажить мужчину."
...
translate russian Jill_2_label_8_bf518b02:
    ...
    ch_Name "{i}(Богом клянусь, она смеется надо мной!){/i}"
...
translate russian Jill_2_label_8_b3f849ab:
    ...
    Faith "Просто расслабься и позволь моим прикосновениям забрать твою боль..."

# game/logic/events/jill.rpy:152
translate russian Jill_2_label_8_5c116305:
...
translate russian Jill_2_label_8_ed025aa4:
    ...
    ch_Name "{i}(Не пойму, сексуально это или жутко... Может быть, и то и другое?){/i}"
...
translate russian Jill_2_label_8_65319b24:

    # ch_Name "Um...Y-yes, I guess."
    ch_Name "Эм... Д-да, я думаю."
...
translate russian Jill_2_label_8_9633c1dd:
    ...
    ch_Name "{i}(Клянусь, я ощущаю ее влажные трусики на своей коже.){/i}"
...
translate russian Jill_2_label_8_2e8bb3da:
    ...
    Faith "У тебя такая широкая спина. По-другому я не справлюсь."
...
translate russian Jill_2_label_8_c9bf1b92:

    # Faith "You're too tense... Ah..."
    Faith "Ты слишком напряжен... Ах..."

# game/logic/events/jill.rpy:169
translate russian Jill_2_label_8_90bf3fd5:

    # Faith "Relax your shoulders... Ah... Now we'll give them a good..."
    Faith "Расслабь свои плечи... Ах... Сейчас мы сделаем им хороший..."
...
translate russian Jill_2_label_8_8acca11e:
    ...
    ch_Name "{i}(Мне кажется или у нее вибрирует... там?){/i}"

# game/logic/events/jill.rpy:173
translate russian Jill_2_label_8_aa947108:
...
translate russian Jill_2_label_8_844308df:
    ...
    Faith "Не могу почувствовать твои чакры."
...
translate russian Jill_2_label_8_a55970ab:
    ...
    Faith "Это стандартная процедура..."
...
translate russian Jill_2_label_8_846d8e0e:
    ...
    Faith "Все! Массаж закончен... Извини, мне пора бежать."
...
translate russian Jill_2_label_8_61181cfa:
    ...
    ch_Name "{i}(Да уж... Она странная.){/i}"
...
translate russian Jill_2_label_8_9da8089d:
    ...
    Jill "Я пойду прогуляюсь. Твое сердитое лицо сводит меня с ума."
...
translate russian Jill_2_label_8_f0350b03:
    ...
    ch_Name "{i}(Чтож, лучше притворюсь что ушел раньше и ничего не слышал.){/i}"
...
translate russian Jill_2_label_8_09c0b473:
    ...
    ch_Name "{i}(Почему снаружи так темно? Который час?){/i}"
...
translate russian Jill_2_label_8_64d999f7:
    ...
    ch_Name "{i}(Дерьмо! Я не думал, что массаж займет так много времени.){/i}"
...
translate russian Jill_2_label_8_5655ca56:
    ...
    ch_Name "{i}(Мне надо спешить, лодка в Cordale скоро отплывает.){/i}"

# game/logic/events/jill.rpy:226
translate russian Jill_0_label_de5c0105:

    # ch_Name "Hey! I'm back for your famous massage!"
    ch_Name "Эй! Я вернулся за вашим знаменитым массажем!"
...
translate russian Jill_0_label_adfebf94:
    ...
    Jill "Извини, боюсь, все часы на следующие пять дней забронированы."
...
translate russian Jill_3_label_e330bae6:
    ...
    ch_Name "{i}(Насыщенная, это верно, но я чувствую себя, как выжатый лимон.){/i}"

# game/logic/events/jill.rpy:246
translate russian Jill_3_label_e0f7b8ec:

    # ch_Name "{i}(And It's my day off! Unthinkable!){/i}"
    ch_Name "{i}(И это мой свободный день! Немыслимо!){/i}"
...
translate russian Jill_3_label_933b501d:
    ...
    ch_Name "{i}(Возможно, мне стоит сделать массаж? Слышал, это помогает в подобных ситуациях.){/i}"

# game/logic/events/jill.rpy:248
translate russian Jill_3_label_19f91803:

    # ch_Name "{i}(And my leg could use some care too.){/i}"
    ch_Name "{i}(И моей ноге тоже не помешает немного заботы.){/i}"
...
translate russian Jill_3_label_6fb76786:
    ...
    ch_Name "{i}(Интересно, выдержит ли она на этот раз.){/i}"
...
translate russian Jill_3_label_57af8977:
    ...
    ch_Name "{i}(Хотя я не против снова почувствовать, как ее тело дрожит от наслаждения...){/i}"
...
translate russian Jill_3_label_ec675ee9:
    ...
    ch_Name "{i}(Но в прошлый раз массажиска представилась как...){/i}"

# game/logic/events/jill.rpy:279
translate russian Jill_3_label_163292ee:

    # ch_Name "Faith, right?"
    ch_Name "Faith, правильно?"
...
translate russian Jill_3_label_276253ce:
    ...
    ch_Name "Я был здесь в прошлый раз."
...
translate russian Jill_3_label_46189e73:
    ...
    ch_Name "Ничего такого не случилось, Faith. Не переживай."
...
translate russian Jill_3_label_06f93a02:
    ...
    ch_Name "Итак, ты можешь помочь мне снять стресс?"
...
translate russian Jill_3_label_0ba43894:

    # Faith "Of course I can."
    Faith "Конечно, я помогу."

# game/logic/events/jill.rpy:315
translate russian Jill_3_label_ef0b23d6:

    # Faith "Your shoulders look stiff."
    Faith "Твои плечи очень напряжены."
...
translate russian Jill_3_label_84d25d3a:
    ...
    Faith "Я знаю, что здесь болит, но ты должен довериться мне."
...
translate russian Jill_3_label_44372b34:
    ...
    Faith "С радостью. На сегодня это все."

# game/logic/events/jill.rpy:336
translate russian Jill_3_label_bbd56698:

    # Faith "I need to go, sorry,"
    Faith "Мне нужно уйти, извини."
...
translate russian Jill_3_label_e73f7b48:
    ...
    ch_Name "{i}(Ну, по крайней мере в этот раз она закончила массаж.){/i}"
...
translate russian Jill_3_label_545f1c4d:

    # Faith "Wow...Yeah, you sure did enjoy my massage."
    Faith "Вау... Да уж, ты точно получил удовольствие от массажа."
...
translate russian Jill_3_label_ad7eef91:
    ...
    Faith "Ты определенно должен сбросить напряжение здесь..."
...
translate russian Jill_3_label_d7f3d285:
    ...
    ch_Name "{i}(Черт... Куда она ушла?){/i}"
...
translate russian Jill_3_label_c7a29cdc:
    ...
    ch_Name "{i}(Ох, чуть не забыл, что у меня есть VIP пропуск в клуб.){/i}"
...
translate russian Jill_3_label_f9d9de7a:
    ...
    ch_Name "{i}(Будет просто кощунством не использовать его почаще, пока он у меня есть.){/i}"
...
translate russian Jill_3_label_ab6e4b4f:
    ...
    Adele "Ох! Это снова ты! Какой приятный сюрприз!"
...
translate russian Jill_1_label_9665fe9d:
    ...
    ch_Name "{i}(Хмм, какой интересный дизайн!){/i}"
...
translate russian Jill_1_label_c3364c6a:
    ...
    Jill "Это семейный бизнес. В Dale так почти у всех."
...
translate russian Jill_1_label_4d1f1729:
    ...
    Jill "Как мне обращаться к тебе?"
...
translate russian Jill_1_label_475b542d:
    ...
    ch_Name "Хотел посмотреть какие услуги тут предоставляют."
...
translate russian Jill_1_label_b8c0f8e8:
    ...
    Jill "Тогда ты обязан попробовать наши массажи."
...
translate russian order_a_message_jil_4eaa2478:
    ...
    ch_Name "К сожалению, я не могу сейчас."
...
translate russian order_a_message_jil_dfe8de78:
    ...
    Jill "Очень жаль. Я могу сделать что-либо, чтобы ты изменил свое решение?"
...
translate russian Jill_4_label_from_gallery_83fcc17d:
    ...
    ch_Name "Я чувствую заметное улучшение."
...
translate russian Jill_4_label_from_gallery_263db661:
    ...
    ch_Name "Тем не менее, у меня по прежнему много стресса и напряжения..."
...
translate russian Jill_4_label_from_gallery_79cca176:
    ...
    ch_Name "{i}(Интересно, о чем она думает?){/i}"
...
translate russian Jill_4_label_from_gallery_c156806b:
    ...
    Faith "Я помогу убрать мышечные зажимы и принесу тебе общее расслабление."
...
translate russian Jill_4_label_from_gallery_60ab327e:
    ...
    Faith "Я также рекомендую выкинуть из головы все мысли..."
...
translate russian Jill_4_label_from_gallery_e69b8d41:
    ...
    Faith "В конце концов,наши  мысли напрямую связаны с языком и положением нашего тела."
...
translate russian Jill_4_label_from_gallery_f8b54836:
    ...
    Faith "Наличие беспокойства и страхов не позволяет телу полностью расслабиться."
...
translate russian Jill_4_label_from_gallery_bb518681:
    ...
    Faith "Обычто во время массажа я предлагаю клиентам надеть специальную маску..."
...
translate russian Jill_4_label_from_gallery_1a5d57d0:
    ...
    Faith "...которая позволяет им заснуть."
...
translate russian Jill_4_label_from_gallery_9c426f04:
    ...
    Faith "Если ты не против, тебе я ее тоже одену."
...
translate russian Jill_4_label_from_gallery_2c2fded3:
    ...
    ch_Name "{i}(Какая нежная у нее кожа!){/i}"
...
translate russian Jill_4_label_from_gallery_387891fd:
    ...
    Faith "Забудь обо всем, что тебя беспокоит."
...
translate russian Jill_4_label_from_gallery_fa0965d1:
    ...
    ch_Name "{i}(Сегодня она проявляет меньше инициативности, чем в прошлый раз.){/i}"
...
translate russian Jill_4_label_from_gallery_40ba363a:
    ...
    ch_Name "{i}(Впрочем, ее \"застенчивость\" не мешала ей щупать меня в наш прошлый раз...){/i}"
...
translate russian Jill_4_label_from_gallery_2e9c6f42:
    ...
    ch_Name "{i}(...и шептать мне на ухо всякие разные вещи.){/i}"
...
translate russian Jill_4_label_from_gallery_110f6626:
    ...
    ch_Name "{i}(Так как мне расслабиться и перестать размышлять, если все так запутанно!){/i}"
...
translate russian Jill_4_label_from_gallery_27102876:
    ...
    ch_Name "{i}(Может, он ждет от меня первого шага, хочет, чтобы я был активнее?){/i}"
...
translate russian Jill_4_label_from_gallery_70794a09:
    ...
    Faith "Беквально все, что ты можешь себе представить."
...
translate russian Jill_4_label_from_gallery_d52710a9:
    ...
    Faith "Спортивный, горячими комнями, ароматерапию, мед..."
...
translate russian Jill_4_label_from_gallery_17f910db:
    ...
    Faith "А что тебя больше всего интересует?"
...
translate russian Jill_4_label_from_gallery_8876c556:
    ...
    ch_Name "Возможно, что-то еще более расслабляющее?"
...
translate russian Jill_4_label_from_gallery_e1cdd165:
    ...
    ch_Name "Массаж с обменом энергией, к примеру, эротический..."
...
translate russian Jill_4_label_from_gallery_d6b6bc17:
    ...
    Faith "Такого в нашем каталоге нет..."
...
translate russian Jill_4_label_from_gallery_f0907e3d:
    ...
    Faith "Но ты можешь поговорить с массажисткой лично..."
...
translate russian Jill_4_label_from_gallery_1971e367:
    ...
    Faith "Расскажи мне подробнее, какой вид массажа ты хотел бы попробовать..."
...
translate russian Jill_4_label_from_gallery_2d87addf:
    ...
    ch_Name "Я ты лично заинтересовалась в сеансе подобного массажа?"
...
translate russian Jill_4_label_from_gallery_6e0fb2b0:
    ...
    Faith "Мы можем обсудить это в следующий раз, если решишь снова посетить нас."
...
translate russian Jill_4_label_from_gallery_fd71a4b2:
    ...
    Faith "Итак, сейчас будет болеть, но потом все твое тело расслабится..."

# game/logic/events/jill.rpy:616
translate russian Jill_4_label_from_gallery_e1064586:

    # Faith "Just saying!"
    Faith "Как я и сказала!"
...
translate russian Jill_4_label_from_gallery_a82b3d9a:
    ...
    ch_Name "{i}(В маске все ощущается по-новому!){/i}"
...
translate russian Jill_4_label_from_gallery_21b5a1d7:
    ...
    ch_Name "{i}(Еще немного и я просто засну.){/i}"
...
translate russian Jill_4_label_from_gallery_669f5cad:
    ...
    Jill "Здесь такая сказочная атмосфера, правда?"
...
translate russian Jill_4_label_from_gallery_b93ae3b0:
    ...
    Jill "Очень приятный запах, правда?"
...
translate russian Jill_4_label_from_gallery_f31ec266:
    ...
    Jill "Что-то цветочное и приторно-сладкое, да?"
...
translate russian Jill_4_label_from_gallery_ab20b39a:
    ...
    ch_Name "Атмосфера очень располагает..."
...
translate russian Jill_4_label_from_gallery_da46273e:
    ...
    ch_Name "Что ты со мной делаешь..."
...
translate russian Jill_4_label_from_gallery_d91b0073:
    ...
    ch_Name "{i}(Я уверен, это был не сон!){/i}"
...
translate russian Jill_4_label_from_gallery_8347f762:
    ...
    ch_Name "{i}(Но ничто не остается скрытым вечно.){/i}"
...
translate russian Jill_4_label_from_gallery_bc2c8759:
    ...
    ch_Name "{i}(Могу поклясться, что мне только что дрочили...){/i}"
...
translate russian Jill_4_label_from_gallery_acaf5041:
    ...
    ch_Name "{i}(Но мой член все еще стоит.){/i}"
...
translate russian Jill_4_label_from_gallery_9966d40d:
    ...
    ch_Name "{i}(Чтож, я знаю место в этом городе, где это можно исправить.){/i}"
...
translate russian Jill_4_label_from_gallery_e079f9a5:
    ...
    ch_Name "{i}(И все же это место странное.){/i}"
...
translate russian Jill_4_label_from_gallery_2464a410:
    ...
    ch_Name "{i}(Когда-нибудь я раскрою тайну этого салона.){/i}"
...
translate russian Jill_4_label_from_gallery_13f33a8e:
    ...
    ch_Name "{i}(И хорошенько трахну эту развратную массажистку.){/i}"
...
translate russian Jill_4_label_from_gallery_f3d2555a:
    ...
    ch_Name "{i}(Вечерний бриз приятно охлаждает.){/i}"
...
translate russian Jill_4_label_from_gallery_05c1a6ee:
    ...
    ch_Name "{i}(Возможно, мне стоит прогуляться по улицам и подышать воздухом.){/i}"
...
translate russian Jill_4_label_from_gallery_90c004ce:
    ...
    ch_Name "{i}(Нет, глупости. У меня есть клуб и меня ждут девочки.){/i}"
...
translate russian Jill_4_label_from_gallery_9dc70ae3:
    ...
    ch_Name "{i}(Кто знает, может быть, сегодня я заполучу сердце Adele.){/i}"
...
translate russian Jill_4_label_from_gallery_2c7c2624:
    ...
    ch_Name "{i}(Она намекала, что я нравлюсь ей.){/i}"
...
translate russian Jill_4_label_from_gallery_c5404335:
    ...
    ch_Name "{i}(Или она так флиртует со всеми посетителями? Хмм...){/i}"
