...
translate russian romul_1_label_2691b779:
    ...
    ch_Name "{i}(Неужели я действительно провел почти весь день на рыбалке?){/i}"
...
translate russian romul_1_label_2748a5e2:
    ...
    ch_Name "{i}(Чувак, еще не так поздно. У меня еще есть время спасти этот день от крысиного дерьма.){/i}"
...
translate russian romul_1_label_27504075:
    ...
    ch_Name "{i}(Может, мне сходить в клуб, о котором говорил Элайджа?){/i}"
...
translate russian romul_1_label_6c3ba351:
    ...
    ch_Name "{i}(Госпожа удача? Кажется, это место, о котором он мне рассказывал.){/i}"
...
translate russian romul_1_label_7ab5a3b8:
    ...
    ch_Name "{i}(Выглядит жутковато, но если с Элайджей здесь все было в порядке, то что может случиться со мной?){/i}"
...
translate russian romul_1_label_71043eb2:
    ...
    ch_Name "{i}(Кажется, здесь рады не всем.){/i}"
...
translate russian romul_1_label_88b5c09a:
    ...
    Romul "Иди прогуляйся еще на свежем воздухе, человечек."
...
translate russian romul_1_label_ad5df1e9:
    ...
    Romul "Ты не соответствуете стандартам."
...
translate russian romul_1_label_7769b9e5:
    ...
    Romul "Мне не нравится твое лицо."
...
translate russian romul_1_label_3c96497f:
    ...
    ch_Name "{i}(Тебе нужно контролировать себя.){/i}"
...
translate russian romul_1_label_1b4abd6c:
    ...
    ch_Name "{i}(Не думаю, что кто-то в академии одобрит избиение охранника клуба.){/i}"

# game/logic/events/romul.rpy:81
translate russian romul_1_label_f19c7a52:

    # Romul "Hmmm... Maybe I overreacted."
    Romul "Хммм... Может быть, я слишком остро отреагировал."
...
translate russian romul_1_label_f4bf6cc5:
    ...
    Romul "Может, ты не отстой, и тебя следует пустить в клуб."
...
translate russian romul_1_label_cea1aaf9:
    ...
    Romul "С другой, я верю в капитализм и второй шанс!"
...
translate russian romul_1_label_menu_bribe_a4e208c6:
    ...
    Romul "Ты хочешь войти? Будь вежливым, плати тихо и улыбайся."
...
translate russian romul_1_label_menu_bribe_58387e87:
    ...
    Romul "И ради Мерлина, надень приличную одежду!"
...
translate russian romul_1_label_menu_bribe_43666fc9:
    ...
    ch_Name "{i}(Я очень хочу попробовать на нем боевой снаряд...){/i}"
...
translate russian romul_1_label_menu_bribe_595947cc:
    ...
    ch_Name "{i}(Интересно, что ему скажет бугимен у двери.){/i}"
...
translate russian romul_1_label_menu_bribe_f932106d:
    ...
    Romul "Извини, чувак, твой VIP здесь не поможет."
...
translate russian romul_1_label_menu_bribe_4624fa59:
    ...
    UnknownDiego "Просто притворись сегодня вечером, что ничего не слышал."
...
translate russian romul_1_label_menu_bribe_2fffe567:
    ...
    UnknownDiego "И никого не видел."
...
translate russian romul_1_label_menu_bribe_a502744e:
    ...
    ch_Name "{i}(Как этот придурок мог на это согласиться?){/i}"
...
translate russian romul_1_label_menu_bribe_321fadb3:
    ...
    ch_Name "{i}(Подожди, этот парень даже не собирался в клуб...){/i}"
...
translate russian romul_1_label_menu_bribe_807a6105:
    ...
    ch_Name "{i}(Это очень странно... Я должен следовать за ним.){/i}"
...
translate russian romul_1_label_menu_bribe_793bf31e:
    ...
    ch_Name "{i}(У меня всегда проблемы...){/i}"
...
translate russian romul_1_label_menu_bribe_7b254889:
    ...
    ch_Name "{i}(Но я же не могу просто так остановиться, не так ли?){/i}"

# game/logic/events/romul.rpy:190
translate russian romul_2_label_89fc89bf:

    # ch_Name "{i}(Hmm, this looks like a service exit from a nightclub.){/i}"
    ch_Name "{i}(Хм, это похоже на служебный выход из ночного клуба.){/i}"
...
translate russian romul_2_label_9f9c2cee:
    ...
    ch_Name "{i}(Но почему он слоняется без дела, если заплатил охраннику?){/i}"

# game/logic/events/romul.rpy:194
translate russian romul_2_label_453bd138:

    # ch_Name "{i}(The entrance clearly costs less than a whole envelope of dough...){/i}"
    ch_Name "{i}(Вход в клуб явно стоит меньше, чем целый конверт с деньгами...){/i}"
...
translate russian romul_2_label_2ef37573:
...
translate russian romul_2_label_71c987ea:
    ...
    Adele "Я слышала это раньше. Я ухожу."
...
translate russian romul_2_label_cc8b1b2e:
    ...
    Diego "Не сопротивляйся, тебе это тогда нравилось..."
...
translate russian romul_2_label_e1e11caa:
    ...
    ch_Name "{i}(Черт, он собирается ее изнасиловать?){/i}"
...
translate russian romul_2_label_31bac05f:
    ...
    ch_Name "{i}(Я всегда могу вмешаться позже.){/i}"
...
translate russian romul_2_label_e6a59dd5:
    ...
    Adele "Отпусти, мудак! Это была работа."
...
translate russian romul_2_label_9041e7ef:
    ...
    Diego "Ты имеешь в виду, что ты текла, как сука, ради денег?!"

# game/logic/events/romul.rpy:238
translate russian romul_2_label_72754f94:

    # Adele "YOU DISGUST ME AS A MAN!"
    Adele "ТЫ ОТВРАТЕН МНЕ КАК МУЖЧИНА!"
...
translate russian romul_2_label_897af73e:
    ...
    Diego "Просто расслабся и постарайся получить от этого удовольствие!"
...
translate russian romul_2_label_f8fb7def:
    ...
    ch_Name "{i}(Черт, он бежит ко мне.){/i}"
...
translate russian romul_2_label_83807fe7:
    ...
    ch_Name "{i}(Интересно. Мне бы это пригодилось.){/i}"
...
translate russian romul_2_label_cb11b272:
    ...
    ch_Name "{i}(Окей, я не хочу, чтобы кто-нибудь видел, как я крадусь по переулкам.){/i}"
...
translate russian romul_2_label_b1cb0473:
    ...
    Diego "Как, черт возьми, ТЫ собирался надрать мне задницу, клоун?"
...
translate russian romul_2_label_d916050f:
    ...
    ch_Name "{i}(Что, черт возьми, только что произошло?){/i}"
...
translate russian romul_2_label_8d97d692:
    ...
    Adele "Иди поплачь своей маме, лох!"
...
translate russian romul_2_label_4ab06ee9:
    ...
    Adele "Почему я не удивлена, что это первое, что ты заметил?"
...
translate russian romul_2_label_c899474e:
    ...
    Diego "Но не так сильно, как я собираюсь причинить тебе!"
...
translate russian romul_2_label_2d23271d:
    ...
    Diego "Я вернусь к тебе через минуту, слад..."
...
translate russian romul_2_label_da9c38ec_1:
    ...
    # ch_Name "{i}(That's gonna hurt for a while...){/i}"
    ch_Name "{i}(Некоторое время будет больно...){/i}"
...
translate russian romul_2_label_f5935405_2:
    ...
    # Diego "You'll pay for this!"
    Diego "Вы заплатите за это!"

# game/logic/events/romul.rpy:407
translate russian romul_2_label_8d97d692_2:
...
translate russian romul_2_label_3dbf630b:
...
translate russian romul_2_label_7b4843f8:
    ...
    ch_Name "Что ж, спасибо тебе."

# game/logic/events/romul.rpy:440
translate russian romul_2_label_1151a353:

    # Adele "I've gotta go, hon. Thank's again!"
    Adele "Мне нужно идти, дорогой. Спасибо еще раз!"
...
translate russian romul_2_label_6452d2ad:
    ...
    ch_Name "{i}(Полагаю, нет причин оставаться в этом жутком месте.){/i}"
...
translate russian romul_2_label_99b7b01e:
    ...
    ch_Name "{i}(С этим пропуском у этого вышибалы не будет выбора, кроме как впустить меня.){/i}"
...
translate russian romul_2_label_7c90deba:
    ...
    ch_Name "{i}(Пришло время узнать, что предлагает этот клуб.){/i}"
