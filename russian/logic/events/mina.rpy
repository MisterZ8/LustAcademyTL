...
translate russian mina_1_label_97a951b2:
    ...
    ch_Name "{i}(Кажется, это местная гостиница.){/i}"
...
translate russian mina_1_label_8989645f:
    ...
    ch_Name "{i}(Оу, кажется, здесь можно будет довольно уютно провести ночь.){/i}"

# game/logic/events/mina.rpy:33
translate russian mina_1_label_82111509:

    # UnknownMina "Hello! Welcome to the Daily Ly Apartments!"
    UnknownMina "Приветствую! Добро пожаловать в Апартаменты Дэйли Ли!"
...
translate russian mina_1_label_32f31626:
    ...
    ch_Name "Просто ты так ловко прочитала мои мысли!"
...
translate russian mina_1_label_45158bcd:
    ...
    Mina "Вечеринка волшебников после конференции по магии стихий вышла из под контроля."

# game/logic/events/mina.rpy:48
translate russian mina_1_label_5aa45adc:

    # ch_Name "I'm sorry to hear that."
    ch_Name "Жаль про такое слышать."
...
translate russian mina_1_label_48bee176:
    ...
    Mina "Побочный эффект работы в Дейле."
...
translate russian mina_1_label_24_32afbc03:
    ...
    ch_Name "{i}(Я всё равно вижу краем глаза название той книги...){/i}"
...
translate russian mina_1_label_24_5277bfa3:
    ...
    ch_Name "{i}(Дельта Венеры? Это часом не сборник порнографических романов?){/i}"
...
translate russian mina_1_label_24_9976a7c8:
    ...
    ch_Name "{i}(А ты не такая невинная, как кажешься, Мина...){/i}"
...
translate russian mina_1_label_24_6a0c7699:
    ...
    ch_Name "Очень жаль. Я как раз искал что-нибудь для чтения в постели, чтобы спалось лучше."
...
translate russian mina_1_label_24_61141a2d:
    ...
    Mina "Извини, ничего интересного на ум не приходит."
...
translate russian mina_1_label_44_a76d3917:
    ...
    ch_Name "{i}(Приятно осознавать, что мне не придётся спать на улице.){/i}"
...
translate russian mina_1_label_44_980b7020:
    ...
    ch_Name "{i}(А теперь можно пойти прогуляться и посетить что-то из тех мест, которые рекомендовал Элайджа.){/i}"

# game/logic/events/mina.rpy:108
translate russian mina_1_label_44_e7363bf5:

    # ch_Name "{i}(So, where do we start?){/i}"
    ch_Name "{i}(Так, с чего бы мне начать?){/i}"
...
translate russian mina_1_label_44_77c940e9:
    ...
    ch_Name "{i}(Мне точно нужно зайти в местный магазинчик, чтобы выполнить поручение Элайджи.){/i}"

# game/logic/events/mina.rpy:110
translate russian mina_1_label_44_87fc3dac:

    # ch_Name "{i}(Well. Why not?){/i}"
    ch_Name "{i}(Что ж, почему нет?){/i}"

# game/logic/events/mina.rpy:127
translate russian mina_0_label_b677eeb0:

    # ch_Name "Can I get a private room?"
    ch_Name "Могу я забронировать одноместный номер?"

# game/logic/events/mina.rpy:128
translate russian mina_0_label_63d8b40d:

    # Mina "I'm very sorry. There are no rooms available today."
    Mina "Мне очень жаль, у нас сейчас все такие номера заняты."

# game/logic/events/mina.rpy:129
translate russian mina_0_label_5aa45adc:

    # ch_Name "I'm sorry to hear that."
    ch_Name "Это печально слышать."

# game/logic/events/mina.rpy:131
translate russian mina_0_label_4de67bd7:

    # ch_Name "Can I get a free bed in the student room?"
    ch_Name "Могу я забронировать бесплатную кровать в общей комнате для студентов?"

# game/logic/events/mina.rpy:132
translate russian mina_0_label_cd9ade03:

    # Mina "I'm sorry, but there are no beds available today."
    Mina "Мне очень жаль, но свободных кроватей сегодня уже нет."

# game/logic/events/mina.rpy:133
translate russian mina_0_label_ed101781:
...
translate russian strings:
    ...
    new "Скидки для студентов"

    # game/logic/events/mina.rpy:125
    old "Separate room"
    new "Отдельная комната"

    # game/logic/events/mina.rpy:125
    old "Bed for freshman"
    new "Кровать для первокурсника"
