...
translate russian sheet_21_a8b041e5:
    ...
    Victoria "Вас ждет индивидуальный экзамен."
...
translate russian sheet_21_df79e689:
    ...
    Victoria "Встретимся в классе номер 1."
...
translate russian sheet_21_64ea08cc:
    ...
    Victoria "Чтобы попасть в класс, вам нужно пройти во вторую дверь слева."
...
translate russian sheet_21_cd31bfab:
    ...
    Victoria "В противоположной стороне парка."
...
translate russian sheet_21_3186aac9:
    ...
    Haley "Фонтан за Вашей спиной имеет магическую природу?"
...
translate russian sheet_21_c245a14f:
    ...
    Victoria "Забавно, что Вы заметили. У Вас отличное чутье на магию, юная леди!"
...
translate russian sheet_21_5a7f6537:
    ...
    Victoria "Эта статуя намного старше самого фонтана."
...
translate russian sheet_21_1ba0c3d3:
    ...
    Victoria "Легенды гласят что она была перенесена из Кордобы одним из основателей..."
...
translate russian sheet_21_9f426bd1:
    ...
    Victoria "Она была здесь всегда, даже когда я сама еще была студенткой."
...
translate russian sheet_21_ed09bcd5:
    ...
    Victoria "И ни разу не активировалась."
...
translate russian sheet_21_cab47bed:
    ...
    Victoria "Несмотря на множество страшных историй, которые вам расскажут."
...
translate russian sheet_21_1725268c:
    ...
    Victoria "Я не хочу портить развлечение старшим ребятам."
...
translate russian sheet_21_37cdc9c5:
    ...
    Victoria "Но, по их утверждениям, каждая дверная ручка в этом замке имеет свою страшную тайну."
...
translate russian sheet_21_bee1e71f:
    ...
    Victoria "Итак! Давайте сосредоточимся на экзамене. Вы готовы?"
...
translate russian sheet_21_395e5e86:
    ...
    Victoria "Вторая дверь налево, как я и сказала."
...
translate russian sheet_21_9be6ce19:
    ...
    Victoria "Любой, кто попытается подглядывать за экзаменом, будет отправлен домой."
...
translate russian sheet_21_7010a762:
    ...
    Victoria "Давайте приступим. Удачи!"
...
translate russian sheet_21_944d302c:
    ...
    ch_Name "{i}(Сосредоточься, [Name]!){/i}"
...
translate russian sheet_21_3f9b6ae0:
    ...
    ch_Name "{i}(Как чертов волшебник!){/i}"
...
translate russian sheet_21_35e74dcd:
    ...
    Haley "Занимай очередь на экзамен. Ты можешь зайти после меня."
...
translate russian sheet_21_f4c79ea7:
    ...
    Haley "Конечно. Я седьмая. Мы договорились еще на платформе, на всякий случай. Когда тебя не было."
...
translate russian sheet_21_cfb1ad22:
    ...
    Haley "Кстати, где ты был? Ты нашел свою подругу?"
...
translate russian sheet_21_9d3920c7:
    ...
    ch_Name "Да, она хотела предостеречь меня насчет экзамена."
...
translate russian sheet_21_dd93d73d:
    ...
    ch_Name "Sam сказала мне, что у нас есть только одна попытка. Мы либо проходим, либо все кончено."
...
translate russian sheet_21_34f8d788:
    ...
    Haley "Это не может быть правдой!"
...
translate russian sheet_21_91afd26d:
    ...
    Haley "Я только что узнала о магии."
...
translate russian sheet_21_6fd0ca70:
    ...
    Haley "Еще так много секретов предстоит обнаружить!"
...
translate russian sheet_21_843cde2d:
    ...
    ch_Name "Это замечательно. А я попробую узнать еще что-нибудь."
...
translate russian sheet_21_280b3bfc:
    ...
    ch_Name "Ну... Я хочу сказать... Да, не торопись. Я постараюсь еще что-нибудь выяснить."
...
translate russian sheet_21_98b1e84e:
    ...
    Haley "Ты не представляешь, что этот шанс означает для меня..."
...
translate russian sheet_21_83f279f2:
    ...
    ch_Name "Ты не проиграешь, если соберешься сейчас."
...
translate russian sheet_21_12f61278:
    ...
    ch_Name "Я обнаружил, что магия питается страстью!"
...
translate russian sheet_21_2141f8e7:
    ...
    ch_Name "Сосредоточься на чем-то, что вызывает в тебе страсть и жги!"
...
translate russian sheet_21_17ce8f40:
    ...
    ch_Name "Поверь в себя. Потому что я в тебя верю!"
...
translate russian sheet_21_3890fed4:
    ...
    Haley "Тебе нравится обниматься со случайными девушками?"
...
translate russian sheet_21_28397ffe:
    ...
    ch_Name "Без проблем. Я пойду проверю, какие еще неожиданности нас ждут."
