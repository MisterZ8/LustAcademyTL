...
translate russian sheet_23_menu_2_2d98ec54:
    ...
    ch_Name "{i}(Ладно, давай сосредоточимся на том, что вызывает в тебе страсть!){/i}"
...
translate russian sheet_23_menu_2_0befe970:
    ...
    ch_Name "{i}(Возможно, та официантка, после кубкового матча в прошлом марте?){/i}"
...
translate russian sheet_23_menu_2_481e1933:
    ...
    ch_Name "{i}(Вот блин, я не могу ничего вспомнить.){/i}"
...
translate russian sheet_23_menu_2_171d3537:
    ...
    ch_Name "{i}(Похоже, мне будет непросто.){/i}"
...
translate russian sheet_23_haley_9b62d2f0:
    ...
    ch_Name "{i}(Сладкие прозрачные трусики.){/i}"
...
translate russian sheet_23_haley_c76c34cf:
    ...
    ch_Name "{i}(О да! Ты даже немного влажная...){/i}"
...
translate russian sheet_23_haley_7634ea46:
    ...
    ch_Name "{i}(Какие у тебя аккуратные, нежные дырочки...){/i}"
...
translate russian sheet_23_energy_4e743823:
    ...
    ch_Name "{i}(Я чувствую такой прилив энергии!){/i}"
