...
translate russian sheet_20_36c945c0:
    ...
    Jacob "У вас будет достаточно времени, чтобы просмотреть все это позже..."
...
translate russian sheet_20_cbd6f300:
    ...
    Victoria "Экзаменатор должен встретиться с абитуриентами."
...
translate russian sheet_20_e0e90f05:
    ...
    Jacob "Директору было трудно связаться с вами..."
...
translate russian sheet_20_26f10086:
    ...
    Jacob "...и он попросил меня встретиться со студентами."
...
translate russian sheet_20_1bd47f69:
    ...
    Victoria "Как странно. Никаких сообщений от него я не получала."
...
translate russian sheet_20_ee1cd8d1:
    ...
    Jacob "Я сообщу директору, что вы появились."
...
translate russian sheet_20_3d821629:
    ...
    Victoria "Наверняка вы заметили фреску позади меня!"
...
translate russian sheet_20_9fd27b31:
    ...
    Victoria "Первый маг, ступивший на земли Северной Америки."
...
translate russian sheet_20_ef701d31:
    ...
    Victoria "Она объединила четырех своих учеников, чтобы продолжить её путь."
...
translate russian sheet_20_0afbd62d:
    ...
    Victoria "И на последнем издыхании...{w} Она создала первый камень для этого здания."
...
translate russian sheet_20_6f3f5fb6:
    ...
    Victoria "Только самые прилежные ученики когда-либо достигнут ее величия."
...
translate russian sheet_20_855d98c5:
    ...
    Victoria "Каждый маг, который учился в Академии Кордейл..."
...
translate russian sheet_20_009b5863:
    ...
    Victoria "...мечтает найти способ получить её скрытые знания."
...
translate russian sheet_20_5336e15c:
    ...
    Victoria "Но сначала вам придется доказать, что вы достойны этого."
...
translate russian sheet_20_458a6c3e:
    ...
    Victoria "...что он придумал предлог, чтобы не отвечать на ваши вопросы, так что это придется делать мне."
...
translate russian sheet_20_37b07f5c:
    ...
    UnknownGirl "Вы сказали, что преподаете \"боевую магию\"..."
...
translate russian sheet_20_42896c1b:
    ...
    ch_Name "{i}(Чертов огненный шар!){/i}"
...
translate russian sheet_20_82fcd1a3:
    ...
    Victoria "Смотрите внимательно, абитуриенты!"
...
translate russian sheet_20_289d913b:
    ...
    Victoria "Это то, что изучают на моих уроках!"
...
translate russian sheet_20_menu_1_ans_1_2fadfefb:
    ...
    Victoria "На протяжении 3-х курсов вы изучите основы всех школ магии, разрешенных в Америке."
...
translate russian sheet_20_menu_1_ans_1_54de9780:
    ...
    ch_Name "...и все же большинство людей думают, что магия не реальна?"
...
translate russian sheet_20_menu_1_ans_1_30b827ed:
    ...
    ch_Name "Я думал, такие вещи, как ваш огненный шар, станут популярными или что-то в этом роде..."
...
translate russian sheet_20_menu_1_ans_1_5192ead6:
    ...
    Victoria "Ну а точнее — кропотливая работа отдела по связям с общественностью."
...
translate russian sheet_20_menu_1_ans_1_f1ef320b:
    ...
    Victoria "Все остальное делается за нас в их воображении."
...
translate russian sheet_20_menu_1_ans_1_ce79aeac:
    ...
    Victoria "Прямо сейчас они уверены, что вы получаете какую-то уважаемую профессию."
...
translate russian sheet_20_menu_1_ans_2_d5c8eea9:
    ...
    Victoria "Прямо сейчас вы все переполнены магической силой!"
...
translate russian sheet_20_menu_1_ans_2_1b6c7bc8:
    ...
    Victoria "Все, что вам осталось, это показать мне, как вы её используете. Во время екзамена."
...
translate russian sheet_20_menu_1_ans_2_9d9cd2e0:
    ...
    Victoria "Поверьте мне, если у вас есть потенциал, это произойдет. Еще вопросы?"
...
translate russian sheet_20_menu_1_ans_3_146b6940:
    ...
    Victoria "Это так? Ну в таком случае..."
...
translate russian sheet_20_menu_1_ans_3_016157f0:
    ...
    Victoria "Было бы жаль, если бы друга моей самого талантливого ученика выгнали из академии..."
...
translate russian sheet_20_menu_2_ans_1_6b9deb9c:
    ...
    Victoria "Уважение к учителям – часть наших обычаев.{w} Еще вопросы?"
...
translate russian sheet_20_menu_2_ans_2_2d242468:
    ...
    ch_Name "Но тогда вы потеряете шанс научить своего нового, самого талантливого ученика."
...
translate russian sheet_20_menu_2_ans_2_2ed2b56c:
    ...
    Victoria "У вас остались вопросы?"
...
translate russian sheet_20_menu_1_ans_4_5d361209:
    ...
    ch_Name "Больше нет вопросов! Я готов!"
...
translate russian sheet_20_menu_1_ans_4_b3f9fd86:
    ...
    Victoria "Боюсь, мы не можем заставить людей ждать дольше."
