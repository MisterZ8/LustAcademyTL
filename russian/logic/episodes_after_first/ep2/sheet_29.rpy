...
translate russian sheet_29_b28259d5:
    ...
    ch_Name "{i}(Так приятно сделать глоток свежего воздуха...){/i}"
...
translate russian sheet_29_58a78b5c:
    ...
    ch_Name "{i}(Надеюсь, так это и останется.){/i}"
...
translate russian sheet_29_8595d21a:
    ...
    ch_Name "{i}(Все кажется таким чудесным сейчас.){/i}"
...
translate russian sheet_29_55a5eac3:
    ...
    Elijah "О, вижу ты уже познакомился с новенькими!"
...
translate russian sheet_29_2bbaf6ae:
    ...
    Elijah "Поэтому вторая повела ее в дамскую комнату."
...
translate russian sheet_29_fde0943e:
    ...
    Elijah "В любом случае, не дай этому испортить момент!"
...
translate russian sheet_29_fbb0f43b:
    ...
    Elijah "Ректор строго запрещает издеваться над новичками в их первый день."
...
translate russian sheet_29_a1d9a122:
    ...
    Elijah "Он утверждает, что это положит конец всем магам."
...
translate russian sheet_29_b5f813ce:
    ...
    Elijah "Так что сегодня вечеринки не будет."
...
translate russian sheet_29_a1a49f05:
    ...
    Elijah "У меня есть хорошее предчувствие в отношении нас с тобой."
...
translate russian sheet_29_a0044d00:
    ...
    Elijah "Я думаю, это начало большой дружбы."
...
translate russian sheet_29_b01456a1:
    ...
    ch_Name "{i}(Боже, похоже, не шутит...){/i}"
...
translate russian sheet_29_49a4e4d8:
    ...
    ch_Name "{i}(Мне нужно принять клевую позу...){/i}"
...
translate russian sheet_29_394011b2:
    ...
    Elijah "Она была бледной и выглядела больной, когда я впервые увидел ее."
...
translate russian sheet_29_1a392aeb:
    ...
    ch_Name "Ну, сейчас она выглядит отлично. Надеюсь, все в порядке."
...
translate russian sheet_29_e24f55da:
    ...
    Lily "...и тогда я поняла, что мой лучший друг - плод моих фантазий!"
...
translate russian sheet_29_3e2792d0:
    ...
    Haley "Не могу представить, что смогла бы сделать нечто подобное."
...
translate russian sheet_29_332c02fb:
    ...
    Lily "Тебе просто надо немного освоиться с колдовством чтобы найти всой источник силы."
...
translate russian sheet_29_4dbf6027:
    ...
    Elijah "Ладно, мальчики и девочки!"
...
translate russian sheet_29_9ce15241:
    ...
    Elijah "Давайте продолжим болтовню по дороге."
