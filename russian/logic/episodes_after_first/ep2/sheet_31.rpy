...
translate russian sheet_31_7c2819e0:
    ...
    Samantha "Встретилась со старым другом."
...
translate russian sheet_31_60f36213:
    ...
    ch_Name "Окей, окей. Не принимай близко к сердцу."
...
translate russian sheet_31_9bca5d39:
    ...
    Samantha "Каждая из них сказала мне несколько слов..."
...
translate russian sheet_31_d00b2372:
    ...
    ch_Name "Мне просто любопытно, у всех ли был одинаковый ритуал."
...
translate russian sheet_31_42b65fad:
    ...
    Samantha "Хмм. Я никогда раньше не задумывалась, как прошли ритуалы у других."
...
translate russian sheet_31_53b3aaf3:
    ...
    Samantha "Я всегда говорила, что ты нестандартно мыслишь!"
...
translate russian sheet_31_e5193ec7:
    ...
    ch_Name "Обычно это не звучит, как комплимент."
...
translate russian sheet_31_0b051706:
    ...
    ch_Name "Ну ладно. Увидимся позже."
...
translate russian sheet_31_fbf96dea:
    ...
    ch_Name "{i}(Поспать? Легко сказать...){/i}"
...
translate russian arthur_label_83fd625f:
    ...
    Elijah "Я подхвачу тебя минут через десять."
...
translate russian arthur_label_dbe35e38:
    ...
    Arthur "Студенты! Поспешите занять места, наше собрание вот-вот начнется!"
...
translate russian arthur_label_02deb966:
    ...
    Arthur "Нам нужно поспешить, если вы хотите вовремя оказаться на занятиях."
...
translate russian arthur_label_c31776ac:
    ...
    Arthur "Ничто так не сближает юных магов, как дом."
...
translate russian arthur_label_80de3aa2:
    ...
    Arthur "Я надеюсь, все довольны тем, куда их распределили?"
...
translate russian arthur_label_8f4ca7bd:
    ...
    Arthur "Факт в том, что образовательный процесс в нашей академии очень необычный."
...
translate russian arthur_label_055a73d0:
    ...
    Elijah "О, я вспомнил, нашему курсу он тоже проводил подобную встречу!"
...
translate russian arthur_label_80493a5d:
    ...
    ch_Name "Да? Она была познавательной?"
...
translate russian arthur_label_94e09a2f:
    ...
    Elijah "Не знаю, я ее проспал. Давай вместе послушаем."
...
translate russian arthur_label_2def8e23:
    ...
    Arthur "Этот дух здоровой конкуренции между четырьмя домами..."
...
translate russian sheet_31_menu_488802d2:
    ...
    Arthur "Как в любом учебном заведении, лекции являются основой всего."
...
translate russian sheet_31_menu_73b81beb:
    ...
    Arthur "{b}Вы можете посещать лекции утром и днем на протяжении недели.{/b}"
...
translate russian sheet_31_menu_b9689b36:
    ...
    Arthur "В отличие от других учебных заведений, у нас нет ограничений."
...
translate russian sheet_31_menu_267dc137:
    ...
    Arthur "Можете посещать лекции или потратить время на другие виды деятельности."
...
translate russian sheet_31_menu_35cd3be0:
    ...
    Arthur "Вместо этого, {b}мы поощряем посещение лекций баллами дома.{/b}"
...
translate russian sheet_31_menu_2f8878df:
    ...
    Arthur "Каждую неделю, в субботу утром, мы суммируем результаты соревнований между домами."
...
translate russian sheet_31_menu_c496ea98:
    ...
    Arthur "И дом с наивысшим баллом получает {b}особые привилегии.{/b}"
...
translate russian sheet_31_menu_b35ea416:
    ...
    Elijah "Это самое близкое к цивилизации место в шаговой доступности."
...
translate russian sheet_31_menu_85a1be50:
    ...
    Elijah "Там можно делать кучу всего."
...
translate russian sheet_31_menu_9c15acfa:
    ...
    Arthur "В выходные лекций нет и вы предоставлены сами себе."
...
translate russian sheet_31_menu_cc02fcd8:
    ...
    Arthur "...будет счастлива {b}наградить вас баллами за небольшую помощь.{/b}"
...
translate russian sheet_31_menu_293766b6:
    ...
    Arthur "В дуэлях есть не только победители, но и проигравшие."
...
translate russian sheet_31_76_e4b251fd:
    ...
    Elijah "Чтобы отдать тебе {b}твой студенческий билет{/b}, глупыш."
...
translate russian sheet_31_76_fa3d9593:
    ...
    Arthur "И помните, волшебники обязаны вести себя достойно!"
...
translate russian sheet_31_76_0f21babf:
    ...
    Arthur "Не буду больше задерживать вас в первый учебный день!"
...
translate russian sheet_31_76_f0f0c68f:
    ...
    Arthur "Поторопитесь, чтобы не опоздать на занятия."
...
translate russian sheet_31_76_701544bb:
    ...
    ch_Name "{i}(Черт, я так торопился, что забыл надеть нижнее белье...){/i}"
...
translate russian sheet_31_76_b849b589:
    ...
    ch_Name "{i}(В трусах намного уютнее.){/i}"
