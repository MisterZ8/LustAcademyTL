...
translate russian sheet_24_repeat_rules_a1746260:
    ...
    ch_Name "Вы не могли бы повторить правила еще раз?"
...
translate russian sheet_24_repeat_rules_c0612a71:
    ...
    ch_Name "Хочу убедиться, что понял все правильно."
...
translate russian sheet_24_repeat_rules_5f6046f7:
    ...
    Victoria "Без проблем. Как я и говорила..."
...
translate russian sheet_24_game_1_37ccf7af:
    ...
    ch_Name "{i}(Еще какой! Это было слишком легко!){/i}"
...
translate russian sheet_24_game_1_17474b4e:
    ...
    Victoria "Но у меня были и более способные студенты."
...
translate russian sheet_24_game_1_829c5ea8:
    ...
    ch_Name "{i}(Неплохо? Я могу куда больше, чем \"неплохо\"! Давай, [Name]!){/i}"
...
translate russian sheet_24_game_1_916ce3a3:
    ...
    ch_Name "{i}(Это сон или я и вправду так хорош?!){/i}"
...
translate russian sheet_24_game_1_7260d6a4:
    ...
    Victoria "Рекомендую отнестись к этому делу серьезнее."
...
translate russian sheet_24_game_1_ebfeb22a:
    ...
    ch_Name "{i}(Я могу лучше, я знаю это!){/i}"
...
translate russian sheet_24_game_1_f45b618f:
    ...
    Victoria "Хорошо, но не идеально."
...
translate russian sheet_24_game_1_41b405df:
    ...
    ch_Name "{i}(Я справлюсь. Нужно только сильнее сосредоточиться.){/i}"
...
translate russian sheet_24_game_1_9bd05493:
    ...
    ch_Name "Извините, похоже я отвлекся."
...
translate russian sheet_24_game_1_92fb82f1:
    ...
    ch_Name "{i}(Я был так близок. Неужели это... конец?){/i}"
...
translate russian sheet_24_game_1_0560b79b:
    ...
    Victoria "Да, но это не так просто."
...
translate russian sheet_24_game_1_2919d6ee:
    ...
    ch_Name "Это честь для меня слышать такое!"
...
translate russian sheet_24_end_game_16c0256d:
    ...
    ch_Name "{i}(Вау, это был намек или мне показалось?){/i}"
...
translate russian sheet_24_end_game_fcaf1caf:
    ...
    Victoria "Все зачисленные студенты приглашаются на торжественный приветственный пир."
