...
translate russian sheet_25_dc06d4dc:
    ...
    Haley "[Name]! Ты тоже прошел? Я так рада!"
...
translate russian sheet_25_0287d422:
    ...
    Haley "Если бы не ты, я бы ни за что не добилась успеха!"
...
translate russian sheet_25_eb77bdf3:
    ...
    ch_Name "Все в порядке! Я бы не оставил тебя в беде."
...
translate russian sheet_25_c55e5d25:
    ...
    Haley "Я слышала, директор произнесет приветственную речь!"
...
translate russian sheet_25_43571d7a:
    ...
    Haley "Теперь мне будет с кем сидеть. Пойдем!"
