...
translate russian sheet_19_b411353a:
    ...
    UnknownJacob "Соберитесь вокруг, чтобы вы все могли меня слышать!"
...
translate russian sheet_19_ad65eec5:
    ...
    ch_Name "{i}(Выглядит так аккуратно...){/i}"
...
translate russian sheet_19_9c3c1527:
    ...
    UnknownJacob "Скоро вы докажете, что достойные остаться..."
...
translate russian sheet_19_0c80d2cb:
    ...
    Jacob "Я учитель защиты от темной магии."
...
translate russian sheet_19_ce4ca856:
    ...
    Jacob "Мне поручили встретить первокурсников и отвезти их к месту проведения экзамена."
...
translate russian sheet_19_2dd89bc3:
    ...
    Jacob "Уверен, у вас много вопросов..."
...
translate russian sheet_19_edde9df5:
    ...
    Jacob "Давайте поторопимся! Очень скоро на все ваши вопросы будут даны ответы ."
...
translate russian sheet_19_25bb6c44:
    ...
    ch_Name "{i}(Это действительно то место, где я буду учиться?){/i}"
...
translate russian sheet_19_7dc24aca:
    ...
    ch_Name "{i}(Оно даже лучше, чем я себе представлял!){/i}"
...
translate russian sheet_19_93031dde:
    ...
    ch_Name "{i}(Я должен убедиться, что сдам экзамен.){/i}"
...
translate russian sheet_19_c4506604:
    ...
    Jacob "В Америке всего три магических заведения."
...
translate russian sheet_19_71f5a7e3:
    ...
    ch_Name "{i}(До сих пор не могу поверить, что всё это реально!){/i}"
...
translate russian sheet_19_e3c4f908:
    ...
    ch_Name "{i}(Я действительно собираюсь учиться в чертовом замке?){/i}"
...
translate russian sheet_19_af8133c6:
    ...
    ch_Name "{i}(Похоже, получить приглашение сюда - большая честь.){/i}"
...
translate russian sheet_19_df9cc034:
    ...
    Jacob "Нельзя не упомянуть о том, что магия — всегда рискованное дело."
...
translate russian sheet_19_bfbf68e6:
    ...
    Jacob "Так что старайтесь изо всех сил, чтобы сдать экзамен, ребята!"
...
translate russian sheet_19_8c442f04:
    ...
    UnknownGirl_2 "Сэр, вы сказали 18 век, не так ли?{w} Но он выглядит современно."
...
translate russian sheet_19_c9dfa630:
    ...
    Jacob "Знаете...{w} Магия может быть опасной."
...
translate russian sheet_19_a7109d95:
    ...
    Jacob "Кроме того, он действительно выглядел довольно устаревшим до ремонта."
...
translate russian sheet_19_4fd666c5:
    ...
    UnknownGirl_3 "Извините меня, сэр! Об экзамене, который вы упомянули."
...
translate russian sheet_19_eccdf630:
    ...
    ch_Name "[Name]. Извините, я не хотел выразить неуважение..."
...
translate russian sheet_19_453b3226:
    ...
    ch_Name "Но как я могу сдать экзамен, если я никогда раньше не практивковал магию?"
...
translate russian sheet_19_5925f563:
    ...
    ch_Name "Это все еще не может уместиться в моей голове. Я знаю, вы так говорите..."
...
translate russian sheet_19_2e0ca786:
    ...
    Jacob "Ну, \"просто [Name]\" — вы волшебник!"
...
translate russian sheet_19_df59ad17:
    ...
    Jacob "И это касается всех вас - если вас пригласили, внутри вас есть волшебство."
...
translate russian sheet_19_639c04ac:
    ...
    Jacob "Просто постарайтесь найти его, когда придет время!"
