...
translate russian sheet_30_756c3b58:
    ...
    ch_Name "{i}(Вау! Значит, это наше общежитие?){/i}"
...
translate russian sheet_30_c7d7472a:
    ...
    ch_Name "{i}(Выглядит куда современнее, чем я ожидал.){/i}"
...
translate russian sheet_30_134f228b:
    ...
    Elijah "Можете выбрать себе любую свободную. Теперь это ваш дом!"
...
translate russian sheet_30_e8fa5614:
    ...
    Elijah "...творится настоящая магия!"
...
translate russian sheet_30_58d7675b:
    ...
    Elijah "Ну, на самом деле оргий тут еще не было, но эй!"
...
translate russian sheet_30_2c1c6663:
    ...
    Elijah "Вы - свежая кровь. Первопроходцы. Я верю в вас."
...
translate russian sheet_30_5671d544:
    ...
    Elijah "Только предупредите меня заранее, чтобы я отменил свои планы на день."
...
translate russian sheet_30_32d53f3d:
    ...
    Elijah "Итак. Что мы забыли... О да. У вас есть ко мне вопросы?"
...
translate russian sheet_30_menu_7472c685:
    ...
    ch_Name "Я не вижу здесь бара, что за вечеринка без выпивки?"
...
translate russian sheet_30_menu_a20f54f7:
    ...
    Elijah "С выпивкой тут все нормально, поверь мне! У нас есть свои источники."
...
translate russian sheet_30_menu_4a010f54:
    ...
    Elijah "Ты просто должен прожить достаточно долго, чтобы увидеть наши вечеринки!"
...
translate russian sheet_30_menu_06981438:
    ...
    Elijah "А после этого можешь умирать спокойно!"
...
translate russian sheet_30_menu_answ_2_c3fa66cd:
    ...
    Elijah "Хороший вопрос! Скучная, но крайне важная информация:"
...
translate russian sheet_30_menu_answ_2_c7bb271a:
    ...
    Elijah "Ваше расписание и все новости приходят напрямую на ваш мобильный телефон."
...
translate russian sheet_30_menu_answ_2_dfad5c35:
    ...
    Elijah "Если вы хотите чего-то добиться здесь, вы должны посещать занятия."
...
translate russian sheet_30_menu_answ_2_676a3bd6:
    ...
    Elijah "Я советую всем ложиться спать пораньше и хорошенько выспаться."
...
translate russian sheet_30_menu_answ_2_b5331d41:
    ...
    Elijah "Магическая энергия, которой вы зарядились в поезде, скоро закончится..."
...
translate russian sheet_30_menu_answ_2_ea52561a:
    ...
    Elijah "... а никто не любит таскать студентов..."
...
translate russian sheet_30_menu_answ_2_599c22de:
    ...
    Elijah "...которые отключились посреди комнаты, в их спальни."
...
translate russian sheet_30_menu_answ_3_58559787:
    ...
    Elijah "В зависимости от того, как весело и шумно ты провел неделю."
...
translate russian sheet_30_menu_answ_3_a05ff41a:
    ...
    Elijah "Вы уже наверняка под впечатлением от академии, но!"
...
translate russian sheet_30_menu_answ_3_67008087:
    ...
    Elijah "Только призраки любят болтаться за этими стенами на протяжении всего года."
...
translate russian sheet_30_menu_answ_3_985de653:
    ...
    Elijah "Пока это мало о чем вам говорит, но поверьте мне - имеет смысл быть готовыми к занятиям!"
...
translate russian end_sheet_30_8d099b3e:
    ...
    Elijah " Спасибо всем за внимание! Сейчас отдыхайте, сегодня вы все молодцы."
...
translate russian end_sheet_30_cbf0a58e:
    ...
    ch_Name "{i}(Надеюсь, моя чуйка не ошибается насчет него.){/i}"
