...
translate dutch strings:
    ...
    new "Breng dit boek terug naar Amelie in de bibliotheek voor een beloning."

    # game/logic/main_interface/quest_log_screen.rpy:257
    old "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz"
    new "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmonpqrstuvwxyz"
    ...
    new "'s verhaallijn voor deze versie van het spel is tot een einde gekomen."
    ...
    new "Hier kan je alle routes, activiteiten, etc. die beschikbaar zijn volgen en snel navigeren."
    ...
    new "voor de desgewenste, zonder tijd te verspillen met rondlopen en zoeken. Naast de"

    # game/logic/main_interface/quest_log_screen.rpy:887
    old "avatars of the characters are icons, the decoding of which is next."
    new "avatars van de personages zijn iconen, waarvan de decodering het volgende is."
    ...
    new "Deze route is niet beschikbaar op dit punt van de dag. Als u deze optie kiest, wordt de tijd doorgespoeld. Doorgaan?"
