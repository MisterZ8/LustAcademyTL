...
translate swedish strings:
    ...
    old "Lost foliant"
    new "Försvunnen foliant"

    # game/logic/main_interface/quest_log_screen.rpy:130
    old "Return this book to Amelie in the library for a reward"
    new "Lämna tillbaka denna book till Amelie i biblioteket för ett pris"
    ...
    new "Denna trollformel är ännu inte lärd. "
    ...
    new "s historia för den här versionen av spelet har kommit till ett slut."
    ...
    new "Här kan du hålla koll på alla rutter, aktiviteter, osv. Som är tillgängliga till dig och navigera dig snabbt."
    ...
    new "till den önskade, utan att slösa tid på att gå runt på platserna och leta. Intill"

    # game/logic/main_interface/quest_log_screen.rpy:887
    old "avatars of the characters are icons, the decoding of which is next."
    new "karaktärernas avatarer är ikoner, vars avkodning är nästa."
    ...
    new "Den här rutten är inte tillgänglig vid den här tiden på dygnet. Att välja det här alternativet kommer att leda till ett tidshopp. Fortsätta?"
