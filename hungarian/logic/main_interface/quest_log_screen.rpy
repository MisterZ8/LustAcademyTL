...
translate hungarian strings:
    ...
    old "Lost foliant"
    new "Elveszett könyvek"

    # game/logic/main_interface/quest_log_screen.rpy:130
    old "Return this book to Amelie in the library for a reward"
    new "Vidd vissza ezt a könyvet Amelie-nek a könyvtárba egy jutalomért"
    ...
    new "Ezt a varázslatot még nem ismered."
    ...
    new "-nak a története ebben a verzióban véget ért."
    ...
    new "Itt tudod nyomon követni a vonalakat, tevékenységeket, stb. amik elérhetők számodra. És gyorsan tudsz navigálni"
    ...
    new "oda ahova szeretnél, ahelyett hogy időt vesztenél össze-vissza járkálással és kereséssel. A képek mellett "

    # game/logic/main_interface/quest_log_screen.rpy:887
    old "avatars of the characters are icons, the decoding of which is next."
    new "lehet látni ikonokat, amelyek mutatják melyek a következők."
    ...
    new "Ez a vonal nem elérhető a napnak ennek a pontjában. Ha ezt választod akkor átugrod az időt. Folytatod?"
