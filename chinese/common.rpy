...
translate chinese strings:
    ...
    new "此菜单上的选项旨在提高可访问性。它们可能不适用于所有游戏，某些选项的组合可能导致游戏不可玩。这不是游戏或引擎的问题。为了在更改字体时获得最佳效果，请尽量保持文本大小与最初的大小相同。"
    ...
    new "这个程序包含一些许可证下的自由软件，包括MIT许可证和GNU Lesser General Public许可证。一个完整的软件列表，包括完整源代码的链接，可以找到{a=https://www.renpy.org/l/license}这里{/a}。"
    ...
    new "关于如何修复这个问题的更多细节可以在{a=[url]}文档{/a}中找到。"
