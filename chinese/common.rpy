...
translate chinese strings:
    ...
    new "此菜单上的选项旨在提高可访问性。它们可能不适用于所有游戏，而且某些选项的组合可能导致游戏不可玩。这不是游戏或引擎的问题。为了在更改字体时获得最佳效果，请尽量保持文本大小与最初的大小相同。"
    ...
    new "本程序包含一系列许可下的自由软件，包括MIT许可证和GNU Lesser General Public许可证。一个完整的软件列表，包括完整源代码的链接，可以找到{a=https://www.renpy.org/l/license}here{/a}。"
    ...
    new "剪贴板表述启用。按'shift+C'键禁用。"

    # renpy/common/00preferences.rpy:585
    old "Self-voicing would say \"[renpy.display.tts.last]\". Press 'alt+shift+V' to disable."
    new "人声会说 \"[renpy.display.tts.last]\"。按'alt+shift+V'禁用。"
