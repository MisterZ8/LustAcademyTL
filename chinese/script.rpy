...
translate chinese strings:
    ...
    new "请注意，我们的游戏有LGBTQ+场景。如果你对这样的东西完全不感兴趣，你可以现在就关闭这个选项（你可以在以后的设置中随时打开）。"
...
translate chinese strings:
    ...
    new "这只是《欲望学院》的网页版！在您的浏览器上来尝试运行我们的游戏！"
    ...
    new "为了享受60fps动画和充满氛围感的音效设计，我们强烈建议尝试《欲望学院》的完整版本。"
