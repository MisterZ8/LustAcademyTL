...
translate chinese Mino_1_label_77e7d9b9:
...
translate chinese Mino_2_label_a393ee18:
...
translate chinese Mino_2_label_5513783e:
    ...
    ch_Name "非常感谢你，Amelie。我不会让你失望的，我保证。"
...
translate chinese Mino_3_label_49458a53:
    ...
    ch_Name "这没什么大不了的，我想我会搞清楚的。"

# game/logic/events/Minotaur.rpy:153
translate chinese Mino_3_label_c7a12ce1:

    # ch_Name "{i}(Let's try the most obvious option.){/i}"
    ch_Name "{i}（让我们试试最明显的选项。）{/i}"
...
translate chinese Mino_3_label_d048d85a:
    ...
    ch_Name "{i}（我只希望这道光表明我所做的一切是正确的。）{/i}"
...
translate chinese Mino_3_label_ad222400:
    ...
    Minotaur "几个月前有人把它藏在那根柱子后面。"

# game/logic/events/Minotaur.rpy:182
translate chinese Mino_3_label_cbe4d4b3:

    # Minotaur "Meh, seems that it fell out from there. "
    Minotaur "嗯，似乎它从那里掉出来了。"
...
translate chinese Mino_3_label_839f0ffb:

    # Minotaur "Minotaurs have always been known for our generosity!"
    Minotaur "牛头怪一向以慷慨大方著称!"

# game/logic/events/Minotaur.rpy:190
translate chinese Mino_3_label_6d6e2215:
