...
translate chinese Katrina_1_label_bfc2c579:

    # NoName "Ring, ring"
    NoName "叮，叮。"

# game/logic/events/Katrina.rpy:8
translate chinese Katrina_1_label_b5c500bc:

    # ch_Name "{i}(Oh... What a splitting headache.){/i}"
    ch_Name "{i}(哦...真是头痛欲裂。){/i}"

# game/logic/events/Katrina.rpy:9
translate chinese Katrina_1_label_8ccc1536:

    # ch_Name "{i}(Damn alarm clock.){/i}"
    ch_Name "{i}(该死的闹钟。){/i}"

# game/logic/events/Katrina.rpy:11
translate chinese Katrina_1_label_d2fd5b41:

    # ch_Name "{i}(What happened yesterday? I can't remember.){/i}"
    ch_Name "{i}(昨天发生了什么事? 我不记得了。){/i}"

# game/logic/events/Katrina.rpy:12
translate chinese Katrina_1_label_8a1aa597:

    # ch_Name "{i}(WAKE UP!){/i}"
    ch_Name "{i}(醒醒吧!){/i}"

# game/logic/events/Katrina.rpy:14
translate chinese Katrina_1_label_913db7e4:
...
translate chinese Katrina_1_label_e3defce8:
...
translate chinese Katrina_1_label_08d8b9a6:

    # Samantha "I can't believe you're such a loser that you fell for it."
    Samantha "我真不敢相信，你这么个窝囊废竟然信以为真。"

# game/logic/events/Katrina.rpy:67
translate chinese Katrina_1_label_b925146b:
...
translate chinese Katrina_1_label_8a19cbd8_1:

    # ch_Name "{i}...{/i}"
    ch_Name "{i}...{/i}"

# game/logic/events/Katrina.rpy:144
translate chinese Katrina_1_label_026db9a9:

    # ch_Name "{i}Ugh...{/i}"
    ch_Name "{i}啊...{/i}"

# game/logic/events/Katrina.rpy:145
translate chinese Katrina_1_label_027b1c56:

    # ch_Name "..."
    ch_Name ""

# game/logic/events/Katrina.rpy:147
translate chinese Katrina_1_label_d2007cb3_1:

    # Don "How dare you talk to me like that?"
    Don "你怎么敢这样跟我说话？"

# game/logic/events/Katrina.rpy:149
translate chinese Katrina_1_label_a2ae2aa0_1:

    # Don "Ungrateful piece of shit."
    Don "忘恩负义的混蛋。"

# game/logic/events/Katrina.rpy:150
translate chinese Katrina_1_label_24caf8e7:

    # ch_Name "{i}(Ugh... That's a hell of a punch. It's ringing in my ears.){/i}"
    ch_Name "{i}(啊... 这一拳可真狠。它在我的耳朵里回响。){/i}"
...
translate chinese Katrina_1_label_3bbb4635_1:

    # Don "I'm going to see how much I can get for your camera and computer."
    Don "我要看看你的照相机和电脑能卖多少钱。"

# game/logic/events/Katrina.rpy:157
translate chinese Katrina_1_label_88097224:

    # Don "I don't want to see you here, when I get back."
    Don "我回来的时候，不想在这里看到你。"

# game/logic/events/Katrina.rpy:163
translate chinese Katrina_1_label_eddfc16f:

    # ch_Name "{i}(Ouch...){/i}"
    ch_Name "{i}(哎哟...){/i}"

# game/logic/events/Katrina.rpy:165
translate chinese Katrina_1_label_851d7c11:

    # ch_Name "{i}(My head hurts so much... That punch was brutal.){/i}"
    ch_Name "{i}(我的头好疼... 那一拳太狠了。){/i}"

# game/logic/events/Katrina.rpy:167
translate chinese Katrina_1_label_cc3b5d61_1:

    # ch_Name "Ugh..."
    ch_Name "啊..."

# game/logic/events/Katrina.rpy:169
translate chinese Katrina_1_label_21e6bd45:
...
translate chinese Katrina_1_label_15383e87:
    ...
    ch_Name "Olivia? 你在干什么?"

# game/logic/events/Katrina.rpy:173
translate chinese Katrina_1_label_9715f275:

    # Olivia "Having some fun."
    Olivia "有些乐趣。"

# game/logic/events/Katrina.rpy:174
translate chinese Katrina_1_label_c3dcd672:
...
translate chinese Katrina_1_label_ad18feb9:
...
translate chinese Katrina_1_label_402cd952:
    ...
    ch_Name "就像我听错了Leona的魔法，对吧，Katrina?"

# game/logic/events/Katrina.rpy:290
translate chinese Katrina_1_label_c11d9a8b:

    # Olivia "Crap... You got me. So there's really no need to..." with hpunch
    Olivia "垃圾... 你明白我的意思。所以真的没有必要..." with hpunch
