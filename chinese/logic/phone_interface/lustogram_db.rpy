...
translate chinese strings:
    ...
    new "{b}Olivia:{/b} 什么? 你同意她的观点吗?"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "{b}Ashley:{/b} We'll talk in private.\t"
    new "{b}Ashley:{/b} 我们私下谈谈。\t"
    ...
    new "我还是不明白为什么镜子不会因为你的热度而融化。"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "Ashley: Stop it, you! I'm blushing already."
    new "Ashley: 停止，你! 我脸红了。"
    ...
    new "{b}Don:{/b} 我不认为我们给你买手机是为了让你发布这样的照片。我们得谈谈，马上去我办公室!"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "{b}Olivia:{/b} Don, she is a grown woman and it's absolutely okay. Baby, you're gorgeous!"
    new "{b}Olivia:{/b} Don，她是个成年人了，这绝对没问题。宝贝，你是美丽的!"
    ...
    new "老实说，99%的人都来看看你的胸部。我可以说它值得一看!"
    ...
    new "我终于找到了属于我的地方，和我最亲爱的人在一起。你怎么称呼这种奇怪的感觉? 这可能是... 幸福吗?"
    ...
    new "我想说我宁愿你邀请我去约会，但说实话—我宁愿你再也不打扰我了! 求你了，躲到黑暗的角落里去死吧。"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "{b}Elijah:{/b} Yeah, you can send me those dick pics instead. "
    new "{b}Elijah:{/b} 你可以把那些鸡巴照片发给我。"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "{b}Elijah:{/b} That's a joke, guys. "
    new "{b}Elijah:{/b} 这是个笑话，伙计们。"
    ...
    new "{b}Lily:{/b} 嘿，哇! 我有同样的运动上衣!"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "{b}Elijah:{/b} Too hot for this app. "
    new "{b}Elijah:{/b} 对这个应用程序来说太热了。"
    ...
    new "我相信骑摩托车的女孩是最性感的，这能帮助我对你调情吗?"
    ...
    new "当Leonheart们的第一天做得很好!看看我们的新学生和我的朋友[Name]充满希望的眼睛!向着美好的未来，我们前进!"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "{b}Haley:{/b} ha-ha, [Name] looks so silly here!"
    new "{b}Haley:{/b} 哈哈，[Name]在这里看起来很傻!"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "{b}Lily:{/b} True. You guys are cute ❤️"
    new "{b}Lily:{/b} 真实的。你们太可爱了 ❤️"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "Thanks, buddy. Glad that you are my prefect."
    new "谢谢你，朋友。很高兴你是我的级长。"
    ...
    new "一开始我还担心自己看起来不好看，但在你面前，我看起来很帅。"
    ...
    new "那年夏天，我是世界上最孤独的人。我的父母不理解我，我的女朋友背叛了我，我从来没有找到一个可以聊天的男朋友。"
    ...
    new "现在我每天都微笑。我有很多新朋友在我身边，我生活在世界上最不可思议的地方，但是有一个人... 不，我们先别急着对一个男人下结论😅"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "Anyway, if life is like a box of chocolates, this fall I haven't had any bad ones yet."
    new "不管怎样，如果生活就像一盒巧克力，这个秋天我还没有吃过一颗不好的。"
    ...
    new "{b}Victoria:{/b} Ranger小姐，我相信你更清楚，但花那么多时间在理论上你就没时间实践了。"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "{b}Haley:{/b} Don't worry, miss Lapis. I'm confident in my spellcasting."
    new "{b}Haley:{/b} 别担心，Lapis小姐。我对我的法术很有信心。"
    ...
    new "在我们奶奶家有一个古老的湖，湖上有神奇的百合花，一年只开一天。我就是在那样的日子出生的。这就是我妈妈想出这个名字的原因。"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "They wanted to call me Angie. Could you imagine?!"
    new "他们想叫我Angie。你能想象吗?!"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "{b}Naomi:{/b} What a beautiful story, Angie..."
    new "{b}Naomi:{/b} 多么美好的故事啊，Angie..."
    ...
    new "我们来组织一个只有我们两个人的睡衣派对吧! 我们可以一起做很多有趣的事情。Cordale咖啡馆的老板。😉"
    ...
    new "我的女朋友们担心，只要我自己做生意，我就找不到男朋友，会永远孤单。"
    ...
    new "{b}Elijah:{/b} 我个人认为没有它会更好... 而且没有穿别的罩衫。"
    ...
    new "我喜欢快速、直接、无情地把事情做好。就像从弓上射出的箭。所以我才这么喜欢这把枪。"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "{b}Lily:{/b} I always thought shart tongue was your scariest weapon..."
    new "{b}Lily:{/b} 我一直以为尖酸刻薄的舌头是你最可怕的武器..."
    ...
    new "{b}Naomi:{/b} Spellman小姐，我只是开玩笑，我发誓。"
    ...
    new "{b}Samantha:{/b} 天啊，这很挑逗，但也很性感!"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "{b}Elijah:{/b} Yep, there is something devilish in you."
    new "{b}Elijah:{/b} 是的，你身上有邪恶的东西。"
    ...
    new "这很简单—年轻是一种精神状态，而不是身体。和我深爱的丈夫在沙滩上度假，享受自然的棕褐色皮肤和“海滩性爱”😈——这是我青春和美丽的秘诀 ❤️"
    ...
    new "我希望在你拍《海滩上的性爱》之前唐把他的《辣马提尼》的原料都弄好了。"
    ...
    new "{b}Samantha:{/b} 被我妈妈烤了。☠️☠️☠️"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "First time ever I envy book club members.☺️ "
    new "我第一次羡慕读书俱乐部的成员。☺️ "
    ...
    new "我丈夫显然低估了我他把我一个人丢在商场拿着他的白金卡。你所爱的人是怎样宠你的?”"
    ...
    new "在你的美丽上再多的工作也不嫌多。我丈夫用昂贵的东西和奢华的旅行取悦我是有原因的。"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "{b}Evelyn:{/b} Not everyone is so lucky with their husband."
    new "{b}Evelyn:{/b} 不是每个人都能如此幸运地拥有自己的丈夫。"
    ...
    new "你觉得我的新款名牌泳衣怎么样?Don特地为我做的，这样我就永远觉得自己是一个配得上他的女王。"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "{b}Don:{/b} You look gorgeous!"
    new "{b}Don:{/b} 你看起来漂亮极了!"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "{b}Samantha:{/b} It suits your eyes, mom."
    new "{b}Samantha:{/b} 它很适合你的眼睛，妈妈。"
    ...
    new "也许这位女王厌倦了她的女王陛下所献上的古老而懒散的权杖?"
    ...
    new "哇，能说出这样的话真好，感觉像一个为改变而自豪的母亲。"
    ...
    new "也许我最重要的两个成就就是Sam和Ashley。我不知道基因是如何工作的，但有了这两个人，自然似乎很慷慨，把我所有的好品质发挥到了极致。"
    ...
    new "哇。如果我要选择你们中的一个去约会，我想我的脑袋一定会爆炸。你们姑娘也一样漂亮啊。"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "Olivia: Well-well, since when did you know how to compliment a woman?"
    new "Olivia: 好吧，你什么时候知道怎么赞美女人了?"
    ...
    new "{b}Audrey:{/b} Elijah，你确定你需要一个“少女”天堂吗?"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "{b}Elijah:{/b} @Audrey why not? "
    new "{b}Elijah:{/b} @Audrey  为什么不呢?"
    ...
    new "一开始，我不确定我是否应该坐在一个有人吃饭的桌子上，但后来我明白了一件事:我是这个地方最美味的菜!"
    ...
    new "你认为我能在这样一幅壁画上画得好吗? 能成为这所久负盛名的学府历史的一部分... 这是值得的，你不觉得吗?"
    ...
    new "今天我才真正意识到，按摩不仅可以舒缓和放松你的身体，也可以放松你的心灵。只要看看这个理想的氛围，充分放松和恢复力量! 我的按摩师Faith非常棒，我强烈推荐她的服务!"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "{b}Amelie:{/b} It's so nice to see how closely you take care of your health and state of mind!"
    new "{b}Amelie:{/b} 看到你如此密切地关注自己的健康和精神状态，真是太好了!"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "{b}Naomi:{/b} Wow! Now I need this massage too."
    new "{b}Naomi:{/b} 哇! 现在我也需要这个按摩。"
    ...
    new "{b}Jacob:{/b} 你看起来很美，一如既往，Lapis小姐。"
    ...
    new "{b}Sabrina:{/b} 哦，亲爱的，你实现了我的梦想!"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "{b}Amelie:{/b} I bet you weren't there all alone."
    new "{b}Amelie:{/b} 我打赌你不是一个人去的。"
