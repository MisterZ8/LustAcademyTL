...
translate philippine strings:
    ...
    old "Lost foliant"
    new "Nawawalang foliant"

    # game/logic/main_interface/quest_log_screen.rpy:130
    old "Return this book to Amelie in the library for a reward"
    new "Ibalik ito kay Amelie sa aklatan upang makakuha ng mga puntos"
    ...
    new "Hindi ka pa marunong maggamit nito."
    ...
    new " - natapos na ang kwento niya sa kasalukuyang bersyon ng laro."
    ...
    new "Dito mo makita ang lahat ng mga gawain ma maaaring matapos. Pwede ka rin makapunta ng mabilis"
    ...
    new "sa gusto mong gawin, at hindi ka magsayang ng oras mo sa pag-ikot sa mga iba't-ibang lugar."

    # game/logic/main_interface/quest_log_screen.rpy:887
    old "avatars of the characters are icons, the decoding of which is next."
    new "May mga icon sa tabi ng mga avatar ng mga tauhan."
    ...
    new "Hindi mo pa magagawa ito sa ngayong bahagi ng araw. Lilipat ang oras kapag piliin mo ito. Magpatuloy?"
