...
translate philippine ashlie_room_label_457043ad:

    # ch_Name "{i}(Ashley's probably in the middle of the training session. I don't want to bother her.){/i}"
    ch_Name "{i}(Siguro may ginagawa si Ashley. Ayaw kong istorbohin siya.){/i}"
...
translate philippine ashlie_room_label_02448681:
    ...
    ch_Name "{i}(Pero siguro makakatingin ako ng kaunti...){/i}"

# game/logic/locations/ashlie_room.rpy:42
translate philippine ashlie_room_label_ad35e680:
...
translate philippine ashlie_room_label_58a2b055:
    ...
    ch_Name "{i}(Sayang, hindi maghihintay si Don para sa akin.){/i}"
...
translate philippine ashlie_room_label_de7a2503:
    ...
    ch_Name "{i}(Naghihintay para sa akin si Don sa sala.){/i}"
