...
translate philippine fishing_start_af8488b6:
    ...
    Gordon "Magiging mayaman na ako dahil sa tulong mo!"

# game/logic/mini_games/fishing/logic.rpy:164
translate philippine fishing_start_654489a2:

    # Gordon "Here's your payment. Good job!"
    Gordon "Ito ang suweldo mo. Magaling!"

# game/logic/mini_games/fishing/logic.rpy:166
translate philippine fishing_start_980b7020:

    # ch_Name "{i}(Now, let's go for a walk and visit some of the places Elijah recommended.){/i}"
    ch_Name "{i}(Magibisita na tayo sa mga lugar na inirekomenda ni Elijah.){/i}"
