...
translate philippine test_duel_game_start_fa6f0a63:

    # Jacob "I'm glad to welcome the participants of the magic duel!"
    Jacob "Maligayang binabati ko ang mga kalahok ng labanang mahika!"

# game/logic/mini_games/duels/logic.rpy:2144
translate philippine test_duel_game_start_c49ef94d:

    # Jacob "Welcome to the Cordale arena!"
    Jacob "Maligayang pagbabati sa arena ng Cordale!"

# game/logic/mini_games/duels/logic.rpy:2145
translate philippine test_duel_game_start_f80b189c:

    # Jacob "Today two of our students will perform in a practice battle."
    Jacob "Ngayong araw makikipaglaban sa pagsasanay ang dalawang estudyante."

# game/logic/mini_games/duels/logic.rpy:2154
translate philippine test_duel_game_start_77c82957:

    # Jacob "Student to my right represents the house [f_now]!"
    Jacob "Ang estudyante sa kanan ko ay mula sa angkan ng [f_now]!"

# game/logic/mini_games/duels/logic.rpy:2156
translate philippine test_duel_game_start_8e46ead1:

    # Jacob "Student to my left represents the house Leonheart!"
    Jacob "Ang estudyante sa kaliwa ko ay mula sa angkan ng Leonheart!"

# game/logic/mini_games/duels/logic.rpy:2158
translate philippine test_duel_game_start_4df77c95:

    # Jacob "Duelists, I expect a fair fight from both of you. Good luck!"
    Jacob "Mga duwelista, umaasa ako sa pantay na laban mula sa iyo. Good luck!"

# game/logic/mini_games/duels/logic.rpy:2159
translate philippine test_duel_game_start_aa59c47b:

    # Jacob "And may the strongest win!"
    Jacob "At mananalo kaya ang mas malakas!"

# game/logic/mini_games/duels/logic.rpy:2168
translate philippine test_duel_game_start_368f8719:

    # ch_Name "{i}(She looks serious. I bet she won't hold back.){/i}"
    ch_Name "{i}(Seryoso siya. Hindi niya pigilan ang lakas niya.){/i}"

# game/logic/mini_games/duels/logic.rpy:2170
translate philippine test_duel_game_start_4e97e690:

    # ch_Name "{i}(Neither should I!){/i}"
    ch_Name "{i}(Hindi ko rin gagawin 'yan!){/i}"

# game/logic/mini_games/duels/logic.rpy:2172
translate philippine test_duel_game_start_6c3294f0:

    # UnknownGirl "I'm ready."
    UnknownGirl "Hnada na ako."

# game/logic/mini_games/duels/logic.rpy:2182
translate philippine test_duel_game_start_a30443e9:

    # UnknownGirl "[unknown_girl_say]"
    UnknownGirl ""

# game/logic/mini_games/duels/logic.rpy:2270
translate philippine test_duel_lose_681664bf:

    # UnknownGirl "{b}[enemy_attack_magick]!{/b}"
    UnknownGirl ""

# game/logic/mini_games/duels/logic.rpy:2274
translate philippine test_duel_lose_58203aaa:

    # UnknownGirl "{b}Combat bolt!{/b}"
    UnknownGirl ""

# game/logic/mini_games/duels/logic.rpy:2373
translate philippine test_duel_lose_a30443e9:

    # UnknownGirl "[unknown_girl_say]"
    UnknownGirl ""

# game/logic/mini_games/duels/logic.rpy:2402
translate philippine test_duel_win_383f3d2e:

    # ch_Name "{b}[duel_damage_name]!{/b}"
    ch_Name ""

# game/logic/mini_games/duels/logic.rpy:2551
translate philippine end_duel_2c0c4064:

    # ch_Name "[unknown_girl_say]"
    ch_Name ""

# game/logic/mini_games/duels/logic.rpy:2556
translate philippine end_duel_37310b9f:

    # Jacob "[f_now]'s duelist cannot continue the battle."
    Jacob "Hindi na makakapatuloy ang duwelista ng [f_now]"
...
translate philippine end_duel_9af6ed18:
    ...
    Jacob "Huminga ka habang ako ay..."

# game/logic/mini_games/duels/logic.rpy:2562
translate philippine end_duel_f815f9fd:

    # Jacob "...see to the loser."
    Jacob "Makikipag-usapan sa natalo."
...
translate philippine strings:
    ...
    new "Humanda kang mawalan ng mga puntos!"
    ...
    new "Mas gusto kong matahimik ka."

    # game/logic/mini_games/duels/logic.rpy:2543
    old "So appetizing. I wonder who's hiding beneath that mask?"
    new "Nagpapasigla naman. Sino ba ang nasa ilalim ng maskara?"

    # game/logic/mini_games/duels/logic.rpy:2543
    old "A worthy fight! I wish I knew who you were..."
    new "Mabuting laban! Sana alam ko kung sino ka..."

    # game/logic/mini_games/duels/logic.rpy:2543
    old "And so shall it be with anyone I challenge!"
    new "Ganyan din ang mangyayari sa lahat na hinahamon ko!"

# TODO: Translation updated at 2022-05-12 08:59

# game/logic/mini_games/duels/logic.rpy:2216
translate philippine test_duel_game_start_a30443e9_1:
