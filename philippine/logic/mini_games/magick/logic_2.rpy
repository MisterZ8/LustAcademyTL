...
translate philippine MagicMiniGameLabel_2_4c3300fa:

    # ch_Name "Miss Lapis, I'd like to practice my spell."
    ch_Name "Miss Lapis, gusto kong mag-ensayo ng mahika."

# game/logic/mini_games/magick/logic_2.rpy:745
translate philippine MagicMiniGameLabel_2_0d57492a:

    # Victoria "Commendable zeal, [Name]. What spell are you interested in?"
    Victoria "Mabuti talaga, [Name]. Anong mahika ang gusto mong subukan?"

# game/logic/mini_games/magick/logic_2.rpy:763
translate philippine MagicMiniGameLabel_2_e928ed52:

    # ch_Name "I wish to improve my mastery of [spellname], ma'am."
    ch_Name "Gusto kong palakasin ang [spellname], ma'am."

# game/logic/mini_games/magick/logic_2.rpy:765
translate philippine MagicMiniGameLabel_2_7fe45ab2:

    # Victoria "Excellent! Stand at the board and begin."
    Victoria "Magaling! Tumayo ka sa harap ang magsimula."

# game/logic/mini_games/magick/logic_2.rpy:788
translate philippine MagicMiniGameLabel_2_1117eb1b:

    # "Score: [score_1]%%"
    "Puntos: [score_1]%%"

# game/logic/mini_games/magick/logic_2.rpy:794
translate philippine MagicMiniGameLabel_2_9ca4635e:

    # Victoria "Concentrate, [Surname]! I know you can do better than that."
    Victoria "Magpokus, [Surname]! Alam ko na kaya mo ito."

# game/logic/mini_games/magick/logic_2.rpy:797
translate philippine MagicMiniGameLabel_2_c0a430be:

    # Victoria "Not a bad result, but there's room for improvement."
    Victoria "Hindi naman masama, pero mapapabuti pa."

# game/logic/mini_games/magick/logic_2.rpy:801
translate philippine MagicMiniGameLabel_2_48a2ce7f:

    # Victoria "Amazing, [Name]! Excellent concentration! Can you do it again?"
    Victoria "Napakahusay, [Name]! Mabuting pagpokus! Magagawa mo ba ulit?"

# game/logic/mini_games/magick/logic_2.rpy:823
translate philippine MagicMiniGameLabel_2_c2ed29a9:

    # "Score: [score_2]%%"
    "Puntos: [score_2]%%"

# game/logic/mini_games/magick/logic_2.rpy:829
translate philippine MagicMiniGameLabel_2_b103f4dd:

    # Victoria "Come on, [Name]. I'm sure you can do better."
    Victoria ""

# game/logic/mini_games/magick/logic_2.rpy:832
translate philippine MagicMiniGameLabel_2_2dc12541:

    # Victoria "Not bad, but I've seen that you can do better."
    Victoria "Hindi naman masama, pero mapapabuti pa."

# game/logic/mini_games/magick/logic_2.rpy:836
translate philippine MagicMiniGameLabel_2_ade62796:

    # Victoria "Well done, [Name]! You're getting better and better! Will you do it again?"
    Victoria "Magaling talaga, [Name]! Nagiging eksperto ka na! Magagawa mo ba ulit?"

# game/logic/mini_games/magick/logic_2.rpy:861
translate philippine MagicMiniGameLabel_2_51d176b9:

    # "Score: [score_3]%%"
    "Puntos: [score_3]%%"

# game/logic/mini_games/magick/logic_2.rpy:867
translate philippine MagicMiniGameLabel_2_28ff02a7:

    # Victoria "No, no. This is clearly not your day, [Name]!"
    Victoria "Hindi, hindi. Hindi ito ang araw mo, [Name]!"

# game/logic/mini_games/magick/logic_2.rpy:870
translate philippine MagicMiniGameLabel_2_35637f40:

    # Victoria "It's a fairly stable spell, but it could be better."
    Victoria "Matatag naman ang mahika, pero hindi perpekto."

# game/logic/mini_games/magick/logic_2.rpy:874
translate philippine MagicMiniGameLabel_2_49d1071b:

    # Victoria "That's great! That's a phenomenal result!"
    Victoria "Ang galing! Kahanga-hangang resulta!"

# game/logic/mini_games/magick/logic_2.rpy:878
translate philippine end_MagicMiniGame_2_label_7feba4d1:

    # Victoria "That's enough, [Name]. The class has come to an end, so we'll continue next time."
    Victoria "Tama na 'yan, [Name]. Natapos na ang klase, kaya ipagpatuloy natin ito sa susunod."

# game/logic/mini_games/magick/logic_2.rpy:881
translate philippine end_MagicMiniGame_2_label_6e5c62ef:

    # ch_Name "Thank you, Miss Lapis. You are my favorite teacher!"
    ch_Name "Salamat po, Ms. Lapis. Ikaw ang paborito kong guro!"
...
translate philippine strings:
    ...
    new "\n\nMag-click at kaladkarin ang mouse para iguhit ang simbolo. Mayroon kang "
