...
translate spanish_LatAm strings:
    ...
    old "Lost foliant"
    new "Perdiste foliante"

    # game/logic/main_interface/quest_log_screen.rpy:130
    old "Return this book to Amelie in the library for a reward"
    new "Regresa este libro a Amelie en la biblioteca y obtén una recompensa"
    ...
    new ", su historia en esta versión del juego ha terminado."
    ...
    new "Aquí puedes observar todas las rutas, actividades, etc. que están disponibles para ti y navegar rápidamente"
    ...
    new "a la que desees, sin desperdiciar tiempo dezplazándote por las locaciones y buscando. Al lado de"

    # game/logic/main_interface/quest_log_screen.rpy:887
    old "avatars of the characters are icons, the decoding of which is next."
    new "los avatares de los personajes hay íconos, cuya decodificación es la siguiente."
    ...
    new "Esta ruta no está disponible a esta hora del día. Elegir esta opción hará que se salte el tiempo. ¿Quieres continuar?"
