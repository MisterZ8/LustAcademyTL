...
translate spanish_LatAm test_duel_game_start_fa6f0a63:

    # Jacob "I'm glad to welcome the participants of the magic duel!"
    Jacob "¡Me da felicidad darle la bienvenida a los participantes del duelo mágico!"

# game/logic/mini_games/duels/logic.rpy:2144
translate spanish_LatAm test_duel_game_start_c49ef94d:

    # Jacob "Welcome to the Cordale arena!"
    Jacob "¡Bienvenidos a la arena de Cordale!"

# game/logic/mini_games/duels/logic.rpy:2145
translate spanish_LatAm test_duel_game_start_f80b189c:

    # Jacob "Today two of our students will perform in a practice battle."
    Jacob "Hoy, dos de nuestros estudiantes participaran en una batalla de práctica."

# game/logic/mini_games/duels/logic.rpy:2154
translate spanish_LatAm test_duel_game_start_77c82957:

    # Jacob "Student to my right represents the house [f_now]!"
    Jacob "¡El estudiante a mi derecha representa la casa [f_now]!"

# game/logic/mini_games/duels/logic.rpy:2156
translate spanish_LatAm test_duel_game_start_8e46ead1:

    # Jacob "Student to my left represents the house Leonheart!"
    Jacob "¡El estudiante a mi izquierda representa la casa Leonheart!"

# game/logic/mini_games/duels/logic.rpy:2158
translate spanish_LatAm test_duel_game_start_4df77c95:

    # Jacob "Duelists, I expect a fair fight from both of you. Good luck!"
    Jacob "Duelistas, espero un combate limpio de los dos. ¡Buena suerte!"

# game/logic/mini_games/duels/logic.rpy:2159
translate spanish_LatAm test_duel_game_start_aa59c47b:

    # Jacob "And may the strongest win!"
    Jacob "¡Y que gane el más fuerte!"

# game/logic/mini_games/duels/logic.rpy:2168
translate spanish_LatAm test_duel_game_start_368f8719:

    # ch_Name "{i}(She looks serious. I bet she won't hold back.){/i}"
    ch_Name "{i}(Se ve muy seria. Apuesto a que no se detendrá.){/i}"

# game/logic/mini_games/duels/logic.rpy:2170
translate spanish_LatAm test_duel_game_start_4e97e690:

    # ch_Name "{i}(Neither should I!){/i}"
    ch_Name "{i}(¡Pero tampoco yo!){/i}"

# game/logic/mini_games/duels/logic.rpy:2172
translate spanish_LatAm test_duel_game_start_6c3294f0:

    # UnknownGirl "I'm ready."
    UnknownGirl "Estoy lista."

# game/logic/mini_games/duels/logic.rpy:2182
translate spanish_LatAm test_duel_game_start_a30443e9:

    # UnknownGirl "[unknown_girl_say]"
    UnknownGirl ""

# game/logic/mini_games/duels/logic.rpy:2270
translate spanish_LatAm test_duel_lose_681664bf:

    # UnknownGirl "{b}[enemy_attack_magick]!{/b}"
    UnknownGirl ""

# game/logic/mini_games/duels/logic.rpy:2274
translate spanish_LatAm test_duel_lose_58203aaa:

    # UnknownGirl "{b}Combat bolt!{/b}"
    UnknownGirl ""

# game/logic/mini_games/duels/logic.rpy:2373
translate spanish_LatAm test_duel_lose_a30443e9:

    # UnknownGirl "[unknown_girl_say]"
    UnknownGirl ""

# game/logic/mini_games/duels/logic.rpy:2402
translate spanish_LatAm test_duel_win_383f3d2e:

    # ch_Name "{b}[duel_damage_name]!{/b}"
    ch_Name ""

# game/logic/mini_games/duels/logic.rpy:2551
translate spanish_LatAm end_duel_2c0c4064:

    # ch_Name "[unknown_girl_say]"
    ch_Name ""

# game/logic/mini_games/duels/logic.rpy:2556
translate spanish_LatAm end_duel_37310b9f:

    # Jacob "[f_now]'s duelist cannot continue the battle."
    Jacob "El duelista de [f_now] no puede continuar con la batalla."

# game/logic/mini_games/duels/logic.rpy:2558
translate spanish_LatAm end_duel_61eb1d29:

    # Jacob "Victory to the House of Leonheart!"
    Jacob "¡Victoria para la casa de Leonheart"

# game/logic/mini_games/duels/logic.rpy:2559
translate spanish_LatAm end_duel_9a6c67b5:

    # Jacob "Great job! That's all for today."
    Jacob "¡Gran trabajo! Eso es todo por hoy."

# game/logic/mini_games/duels/logic.rpy:2561
translate spanish_LatAm end_duel_9af6ed18:

    # Jacob "Go rest while I..."
    Jacob "Relajate mientras yo..."

# game/logic/mini_games/duels/logic.rpy:2562
translate spanish_LatAm end_duel_f815f9fd:

    # Jacob "...see to the loser."
    Jacob "... veo al perdedor"
...
translate spanish_LatAm strings:
    ...
    new "¡Preparate para perder los puntos de tu casa, perdedor!"

    # game/logic/mini_games/duels/logic.rpy:2173
    old "You're in a lot of trouble!"
    new "!Estas en muchos problemas!"

    # game/logic/mini_games/duels/logic.rpy:2173
    old "I can't guarantee you'll survive our battle."
    new "No te garantizo que sobrevivas nuestra batalla."

    # game/logic/mini_games/duels/logic.rpy:2173
    old "Are you challenging me? Unwise!"
    new "¿Me estas desafiando a mi? ¡Insensata!"

    # game/logic/mini_games/duels/logic.rpy:2173
    old "Let's get this over with, I'm bored already!"
    new "Vamos a terminar con esto, ¡ya me aburrí!"

    # game/logic/mini_games/duels/logic.rpy:2173
    old "Hey, try to go easy on me, okay?"
    new "Oye, intenta ir con calma conmigo, ¿si?"

    # game/logic/mini_games/duels/logic.rpy:2285
    old "You realize now that you're no match for me, right?"
    new "¿Te das cuenta ahora de que no eres rival para mi?"

    # game/logic/mini_games/duels/logic.rpy:2285
    old "What's the matter, was that too much?"
    new "¿Cual es el problema, fue mucho para ti?"

    # game/logic/mini_games/duels/logic.rpy:2285
    old "If you can't take a punch like a man, go running back to mommy!"
    new "¡Si no puedes recibir un golpe como un hombre, regresa corriendo con mami!"
    ...
    new "Me gustas más cuando estas callada"

    # game/logic/mini_games/duels/logic.rpy:2543
    old "So appetizing. I wonder who's hiding beneath that mask?"
    new "Tan apetecedor, ¿me pregunto quien estará escondido detras de esa máscara?"

    # game/logic/mini_games/duels/logic.rpy:2543
    old "A worthy fight! I wish I knew who you were..."
    new "¡Una pelea digna! Desearía saber quien eres..."

    # game/logic/mini_games/duels/logic.rpy:2543
    old "And so shall it be with anyone I challenge!"
    new "¡Y así será con cualquiera que yo desafie!"
