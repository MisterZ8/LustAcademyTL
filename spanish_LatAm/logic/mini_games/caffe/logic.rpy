...
translate spanish_LatAm end_caffe_2_08702551:

    # Molly "You're doing just fine! Keep up the good work!"
    Molly "¡Lo estas haciendo bien! ¡Sigue así!"

# game/logic/mini_games/caffe/logic.rpy:265
translate spanish_LatAm end_caffe_2_fa4a7e1c:

    # Molly "You're a treasure! What would I do without you?"
    Molly "¡Eres un tesoro! ¿Que haría sin ti?"

# game/logic/mini_games/caffe/logic.rpy:270
translate spanish_LatAm end_caffe_2_7e771fa2:

    # Molly "Just magical! [Name], you're on fire!"
    Molly "¡Mágico! [Name], estas que ardes!"

# game/logic/mini_games/caffe/logic.rpy:275
translate spanish_LatAm end_caffe_2_9a2c499b:

    # Molly "The clients are crazy about you! What's your secret?"
    Molly "¡Los clientes estan locos por ti! ¿Cuál es tu secreto?"

# game/logic/mini_games/caffe/logic.rpy:280
translate spanish_LatAm end_caffe_2_f834478f:

    # Molly "Great job, [Name]! Looks like all the tips are yours today."
    Molly "¡Gran trabajo, [Name]! Parece que todas las propinas son tuyas hoy."

# game/logic/mini_games/caffe/logic.rpy:290
translate spanish_LatAm end_caffe_2_1e36850f:

    # Molly "Hey! If you keep this up, we'll lose all our customers."
    Molly "¡Oye! Si sigues asi, perderemos todos nuestros clientes."

# game/logic/mini_games/caffe/logic.rpy:292
translate spanish_LatAm end_caffe_2_196ca8b4:

    # Molly "What's the matter with you today? Pull yourself together, please!"
    Molly "¿Cuál es el problema contigo hoy? ¡Mejora, por favor!"

# game/logic/mini_games/caffe/logic.rpy:294
translate spanish_LatAm end_caffe_2_00855181:

    # Molly "Quit your daydreaming and focus on work, [Name]! "
    Molly "¡Deja de dormir y enfocate en el trabajo, [Name]!"

# game/logic/mini_games/caffe/logic.rpy:296
translate spanish_LatAm end_caffe_2_f948c336:

    # Molly "Are you sure you weren't lying that you used to work in the service industry?"
    Molly "¿Estas seguro de que no mentiste cuando me dijiste que trabajabas en la industria de servicio?"

# game/logic/mini_games/caffe/logic.rpy:298
translate spanish_LatAm end_caffe_2_fd0c933a:

    # Molly "What's wrong with you today? I don't need that kind of help!"
    Molly "¿Que pasa contigo hoy? ¡No necesito ese tipo de ayuda!"

# game/logic/mini_games/caffe/logic.rpy:351
translate spanish_LatAm hide_all_caffe_screens_f86310cf:

    # Molly "Thank you for your help, [Name]."
    Molly "Gracias por tu ayuda, [Name]."

# game/logic/mini_games/caffe/logic.rpy:352
translate spanish_LatAm hide_all_caffe_screens_4003e28f:

    # Molly "I'm very glad I found someone I can count on."
    Molly "Estoy muy feliz de haber encontrado alguien en quien confiar."

# game/logic/mini_games/caffe/logic.rpy:353
translate spanish_LatAm hide_all_caffe_screens_1edd7886:

    # ch_Name "Thank you, too, Molly. I'm glad we're working together, too."
    ch_Name "Gracias, tambien, Molly. Yo igual estoy contento de trabajar contigo."

# game/logic/mini_games/caffe/logic.rpy:358
translate spanish_LatAm hide_all_caffe_screens_99f9584f:

    # Molly "[Name]! I never thought I'd find the perfect employee..."
    Molly "¡[Name]! Nunca pense que encontraría al empleado perfecto..."

# game/logic/mini_games/caffe/logic.rpy:359
translate spanish_LatAm hide_all_caffe_screens_95bcb68b:

    # Molly "But you and I are taking over! Be sure to come again!"
    Molly "¡Pero tu y yo nos estamos haciendo cargo! ¡Asegurate de regresar!"

# game/logic/mini_games/caffe/logic.rpy:360
translate spanish_LatAm hide_all_caffe_screens_1368a22f:

    # ch_Name "Of course, always happy to spend time with you and make some extra money."
    ch_Name "Por supuesto, siempre feliz de pasar tiempo contigo y hacer dinero extra."

# game/logic/mini_games/caffe/logic.rpy:365
translate spanish_LatAm hide_all_caffe_screens_00000a5f:

    # Molly "Good work today!"
    Molly "¡Buena suerte hoy!"

# game/logic/mini_games/caffe/logic.rpy:366
translate spanish_LatAm hide_all_caffe_screens_5a8f6979:

    # Molly "Come back more often and we'll get rich!"
    Molly "¡Ven más seguido y nos haremos ricos!"

# game/logic/mini_games/caffe/logic.rpy:367
translate spanish_LatAm hide_all_caffe_screens_1a051f3a:

    # ch_Name "You got it."
    ch_Name "Lo tienes."

# game/logic/mini_games/caffe/logic.rpy:372
translate spanish_LatAm hide_all_caffe_screens_35d314aa:

    # Molly "Good work today. But we can do better!"
    Molly "Buen trabajo hoy. ¡Pero podemos mejorar!"

# game/logic/mini_games/caffe/logic.rpy:373
translate spanish_LatAm hide_all_caffe_screens_8c42e022:

    # Molly "Come again."
    Molly "Vuelve."

# game/logic/mini_games/caffe/logic.rpy:374
translate spanish_LatAm hide_all_caffe_screens_d3d0271c:

    # ch_Name "Always happy to help."
    ch_Name "Siempre contento de ayudar."

# game/logic/mini_games/caffe/logic.rpy:379
translate spanish_LatAm hide_all_caffe_screens_2dcba8e4:

    # Molly "Yeah, well...{w} It could have been better."
    Molly "Si, bueno... {w} Pudo ser mejor"

# game/logic/mini_games/caffe/logic.rpy:380
translate spanish_LatAm hide_all_caffe_screens_4d5b28e8:

    # Molly "I hope you'll learn in time."
    Molly "Espero que aprendas con el tiempo."
...
translate spanish_LatAm hide_all_caffe_screens_28fa1654:
    ...
    Molly "Hubieron muchas quejas sobre ti hoy. ¿Qué pasa?"

# game/logic/mini_games/caffe/logic.rpy:387
translate spanish_LatAm hide_all_caffe_screens_fd7e2229:

    # Molly "Are you sick?"
    Molly "¿Estas enfermo?"

# game/logic/mini_games/caffe/logic.rpy:388
translate spanish_LatAm hide_all_caffe_screens_081376df:

    # ch_Name "No, I don't know what came over me. Next time will be better."
    ch_Name "No, no se que me paso. La siguente vez será mejor."

# game/logic/mini_games/caffe/logic.rpy:393
translate spanish_LatAm hide_all_caffe_screens_27c21352:

    # Molly "Goblin socks, [Name]! Thanks for volunteering, of course..."
    Molly "Goblin socks, [Name]! Gracias por ser voluntario, por supuesto..."

# game/logic/mini_games/caffe/logic.rpy:394
translate spanish_LatAm hide_all_caffe_screens_be5fe4a5:

    # Molly "But you're no help at all."
    Molly "Pero no ayudas en nada."

# game/logic/mini_games/caffe/logic.rpy:395
translate spanish_LatAm hide_all_caffe_screens_1cc8e8c0:

    # ch_Name "Yes, something went wrong, sorry. But next time it'll be fine."
    ch_Name "Si, algo malo paso. La siguiente vez será mejor."

translate spanish_LatAm strings:

    # game/logic/mini_games/caffe/logic.rpy:193
    old "Satisfied guests left a tip!"
    new "¡Cliente satisfecho dejo propina!"
    ...
    new "Los clientes se cansaron de esperar y se fueron..."

    # game/logic/mini_games/caffe/logic.rpy:199
    old "You messed up the order..."
    new "Arruinaste la orden..."
